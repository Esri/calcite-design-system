    ...
    <calcite-card-group label="label">
      <calcite-card label="test card">
        <img
          ...
          src="${(0,_storybook_placeholder_image__WEBPACK_IMPORTED_MODULE_3__.j)({width:280,height:150})}"
        />
        <h3 slot="heading">Portland Businesses</h3>
        <div>
          Created: Apr 22, 2019
...
//# sourceMappingURL=components-card-group-card-group-stories.c5bada8f.iframe.bundle.js.map