...
`,withDescriptionShortLabelAndContentEndSlot=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
  <calcite-combobox-item
...
`;withDescriptionShortLabelAndContentEndSlot.decorators=[function allScaleComboboxBuilder(itemsStory,context){const items=itemsStory(),{selectionMode}=context.args,selectionModes=Array.isArray(selectionMode)?selectionMode:[selectionMode],scales=["s","m","l"];return _support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
    <style>
      calcite-combobox {
        margin-bottom: 250px;
      }
    ...
    ${selectionModes.map((selectionMode=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
        <div class="selection-mode-group">
          ${scales.map((scale=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
