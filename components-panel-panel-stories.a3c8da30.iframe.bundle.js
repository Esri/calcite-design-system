...
`,footerHTML=_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
  <calcite-button slot="${_resources__WEBPACK_IMPORTED_MODULE_4__._f.footerStart}" width="half" appearance="outline">Footer start</calcite-button>
  <calcite-button slot="${_resources__WEBPACK_IMPORTED_MODULE_4__._f.footerEnd}" width="half">Footer end</calcite-button>
`,panelContent=`${headerHTML}\n  <calcite-action text="Action" label="Action" slot="${_resources__WEBPACK_IMPORTED_MODULE_4__._f.headerActionsStart}" icon="bluetooth"></calcite-action>\n  <calcite-action text="Action" label="Action" slot="${_resources__WEBPACK_IMPORTED_MODULE_4__._f.headerActionsEnd}" icon="attachment"></calcite-action>\n  ${contentHTML}\n  ${footerHTML}`,simple=args=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
  <calcite-panel
