...
`,allVariantsHorizontal=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`
  ...
  <div class="parent">
    ...
    <div class="child">
      <calcite-tile-group scale="s">
        <calcite-tile>
          <img src="${(0,_storybook_placeholder_image__WEBPACK_IMPORTED_MODULE_3__.j)({width:500,height:500})}" slot="content-top" />
        </calcite-tile>
        <calcite-tile>
          <img src="${(0,_storybook_placeholder_image__WEBPACK_IMPORTED_MODULE_3__.j)({width:500,height:500})}" slot="content-top" />
        </calcite-tile>
  ...
  <div class="parent">
    ...
    <div class="child">
      <calcite-tile-group scale="s">
        <calcite-tile>
          <img src="${(0,_storybook_placeholder_image__WEBPACK_IMPORTED_MODULE_3__.j)({width:500,height:500})}" slot="content-bottom" />
        </calcite-tile>
        <calcite-tile>
          <img src="${(0,_storybook_placeholder_image__WEBPACK_IMPORTED_MODULE_3__.j)({width:500,height:500})}" slot="content-bottom" />
        </calcite-tile>
