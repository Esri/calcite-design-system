...
# You can build/test/start/serve the components here:
# CMD [ "npm", "run", "test" ]

# Or call the test/start/etc npm script afterwards:
#  $ docker build --tag components .
#  $ docker run -i --init --rm --cap-add=SYS_ADMIN -v ./:/app -p 3333:3333 --name components-demos components npm start
