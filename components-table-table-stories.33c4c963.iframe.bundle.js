...
`,simpleStriped_TestOnly=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_0__.q`<calcite-table striped caption="Simple-striped table">
  ...
  </calcite-table>`,singleSelectionSelected_TestOnly=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_0__.q` <calcite-table selection-mode="single" caption="selection-mode single table">
    <calcite-action slot="selection-actions" icon="layer"></calcite-action>
    <calcite-action slot="selection-actions" icon="send"></calcite-action>
    <calcite-action slot="selection-actions" icon="copy"></calcite-action>
    <calcite-action slot="selection-actions" icon="plus"></calcite-action>
  ...
  </calcite-table>`,selectionModeMultipleAndAllSelectedSinglePageOnLoad_TestOnly=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_0__.q` <calcite-table selection-mode="multiple" numbered caption="selection-mode multiple with selected at load">
    <calcite-action slot="selection-actions" icon="layer"></calcite-action>
    <calcite-action slot="selection-actions" icon="send"></calcite-action>
    <calcite-action slot="selection-actions" icon="copy"></calcite-action>
    <calcite-action slot="selection-actions" icon="plus"></calcite-action>
  ...
  </calcite-table>`,selectionModeMultipleAndAllSelectedMultiplePagesOnLoad_TestOnly=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_0__.q` <calcite-table
    page-size="4"
    selection-mode="multiple"
    numbered
    caption="selection-mode multiple with selected at load"
