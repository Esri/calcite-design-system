...
- `3 - in development`: Issues that are actively being worked on.
...
- `1 - in design`: Issues that are going through a design phase. Once design completes their work or review, the `2 - ready for dev` label will be added to the issue, which means a developer can pick up the issue.
