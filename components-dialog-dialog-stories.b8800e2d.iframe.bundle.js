...
--calcite-dialog-content-space: 50px; --calcite-dialog-offset-x: 50px; --calcite-dialog-offset-y: -30px;`,withShellInside=()=>formatting.q`<calcite-dialog
    open
    modal
    heading="heading"
    description="description"
