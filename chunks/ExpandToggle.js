...
import { x as C, E as T } from "./iframe.js";
...
const P = ({ tooltip: t, referenceElement: o, expanded: e, ref: n }) => (t && (t.referenceElement = !e && o ? o : null), n && n(o), o), G = ({ expanded: t, expandText: o, collapseText: e, expandLabel: n, collapseLabel: i, toggle: r, el: c, position: s, tooltip: u, ref: f, scale: x }) => {
  ...
  return C`<calcite-action .icon=${t ? E : p} id=expand-toggle .label=${S} @click=${r} .scale=${x} .text=${h} .textEnabled=${t} title=${(!t && !u ? h : null) ?? T} ${b(($) => P({ tooltip: u, referenceElement: $, expanded: t, ref: f }))}></calcite-action>`;
};
export {
  G as E,
  H as a,
