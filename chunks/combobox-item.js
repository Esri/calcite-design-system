...
import { a as z, L as w, c as g, s as i, b as c, A as y, o as I, d as H } from "./index.js";
...
class F extends w {
  ...
  render() {
    const { disabled: e, heading: a, label: v, value: h, filterTextMatchPattern: n, description: m, shortHeading: b } = this, l = A(this.selectionMode), f = e || l ? void 0 : o.checked, x = l ? this.selected ? o.selectedSingle : o.circle : this.indeterminate ? o.indeterminate : this.selected ? o.checked : o.unchecked, C = v || h || a, $ = a || h, k = {
      [t.label]: !0,
    ...
    })} style=${I({ [D]: `${S}` })}><li class=${i(k)} id=${this.guid ?? y} @click=${this.itemClickHandler}>${this.renderSelectIndicator(x)}<slot name=${p.contentStart}></slot>${this.renderIcon(f)}<div class=${i(t.centerContent)}><div class=${i(t.heading)}>${r({
      text: $,
      pattern: n
