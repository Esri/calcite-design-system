import { a as S, L as I, d as b, s as i, x as c, j as y, E as L, c as H } from "./iframe.js";
...
class j extends I {
  ...
  render() {
    ...
    })} style=${y({ "--calcite-combobox-item-spacing-indent-multiplier": `${z}` })}><li class=${i(k)} id=${this.guid ?? L} @click=${this.itemClickHandler}>${this.renderSelectIndicator(C)}<slot name=${p.contentStart}></slot>${this.renderIcon(f)}<div class=${i(t.centerContent)}><div class=${i(t.heading)}>${r({
      text: $,
      pattern: l
