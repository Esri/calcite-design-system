...
import { b as a, o as g, c as w, m as T } from "./utils3.js";
...
const {
  ...
  args: {
    type: v.defaultValue,
    alignment: y.defaultValue,
    numberButtonType: f.defaultValue,
    min: 0,
    max: 100,
    step: 1,
    prefixText: "",
  ...
  argTypes: {
    ...
    alignment: {
      options: y.values.filter((e) => e !== "center"),
      control: {
        type: "select"
      }
    },
    numberButtonType: {
      options: f.values.filter((e) => e !== "grid" && e !== "inline" && e !== "center" && e !== "auto" && e !== "fixed" && e !== "horizontal-single"),
      control: {
        type: "select"
      }
    },
  ...
  <div style="width:300px;max-width:100%;text-align:center;">
    <calcite-input
      ...
      ${g("validation-icon", e.validationIcon)}
    ></calcite-input>
  </div>
`, l = () => t`
  <div style="width:300px;max-width:100%;text-align:center;">
...
`, o = () => t`<calcite-input disabled value="disabled"></calcite-input>`, i = () => t`
...
const s = () => t` <calcite-input type="number" value="-Infinity"></calcite-input>`, c = () => t` <calcite-input type="number" lang="ar-EG" value="123456"></calcite-input>`, r = () => t`
  <style>
    .container {
      display: flex;
...
const B = ["simple", "withSlottedAction", "disabled", "darkModeRTL", "negativeInfinity", "arabicLocaleWithLatinNumberingSystem", "validationMessageAllScales", "widthSetToBreakpoints", "shrinkingInputDoesNotObscureCalendarIcon", "fontSizeSetAtRoot", "overlayDoesNotObscureIcon", "numberHorizontal", "inlineEditable"];
export {
  B as __namedExportsOrder,
  c as arabicLocaleWithLatinNumberingSystem,
  i as darkModeRTL,
  P as default,
  o as disabled,
  p as fontSizeSetAtRoot,
  x as inlineEditable,
  s as negativeInfinity,
  b as numberHorizontal,
