import { r as a, e as n } from "./index9.js";
import { r as d, H as h, A as R, C as _, D as f } from "./index2.js";
  ...
  constructor() {
    this.render = async (e, t, r) => {
      ...
      return new Promise((c, E) => {
        import("./index3.js").then(({ MDXProvider: p }) => g(n.createElement(N, { showException: E, key: Math.random() }, n.createElement(p, { components: o }, n.createElement(u, { context: e, docsParameter: t }))), r)).then(() => c());
      });
    }, this.unmount = (e) => {
      w(e);
    };
