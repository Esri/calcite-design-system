...
import { u as g, I as m } from "./interactive.js";
...
class w extends h {
  ...
  async setFocus(e) {
    return this.focusSetter(() => ({ target: this.containerEl.value, includeContainer: !0 }), e);
  }
  updated() {
    g(this);
  }
