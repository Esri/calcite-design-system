...
import { a as O, L as M, D as R, c as m, l as k, s as p, o as H, b as d, d as T } from "./index.js";
import { n as L } from "./ref.js";
import { i as C } from "./keyed.js";
import { d as U } from "./debounce.js";
import { v as y, s as S, g as G } from "./dom.js";
...
class Q extends M {
  constructor() {
    ...
    }), this.cancelable = B()(this), this.sortable = V()(this), this.updateListItemsDebounced = U(this.updateListItems, R.nextTick), this.visibleItems = [], this.willFilterEmit = !1, this.willPerformFilter = !1, this.messages = q({ blocking: !0 }), this.focusSetter = W()(this), this.interactiveContainer = K(this), this.filterRowResizeObserver = D("resize", () => this.updateFilterRowHeight()), this.setFilterContainerEl = (t) => {
  ...
  filterElements({ el: t, filteredItems: e, visibleParents: i }) {
    ...
    t.filterHidden = a;
    const s = t.parentElement.closest(J);
