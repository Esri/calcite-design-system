...
import { c as x, b as m, m as v } from "./utils.js";
...
const {
  ...
  argTypes: {
    ...
    alignment: {
      options: b.values.filter((e) => e !== "center"),
      control: {
        type: "select"
      }
    },
...
const k = ["simple", "withSlottedAction", "darkModeRTL_TestOnly", "Infinity_TestOnly", "mediumIconForLargeInputStyling_TestOnly", "arabicLocaleWithLatinNumberingSystem_TestOnly", "validationMessageAllScales_TestOnly", "widthSetToBreakpoints_TestOnly", "fontSizeSetAtRoot"];
export {
