import { j as r, L as o, x as s, s as i, k as c } from "./iframe.js";
import { n as d } from "./ref.js";
import { c as h } from "./observers.js";
import { B as m } from "./dom.js";
...
class f extends o {
  ...
  render() {
    ...
    return s`<div class=${i(n.scrim)}>${t ? s`<calcite-loader .label=${l.loading} .scale=${this.loaderScale} ${d(this.storeLoaderEl)}></calcite-loader>` : null}<div class=${i(n.content)} .hidden=${!e}><slot @slotchange=${this.handleDefaultSlotChange}></slot></div></div>`;
  }
}
c("calcite-scrim", f);
export {
