import { k as n, h as e, j as U } from "./index.js";
import { A as V } from "./resources16.js";
import { d as W, S as t } from "./resources8.js";
...
const {
  ...
  args: {
    ...
    dragEnabled: !1,
    resizable: !1,
    overlayPositioning: K.defaultValue,
    outsideCloseDisabled: !1
  },
  argTypes: {
    kind: {
      options: j.values.filter((a) => a !== "inverse" && a !== "neutral"),
      control: {
        type: "select"
      }
    },
  ...
  parameters: {
    ...
    icon="bluetooth"
  ></calcite-action>
  <calcite-action text="Action" label="Action" slot="${t.headerActionsEnd}" icon="attachment"></calcite-action>`, F = e` <calcite-action
    text="banana"
    text-enabled
    icon="banana"
  ...
  >
    ${_} ${F} The small modal is perfect for short confirmation dialogs or very compact
    interfaces with few elements. ${c}
  </calcite-dialog>
`, R = e`
...
`, c = e`<calcite-button
  ...
  <calcite-button slot="${t.footerEnd}" width="auto">Save</calcite-button>`, Y = e` <div
  style="margin: auto;
        padding: 20px;
        display: flex;
...
`, p = () => e`
  <calcite-dialog heading="Custom content slot dialog" open placement="cover"> ${Y} </calcite-dialog>
`, m = () => e`
...
`, N = e`--calcite-dialog-scrim-background-color: purple; --calcite-dialog-size-x: 400px;
--calcite-dialog-size-y: 400px; --calcite-dialog-footer-space: 50px; --calcite-dialog-border-color: pink;
--calcite-dialog-content-space: 50px; --calcite-dialog-offset-x: 50px; --calcite-dialog-offset-y: -30px;`, M = () => e`<calcite-dialog open modal heading="heading" description="description" scale="m" width-scale="l">
    <calcite-shell>
  ...
  </calcite-dialog>`, q = () => e`<calcite-dialog
    style="${N}"
    open
    modal
    heading="heading"
...
export {
  ...
  H as placementBottomEnd,
  E as placementBottomStart,
  L as placementTop,
  z as placementTopEnd,
  O as placementTopStart,
  k as scaleL,
  T as scaleS,
  s as simple,
  d as slots,
  ...
  A as widthScaleM,
  D as withAlertsSlot,
  f as withCustomContent,
  $ as withCustomContentDivPanel,
  v as withCustomContentPanel,
  w as withCustomHeader,
  y as withFooter,
  m as withIcon,
  g as withKindBrandIcon,
  h as withKindDangerIcon,
  u as withKindInfoIcon,
  b as withKindSuccessIcon,
  S as withKindWarningIcon,
  M as withShellInside,
  o as withTooltips
};
