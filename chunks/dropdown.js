import { a as b, L as v, d as o, s as l, x as D, c as I } from "./iframe.js";
import { n } from "./ref.js";
import { f as y, b as a, a as c } from "./dom.js";
import { d, r as E, c as r, b as x, f as k, h as C, F as p } from "./floating-ui.js";
...
import { t as H } from "./openCloseComponent.js";
...
class U extends v {
  ...
  async setFocus() {
    await F(this), y(this.referenceEl);
  }
  connectedCallback() {
    super.connectedCallback(), this.mutationObserver?.observe(this.el, { childList: !0, subtree: !0 }), this.setFilteredPlacements(), this.updateItems(), r(this);
  }
  willUpdate(e) {
  ...
  loaded() {
    this.updateSelectedItems(), r(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.mutationObserver?.disconnect(), this.resizeObserver?.disconnect(), x(this);
  }
  openHandler() {
  ...
  setReferenceEl(e) {
    this.referenceEl = e, r(this), e && this.resizeObserver?.observe(e);
  }
  setFloatingEl(e) {
    this.floatingEl = e, r(this);
  }
  keyDownHandler(e) {
    ...
    if (!t) {
      ...
      $(i) ? (this.toggleDropdown(), e.preventDefault()) : (i === "ArrowDown" || i === "ArrowUp") && (e.preventDefault(), this.focusLastDropdownItem = i === "ArrowUp", this.open = !0);
    }
  }
  updateSelectedItems() {
  ...
  render() {
    ...
    return P({ disabled: this.disabled, children: D`<div class="calcite-trigger-container" .id=${`${t}-menubutton`} @click=${this.toggleDropdown} @keydown=${this.keyDownHandler} ${n(this.setReferenceEl)}><slot aria-controls=${`${t}-menu`} .ariaExpanded=${e} aria-haspopup=menu name=${T.dropdownTrigger} @slotchange=${this.updateTriggers}></slot></div><div .ariaHidden=${!e} class=${l({
      [f.wrapper]: !0,
      [z("width", this.width, this.widthScale)]: !!(this.width || this.widthScale)
    })} ${n(this.setFloatingEl)}><div aria-labelledby=${`${t}-menubutton`} class=${l({
      [f.content]: !0,
      [p.animation]: !0,
      [p.animationActive]: e
    })} .id=${`${t}-menu`} role=menu ${n(this.setScrollerAndTransitionEl)}><slot @slotchange=${this.updateGroups}></slot></div></div>` });
  }
}
I("calcite-dropdown", U);
export {
  U as Dropdown
};
