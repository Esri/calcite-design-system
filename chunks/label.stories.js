...
const {
  ...
  args: {
    alignment: i.defaultValue,
    layout: "block",
    scale: n.defaultValue
  },
  argTypes: {
    alignment: {
      options: i.values.filter((e) => e !== "center"),
      control: {
        type: "select"
      }
    },
  ...
  <div style="width:300px;max-width:100%;text-align:center;">
    <calcite-label alignment="${e.alignment}" layout="${e.layout}" scale="${e.scale}">
      Controlled label
...
c.parameters = {
  ...
  docs: {
    ...c.parameters?.docs,
    source: {
      originalSource: `(args: LabelStoryArgs): string => html\`
  <div style="width:300px;max-width:100%;text-align:center;">
...
const S = ["simple", "darkModeRTL", "spacingWithLabel"];
export {
  S as __namedExportsOrder,
  l as darkModeRTL,
  f as default,
  c as simple,
  a as spacingWithLabel
};
