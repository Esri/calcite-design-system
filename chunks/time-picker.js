...
class Y extends K {
  ...
  render() {
    ...
    return r`<div class=${t({
      ...
      [e.buttonHourUp]: !0,
      [e.buttonTopLeft]: !0
    })} @click=${this.hourUpClickHandler} role=button><calcite-icon .icon=${a.chevronUp} .scale=${c}></calcite-icon></span><span .ariaLabel=${o.hour} aria-valuemax=23 aria-valuemin=1 .ariaValueNow=${z && parseInt(h, 10) || "0"} .ariaValueText=${h ?? void 0} class=${t({
      [e.input]: !0,
      [e.hour]: !0,
    ...
    })} @click=${this.hourDownClickHandler} role=button><calcite-icon .icon=${a.chevronDown} .scale=${c}></calcite-icon></span></div><span class=${t({ [e.delimiter]: !0, [e.hourSuffix]: !0 })}>${U}</span><div class=${t(e.column)} role=group><span .ariaLabel=${o.minuteUp} class=${t({
      [e.button]: !0,
      [e.buttonMinuteUp]: !0
    })} @click=${this.minuteUpClickHandler} role=button><calcite-icon .icon=${a.chevronUp} .scale=${c}></calcite-icon></span><span .ariaLabel=${o.minute} aria-valuemax=12 aria-valuemin=1 .ariaValueNow=${T && parseInt(m, 10) || "0"} .ariaValueText=${m ?? void 0} class=${t({
      [e.input]: !0,
      [e.minute]: !0,
    ...
    })} @click=${this.minuteDownClickHandler} role=button><calcite-icon .icon=${a.chevronDown} .scale=${c}></calcite-icon></span></div>${this.showSecond && r`<span class=${t({ [e.delimiter]: !0, [e.minuteSuffix]: !0 })}>${L}</span>` || ""}${this.showSecond && r`<div class=${t(e.column)} role=group><span .ariaLabel=${o.secondUp} class=${t({
      [e.button]: !0,
      [e.buttonSecondUp]: !0
    })} @click=${this.secondUpClickHandler} role=button><calcite-icon .icon=${a.chevronUp} .scale=${c}></calcite-icon></span><span .ariaLabel=${o.second} aria-valuemax=59 aria-valuemin=0 .ariaValueNow=${A && parseInt(p, 10) || "0"} .ariaValueText=${p ?? void 0} class=${t({
      [e.input]: !0,
      [e.second]: !0,
    ...
    })} @click=${this.secondDownClickHandler} role=button><calcite-icon .icon=${a.chevronDown} .scale=${c}></calcite-icon></span></div>` || ""}${this.showFractionalSecond && r`<span class=${t({ [e.delimiter]: !0, [e.decimalSeparator]: !0 })}>${E}</span>` || ""}${this.showFractionalSecond && r`<div class=${t(e.column)} role=group><span .ariaLabel=${o.fractionalSecondUp} class=${t({
      [e.button]: !0,
      [e.buttonFractionalSecondUp]: !0
    })} @click=${this.fractionalSecondUpClickHandler} role=button><calcite-icon .icon=${a.chevronUp} .scale=${c}></calcite-icon></span><span .ariaLabel=${o.fractionalSecond} aria-valuemax=999 aria-valuemin=1 .ariaValueNow=${V && parseInt(v, 10) || "0"} .ariaValueText=${b ?? void 0} class=${t({
      [e.input]: !0,
    ...
    })} @click=${this.fractionalSecondDownClickHandler} role=button><calcite-icon .icon=${a.chevronDown} .scale=${c}></calcite-icon></span></div>` || ""}${N && r`<span class=${t({ [e.delimiter]: !0, [e.secondSuffix]: !0 })}>${k}</span>` || ""}${w && r`<div class=${t({
      [e.column]: !0,
      ...
      [e.buttonTopRight]: !0
    })} @click=${this.meridiemUpClickHandler} role=button><calcite-icon .icon=${a.chevronUp} .scale=${c}></calcite-icon></span><span .ariaLabel=${o.meridiem} aria-valuemax=2 aria-valuemin=1 .ariaValueNow=${$ === "PM" && "2" || "1"} .ariaValueText=${$ ?? void 0} class=${t({
      [e.input]: !0,
      [e.meridiem]: !0,
