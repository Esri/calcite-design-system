import { b as S, m as T } from "./utils.js";
...
const l = () => e`<calcite-sheet resizable label="libero nunc" open position="inline-start">${t}</calcite-sheet>`, n = () => e`<calcite-sheet width="s" resizable label="libero nunc" open position="inline-start">
  ...
  >`, r = () => e`<calcite-sheet resizable label="libero nunc" open position="block-start">${t}</calcite-sheet>`, c = () => e`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="inline-start"
    >${t}</calcite-sheet
  >`, u = () => e`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="inline-end"
    >${t}</calcite-sheet
  >`, p = () => e`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="block-start"
    >${t}</calcite-sheet
  >`, m = () => e`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="block-end"
    >${t}</calcite-sheet
  >`, d = () => e`<calcite-sheet resizable label="libero nunc" open position="inline-end"
  ...
  </calcite-sheet>`, b = () => e`<calcite-sheet label="libero nunc" open position="inline-start" display-mode="float"
    >${t}</calcite-sheet
  >`, h = () => e`<calcite-sheet label="libero nunc" open position="block-start" display-mode="float"
    >${t}</calcite-sheet
  >`, g = () => e`<calcite-sheet label="libero nunc" open position="inline-start">${t}</calcite-sheet>`, f = () => e`<calcite-sheet label="libero nunc" open position="inline-end">${t}</calcite-sheet>`, v = () => e`<calcite-sheet label="libero nunc" open position="block-start">${t}</calcite-sheet>`, y = () => e`<calcite-sheet label="libero nunc" open position="block-end">${t}</calcite-sheet>`, s = () => e`<div dir="rtl">
...
const _ = ["simple", "simpleDarkMode", "resizable", "resizableWithDropdown", "resizableBlockStart", "resizableFloatInlineStart", "resizableFloatInlineEnd", "resizableFloatBlockStart", "resizableFloatBlockEnd", "resizableLoremIpsum", "inlineStartFloat_TestOnly", "blockStartFloat_TestOnly", "inlineStart_TestOnly", "inlineEnd_TestOnly", "blockStart_TestOnly", "blockEnd_TestOnly", "darkModeFloatRTL_TestOnly"];
export {
  _ as __namedExportsOrder,
  y as blockEnd_TestOnly,
  h as blockStartFloat_TestOnly,
  v as blockStart_TestOnly,
  s as darkModeFloatRTL_TestOnly,
  L as default,
  f as inlineEnd_TestOnly,
  b as inlineStartFloat_TestOnly,
  g as inlineStart_TestOnly,
  l as resizable,
  r as resizableBlockStart,
  m as resizableFloatBlockEnd,
  p as resizableFloatBlockStart,
  u as resizableFloatInlineEnd,
  c as resizableFloatInlineStart,
  d as resizableLoremIpsum,
  n as resizableWithDropdown,
  o as simple,
  i as simpleDarkMode
};
