import { j as d, L as h, n as s, x as u, s as b, E as c, k as p } from "./iframe.js";
...
class S extends h {
  ...
  // #region Rendering
  render() {
    return y({ disabled: this.disabled, children: u`<span .ariaChecked=${this.disabled ? null : this.selected} .ariaDisabled=${this.disabled ? this.disabled : null} .ariaLabel=${this.disabled ? null : this.getAriaText("label")} class=${b({ [r.handle]: !0, [r.handleSelected]: !this.disabled && this.selected })} @blur=${this.handleBlur} @keydown=${this.handleKeyDown} role=radio tabindex=${(this.disabled ? null : 0) ?? c} title=${this.getTooltip() ?? c} ${f(this.handleButton)}><calcite-icon .icon=${H.drag} scale=s></calcite-icon></span>` });
  }
}
p("calcite-handle", S);
export {
