...
class we extends _ {
  ...
  get showingInlineIcon() {
    const { placeholderIcon: e, selectionMode: t, selectedItems: i, open: s } = this, l = i[0], a = l?.icon, o = v(t);
  ...
  async refreshSelectionDisplay() {
    ...
    if (this.setCompactSelectionDisplay({
      ...
      const I = Array.from(this.el.shadowRoot.querySelectorAll("calcite-chip")).filter((N) => N.closable), b = Math.round(n - ((this.selectedHiddenChipsCount > 0 ? D : 0) + o + m + o));
      this.refreshChipDisplay({ availableHorizontalChipElSpace: b, chipContainerElGap: o, chipEls: I }), this.setVisibleAndHiddenChips(I);
    }
  }
  setFloatingEl(e) {
  ...
  renderInput() {
    const { guid: e, disabled: t, placeholder: i, selectionMode: s, selectedItems: l, open: a } = this, o = v(s), n = l[0], r = !a && o && !!n && !this.filterText;
  ...
  render() {
    const { selectionDisplay: e, guid: t, label: i, open: s, readOnly: l } = this, a = v(this.selectionMode), o = e === "all", n = e === "single", r = !a && e === "fit", p = !this.clearDisabled && this.value?.length > 0;
