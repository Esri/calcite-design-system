...
import { u as A } from "./useFocusTrap.js";
import { u as B } from "./usePreventDocumentScroll.js";
...
class F extends D {
  constructor() {
    super(...arguments), this.dragPosition = { ...k }, this.focusTrap = A({
      triggerProp: "open",
      focusTrapOptions: {
    ...
    })(this), this.usePreventDocumentScroll = B()(this), this.mutationObserver = O("mutation", () => this.handleMutationObserver()), this._open = !1, this.openProp = "opened", this.transitionProp = "opacity", this.panelEl = E(), this.resizePosition = { ...$ }, this.messages = M(), this.focusSetter = R()(this), this.assistiveText = null, this.hasContentBottom = !1, this.hasContentTop = !1, this.hasFooter = !0, this.opened = !1, this.closeDisabled = !1, this.dragEnabled = !1, this.embedded = !1, this.escapeDisabled = !1, this.iconFlipRtl = !1, this.loading = !1, this.menuOpen = !1, this.modal = !1, this.focusTrapDisabled = !1, this.outsideCloseDisabled = !1, this.overlayPositioning = "absolute", this.placement = "center", this.resizable = !1, this.scale = "m", this.widthScale = "m", this.calciteDialogBeforeClose = b({ cancelable: !1 }), this.calciteDialogBeforeOpen = b({ cancelable: !1 }), this.calciteDialogClose = b({ cancelable: !1 }), this.calciteDialogOpen = b({ cancelable: !1 }), this.calciteDialogScroll = b({ cancelable: !1 });
  }
  static {
    this.properties = { assistiveText: 16, hasContentBottom: 16, hasContentTop: 16, hasFooter: 16, opened: 16, beforeClose: 0, closeDisabled: 7, description: 1, dragEnabled: 7, embedded: 5, escapeDisabled: 7, focusTrapOptions: 0, heading: 1, headingLevel: 11, kind: 3, icon: 3, iconFlipRtl: 7, loading: 7, menuOpen: 7, messageOverrides: 0, modal: 7, focusTrapDisabled: 7, open: 7, outsideCloseDisabled: 7, overlayPositioning: 3, placement: 3, resizable: 7, scale: 3, widthScale: 3, width: 3 };
  }
  static {
    this.styles = L;
  }
  ...
  async setFocus(e) {
    return this.focusSetter(() => this.panelEl.value ?? this.el, e);
  }
  ...
  handleInternalPanelCloseClick(e) {
    e.target === this.panelEl.value && (e.preventDefault(), e.stopPropagation(), this.open = !1);
  }
  ...
  render() {
    ...
    })} @keydown=${this.handleKeyDown} role=dialog ${y(this.setTransitionEl)}>${e ? C("assistive-text", w`<div aria-live=polite class=${v(m.assistiveText)}>${e}</div>`) : null}<slot name=${l.customContent}><slot name=${l.content}><calcite-panel class=${v(m.panel)} .closable=${!this.closeDisabled} .description=${i} .heading=${t} .headingLevel=${this.headingLevel} .icon=${a} .iconFlipRtl=${o} .loading=${this.loading} .menuOpen=${this.menuOpen} .messageOverrides=${this.messageOverrides} @keydown=${this.handlePanelKeyDown} @calcitePanelClose=${this.handleInternalPanelCloseClick} @calcitePanelScroll=${this.handleInternalPanelScroll} .overlayPositioning=${this.overlayPositioning} .scale=${this.scale} ${y(this.panelEl)}><slot name=${l.actionBar} slot=${h.actionBar}></slot><slot name=${l.alerts} slot=${h.alerts}></slot><slot name=${l.headerActionsStart} slot=${h.headerActionsStart}></slot><slot name=${l.headerActionsEnd} slot=${h.headerActionsEnd}></slot><slot name=${l.headerContent} slot=${h.headerContent}></slot><slot name=${l.headerMenuActions} slot=${h.headerMenuActions}></slot><slot name=${l.fab} slot=${h.fab}></slot><slot name=${l.contentTop} slot=${h.contentTop}></slot><slot name=${l.contentBottom} slot=${h.contentBottom}></slot><slot name=${l.footerStart} slot=${h.footerStart}></slot><slot name=${l.footer} slot=${h.footer}></slot><slot name=${l.footerEnd} slot=${h.footerEnd}></slot><slot></slot></calcite-panel></slot></slot></div></div>`;
  }
}
T("calcite-dialog", F);
export {
