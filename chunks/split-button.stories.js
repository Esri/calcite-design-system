...
import { b as y, o as g, m as f } from "./utils3.js";
...
const {
  ...
  args: {
    ...
    dropdownIconType: k.defaultValue
  },
  argTypes: {
    appearance: {
      options: O.values,
    ...
    kind: {
      options: h.values.filter((t) => t !== "info" && t !== "warning" && t !== "success"),
      control: {
        type: "select"
      }
    },
    ...
    dropdownIconType: {
      options: k.values.filter((t) => t !== "plus-minus"),
      control: {
        type: "select"
      }
    }
  ...
  <div style="width:70vw;">
    <calcite-split-button
      ...
      ${g("primary-icon-start", t.primaryIconStart)}
      ${g("primary-icon-end", t.primaryIconEnd)}
...
const D = ["simple", "allWidths", "iconEnd", "iconStartAndIconEnd", "placementTopStart", "darkModeRTL", "disabled", "appearanceAndKindCombinations", "loadingAndDisabled", "primaryAsALink", "primaryAsALinkAppearanceOutline", "primaryAsADownload", "primaryAsADownloadAppearanceOutlineFill"];
export {
  D as __namedExportsOrder,
  a as allWidths,
  l as appearanceAndKindCombinations,
  o as darkModeRTL,
  E as default,
  p as disabled,
  c as iconEnd,
  r as iconStartAndIconEnd,
  s as loadingAndDisabled,
