import { g as v, j as x, L as I, i as C, x as z, s as y, h as u, E as p, k as $ } from "./iframe.js";
import { g as k, t as D } from "./dom.js";
...
class R extends I {
  ...
  // #region Rendering
  render() {
    const { el: t, flipRtl: s, pathData: i, scale: n, textLabel: a } = this, r = k(t), l = b[n], c = !!a, h = [].concat(i || "");
    return this.el.ariaHidden = D(!c), this.el.ariaLabel = c ? a : null, this.el.role = c ? "img" : null, z`<svg aria-hidden=true class=${y({
      [P.flipRtl]: r === "rtl" && s,
      svg: !0
