...
class O extends x {
  ...
  renderBottomActionGroup() {
    ...
    return i ? s`<calcite-action-group class=${n(l.actionGroupEnd)} .label=${h} .layout=${p} .overlayPositioning=${u} .scale=${a}><slot name=${C.expandTooltip} @slotchange=${this.handleTooltipSlotChange}></slot>${i}</calcite-action-group>` : null;
  }
  render() {
