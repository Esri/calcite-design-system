...
class P extends m {
  ...
  renderBottomActionGroup() {
    const { expanded: t, expandDisabled: o, messages: e, el: r, position: d, toggleExpand: p, scale: i, layout: h, actionsEndGroupLabel: u, overlayPositioning: x } = this, s = o ? null : y({ collapseLabel: e.collapseLabel, collapseText: e.collapse, el: r, expandLabel: e.expandLabel, expandText: e.expand, expanded: t, position: d, scale: i, toggle: p, tooltip: this.expandTooltip });
