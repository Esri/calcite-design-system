...
import { b as t, m } from "./utils3.js";
...
const x = {
  ...
  ></calcite-action>
`, p = i`
  <calcite-button slot="${s.footerStart}" width="full" appearance="outline">Cancel</calcite-button>
  <calcite-button slot="${s.footerEnd}" width="full">Save</calcite-button>
`;
function c(e) {
  return `${d}${e}${p}`;
}
...
const $ = ["simple", "darkModeRTL", "noDoubleScrollbars", "scales"];
export {
