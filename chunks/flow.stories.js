...
import { b as t } from "./utils3.js";
import { h as i } from "./formatting.js";
import { S as a } from "./resources14.js";
import "./action.js";
import "./button.js";
import "./flow.js";
import "./flow-item.js";
const w = {
  ...
  ></calcite-action>
`, d = i`
  <calcite-button slot="${a.footerStart}" width="full" appearance="outline">Cancel</calcite-button>
  <calcite-button slot="${a.footerEnd}" width="full">Save</calcite-button>
`;
function c(e) {
  return `${m}${e}${d}`;
}
...
const x = ["simple", "darkModeRTL", "noDoubleScrollbars", "scales"];
export {
  x as __namedExportsOrder,
  n as darkModeRTL,
  w as default,
  u as noDoubleScrollbars,
  l as scales,
  s as simple
};
