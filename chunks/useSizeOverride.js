...
import { W as Fr } from "./index.js";
import { c as Br } from "./index2.js";
var Ee = { exports: {} }, Xr = Ee.exports, wn;
function Yr() {
  return wn || (wn = 1, (function(O, L) {
    (function(j, I) {
      O.exports = I();
    })(Xr, (function() {
      function j(t, e) {
      ...
      function qe(t, e) {
        return qe = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(n, r) {
      ...
      function Te() {
        return Te = typeof Reflect < "u" && Reflect.get ? Reflect.get.bind() : function(t, e, n) {
          var r = (function(o, a) {
            for (; !Object.prototype.hasOwnProperty.call(o, a) && (o = Z(o)) !== null; ) ;
            return o;
          })(t, e);
          if (r) {
      ...
      function xt(t) {
        ...
        e.ownerDocument !== t.document && typeof t.wrap == "function" && t.wrap(e) === e && (t = t.wrap(t)), ee = t;
      }
      function V(t) {
        return yt(t) ? t : (t.ownerDocument || t).defaultView || ee.window;
      }
      typeof window < "u" && window && xt(window);
      var _e = function(t) {
        return !!t && R(t) === "object";
      }, wt = function(t) {
      ...
      }, object: _e, func: wt, number: function(t) {
        ...
        if (!t || R(t) !== "object") return !1;
        var e = V(t) || ee;
        return /object|function/.test(typeof Element > "u" ? "undefined" : R(Element)) ? t instanceof Element || t instanceof e.Element : t.nodeType === 1 && typeof t.nodeName == "string";
      }, plainObject: function(t) {
        return _e(t) && !!t.constructor && /function Object\b/.test(t.constructor.toString());
      }, array: function(t) {
        return _e(t) && t.length !== void 0 && wt(t.splice);
      } };
      function Ve(t) {
        var e = t.interaction;
      ...
      }, listeners: { "interactions:before-action-move": Ve, "interactions:action-resume": Ve, "interactions:action-move": Et, "auto-start:check": function(t) {
      ...
      }, beforeMove: Ve, move: Et, defaults: { startAxis: "xy", lockAxis: "xy" }, getCursor: function() {
        return "move";
      }, filterEventType: function(t) {
        return t.search("drag") === 0;
      } }, St = ke, F = { init: function(t) {
        var e = t;
        F.document = e.document, F.DocumentFragment = e.DocumentFragment || oe, F.SVGElement = e.SVGElement || oe, F.SVGSVGElement = e.SVGSVGElement || oe, F.SVGElementInstance = e.SVGElementInstance || oe, F.Element = e.Element || oe, F.HTMLElement = e.HTMLElement || F.Element, F.Event = e.Event, F.Touch = e.Touch || oe, F.PointerEvent = e.PointerEvent || e.MSPointerEvent;
      }, document: null, DocumentFragment: null, SVGElement: null, SVGSVGElement: null, SVGElementInstance: null, Element: null, HTMLElement: null, Event: null, Touch: null, PointerEvent: null };
      function oe() {
      }
      var z = F, B = { init: function(t) {
        var e = z.Element, n = t.navigator || {};
        B.supportsTouch = "ontouchstart" in t || d.func(t.DocumentTouch) && z.document instanceof t.DocumentTouch, B.supportsPointerEvent = n.pointerEnabled !== !1 && !!z.PointerEvent, B.isIOS = /iP(hone|od|ad)/.test(n.platform), B.isIOS7 = /iP(hone|od|ad)/.test(n.platform) && /OS 7[^\d]/.test(n.appVersion), B.isIe9 = /MSIE 9/.test(n.userAgent), B.isOperaMobile = n.appName === "Opera" && B.supportsTouch && /Presto/.test(n.userAgent), B.prefixedMatchesSelector = "matches" in e.prototype ? "matches" : "webkitMatchesSelector" in e.prototype ? "webkitMatchesSelector" : "mozMatchesSelector" in e.prototype ? "mozMatchesSelector" : "oMatchesSelector" in e.prototype ? "oMatchesSelector" : "msMatchesSelector", B.pEventTypes = B.supportsPointerEvent ? z.PointerEvent === t.MSPointerEvent ? { up: "MSPointerUp", down: "MSPointerDown", over: "mouseover", out: "mouseout", move: "MSPointerMove", cancel: "MSPointerCancel" } : { up: "pointerup", down: "pointerdown", over: "pointerover", out: "pointerout", move: "pointermove", cancel: "pointercancel" } : null, B.wheelEvent = z.document && "onmousewheel" in z.document ? "mousewheel" : "wheel";
      ...
      function H(t, e) {
        return ee !== bt && (e = e.replace(/\/deep\//g, " ")), t[X.prefixedMatchesSelector](e);
      }
      var We = function(t) {
        return t.parentNode || t.host;
      };
      function _t(t, e) {
        for (var n, r = [], i = t; (n = We(i)) && i !== e && n !== i.ownerDocument; ) r.unshift(i), i = n;
        return r;
      }
      function Ge(t, e, n) {
        for (; d.element(t); ) {
          if (H(t, e)) return !0;
          if ((t = W(t)) === n) return H(t, e);
        }
        return !1;
      }
      function kt(t) {
      ...
      function Ue(t) {
        var e, n = Ne(t);
        if (!X.isIOS7 && n) {
          var r = { x: (e = (e = V(t)) || ee).scrollX || e.document.documentElement.scrollLeft, y: e.scrollY || e.document.documentElement.scrollTop };
      ...
      function Ot(t) {
        return !!d.string(t) && (z.document.querySelector(t), !0);
      }
      function x(t, e) {
      ...
      function It(t, e, n) {
        return t === "parent" ? W(n) : t === "self" ? e.getRect(n) : Tt(n, t);
      }
      function ue(t, e, n, r) {
        var i = t;
        return d.string(i) ? i = It(i, e, n) : d.func(i) && (i = i.apply(void 0, r)), d.element(i) && (i = Ue(i)), i;
      }
      function Pe(t) {
      ...
      function pe(t, e, n) {
        var r = n && t.options[n];
        return Pe(ue(r && r.origin || t.options.origin, t, e, [t && e])) || { x: 0, y: 0 };
      }
      function ne(t, e) {
        var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : function(c) {
          return !0;
        }, r = arguments.length > 3 ? arguments[3] : void 0;
        if (r = r || {}, d.string(t) && t.search(" ") !== -1 && (t = Dt(t)), d.array(t)) return t.forEach((function(c) {
          return ne(c, e, n, r);
        })), r;
      ...
      function At(t, e) {
        return e = e || { x: 0, y: 0 }, X.isOperaMobile && Mt(t) ? (ze("screen", t, e), e.x += window.scrollX, e.y += window.scrollY) : ze("page", t, e), e;
      }
      function de(t) {
        return d.number(t.pointerId) ? t.pointerId : t.identifier;
      }
      function _n(t, e, n) {
        var r = e.length > 1 ? Rt(e) : e[0];
        At(r, t.page), (function(i, o) {
          o = o || {}, X.isOperaMobile && Mt(i) ? ze("screen", i, o) : ze("client", i, o);
      ...
      function Ke(t) {
        ...
        var e = $e(t), n = Math.min(e[0].pageX, e[1].pageX), r = Math.min(e[0].pageY, e[1].pageY), i = Math.max(e[0].pageX, e[1].pageX), o = Math.max(e[0].pageY, e[1].pageY);
        return { x: n, y: r, left: n, top: r, right: i, bottom: o, width: i - n, height: o - r };
      }
      function Je(t, e) {
        var n = e + "X", r = e + "Y", i = $e(t), o = i[0][n] - i[1][n], a = i[0][r] - i[1][r];
        return fe(o, a);
      }
      function Qe(t, e) {
        var n = e + "X", r = e + "Y", i = $e(t), o = i[1][n] - i[0][n], a = i[1][r] - i[0][r];
        return 180 * Math.atan2(a, o) / Math.PI;
      }
      function Ct(t) {
        return d.string(t.pointerType) ? t.pointerType : d.number(t.pointerType) ? [void 0, void 0, "touch", "pen", "mouse"][t.pointerType] : /touch/.test(t.type || "") || t instanceof z.Touch ? "touch" : "mouse";
      }
      function jt(t) {
        var e = d.func(t.composedPath) ? t.composedPath() : t.path;
        return [kt(e ? e[0] : t.target), kt(t.currentTarget)];
      }
      var Me = (function() {
        function t(e) {
      ...
      Object.defineProperty(Me.prototype, "interaction", { get: function() {
      ...
      var Ft = function(t, e) {
        ...
        return D(n, [{ key: "reject", value: function() {
          ...
          if (this.type === "dropactivate" || this.dropzone && i.cur.dropzone === this.dropzone && i.cur.element === this.target) if (i.prev.dropzone = this.dropzone, i.prev.element = this.target, i.rejected = !0, i.events.enter = null, this.stopImmediatePropagation(), this.type === "dropactivate") {
            var o = i.activeDrops, a = ve(o, (function(c) {
        ...
        for (var n = (function(o, a) {
          for (var s = [], c = 0, u = o.interactables.list; c < u.length; c++) {
            ...
            if (l.options.drop.enabled) {
              ...
              if (!(d.element(p) && p !== a || d.string(p) && !H(a, p) || d.func(p) && !p({ dropzone: l, draggableElement: a }))) for (var f = 0, h = l.getAllElements(); f < h.length; f++) {
                var v = h[f];
      ...
      function Yt(t, e, n) {
        ...
        var v = (function(g) {
          for (var y, m, b, S = [], _ = 0; _ < g.length; _++) {
            var w = g[_], T = g[y];
            if (w && _ !== y) if (T) {
              var A = We(w), P = We(T);
              if (A !== w.ownerDocument) if (P !== w.ownerDocument) if (A !== P) {
                S = S.length ? S : _t(T);
                var C = void 0;
                if (T instanceof z.HTMLElement && w instanceof z.SVGElement && !(w instanceof z.SVGSVGElement)) {
                  if (w === P) continue;
                  C = w.ownerSVGElement;
                } else C = w;
                for (var Y = _t(C, T.ownerDocument), U = 0; Y[U] && Y[U] === S[U]; ) U++;
                var Le = [Y[U - 1], Y[U], S[U]];
                if (Le[0]) for (var we = Le[0].lastChild; we; ) {
                  if (we === Le[1]) {
                    y = _, S = Y;
                    break;
                  }
              ...
              } else b = T, (parseInt(V(m = w).getComputedStyle(m).zIndex, 10) || 0) >= (parseInt(V(b).getComputedStyle(b).zIndex, 10) || 0) && (y = _);
              else y = _;
            } else y = _;
          }
          return y;
      ...
      function Lt(t, e) {
        ...
        if (r.type === "dragmove" || r.type === "dragend") {
          var o = n.dropState;
          e.dynamicDrop && (o.activeDrops = Ze(e, n.element));
          var a = r, s = Yt(n, a, i);
          o.rejected = o.rejected && !!s && s.dropzone === o.cur.dropzone && s.element === o.cur.element, o.cur.dropzone = s && s.dropzone, o.cur.element = s && s.element, o.events = et(n, 0, a);
        }
      }
      var qt = { id: "actions/drop", install: function(t) {
        var e = t.actions, n = t.interactStatic, r = t.Interactable, i = t.defaults;
        t.usePlugin(St), r.prototype.dropzone = function(o) {
          return (function(a, s) {
            if (d.object(s)) {
              if (a.options.drop.enabled = s.enabled !== !1, s.listeners) {
                var c = ne(s.listeners), u = Object.keys(c).reduce((function(p, f) {
          ...
          return (function(p, f, h, v, g, y, m) {
            ...
            if (S === "pointer") {
              var _ = pe(v, g, "drag"), w = At(f);
              w.x += _.x, w.y += _.y;
              var T = w.x > m.left && w.x < m.right, A = w.y > m.top && w.y < m.bottom;
              b = T && A;
            }
            var P = v.getRect(g);
            if (P && S === "center") {
              var C = P.left + P.width / 2, Y = P.top + P.height / 2;
              b = C >= m.left && C <= m.right && Y >= m.top && Y <= m.bottom;
            }
            return P && d.number(S) && (b = Math.max(0, Math.min(m.right, P.right) - Math.max(m.left, P.left)) * Math.max(0, Math.min(m.bottom, P.bottom) - Math.max(m.top, P.top)) / (P.width * P.height) >= S), p.options.drop.checker && (b = p.options.drop.checker(f, h, b, p, y, v, g)), b;
          })(this, o, a, s, c, u, l);
        ...
        if (n.prepared.name === "drag") {
          var i = n.dropState;
          i.activeDrops = [], i.events = {}, i.activeDrops = Ze(e, n.element), i.events = et(n, 0, r), i.events.activate && (Xt(i.activeDrops, i.events.activate), e.fire("actions/drop:start", { interaction: n, dragEvent: r }));
        }
        ...
        if (t.interaction.prepared.name === "drag") {
          var n = t.interaction, r = t.iEvent;
          Lt(t, e), tt(n, n.dropState.events), e.fire("actions/drop:end", { interaction: n, dragEvent: r });
        }
      ...
      } }, getActiveDrops: Ze, getDrop: Yt, getDropEvents: et, fireDropEvents: tt, filterEventType: function(t) {
        return t.search("drag") === 0 || t.search("drop") === 0;
      }, defaults: { enabled: !1, accept: null, overlap: "pointer" } }, kn = qt;
      function nt(t) {
        ...
        if (e.prepared.name === "gesture") {
          ...
          if (n.touches = [i[0], i[1]], o) n.distance = Je(i, s), n.box = Ke(i), n.scale = 1, n.ds = 0, n.angle = Qe(i, s), n.da = 0, e.gesture.startDistance = n.distance, e.gesture.startAngle = n.angle;
          else if (a || e.pointers.length < 2) {
            var c = e.prevEvent;
            n.distance = c.distance, n.box = c.box, n.scale = c.scale, n.ds = 0, n.angle = c.angle, n.da = 0;
          } else n.distance = Je(i, s), n.box = Ke(i), n.scale = n.distance / e.gesture.startDistance, n.angle = Qe(i, s), n.ds = n.scale - e.gesture.scale, n.da = n.angle - e.gesture.angle;
          e.gesture.distance = n.distance, e.gesture.angle = n.angle, d.number(n.scale) && n.scale !== 1 / 0 && !isNaN(n.scale) && (e.gesture.scale = n.scale);
        }
      }
      var rt = { id: "actions/gesture", before: ["actions/drag", "actions/resize"], install: function(t) {
        var e = t.actions, n = t.Interactable, r = t.defaults;
        ...
        }, e.map.gesture = rt, e.methodDict.gesture = "gesturable", r.actions.gesture = rt.defaults;
      }, listeners: { "interactions:action-start": nt, "interactions:action-move": nt, "interactions:action-end": nt, "interactions:new": function(t) {
      ...
      function On(t, e, n, r, i, o, a) {
        ...
        return !!d.element(r) && (d.element(e) ? e === r : Ge(r, e, i));
      }
      function Vt(t) {
        var e = t.iEvent, n = t.interaction;
      ...
      var G, re, N = { id: "actions/resize", before: ["actions/drag"], install: function(t) {
        var e = t.actions, n = t.browser, r = t.Interactable, i = t.defaults;
        N.cursors = (function(o) {
        ...
        })(n), N.defaultMargin = n.supportsTouch || n.supportsPointerEvent ? 20 : 10, r.prototype.resizable = function(o) {
        ...
        }, e.map.resize = N, e.methodDict.resize = "resizable", i.actions.resize = N.defaults;
        ...
        if (i) {
          ...
          if (s && s.enabled && (!e.pointerIsDown || !/mouse|pointer/.test(e.pointerType) || (o & s.mouseButtons) != 0)) {
            if (d.object(s.edges)) {
              ...
              for (var u in c) c[u] = On(u, s.edges[u], a, e._latestPointer.eventTarget, r, i, s.margin || N.defaultMargin);
              c.left = c.left && !c.right, c.top = c.top && !c.bottom, (c.left || c.right || c.top || c.bottom) && (t.action = { name: "resize", edges: c });
            } else {
              var l = s.axis !== "y" && a.x > i.right - N.defaultMargin, p = s.axis !== "x" && a.y > i.bottom - N.defaultMargin;
        ...
        var e = t.edges, n = t.axis, r = t.name, i = N.cursors, o = null;
        if (n) o = i[r + n];
        else if (e) {
      ...
      }, defaultMargin: null }, In = N, Dn = { id: "actions", install: function(t) {
        t.usePlugin(Pn), t.usePlugin(In), t.usePlugin(St), t.usePlugin(kn);
      } }, Wt = 0, $ = { request: function(t) {
        return G(t);
      }, cancel: function(t) {
        return re(t);
      }, init: function(t) {
        if (G = t.requestAnimationFrame, re = t.cancelAnimationFrame, !G) for (var e = ["ms", "moz", "webkit", "o"], n = 0; n < e.length; n++) {
          var r = e[n];
          G = t["".concat(r, "RequestAnimationFrame")], re = t["".concat(r, "CancelAnimationFrame")] || t["".concat(r, "CancelRequestAnimationFrame")];
        }
        G = G && G.bind(t), re = re && re.bind(t), G || (G = function(i) {
          var o = Date.now(), a = Math.max(0, 16 - (o - Wt)), s = t.setTimeout((function() {
            i(o + a);
          }), a);
          return Wt = o + a, s;
        }, re = function(i) {
        ...
        E.isScrolling = !0, $.cancel(E.i), t.autoScroll = E, E.interaction = t, E.prevTime = E.now(), E.i = $.request(E.scroll);
      }, stop: function() {
        E.isScrolling = !1, E.interaction && (E.interaction.autoScroll = null), $.cancel(E.i);
      }, scroll: function() {
        var t = E.interaction, e = t.interactable, n = t.element, r = t.prepared.name, i = e.options[r].autoScroll, o = Gt(i.container, e, n), a = E.now(), s = (a - E.prevTime) / 1e3, c = i.speed * s;
        if (c >= 1) {
          var u = { x: E.x * c, y: E.y * c };
          if (u.x || u.y) {
            var l = Nt(o);
            d.window(o) ? o.scrollBy(u.x, u.y) : o && (o.scrollLeft += u.x, o.scrollTop += u.y);
            var p = Nt(o), f = { x: p.x - l.x, y: p.y - l.y };
            (f.x || f.y) && e.fire({ type: "autoscroll", target: n, interactable: e, delta: f, interaction: t, container: o });
          }
          E.prevTime = a;
        }
        E.isScrolling && ($.cancel(E.i), E.i = $.request(E.scroll));
      }, check: function(t, e) {
        var n;
        ...
        if (e.interacting() && E.check(e.interactable, e.prepared.name)) if (e.simulation) E.x = E.y = 0;
          ...
          var r, i, o, a, s = e.interactable, c = e.element, u = e.prepared.name, l = s.options[u].autoScroll, p = Gt(l.container, s, c);
      ...
      function Gt(t, e, n) {
        return (d.string(t) ? It(t, e, n) : t) || V(n);
      }
      function Nt(t) {
        return d.window(t) && (t = window.document.body), { x: t.scrollLeft, y: t.scrollTop };
      }
      var zn = { id: "auto-scroll", install: function(t) {
      ...
      function ge(t, e) {
        var n = !1;
        return function() {
          return n || (ee.console.warn(e), n = !0), t.apply(this, arguments);
        };
      }
      function it(t, e) {
      ...
      var Cn = { id: "auto-start/interactableMethods", install: function(t) {
        ...
        }, e.prototype.ignoreFrom = ge((function(n) {
          return this._backCompatOption("ignoreFrom", n);
        }), "Interactable.ignoreFrom() has been deprecated. Use Interactble.draggable({ignoreFrom: newValue})."), e.prototype.allowFrom = ge((function(n) {
          return this._backCompatOption("allowFrom", n);
        }), "Interactable.allowFrom() has been deprecated. Use Interactble.draggable({allowFrom: newValue})."), e.prototype.actionChecker = Rn, e.prototype.styleCursor = An;
      } };
      function Ut(t, e, n, r, i) {
        return e.testIgnoreAllow(e.options[t.name], n, r) && e.options[t.name].enabled && Ae(e, n, t, i) ? t : null;
      }
      ...
      function $t(t, e, n) {
        ...
        r = r || { name: null }, t.interactable = i, t.element = o, it(t.prepared, r), t.rect = i && r.name ? i.getRect(o) : null, Jt(t, n), n.fire("autoStart:prepared", { interaction: t });
      }
      function Ae(t, e, n, r) {
      ...
      function Jt(t, e) {
        ...
        if (t.pointerType === "mouse" && n && n.options.styleCursor) {
          ...
          ot(t.element, o || "", e);
        } else e.autoStart.cursorElement && ot(e.autoStart.cursorElement, "", e);
      }
      var Fn = { id: "auto-start/base", before: ["actions"], install: function(t) {
        var e = t.interactStatic, n = t.defaults;
        t.usePlugin(Cn), n.base.actionChecker = null, n.base.styleCursor = !0, x(n.perAction, { manualStart: !1, max: 1 / 0, maxPerElement: 1, allowFrom: null, ignoreFrom: null, mouseButtons: 1 }), e.maxInteractions = function(r) {
          return Kt(r, t);
        }, t.autoStart = { maxInteractions: 1 / 0, withinInteractionLimit: Ae, cursorElement: null };
      }, listeners: { "interactions:down": function(t, e) {
        var n = t.interaction, r = t.pointer, i = t.event, o = t.eventTarget;
        n.interacting() || $t(n, Ht(n, r, i, o, e), e);
      }, "interactions:move": function(t, e) {
        (function(n, r) {
          var i = n.interaction, o = n.pointer, a = n.event, s = n.eventTarget;
          i.pointerType !== "mouse" || i.pointerIsDown || i.interacting() || $t(i, Ht(i, o, a, s, r), r);
        })(t, e), (function(n, r) {
          var i = n.interaction;
          if (i.pointerIsDown && !i.interacting() && i.pointerWasMoved && i.prepared.name) {
            ...
            a && o && (o.options[a].manualStart || !Ae(o, i.element, i.prepared, r) ? i.stop() : (i.start(i.prepared, o, i.element), Jt(i, r)));
          }
        })(t, e);
      }, "interactions:stop": function(t, e) {
        var n = t.interaction, r = n.interactable;
        r && r.options.styleCursor && ot(n.element, "", e);
      } }, maxInteractions: Kt, withinInteractionLimit: Ae, validateAction: Ut }, at = Fn, Bn = { id: "auto-start/dragAxis", listeners: { "autoStart:before-start": function(t, e) {
              ...
              if (v !== n.interactable) {
                ...
                if (!g.manualStart && v.testIgnoreAllow(g, p, r)) {
                  ...
                  if (y && y.name === "drag" && (function(m, b) {
                    if (!b) return !1;
                    var S = b.options.drag.startAxis;
                    return m === "xy" || S === "xy" || S === m;
                  })(l, v) && at.validateAction(y, v, p, r, e)) return v;
                }
              }
            }; d.element(p); ) {
      ...
      var Xn = { id: "auto-start/hold", install: function(t) {
        var e = t.defaults;
        t.usePlugin(at), e.perAction.hold = 0, e.perAction.delay = 0;
      }, listeners: { "interactions:new": function(t) {
        t.interaction.autoStartHoldTimer = null;
      }, "autoStart:prepared": function(t) {
        var e = t.interaction, n = st(e);
        ...
        var e = t.interaction;
        st(e) > 0 && (e.prepared.name = null);
      } }, getHoldDuration: st }, Yn = Xn, Ln = { id: "auto-start", install: function(t) {
        t.usePlugin(at), t.usePlugin(Yn), t.usePlugin(Bn);
      } }, qn = function(t) {
      ...
      var Qt = { id: "core/interactablePreventDefault", install: function(t) {
        var e = t.Interactable;
        e.prototype.preventDefault = qn, e.prototype.checkAndPreventDefault = function(n) {
          return (function(r, i, o) {
            var a = r.options.preventDefault;
            if (a !== "never") if (a !== "always") {
              if (i.events.supportsPassive && /^touch(start|move)$/.test(o.type)) {
                var s = V(o.target).document, c = i.getDocOptions(s);
                if (!c || !c.events || c.events.passive !== !1) return;
              }
              /^(mouse|pointer|touch)*(down|start)/i.test(o.type) || d.element(o.target) && H(o.target, "input,select,textarea,[contenteditable=true],[contenteditable=true] *") || o.preventDefault();
            } else o.preventDefault();
          })(this, t, n);
        }, t.interactions.docEvents.push({ type: "dragstart", listener: function(n) {
          for (var r = 0, i = t.interactions.list; r < i.length; r++) {
            var o = i[r];
            if (o.element && (o.element === n.target || te(o.element, n.target))) return void o.interactable.checkAndPreventDefault(n);
          }
        } });
      }, listeners: ["down", "move", "up", "cancel"].reduce((function(t, e) {
        return t["interactions:".concat(e)] = Vn, t;
      }), {}) };
      function Re(t, e) {
      ...
      function se(t) {
        ...
        for (var n in t) {
          var r = t[n];
          d.plainObject(r) ? e[n] = se(r) : d.array(r) ? e[n] = Bt(r) : e[n] = r;
        }
        return e;
      }
      var ct = (function() {
        function t(e) {
          k(this, t), this.states = [], this.startOffset = { left: 0, right: 0, top: 0, bottom: 0 }, this.startDelta = void 0, this.result = void 0, this.endResult = void 0, this.startEdges = void 0, this.edges = void 0, this.interaction = void 0, this.interaction = e, this.result = Ce(), this.edges = { left: !1, right: !1, top: !1, bottom: !1 };
        }
        return D(t, [{ key: "start", value: function(e, n) {
          ...
          return this.result = Ce(), this.startAll(c), this.result = this.setAll(c);
          ...
          for (var s = i ? this.states.slice(i) : this.states, c = Ce(e.coords, e.rect), u = 0; u < s.length; u++) {
            var l, p = s[u], f = p.options, h = x({}, e.coords), v = null;
            (l = p.methods) != null && l.set && this.shouldDo(f, r, n) && (e.state = p, v = p.methods.set(e), Oe(e.edges, e.rect, { x: e.coords.x - h.x, y: e.coords.y - h.y })), c.eventProps.push(v);
          }
          ...
          this.startOffset = e.startOffset, this.startDelta = e.startDelta, this.startEdges = e.startEdges, this.edges = e.edges, this.states = e.states.map((function(n) {
            return se(n);
          })), this.result = Ce(x({}, e.result.coords), x({}, e.result.rect));
      ...
      var Wn = { id: "modifiers/base", before: ["actions"], install: function(t) {
        t.defaults.perAction.modifiers = [];
      }, listeners: { "interactions:new": function(t) {
        var e = t.interaction;
        e.modification = new ct(e);
      ...
      }, "interactions:action-start": me, "interactions:action-move": me, "interactions:action-end": me, "interactions:after-action-start": function(t) {
        return t.interaction.modification.restoreInteractionCoords(t);
      }, "interactions:after-action-move": function(t) {
        return t.interaction.modification.restoreInteractionCoords(t);
      }, "interactions:stop": function(t) {
        return t.interaction.modification.stop(t);
      } } }, Zt = Wn, en = { base: { preventDefault: "auto", deltaSource: "page" }, perAction: { enabled: !1, origin: { x: 0, y: 0 } }, actions: {} }, lt = (function(t) {
        ce(n, t);
        var e = le(n);
      ...
      Object.defineProperties(lt.prototype, { pageX: { get: function() {
        return this.page.x;
      }, set: function(t) {
        this.page.x = t;
      } }, pageY: { get: function() {
      ...
      var Gn = D((function t(e, n, r, i, o) {
        ...
        function t(e) {
          ...
          k(this, t), this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = { name: null, axis: null, edges: null }, this.pointerType = void 0, this.pointers = [], this.downEvent = null, this.downPointer = {}, this._latestPointer = { pointer: null, event: null, eventTarget: null }, this.prevEvent = null, this.pointerIsDown = !1, this.pointerWasMoved = !1, this._interacting = !1, this._ending = !1, this._stopped = !0, this._proxy = void 0, this.simulation = null, this.doMove = ge((function(l) {
            this.move(l);
        ...
        return D(t, [{ key: "pointerMoveTolerance", get: function() {
          ...
          return !(this.interacting() || !this.pointerIsDown || this.pointers.length < (e.name === "gesture" ? 2 : 1) || !n.options[e.name].enabled) && (it(this.prepared, e), this.interactable = n, this.element = r, this.rect = n.getRect(r), this.edges = this.prepared.edges ? x({}, this.prepared.edges) : { left: !0, right: !0, top: !0, bottom: !0 }, this._stopped = !1, this._interacting = this._doPhase({ interaction: this, event: this.downEvent, phase: "start" }) && !this._stopped, this._interacting);
          ...
          this.pointerIsDown && !this.pointerWasMoved && (i = this.coords.cur.client.x - this.coords.start.client.x, o = this.coords.cur.client.y - this.coords.start.client.y, this.pointerWasMoved = fe(i, o) > this.pointerMoveTolerance);
          ...
          a || (s = this.coords.velocity, c = this.coords.delta, u = Math.max(c.timeStamp / 1e3, 1e-3), s.page.x = c.page.x / u, s.page.y = c.page.y / u, s.client.x = c.client.x / u, s.client.y = c.client.y / u, s.timeStamp = u), this._scopeFire("interactions:move", p), a || this.simulation || (this.interacting() && (p.type = null, this.move(p)), this.pointerWasMoved && De(this.coords.prev, this.coords.cur));
        } }, { key: "move", value: function(e) {
          e && e.event || zt(this.coords.delta), (e = x({ pointer: this._latestPointer.pointer, event: this._latestPointer.event, eventTarget: this._latestPointer.eventTarget, interaction: this }, e || {})).phase = "move", this._doPhase(e);
          ...
          return new lt(this, e, this.prepared.name, n, this.element, r, i);
          ...
          if (a && r === "move" && (Oe(this.edges, a, this.coords.delta[this.interactable.options.deltaSource]), a.width = a.right - a.left, a.height = a.bottom - a.top), this._scopeFire("interactions:before-action-".concat(r), e) === !1) return !1;
      ...
      function rn(t) {
        ...
        return ut(t.coords.cur, e), ut(t.coords.delta, e), Oe(t.edges, t.rect, e), e.x = 0, e.y = 0, !0;
      }
      function $n(t) {
        var e = t.x, n = t.y;
      ...
      tn.offsetBy = "";
      var Kn = { id: "offset", before: ["modifiers", "pointer-events", "actions", "inertia"], install: function(t) {
        t.Interaction.prototype.offsetBy = $n;
      }, listeners: { "interactions:new": function(t) {
        t.interaction.offset = { total: { x: 0, y: 0 }, pending: { x: 0, y: 0 } };
      }, "interactions:update-pointer": function(t) {
        return (function(e) {
          e.pointerIsDown && (ut(e.coords.cur, e.offset.total), e.offset.pending.x = 0, e.offset.pending.y = 0);
        })(t.interaction);
      }, "interactions:before-action-start": nn, "interactions:before-action-move": nn, "interactions:before-action-end": function(t) {
        var e = t.interaction;
        if (rn(e)) return e.move({ offset: !0 }), e.end(), !1;
      }, "interactions:stop": function(t) {
        var e = t.interaction;
        ...
        return D(t, [{ key: "start", value: function(e) {
          var n = this.interaction, r = je(n);
          if (!r || !r.enabled) return !1;
          var i = n.coords.velocity.client, o = fe(i.x, i.y), a = this.modification || (this.modification = new ct(n));
          ...
          var e = this, n = this.interaction.coords.velocity.client, r = je(this.interaction), i = r.resistance, o = -Math.log(r.endSpeed / this.v0) / i;
          ...
          var n = this;
          this.timeout = $.request((function() {
            n.active && e();
          }));
        } }, { key: "inertiaTick", value: function() {
          var e, n, r, i, o, a, s, c = this, u = this.interaction, l = je(u).resistance, p = (u._now() - this.t0) / 1e3;
          if (p < this.te) {
            var f, h = 1 - (Math.exp(-l * p) - this.lambda_v0) / this.one_ve_v0;
            this.isModified ? (e = 0, n = 0, r = this.targetOffset.x, i = this.targetOffset.y, o = this.modifiedOffset.x, a = this.modifiedOffset.y, f = { x: an(s = h, e, r, o), y: an(s, n, i, a) }) : f = { x: this.targetOffset.x * h, y: this.targetOffset.y * h };
          ...
          var e = this, n = this.interaction, r = n._now() - this.t0, i = je(n).smoothEndDuration;
          if (r < i) {
            var o = { x: sn(r, 0, this.targetOffset.x, i), y: sn(r, 0, this.targetOffset.y, i) }, a = { x: o.x - this.currentOffset.x, y: o.y - this.currentOffset.y };
          ...
          o.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }), o.updatePointer(n, r, i, !0), o._doPhase({ interaction: o, event: r, phase: "resume" }), De(o.coords.prev, o.coords.cur), this.stop();
        } }, { key: "end", value: function() {
          this.interaction.move(), this.interaction.end(), this.stop();
        } }, { key: "stop", value: function() {
          this.active = this.smoothEnd = !1, this.interaction.simulation = null, $.cancel(this.timeout);
        } }]), t;
      })();
      function je(t) {
      ...
      var Qn = { id: "inertia", before: ["modifiers", "actions"], install: function(t) {
        var e = t.defaults;
        t.usePlugin(on), t.usePlugin(Zt), t.actions.phases.inertiastart = !0, t.actions.phases.resume = !0, e.perAction.inertia = { enabled: !1, resistance: 10, minSpeed: 100, endSpeed: 10, allowResume: !0, smoothEndDuration: 300 };
      }, listeners: { "interactions:new": function(t) {
        var e = t.interaction;
        e.inertia = new Jn(e);
      }, "interactions:before-action-end": function(t) {
      ...
      }, "interactions:action-resume": me, "interactions:action-inertiastart": me, "interactions:after-action-inertiastart": function(t) {
        return t.interaction.modification.restoreInteractionCoords(t);
      ...
      var ln = (function() {
        ...
        return D(t, [{ key: "fire", value: function(e) {
          var n, r = this.global;
          (n = this.types[e.type]) && cn(e, n), !e.propagationStopped && r && (n = r[e.type]) && cn(e, n);
        } }, { key: "on", value: function(e, n) {
          var r = ne(e, n);
          for (e in r) this.types[e] = Ft(this.types[e] || [], r[e]);
        ...
        function t(e) {
          k(this, t), this.currentTarget = void 0, this.originalEvent = void 0, this.type = void 0, this.originalEvent = e, Ie(this, e);
        }
      ...
      var tr = { id: "events", install: function(t) {
        var e, n = [], r = {}, i = [], o = { add: a, remove: s, addDelegate: function(l, p, f, h, v) {
          ...
          var b = r[f], S = he(b, (function(_) {
            return _.selector === l && _.context === p;
          }));
          S || (S = { selector: l, context: p, listeners: [] }, b.push(S)), S.listeners.push({ func: h, options: g });
        }, removeDelegate: function(l, p, f, h, v) {
          var g, y = ye(v), m = r[f], b = !1;
          if (m)
            for (g = m.length - 1; g >= 0; g--) {
              var S = m[g];
              if (S.selector === l && S.context === p) {
                for (var _ = S.listeners, w = _.length - 1; w >= 0; w--) {
                  var T = _[w];
                  if (T.func === h && Fe(T.options, y)) {
        ...
        function a(l, p, f, h) {
          if (l.addEventListener) {
            var v = ye(h), g = he(n, (function(y) {
              return y.eventTarget === l;
            }));
            g || (g = { eventTarget: l, events: {} }, n.push(g)), g.events[p] || (g.events[p] = []), he(g.events[p], (function(y) {
              return y.func === f && Fe(y.options, v);
        ...
        function s(l, p, f, h) {
          if (l.addEventListener && l.removeEventListener) {
            var v = ve(n, (function(A) {
              return A.eventTarget === l;
            })), g = n[v];
              ...
              if (m) {
                if (f === "all") {
                  for (var b = m.length - 1; b >= 0; b--) {
                    var S = m[b];
                    s(l, p, S.func, S.options);
                  }
                  return;
                }
                for (var _ = ye(h), w = 0; w < m.length; w++) {
                  var T = m[w];
                  if (T.func === f && Fe(T.options, _)) {
        ...
        function c(l, p) {
          for (var f = ye(p), h = new er(l), v = r[l.type], g = jt(l)[0], y = g; d.element(y); ) {
            for (var m = 0; m < v.length; m++) {
              var b = v[m], S = b.selector, _ = b.context;
              if (H(y, S) && te(_, g) && te(_, y)) {
                var w = b.listeners;
                h.currentTarget = y;
                for (var T = 0; T < w.length; T++) {
                  var A = w[T];
                  Fe(A.options, f) && A.func(h);
                }
              }
            }
            y = W(y);
        ...
        for (var a = 0, s = o.interactions.list; a < s.length; a++) {
          var c = s[a];
          if (c.pointerType === r) {
            if (c.simulation && !un(c, n)) continue;
      ...
      var nr = pt, ft = ["pointerDown", "pointerMove", "pointerUp", "updatePointer", "removePointer", "windowBlur"];
      function pn(t, e) {
        return function(n) {
          var r = e.interactions.list, i = Ct(n), o = jt(n), a = o[0], s = o[1], c = [];
          if (/^touch/.test(n.type)) {
            e.prevTouchTime = e.now();
            for (var u = 0, l = n.changedTouches; u < l.length; u++) {
              var p = l[u], f = { pointer: p, pointerId: de(p), pointerType: i, eventType: n.type, eventTarget: a, curEventTarget: s, scope: e }, h = fn(f);
              c.push([f.pointer, f.eventTarget, f.curEventTarget, h]);
            }
          } else {
            var v = !1;
            if (!X.supportsPointerEvent && /mouse/.test(n.type)) {
              for (var g = 0; g < r.length && !v; g++) v = r[g].pointerType !== "mouse" && r[g].pointerIsDown;
              v = v || e.now() - e.prevTouchTime < 500 || n.timeStamp === 0;
            }
            if (!v) {
              var y = { pointer: n, pointerId: de(n), pointerType: i, eventType: n.type, curEventTarget: s, eventTarget: a, scope: e }, m = fn(y);
              c.push([y.pointer, y.eventTarget, y.curEventTarget, m]);
            }
          }
          for (var b = 0; b < c.length; b++) {
            var S = c[b], _ = S[0], w = S[1], T = S[2];
            S[3][t](_, n, w, T);
          }
        };
      }
      function fn(t) {
        var e = t.pointerType, n = t.scope, r = { interaction: nr.search(t), searchDetails: t };
      ...
      var rr = { id: "core/interactions", install: function(t) {
        for (var e = {}, n = 0; n < ft.length; n++) {
          var r = ft[n];
          e[r] = pn(r, t);
        }
        var i, o = X.pEventTypes;
        function a() {
          for (var s = 0, c = t.interactions.list; s < c.length; s++) {
            ...
            if (u.pointerIsDown && u.pointerType === "touch" && !u._interacting) for (var l = function() {
              ...
              t.documents.some((function(v) {
                return te(v.doc, h.downTarget);
              })) || u.removePointer(h.pointer, h.event);
            }, p = 0, f = u.pointers; p < f.length; p++) l();
          }
        }
        (i = z.PointerEvent ? [{ type: o.down, listener: a }, { type: o.down, listener: e.pointerDown }, { type: o.move, listener: e.pointerMove }, { type: o.up, listener: e.pointerUp }, { type: o.cancel, listener: e.pointerUp }] : [{ type: "mousedown", listener: e.pointerDown }, { type: "mousemove", listener: e.pointerMove }, { type: "mouseup", listener: e.pointerUp }, { type: "touchstart", listener: a }, { type: "touchstart", listener: e.pointerDown }, { type: "touchmove", listener: e.pointerMove }, { type: "touchend", listener: e.pointerUp }, { type: "touchcancel", listener: e.pointerUp }]).push({ type: "blur", listener: function(s) {
        ...
        })(Hn), t.interactions = { list: [], new: function(s) {
          s.scopeFire = function(u, l) {
            return t.fire(u, l);
          };
          var c = new t.Interaction(s);
          return t.interactions.list.push(c), c;
        }, listeners: e, docEvents: i, pointerMoveTolerance: 1 }, t.usePlugin(Qt);
      ...
      } }, onDocSignal: dt, doOnInteractions: pn, methodNames: ft }, ir = rr, J = (function(t) {
        return t[t.On = 0] = "On", t[t.Off = 1] = "Off", t;
      })(J || {}), or = (function() {
        function t(e, n, r, i) {
          k(this, t), this.target = void 0, this.options = void 0, this._actions = void 0, this.events = new ln(), this._context = void 0, this._win = void 0, this._doc = void 0, this._scopeEvents = void 0, this._actions = n.actions, this.target = e, this._context = n.context || r, this._win = V(Ot(e) ? this._context : e), this._doc = this._win.document, this._scopeEvents = i, this.set(n);
        }
        return D(t, [{ key: "_defaults", get: function() {
          ...
          var i, o = this, a = (i = this._actions.map[e]) == null ? void 0 : i.filterEventType, s = function(c) {
            return (a == null || a(c)) && Re(c, o._actions);
          };
          (d.array(n) || d.object(n)) && this._onOff(J.Off, e, n, void 0, s), (d.array(r) || d.object(r)) && this._onOff(J.On, e, r, void 0, s);
        } }, { key: "setPerAction", value: function(e, n) {
          var r = this._defaults;
          for (var i in n) {
            var o = i, a = this.options[e], s = n[o];
            o === "listeners" && this.updatePerActionListeners(e, a.listeners, s), d.array(s) ? a[o] = Bt(s) : d.plainObject(s) ? (a[o] = x(a[o] || {}, se(s)), d.object(r.perAction[o]) && "enabled" in r.perAction[o] && (a[o].enabled = s.enabled !== !1)) : d.bool(s) && d.object(r.perAction[o]) ? a[o].enabled = s : a[o] = s;
          }
        } }, { key: "getRect", value: function(e) {
          return e = e || (d.element(this.target) ? this.target : null), d.string(this.target) && (e = e || this._context.querySelector(this.target)), Ue(e);
          ...
          return this._context === e.ownerDocument || te(this._context, e);
          ...
          return !e || !!d.element(r) && (d.string(e) ? Ge(r, e, n) : !!d.element(e) && te(e, r));
          ...
          var a = ne(n, r, o);
          for (var s in a) {
            s === "wheel" && (s = X.wheelEvent);
            for (var c = 0, u = a[s]; c < u.length; c++) {
              var l = u[c];
              Re(s, this._actions) ? this.events[e === J.On ? "on" : "off"](s, l) : d.string(this.target) ? this._scopeEvents[e === J.On ? "addDelegate" : "removeDelegate"](this.target, this._context, s, l, i) : this._scopeEvents[e === J.On ? "add" : "remove"](this.target, s, l, i);
            }
          }
          return this;
        } }, { key: "on", value: function(e, n, r) {
          return this._onOff(J.On, e, n, r);
        } }, { key: "off", value: function(e, n, r) {
          return this._onOff(J.Off, e, n, r);
        } }, { key: "set", value: function(e) {
          var n = this._defaults;
          for (var r in d.object(e) || (e = {}), this.options = se(n.base), this._actions.methodDict) {
        ...
        function t(e) {
          ...
          k(this, t), this.list = [], this.selectorMap = {}, this.scope = void 0, this.scope = e, e.addListeners({ "interactable:unset": function(r) {
            var i = r.interactable, o = i.target, a = d.string(o) ? n.selectorMap[o] : o[n.scope.id], s = ve(a, (function(c) {
              return c === i;
            }));
            a.splice(s, 1);
          } });
        ...
        return D(t, [{ key: "new", value: function(e, n) {
          ...
          if (o) return he(o, (function(a) {
            return a._context === r && (i || a.inContext(e));
          }));
        } }, { key: "forEachMatch", value: function(e, n) {
          for (var r = 0, i = this.list; r < i.length; r++) {
            var o = i[r], a = void 0;
            if ((d.string(o.target) ? d.element(e) && H(e, o.target) : e === o.target) && o.inContext(e) && (a = n(o)), a !== void 0) return a;
          }
        } }]), t;
      })(), sr = (function() {
        function t() {
          var e = this;
          k(this, t), this.id = "__interact_scope_".concat(Math.floor(100 * Math.random())), this.isInitialized = !1, this.listenerMaps = [], this.browser = X, this.defaults = se(en), this.Eventable = ln, this.actions = { map: {}, phases: { start: !0, move: !0, end: !0 }, methodDict: {}, phaselessTypes: {} }, this.interactStatic = (function(r) {
            ...
            return i.getPointerAverage = Rt, i.getTouchBBox = Ke, i.getTouchDistance = Je, i.getTouchAngle = Qe, i.getElementRect = Ue, i.getElementClientRect = Ne, i.matchesSelector = H, i.closest = Tt, i.globalEvents = {}, i.version = "1.10.27", i.scope = r, i.use = function(o, a) {
              return this.scope.usePlugin(o, a), this;
            }, i.isSet = function(o, a) {
              return !!this.scope.interactables.get(o, a && a.context);
            }, i.on = ge((function(o, a, s) {
              ...
              return Re(o, this.scope.actions) ? this.globalEvents[o] ? this.globalEvents[o].push(a) : this.globalEvents[o] = [a] : this.scope.events.add(this.scope.document, o, a, { options: s }), this;
            }), "The interact.on() method is being deprecated"), i.off = ge((function(o, a, s) {
              if (d.string(o) && o.search(" ") !== -1 && (o = o.trim().split(/ +/)), d.array(o)) {
                for (var c = 0, u = o; c < u.length; c++) {
                  var l = u[c];
                  this.off(l, a, s);
              ...
              var f;
              return Re(o, this.scope.actions) ? o in this.globalEvents && (f = this.globalEvents[o].indexOf(a)) !== -1 && this.globalEvents[o].splice(f, 1) : this.scope.events.remove(this.scope.document, o, a, s), this;
          ...
          })(this), this.InteractEvent = lt, this.Interactable = void 0, this.interactables = new ar(this), this._win = void 0, this.document = void 0, this.window = void 0, this.documents = [], this._plugins = { list: [], map: {} }, this.onWindowUnload = function(r) {
          ...
          this.Interactable = (function(r) {
            ...
            return D(o, [{ key: "_defaults", get: function() {
              ...
              return Te(Z(o.prototype), "set", this).call(this, a), n.fire("interactable:set", { options: a, interactable: this }), this;
            } }, { key: "unset", value: function() {
              Te(Z(o.prototype), "unset", this).call(this);
        ...
        return D(t, [{ key: "addListeners", value: function(e, n) {
          ...
          return this.isInitialized ? this : (function(n, r) {
            return n.isInitialized = !0, d.window(r) && xt(r), z.init(r), X.init(r), $.init(r), n.window = r, n.document = r.document, n.usePlugin(ir), n.usePlugin(tr), n;
          })(this, e);
          ...
          if (e.id && (this._plugins.map[e.id] = e), this._plugins.list.push(e), e.install && e.install(this, n), e.listeners && e.before) {
            for (var r = 0, i = this.listenerMaps.length, o = e.before.reduce((function(s, c) {
              return s[c] = !0, s[dn(c)] = !0, s;
            }), {}); r < i; r++) {
              var a = this.listenerMaps[r].id;
              if (a && (o[a] || o[dn(a)])) break;
            }
          ...
          var n = this.getDocIndex(e), r = V(e), i = this.documents[n].options;
      ...
      var vn = new sr(), M = vn.interactStatic, cr = typeof globalThis < "u" ? globalThis : window;
      vn.init(cr);
      ...
      } }), ur = { id: "snappers", install: function(t) {
        var e = t.interactStatic;
        e.snappers = x(e.snappers || {}, lr), e.createSnapGrid = e.snappers.grid;
      } }, pr = ur, fr = { start: function(t) {
      ...
      var hr = K(fr, "aspectRatio"), hn = function() {
      };
      hn._defaults = {};
      var Be = hn;
      function ie(t, e, n) {
        return d.func(t) ? ue(t, e.interactable, e.element, [n.x, n.y, e]) : ue(t, e.interactable, e.element);
      }
      var Xe = { start: function(t) {
        ...
        var e = t.coords, n = t.interaction, r = t.state, i = r.options, o = r.offset, a = ie(i.restriction, n, e);
        if (a) {
          var s = (function(c) {
      ...
      }, defaults: { restriction: null, elementRect: null, offset: null, endOnly: !1, enabled: !1 } }, gr = K(Xe, "restrict"), gn = { top: 1 / 0, left: 1 / 0, bottom: -1 / 0, right: -1 / 0 }, mn = { top: -1 / 0, left: -1 / 0, bottom: 1 / 0, right: 1 / 0 };
      function yn(t, e) {
      ...
      var be = { noInner: gn, noOuter: mn, start: function(t) {
        var e, n = t.interaction, r = t.startOffset, i = t.state, o = i.options;
        o && (e = Pe(ie(o.offset, n, n.coords.start.page))), e = e || { x: 0, y: 0 }, i.offset = { top: e.y + r.top, left: e.x + r.left, bottom: e.y - r.bottom, right: e.x - r.right };
      }, set: function(t) {
        var e = t.coords, n = t.edges, r = t.interaction, i = t.state, o = i.offset, a = i.options;
        if (n) {
          var s = x({}, e), c = ie(a.inner, r, s) || {}, u = ie(a.outer, r, s) || {};
          yn(c, gn), yn(u, mn), n.top ? e.y = Math.min(Math.max(u.top + o.top, s.y), c.top + o.top) : n.bottom && (e.y = Math.max(Math.min(u.bottom + o.bottom, s.y), c.bottom + o.bottom)), n.left ? e.x = Math.min(Math.max(u.left + o.left, s.x), c.left + o.left) : n.right && (e.x = Math.max(Math.min(u.right + o.right, s.x), c.right + o.right));
        }
      }, defaults: { inner: null, outer: null, offset: null, endOnly: !1, enabled: !1 } }, mr = K(be, "restrictEdges"), yr = x({ get elementRect() {
        return { top: 0, left: 0, bottom: 1, right: 1 };
      }, set elementRect(t) {
      } }, Xe.defaults), br = K({ start: Xe.start, set: Xe.set, defaults: yr }, "restrictRect"), xr = { width: -1 / 0, height: -1 / 0 }, wr = { width: 1 / 0, height: 1 / 0 }, Er = K({ start: function(t) {
        return be.start(t);
      }, set: function(t) {
        var e = t.interaction, n = t.state, r = t.rect, i = t.edges, o = n.options;
        if (i) {
          var a = He(ie(o.min, e, t.coords)) || xr, s = He(ie(o.max, e, t.coords)) || wr;
          n.options = { endOnly: o.endOnly, inner: x({}, be.noInner), outer: x({}, be.noOuter) }, i.top ? (n.options.inner.top = r.bottom - a.height, n.options.outer.top = r.bottom - s.height) : i.bottom && (n.options.inner.bottom = r.top + a.height, n.options.outer.bottom = r.top + s.height), i.left ? (n.options.inner.left = r.right - a.width, n.options.outer.left = r.right - s.width) : i.right && (n.options.inner.right = r.left + a.width, n.options.outer.right = r.left + s.width), be.set(t), n.options = o;
        }
      }, defaults: { min: null, max: null, endOnly: !1, enabled: !1 } }, "restrictSize"), vt = { start: function(t) {
        var e, n = t.interaction, r = t.interactable, i = t.element, o = t.rect, a = t.state, s = t.startOffset, c = a.options, u = c.offsetWithOrigin ? (function(f) {
          var h = f.interaction.element, v = Pe(ue(f.state.options.origin, null, null, [h])), g = v || pe(f.interactable, h, f.interaction.prepared.name);
          return g;
        })(t) : { x: 0, y: 0 };
        if (c.offset === "startCoords") e = { x: n.coords.start.page.x, y: n.coords.start.page.y };
        else {
          var l = ue(c.offset, r, i, [n]);
          (e = Pe(l) || { x: 0, y: 0 }).x += u.x, e.y += u.y;
        }
        ...
        var e = t.interaction, n = t.coords, r = t.state, i = r.options, o = r.offsets, a = pe(e.interactable, e.element, e.prepared.name), s = x({}, n), c = [];
        ...
        for (var b = { target: null, inRange: !1, distance: 0, range: 0, delta: { x: 0, y: 0 } }, S = 0; S < c.length; S++) {
          var _ = c[S], w = _.range, T = _.x - s.x, A = _.y - s.y, P = fe(T, A), C = P <= w;
          w === 1 / 0 && b.inRange && b.range !== 1 / 0 && (C = !1), b.target && !(C ? b.inRange && w !== 1 / 0 ? P / w < b.distance / b.range : w === 1 / 0 && b.range !== 1 / 0 || P < b.distance : !b.inRange && P < b.distance) || (b.target = _, b.distance = P, b.range = w, b.inRange = C, b.delta.x = T, b.delta.y = A);
        }
        return b.inRange && (n.x = b.target.x, n.y = b.target.y), r.closest = b, b;
      }, defaults: { range: 1 / 0, targets: null, offset: null, offsetWithOrigin: !0, origin: null, relativePoints: null, endOnly: !1, enabled: !1 } }, Sr = K(vt, "snap"), Ye = { start: function(t) {
        var e = t.state, n = t.edges, r = e.options;
        if (!n) return null;
        t.state = { options: { targets: null, relativePoints: [{ x: n.left ? 0 : 1, y: n.top ? 0 : 1 }], offset: r.offset || "self", origin: { x: 0, y: 0 }, range: r.range } }, e.targetFields = e.targetFields || [["width", "height"], ["x", "y"]], vt.start(t), e.offsets = t.state.offsets, t.state = e;
      }, set: function(t) {
      ...
      }, defaults: { range: 1 / 0, targets: null, offset: null, endOnly: !1, enabled: !1 } }, Tr = K(Ye, "snapSize"), ht = { aspectRatio: hr, restrictEdges: mr, restrict: gr, restrictRect: br, restrictSize: Er, snapEdges: K({ start: function(t) {
        var e = t.edges;
        return e ? (t.state.targetFields = t.state.targetFields || [[e.left ? "left" : "right", e.top ? "top" : "bottom"]], Ye.start(t)) : null;
      }, set: Ye.set, defaults: x(se(Ye.defaults), { targets: void 0, range: void 0, offset: { x: 0, y: 0 } }) }, "snapEdges"), snap: Sr, snapSize: Tr, spring: Be, avoid: Be, transform: Be, rubberband: Be }, _r = { id: "modifiers", install: function(t) {
        var e = t.interactStatic;
        for (var n in t.usePlugin(Zt), t.usePlugin(pr), e.modifiers = ht, ht) {
          var r = ht[n], i = r._defaults, o = r._methods;
        ...
        function n(r, i, o, a, s, c) {
          var u;
          if (k(this, n), Ie(Se(u = e.call(this, s)), o), o !== i && Ie(Se(u), i), u.timeStamp = c, u.originalEvent = o, u.type = r, u.pointerId = de(i), u.pointerType = Ct(i), u.target = a, u.currentTarget = null, r === "tap") {
      ...
      })(Me), xe = { id: "pointer-events/base", before: ["inertia", "modifiers", "auto-start", "actions"], install: function(t) {
        t.pointerEvents = xe, t.defaults.actions.pointerEvents = xe.defaults, x(t.actions.phaselessTypes, xe.types);
      }, listeners: { "interactions:new": function(t) {
        var e = t.interaction;
        ...
        var n = t.interaction, r = t.pointer, i = t.event, o = t.eventTarget;
        t.duplicate || n.pointerIsDown && !n.pointerWasMoved || (n.pointerIsDown && gt(t), Q({ interaction: n, pointer: r, event: i, eventTarget: o, type: "move" }, e));
        ...
        (function(n, r) {
          ...
          if (p.targets.length) {
            ...
            u.duration = v, u.timeout = setTimeout((function() {
              Q({ interaction: i, eventTarget: s, pointer: o, event: a, type: "hold" }, r);
            }), v);
          }
        })(t, e), Q(t, e);
      }, "interactions:up": function(t, e) {
        gt(t), Q(t, e), (function(n, r) {
          var i = n.interaction, o = n.pointer, a = n.event, s = n.eventTarget;
          i.pointerWasMoved || Q({ interaction: i, eventTarget: s, pointer: o, event: a, type: "tap" }, r);
        })(t, e);
      }, "interactions:cancel": function(t, e) {
        gt(t), Q(t, e);
      } }, PointerEvent: bn, fire: Q, collectEventTargets: xn, defaults: { holdDuration: 600, ignoreFrom: null, allowFrom: null, origin: { x: 0, y: 0 } }, types: { down: !0, move: !0, up: !0, cancel: !0, tap: !0, doubletap: !0, hold: !0 } };
      function Q(t, e) {
        var n = t.interaction, r = t.pointer, i = t.event, o = t.eventTarget, a = t.type, s = t.targets, c = s === void 0 ? xn(t, e) : s, u = new bn(a, r, i, o, n, e.now());
        ...
        if (e.fire("pointerEvents:fired", l), a === "tap") {
          var g = u.double ? Q({ interaction: n, pointer: r, event: i, eventTarget: o, type: "doubletap" }, e) : u;
      ...
      var Pr = Object.freeze({ __proto__: null, default: xe });
      function Or(t) {
        var e = t.interaction;
        e.holdIntervalHandle && (clearInterval(e.holdIntervalHandle), e.holdIntervalHandle = null);
      }
      var Ir = { id: "pointer-events/holdRepeat", install: function(t) {
        t.usePlugin(xe);
        var e = t.pointerEvents;
        e.defaults.holdRepeatInterval = 0, e.types.holdrepeat = t.actions.phaselessTypes.holdrepeat = !0;
      }, listeners: ["move", "up", "cancel", "endall"].reduce((function(t, e) {
        return t["pointerEvents:".concat(e)] = Or, t;
      ...
      } }) }, Dr = Ir, zr = { id: "pointer-events/interactableTargets", install: function(t) {
        var e = t.Interactable;
      ...
      } } }, Mr = zr, Ar = { id: "pointer-events", install: function(t) {
        t.usePlugin(Pr), t.usePlugin(Dr), t.usePlugin(Mr);
      } }, Rr = Ar, Cr = { id: "reflow", install: function(t) {
        var e = t.Interactable;
        t.actions.phases.reflow = !0, e.prototype.reflow = function(n) {
          return (function(r, i, o) {
            for (var a = r.getAllElements(), s = o.window.Promise, c = s ? [] : null, u = function() {
              ...
              if (!f) return 1;
              var h, v = he(o.interactions.list, (function(m) {
              ...
              if (v) v.move(), c && (h = v._reflowPromise || new s((function(m) {
                ...
                var g = He(f), y = /* @__PURE__ */ (function(m) {
                ...
                h = (function(m, b, S, _, w) {
                  var T = m.interactions.new({ pointerType: "reflow" }), A = { interaction: T, event: w, pointer: w, eventTarget: S, phase: "reflow" };
                  T.interactable = b, T.element = S, T.prevEvent = w, T.updatePointer(w, w, S, !0), zt(T.coords.delta), it(T.prepared, _), T._doPhase(A);
                  var P = m.window, C = P.Promise, Y = C ? new C((function(U) {
                    T._reflowResolve = U;
                  })) : void 0;
                  return T._reflowPromise = Y, T.start(_, b, S), T._interacting ? (T.move(A), T.end(w)) : (T.stop(), T._reflowResolve()), T.removePointer(w, w), Y;
                })(o, r, p, i, y);
              }
              c && c.push(h);
            }, l = 0; l < a.length && !u(); l++) ;
      ...
      if (M.use(Qt), M.use(on), M.use(Rr), M.use(Zn), M.use(kr), M.use(Ln), M.use(Dn), M.use(Mn), M.use(jr), M.default = M, R(O) === "object" && O) try {
        O.exports = M;
      } catch {
      }
      return M.default = M, M;
    }));
  })(Ee, Ee.exports)), Ee.exports;
}
var Lr = /* @__PURE__ */ Yr();
const Gr = /* @__PURE__ */ Fr(Lr);
function En(O, L, j, I) {
  const R = `${O}-size`;
  if (L === void 0)
    return null;
  if (L === null)
    return I.style.removeProperty(R), null;
  let k = L;
  return j.min !== null && (k = Math.round(Math.max(k, j.min))), j.max !== null && (k = Math.round(Math.min(k, j.max))), I.style.setProperty(R, `${Math.round(k)}px`), k;
}
function qr(O, L, j) {
  const I = j?.() ?? {
    inline: { min: null, max: null },
    block: { min: null, max: null }
  }, R = En("inline", O.inline, I.inline, L), k = En("block", O.block, I.block, L);
  return {
    inline: R,
    block: k
  };
...
const Nr = (O) => Br(() => {
  ...
  return {
    resize(j) {
      let I;
      if (typeof O.targetElement == "function" ? I = O.targetElement()?.value ?? null : O.targetElement && "value" in O.targetElement ? I = O.targetElement.value : I = O.targetElement, !I)
        return { inline: void 0, block: void 0 };
      const { inline: R, block: k } = qr(j, I, O.getBounds), q = O.getBounds?.() ?? {
        inline: { min: null, max: null },
        block: { min: null, max: null }
      };
      return L = {
        inlineSize: R,
        blockSize: k,
        minInlineSize: q.inline.min,
        maxInlineSize: q.inline.max,
        minBlockSize: q.block.min,
        maxBlockSize: q.block.max
      }, O.onResize?.(L), {
        inline: R,
        block: k,
        minInlineSize: q.inline.min,
