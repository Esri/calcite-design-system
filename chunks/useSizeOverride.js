...
function Yr() {
  return wn || (wn = 1, (function(O, L) {
    (function(j, I) {
      ...
      function ue(t, e, n, r) {
        var i = t;
        return d.string(i) ? i = It(i, e, n) : d.func(i) && (i = i.apply(void 0, r)), d.element(i) && (i = He(i)), i;
      }
      function Pe(t) {
        ...
        for (var n = (function(o, a) {
          for (var s = [], c = 0, u = o.interactables.list; c < u.length; c++) {
            ...
            if (l.options.drop.enabled) {
              ...
              if (!(d.element(p) && p !== a || d.string(p) && !U(a, p) || d.func(p) && !p({ dropzone: l, draggableElement: a }))) for (var f = 0, h = l.getAllElements(); f < h.length; f++) {
                var v = h[f];
          ...
          for (var y, m, b, S = [], _ = 0; _ < g.length; _++) {
            ...
            if (w && _ !== y) if (T) {
              ...
              if (A !== w.ownerDocument) if (P !== w.ownerDocument) if (A !== P) {
                ...
                for (var Y = _t(C, T.ownerDocument), H = 0; Y[H] && Y[H] === S[H]; ) H++;
                var Le = [Y[H - 1], Y[H], S[H]];
      ...
      var Fn = { id: "auto-start/base", before: ["actions"], install: function(t) {
        ...
        n.interacting() || $t(n, Ut(n, r, i, o, e), e);
      }, "interactions:move": function(t, e) {
        (function(n, r) {
          var i = n.interaction, o = n.pointer, a = n.event, s = n.eventTarget;
          i.pointerType !== "mouse" || i.pointerIsDown || i.interacting() || $t(i, Ut(i, o, a, s, r), r);
        })(t, e), (function(n, r) {
          var i = n.interaction;
      ...
      } }, maxInteractions: Kt, withinInteractionLimit: Ae, validateAction: Ht }, at = Fn, Bn = { id: "auto-start/dragAxis", listeners: { "autoStart:before-start": function(t, e) {
        ...
        e.prototype.preventDefault = qn, e.prototype.checkAndPreventDefault = function(n) {
          return (function(r, i, o) {
            ...
            if (a !== "never") if (a !== "always") {
              ...
              /^(mouse|pointer|touch)*(down|start)/i.test(o.type) || d.element(o.target) && U(o.target, "input,select,textarea,[contenteditable=true],[contenteditable=true] *") || o.preventDefault();
      ...
      var rr = { id: "core/interactions", install: function(t) {
        ...
        })(Un), t.interactions = { list: [], new: function(s) {
        ...
        return D(t, [{ key: "_defaults", get: function() {
          ...
          return e = e || (d.element(this.target) ? this.target : null), d.string(this.target) && (e = e || this._context.querySelector(this.target)), He(e);
        ...
        return D(t, [{ key: "new", value: function(e, n) {
          ...
          for (var r = 0, i = this.list; r < i.length; r++) {
            var o = i[r], a = void 0;
            if ((d.string(o.target) ? d.element(e) && U(e, o.target) : e === o.target) && o.inContext(e) && (a = n(o)), a !== void 0) return a;
          }
        } }]), t;
      })(), sr = (function() {
        function t() {
          ...
          k(this, t), this.id = "__interact_scope_".concat(Math.floor(100 * Math.random())), this.isInitialized = !1, this.listenerMaps = [], this.browser = X, this.defaults = se(en), this.Eventable = ln, this.actions = { map: {}, phases: { start: !0, move: !0, end: !0 }, methodDict: {}, phaselessTypes: {} }, this.interactStatic = (function(r) {
            ...
            return i.getPointerAverage = Rt, i.getTouchBBox = Ke, i.getTouchDistance = Je, i.getTouchAngle = Qe, i.getElementRect = He, i.getElementClientRect = Ne, i.matchesSelector = U, i.closest = Tt, i.globalEvents = {}, i.version = "1.10.27", i.scope = r, i.use = function(o, a) {
      ...
      var be = { noInner: gn, noOuter: mn, start: function(t) {
        ...
        if (i) {
          var a = Ue(ie(o.min, e, t.coords)) || xr, s = Ue(ie(o.max, e, t.coords)) || wr;
          ...
          return (function(r, i, o) {
            for (var a = r.getAllElements(), s = o.window.Promise, c = s ? [] : null, u = function() {
              ...
              if (v) v.move(), c && (h = v._reflowPromise || new s((function(m) {
                ...
                var g = Ue(f), y = /* @__PURE__ */ (function(m) {
                ...
                h = (function(m, b, S, _, w) {
                  ...
                  var P = m.window, C = P.Promise, Y = C ? new C((function(H) {
                    T._reflowResolve = H;
                  })) : void 0;
