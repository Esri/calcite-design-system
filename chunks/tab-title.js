import { c as f, L as v, h as o, s as n, x as a, n as s, E as g, d as x } from "./iframe.js";
import { i as k } from "./keyed.js";
import { e as y, n as b } from "./ref.js";
import { n as T, g as h, t as z } from "./dom.js";
...
class A extends v {
  ...
  render() {
    ...
    return s(this.el, "aria-controls", this.controls), this.el.ariaSelected = z(this.selected), s(this.el, "id", c), this.el.role = "tab", s(this.el, "tabIndex", this.selected && !this.disabled ? 0 : -1), C({ disabled: this.disabled, children: a`<div class=${n({
      [e.container]: !0,
  ...
  renderCloseButton() {
    ...
    return t ? k(e.closeButton, a`<button .ariaLabel=${i.close} class=${n(e.closeButton)} @click=${this.closeClickHandler} title=${i.close ?? g} type=button ${b(this.closeButtonEl)}><calcite-icon .icon=${$.close} .scale=${r(this.scale)}></calcite-icon></button>`) : null;
  }
}
x("calcite-tab-title", A);
export {
  A as TabTitle
};
