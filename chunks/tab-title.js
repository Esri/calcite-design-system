import { a as m, L as v, d as o, s as c, x as a, k as r, c as f } from "./iframe.js";
...
class F extends v {
  ...
  render() {
    ...
    return r(this.el, "aria-controls", this.controls), this.el.ariaSelected = T(this.selected), r(this.el, "id", n), this.el.role = "tab", r(this.el, "tabIndex", this.selected && !this.disabled ? 0 : -1), w({ disabled: this.disabled, children: a`<div class=${c({
      [e.container]: !0,
      [e.containerBottom]: this.position === "bottom",
      [e.iconPresent]: !!this.iconStart || !!this.iconEnd,
      [e.scale(this.scale)]: !0
    })} .hidden=${i} ${k((l) => l ? this.resizeObserver?.observe(l) : null)}><div class=${c({ [e.content]: !0, [e.contentHasText]: this.hasText })}>${this.iconStart ? u : null}<slot></slot>${this.iconEnd ? p : null}</div>${this.renderCloseButton()}<div class=${c(e.selectedIndicator)}></div></div>` });
  }
  renderCloseButton() {
    const { closable: t, messages: i } = this;
    return t ? g("close-button", C({ disabled: !1, focusable: !0, label: i.close, onClick: this.closeClickHandler, ref: this.closeButtonEl, round: !1, scale: this.scale, title: i.close })) : null;
  }
}
f("calcite-tab-title", F);
export {
  F as TabTitle
};
