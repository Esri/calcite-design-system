import { a as u, L as w, d as r, x as s, s as p, B as m, c as f } from "./iframe.js";
import { i as a } from "./keyed.js";
import { e as C, n as h } from "./ref.js";
import { b as c } from "./dom.js";
import { i as R } from "./key.js";
...
class A extends w {
  ...
  render() {
    return y({ disabled: this.disabled, children: s`<tr .ariaRowIndex=${this.positionAll + 1} .ariaSelected=${this.selected} class=${p({ [$.lastVisibleRow]: this.lastVisibleRow })} @keydown=${this.keyDownHandler} ${h((e) => {
