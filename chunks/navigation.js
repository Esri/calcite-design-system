...
class y extends l {
  constructor() {
    super(...arguments), this.navigationActionEl = h(), this.focusSetter = d()(this), this.navigationAction = !1, this.calciteNavigationActionSelect = c({ cancelable: !1 });
  }
  static {
  ...
  async setFocus(t) {
    return this.focusSetter(() => this.navigationActionEl.value, t);
  }
  actionClickHandler() {
