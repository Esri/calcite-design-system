import { a as l, L as r, d as c, x as s, s as o, c as m } from "./iframe.js";
...
class y extends r {
  ...
  renderMenuAction() {
    return s`<slot name=${e.navigationAction} @slotchange=${this.handleMenuActionSlotChange}>${this.navigationAction && s`<calcite-action .icon=${v.hamburger} @click=${this.actionClickHandler} .text=${this.label} ${d(this.navigationActionEl)}></calcite-action>` || ""}</slot>`;
  }
  render() {
