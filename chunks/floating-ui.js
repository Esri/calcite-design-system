...
import { D as Qt, l as Zt } from "./index.js";
...
const ae = 50, fe = async (t, e, n) => {
  ...
  async fn(e) {
    ...
    const S = b / 2 - R / 2, P = A / 2 - p[g] / 2 - 1, v = J(u[h], P), L = J(u[y], P), z = A - p[g] - L, E = A / 2 - p[g] / 2 + S, T = kt(v, E, z), I = !a.arrow && F(i) != null && E !== T && r.reference[g] / 2 - (E < v ? v : L) - p[g] / 2 < 0, N = I ? E < v ? E - v : E - z : 0;
    return {
      [f]: m[f] + N,
      data: {
        [f]: T,
...
function de(t, e, n) {
  return (t ? [...n.filter((i) => F(i) === t), ...n.filter((i) => F(i) !== t)] : n.filter((i) => V(i) === i)).filter((i) => t ? F(i) === t || (e ? it(i) !== i : !1) : !0);
}
const me = function(t) {
  return t === void 0 && (t = {}), {
    name: "autoPlacement",
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (v = [...v, {
        ...
        v.every((D) => B(D.placement) === y ? D.overflows[0] > 0 : !0)))
          return {
            data: {
              index: T,
              overflows: v
        ...
        let N = (z = v.filter((U) => U.overflows[0] <= 0).sort((U, D) => U.overflows[1] - D.overflows[1])[0]) == null ? void 0 : z.placement;
        if (!N)
          switch (f) {
            case "bestFit": {
              var E;
              const U = (E = v.filter((D) => {
                if (O) {
                  const _ = B(D.placement);
                  return _ === y || // Create a bias to the `y` side axis due to horizontal
                  // reading directions favoring greater width.
                  _ === "y";
                }
                return !0;
              }).map((D) => [D.placement, D.overflows.filter((_) => _ > 0).reduce((_, Jt) => _ + Jt, 0)]).sort((D, _) => D[1] - _[1])[0]) == null ? void 0 : E[0];
              U && (N = U);
              break;
            }
...
async function we(t, e) {
  const {
    ...
    platform: o,
    elements: i
  } = t, r = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), s = V(n), c = F(n), a = B(n) === "y", l = pe.has(s) ? -1 : 1, d = r && a ? -1 : 1, u = K(e, t);
  let {
    mainAxis: m,
    crossAxis: f,
    alignmentAxis: g
...
function Me(t) {
  ...
  const s = [...n === "clippingAncestors" ? ft(e) ? [] : Fe(e, this._c) : [].concat(n), o], c = Dt(e, s[0], i);
