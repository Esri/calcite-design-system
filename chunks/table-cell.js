...
class f extends i {
  constructor() {
    super(...arguments), this.containerEl = d(), this.messages = p(), this.focusSetter = m()(this), this.contentsText = "", this.focused = !1, this.selectionText = "", this.alignment = "start", this.interactionMode = "interactive", this.parentRowAlignment = "start", this.scale = "m";
  }
  static {
