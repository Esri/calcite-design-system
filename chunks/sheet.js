import { a as D, L as E, d as z, k as O, s as d, C as I, x as S, n as B, K as T, c as $ } from "./iframe.js";
import { n as k } from "./ref.js";
import { i as H } from "./keyed.js";
import { i as y } from "./interact.min.js";
import { f as M, g as w, k as p, E as R } from "./dom.js";
import { c as V } from "./component.js";
import { c as A } from "./observers.js";
import { o as P } from "./openCloseComponent.js";
...
class j extends E {
  constructor() {
    ...
    })(this), this.usePreventDocumentScroll = F()(this), this.ignoreOpenChange = !1, this.messages = U(), this.mutationObserver = A("mutation", () => this.handleMutationObserver()), this._open = !1, this.openProp = "opened", this.transitionProp = "opacity", this.keyDownHandler = (e) => {
  ...
  static {
    this.properties = { resizeValues: 16, preventDocumentScroll: 16, beforeClose: 0, displayMode: 3, embedded: 5, escapeDisabled: 7, focusTrapDisabled: 7, focusTrapOptions: 0, heightScale: 3, height: 3, label: 1, messageOverrides: 0, open: 7, opened: 7, outsideCloseDisabled: 7, position: 3, resizable: 7, widthScale: 3, width: 3 };
  }
  static {
    this.styles = _;
  }
  ...
  willUpdate(e) {
    e.has("opened") && (this.hasUpdated || this.opened !== !1) && P(this), (e.has("open") && (this.hasUpdated || this.open !== !1) || e.has("position") && (this.hasUpdated || this.position !== "inline-start") || e.has("resizable") && (this.hasUpdated || this.resizable !== !1)) && this.setupInteractions();
  }
  ...
  handleKeyDown(e) {
    const { key: t, defaultPrevented: a, shiftKey: n } = e, { position: i, resizable: s, contentEl: b, el: c, resizeValues: { maxBlockSize: v, maxInlineSize: x, minBlockSize: f, minInlineSize: g } } = this, u = [...i === "block-end" || i === "block-start" ? ["ArrowUp", "ArrowDown"] : ["ArrowLeft", "ArrowRight"], "Home", "End"];
    if (!s || !b || a || !u.includes(t))
      return;
    const r = this.getContentElDOMRect(), m = w(c) === "rtl" ? -1 : 1, o = n ? B : T;
    switch (t) {
      case "ArrowUp":
        this.updateSize({
          size: r.height + (i === "block-end" ? o : -o),
          type: "blockSize"
        }), e.preventDefault();
        break;
      case "ArrowDown":
      ...
      case "ArrowLeft":
        this.updateSize({
          size: r.width + (i === "inline-end" ? o : -o) * m,
          type: "inlineSize"
        }), e.preventDefault();
        break;
      case "ArrowRight":
      ...
      case "Home":
        this.updateSize({
          size: i === "block-start" || i === "block-end" ? f : g,
  ...
  updateSize({ type: e, size: t }) {
    ...
    if (!a)
      return;
    const i = e === "blockSize" ? "minBlockSize" : "minInlineSize", s = e === "blockSize" ? "maxBlockSize" : "maxInlineSize", b = n[i] && n[s] ? L(t, n[i], n[s]) : t, c = Math.round(b);
    this.resizeValues = {
      ...n,
      [e]: c
  ...
  async setupInteractions() {
    ...
    const { inlineSize: b, minInlineSize: c, blockSize: v, minBlockSize: x, maxInlineSize: f, maxBlockSize: g } = window.getComputedStyle(t), h = {
      inlineSize: p(b),
      blockSize: p(v),
      minInlineSize: p(c),
      minBlockSize: p(x),
      maxInlineSize: p(f) || window.innerWidth,
      maxBlockSize: p(g) || window.innerHeight
    };
    this.resizeValues = h;
    const u = w(e) === "rtl";
    this.interaction = y(t, { context: e.ownerDocument }).resizable({
      ...
      modifiers: [
        y.modifiers.restrictSize({
          min: {
            width: h.minInlineSize,
            height: h.minBlockSize
          },
          max: {
            width: h.maxInlineSize,
            height: h.maxBlockSize
          }
        })
      ],
      listeners: {
  ...
  setContentEl(e) {
    this.contentEl = e, this.contentId = R(e);
  }
  setTransitionEl(e) {
  ...
  render() {
    ...
    return O(this.el, "aria-describedby", this.contentId), this.el.ariaLabel = this.label, this.el.ariaModal = "true", this.el.role = "dialog", S`<div class=${d({
      [l.container]: !0,
    ...
    })} ${k(this.setTransitionEl)}><calcite-scrim class=${d(l.scrim)} @click=${this.handleOutsideClose}></calcite-scrim><div class=${d(l.content)} id=sheet-content ${k(this.setContentEl)}><div class=${d(l.contentContainer)}><slot></slot></div>${e ? H("resize-handle", S`<div .ariaLabel=${this.messages.resizeEnabled} .ariaOrientation=${i ? "vertical" : "horizontal"} .ariaValueMax=${i ? a.maxBlockSize : a.maxInlineSize} .ariaValueMin=${i ? a.minBlockSize : a.minInlineSize} .ariaValueNow=${i ? a.blockSize : a.inlineSize} class=${d(l.resizeHandle)} @keydown=${this.handleKeyDown} role=separator tabindex=0 touch-action=none ${k(this.setResizeHandleEl)}><div class=${d(l.resizeHandleBar)}><calcite-icon .icon=${this.getResizeIcon()} scale=s></calcite-icon></div></div>`) : null}</div></div>`;
  }
}
$("calcite-sheet", j);
export {
