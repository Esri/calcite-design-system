import { j as E, L as O, n as g, w as I, x as S, s as p, C as D, k as B } from "./iframe.js";
...
class K extends O {
  ...
  handleKeyDown(e) {
    ...
    if (!a || !h || s || !v.includes(t))
      return;
    const c = this.getContentElDOMRect(), b = w(r) === "rtl" ? -1 : 1, o = n ? U : F;
    switch (t) {
      case "ArrowUp":
        this.updateSize({
