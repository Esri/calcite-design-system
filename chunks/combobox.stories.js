import { m as M } from "./utils.js";
import { h as e } from "./formatting.js";
/*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
v3.3.0-next.19 */
var B = Object.freeze, O = Object.defineProperty, V = (m, N) => B(O(m, "raw", { value: B(m.slice()) })), E;
function A(m, N) {
  const _ = m(), {
    selectionMode: q
  } = N.args, C = Array.isArray(q) ? q : [q], L = ["s", "m", "l"];
  return e`
    <style>
      calcite-combobox {
        margin-bottom: 250px;
