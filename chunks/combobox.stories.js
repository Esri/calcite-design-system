import { m as V } from "./utils.js";
import { h as e } from "./formatting.js";
/*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
v3.3.0-next.9 */
var _ = Object.freeze, W = Object.defineProperty, z = (m, R) => _(W(m, "raw", { value: _(m.slice()) })), C;
function N(m, R) {
  const L = m(), {
    selectionMode: I
  } = R.args, M = Array.isArray(I) ? I : [I], O = ["s", "m", "l"];
  return e`
    <style>
      calcite-combobox {
        margin-bottom: 250px;
        ...
        <div class="selection-mode-group">
          ${O.map((E) => e`
              <div class="combobox-container">
                <h3>${B} selection mode + ${E} scale</h3>
                <calcite-combobox
...
export {
  ...
  k as selectAllEnabledAndAllSelected,
  A as selectAllEnabledAndAllSelectedWithPlaceholder,
  q as selectAllEnabledIndeterminate,
  x as single,
