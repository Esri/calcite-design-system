import { j as h, L as d, n as a, i as v, x as i, s as t, k as m } from "./iframe.js";
import { e as o, n as r } from "./ref.js";
import { s as g } from "./dom.js";
import { c as x, g as n } from "./component.js";
...
class C extends d {
  ...
  async setFocus() {
    await x(this), !this.disabled && this.interactive ? this.containerEl.value?.focus() : !this.disabled && this.closable && this.closeButtonEl.value?.focus();
  }
  async load() {
