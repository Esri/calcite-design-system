import { a as z, L as w, d as b, s as i, x as n, E as x, c as F } from "./iframe.js";
...
class D extends w {
  constructor() {
    super(), this.resizeObserver = I("resize", () => this.resizeHandler()), this.messages = L(), this.hasActionBar = !1, this.hasContentBottom = !1, this.hasContentTop = !1, this.hasEndActions = !1, this.hasFab = !1, this.hasFooterActions = !1, this.hasFooterContent = !1, this.hasFooterEndContent = !1, this.hasFooterStartContent = !1, this.hasHeaderContent = !1, this.hasMenuItems = !1, this.hasStartActions = !1, this.isClosed = !1, this.showHeaderContent = !1, this.closable = !1, this.closed = !1, this.collapseDirection = "down", this.collapsed = !1, this.collapsible = !1, this.disabled = !1, this.loading = !1, this.menuOpen = !1, this.menuPlacement = O, this.overlayPositioning = "absolute", this.scale = "m", this.calcitePanelClose = b({ cancelable: !1 }), this.calcitePanelScroll = b({ cancelable: !1 }), this.calcitePanelToggle = b({ cancelable: !1 }), this.listen("keydown", this.panelKeyDownHandler);
  }
  static {
  ...
  renderMenu() {
    ...
    return d("menu", n`<calcite-action-menu .flipPlacements=${l ?? ["top", "bottom"]} .hidden=${!e} .label=${a.options} .open=${o} .overlayPositioning=${this.overlayPositioning} .placement=${c}><calcite-action class=${i(t.menuAction)} .icon=${u.menu} .scale=${this.scale} slot=${M.trigger} .text=${a.options}></calcite-action><slot name=${s.headerMenuActions} @slotchange=${this.handleHeaderMenuActionsSlotChange}></slot></calcite-action-menu>`);
  }
  renderHeaderNode() {
