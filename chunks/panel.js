...
import { a as z, L as F, c as C, s as o, b as n, A as E, d as B } from "./index.js";
import { i as b } from "./keyed.js";
import { e as P, n as T } from "./ref.js";
import { s as p, b as H, d as A, y as k } from "./dom.js";
...
class q extends F {
  constructor() {
    super(), this.containerRef = P(), this.resizeObserver = N("resize", () => this.resizeHandler()), this.messages = I(), this._closed = !1, this.focusSetter = _()(this), this.focusTrapController = V({
      focusTrapOptions: {
        allowOutsideClick: !0,
  ...
  handleHeaderDescriptionSlotChange(e) {
    this.hasHeaderDescription = A(e) || H(e).some(k);
  }
  handleHeaderHeadingSlotChange(e) {
    this.hasHeaderHeading = A(e) || H(e).some(k);
  }
  ...
  render() {
    const { disabled: e, loading: a, closed: i, heading: s, description: r, focusTrapEnabled: c, closable: g } = this, d = c && g, u = n`<div .ariaBusy=${G(a, void 0)} .ariaDescription=${d && r ? r : void 0} .ariaLabel=${d && s ? s : void 0} .ariaLive=${d ? "polite" : void 0} class=${o(t.container)} .hidden=${i} .role=${d ? "dialog" : "article"} ${T(this.containerRef)}>${this.renderHeaderNode()}${this.renderContent()}${this.renderContentBottom()}${this.renderFooterNode()}${b("alerts", n`<slot name=${l.alerts} @slotchange=${this.handleAlertsSlotChange}></slot>`)}</div>`;
