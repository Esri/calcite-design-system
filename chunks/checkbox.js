import { a as i, L as s, d as t, s as o, o as c, C as l, b as r, x as n, c as h } from "./iframe.js";
import { e as d, n as g } from "./ref.js";
import { g as b } from "./dom.js";
import { c as v, d as k, H as u } from "./form.js";
import { u as p, I as m } from "./interactive.js";
import { i as f } from "./key.js";
import { c as x, d as y, g as w } from "./label.js";
import { c as C } from "./component.js";
...
class I extends s {
  ...
  render() {
    ...
    return m({ disabled: this.disabled, children: n`<div .ariaChecked=${this.checked} .ariaLabel=${w(this)} class=${o({
      [a.toggle]: !0,
      [l.rtl]: e
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? c} ${g(this.toggleEl)}><svg aria-hidden=true class=${o(a.check)} viewBox="0 0 16 16">${r`<path d=${this.getPath() ?? c} />`}</svg><slot></slot></div>${u({ component: this })}` });
  }
}
