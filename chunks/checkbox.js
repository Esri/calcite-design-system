import { j as c, L as a, n as t, x as l, s as o, z as i, C as n, h as r, k as h } from "./iframe.js";
...
import { c as x, d as y, g as z } from "./label.js";
...
class I extends a {
  ...
  render() {
    ...
    return f({ disabled: this.disabled, children: l`<div .ariaChecked=${this.checked} .ariaLabel=${z(this)} class=${o({
      [s.toggle]: !0,
      [n.rtl]: e
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? i} ${g(this.toggleEl)}><svg aria-hidden=true class=${o(s.check)} viewBox="0 0 16 16">${r`<path d=${this.getPath() ?? i} />`}</svg><slot></slot></div>${p({ component: this })}` });
  }
}
