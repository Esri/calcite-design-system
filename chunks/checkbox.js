import { a as i, L as a, d as t, s as o, o as c, C as l, b as r, x as n, c as h } from "./iframe.js";
import { e as d, n as g } from "./ref.js";
import { g as b } from "./dom.js";
import { c as v, d as k, H as p } from "./form.js";
...
class I extends a {
  ...
  async setFocus() {
    await w(this), this.toggleEl.value?.focus();
  }
  connectedCallback() {
  ...
  render() {
    ...
    return m({ disabled: this.disabled, children: n`<div .ariaChecked=${this.checked} .ariaLabel=${C(this)} class=${o({
      [s.toggle]: !0,
      [l.rtl]: e
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? c} ${g(this.toggleEl)}><svg aria-hidden=true class=${o(s.check)} viewBox="0 0 16 16">${r`<path d=${this.getPath() ?? c} />`}</svg><slot></slot></div>${p({ component: this })}` });
  }
}
