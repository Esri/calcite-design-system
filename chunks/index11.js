...
v3.3.0-next.15 */
var B = { exports: {} }, on = B.exports, Ue;
function sn() {
  return Ue || (Ue = 1, function(r, o) {
    (function(a, l) {
      l(o);
    })(on, function(a) {
      function l(e) {
      ...
      class D {
        static create(t) {
          ...
          t = n.text;
          const s = this.read(t);
          return t = s.text, new D(t, void 0, n.token, s.token);
        }
        constructor(t, n, s, i) {
          this.text = "", this.text = t, this.previous = n, this.current = s, this.next = i;
        }
        static read(t, n = !1) {
          n = n || Pt.test(t), t = t.trim();
          for (const s of Et) {
            const i = s(t);
            if (i !== null) {
      ...
      function re(e) {
        return e.type === "JsdocTypeKeyValue" ? G(e) : w(e);
      }
      function bt(e) {
      ...
      class j {
        constructor(t, n, s) {
          this.grammar = t, typeof n == "string" ? this._lexer = D.create(n) : this._lexer = n, this.baseParser = s;
        }
        get lexer() {
          return this._lexer;
        }
      ...
      function Q({ allowSquareBracketsOnAnyType: e, allowJsdocNamePaths: t, pathGrammar: n }) {
      ...
      function ce({ allowNamedParameters: e, allowNoReturnType: t, allowWithoutParenthesis: n, allowNewAsFunctionKeyword: s }) {
        return J({
      ...
      function ue({ allowSquaredProperties: e, allowKeyTypes: t, allowReadonly: n, allowOptional: s }) {
        return J({
          ...
          parseInfix: (i, y) => {
            ...
            if (b.acceptLexerState(i), y.type === "JsdocTypeNumber" || y.type === "JsdocTypeName" || y.type === "JsdocTypeStringValue" || oe(y)) {
              if (oe(y) && !e)
                throw new d(y);
              b.consume(":");
              let O;
      ...
      function jt({ allowQuestionMark: e }) {
        return J({
          ...
          parsePrefix: (t) => {
            ...
            if (s.type === "JsdocTypeParameterList" ? s.elements[0].type === "JsdocTypeKeyValue" ? n.elements = s.elements.map(G) : n.elements = s.elements.map(w) : s.type === "JsdocTypeKeyValue" ? n.elements = [G(s)] : n.elements = [w(s)], !t.consume("]"))
      ...
      function ve(e, t) {
        switch (t) {
          ...
          case "typescript":
            return new j(Yt, e).parse();
        }
      }
      function Gt(e, t = ["typescript", "closure", "jsdoc"]) {
        let n;
        for (const s of t)
          try {
            return ve(e, s);
      ...
      function Re() {
        return {
          ...
          JsdocTypeVariadic: (e, t) => e.meta.position === void 0 ? "..." : z(e.meta.position, t(e.element), "..."),
          ...
          JsdocTypeNotNullable: (e, t) => z(e.meta.position, t(e.element), "!"),
          JsdocTypeNull: () => "null",
          JsdocTypeNullable: (e, t) => z(e.meta.position, t(e.element), "?"),
          JsdocTypeNumber: (e) => e.value.toString(),
          JsdocTypeObject: (e, t) => `{${e.elements.map(t).join((e.meta.separator === "comma" ? "," : ";") + " ")}}`,
          JsdocTypeOptional: (e, t) => z(e.meta.position, t(e.element), "="),
      ...
      function R(e) {
        ...
        return Qt.includes(e) && (t.reservedWord = !0), t;
      }
      const Ht = {
      ...
      a.catharsisTransform = zt, a.identityTransformRules = nn, a.jtpTransform = tn, a.parse = ve, a.stringify = Xt, a.stringifyRules = Re, a.transform = q, a.traverse = rn, a.tryParse = Gt, a.visitorKeys = _e;
    });
  }(B, B.exports)), B.exports;
}
var fe = sn(), an = Object.defineProperty, c = (r, o) => an(r, "name", { value: o, configurable: !0 });
...
var ln = ["null", "undefined"];
function ee(r) {
  return ln.some((o) => o === r);
}
...
c(un, "isValidDocgenSection");
function yn(r, o) {
  return Te(r) ? r.__docgenInfo[o] : null;
}
c(yn, "getDocgenSection");
function je(r) {
  return Te(r) ? pn(r.__docgenInfo.description) : "";
}
c(je, "getDocgenDescription");
var _;
(function(r) {
...
var dn = /^@\S+/;
function Me({ fence: r = "```" } = {}) {
  let o = Be(r), a = /* @__PURE__ */ c((l, u) => o(l) ? !u : u, "toggleFence");
  return /* @__PURE__ */ c(function(l) {
    let u = [[]], p = !1;
    for (let d of l)
      dn.test(d.tokens.description) && !p ? u.push([d]) : u[u.length - 1].push(d), p = a(d.tokens.description, p);
    return u;
  }, "parseBlock");
}
c(Me, "getParser");
...
function Ce({ startLine: r = 0, markers: o = _ } = {}) {
  ...
  return /* @__PURE__ */ c(function(u) {
    let p = u, d = qe();
    if ([d.lineEnd, p] = Ke(p), [d.start, p] = U(p), a === null && p.startsWith(o.start) && !p.startsWith(o.nostart) && (a = [], d.delimiter = p.slice(0, o.start.length), p = p.slice(o.start.length), [d.postDelimiter, p] = U(p)), a === null)
      return l++, null;
...
c(We, "typeTokenizer");
var mn = /* @__PURE__ */ c((r) => r.trim(), "trim");
function Xe(r) {
  return r === "compact" ? (o) => o.map(mn).join("") : r === "preserve" ? (o) => o.join(`
`) : r;
}
c(Xe, "getJoiner");
var fn = /* @__PURE__ */ c((r) => r && r.startsWith('"') && r.endsWith('"'), "isQuoted");
function Qe() {
...
c(ze, "compactJoiner");
var Tn = /* @__PURE__ */ c((r, { tokens: o }, a) => o.type === "" ? r : a, "lineNo"), hn = /* @__PURE__ */ c(({ tokens: r }) => (r.delimiter === "" ? r.start : r.postDelimiter.slice(1)) + r.description, "getDescription");
function Ze(r, o = _) {
  if (r.length === 0)
    return "";
  r[0].tokens.description === "" && r[0].tokens.delimiter === o.start && (r = r.slice(1));
  let a = r[r.length - 1];
  return a !== void 0 && a.tokens.description === "" && a.tokens.end.endsWith(o.end) && (r = r.slice(0, -1)), r = r.slice(r.reduce(Tn, 0)), r.map(hn).join(`
`);
}
c(Ze, "preserveJoiner");
function et({ startLine: r = 0, fence: o = "```", spacing: a = "compact", markers: l = _, tokenizers: u = [
  Ge(),
  We(a),
  Qe(),
  He(a)
  ...
  let p = Ce({ startLine: r, markers: l }), d = Me({ fence: o }), T = Ye({ tokenizers: u }), h = he(a);
  return function(S) {
    let E = [];
    for (let te of De(S)) {
      let K = p(te);
      if (K === null)
        continue;
      let C = d(K), Y = C.slice(1).map(T);
      E.push({
        description: h(C[0], l),
        tags: Y,
        source: K,
        problems: Y.reduce((P, ne) => P.concat(ne.problems), [])
      });
    }
    return E;
  };
...
c(tt, "join");
function Jn() {
  return (r) => r.source.map(({ tokens: o }) => tt(o)).join(`
`);
}
c(Jn, "getStringifier");
function nt(r, o = {}) {
...
}, wn = /* @__PURE__ */ c((r, o = gn) => {
  if (!rt(r))
    return {
      includesJsDoc: !1,
      ignore: !1
    };
  let a = ot(r), l = st(a, o.tags);
  return l.ignore ? {
    includesJsDoc: !0,
    ignore: !0
  } : {
...
function it(r) {
  ...
  return {
    ...
    getPrettyName: /* @__PURE__ */ c(() => at(r.name), "getPrettyName"),
...
c(lt, "extractReturns");
var L = fe.stringifyRules(), Nn = L.JsdocTypeObject;
L.JsdocTypeAny = () => "any";
L.JsdocTypeObject = (r, o) => `(${Nn(r, o)})`;
...
function ut({ name: r, raw: o, elements: a }) {
...
function xn({ tsType: r, required: o }) {
  if (r == null)
    return null;
  let a = r.name;
...
function gt(r, o) {
  if (r != null) {
    let { value: a } = r;
    if (!ee(a))
      return ht(r) && Jt(o) ? N(JSON.stringify(a)) : N(a);
  }
  return null;
}
...
c(Sn, "applyJsDocResult");
function On(r, o, a, l) {
  let u = wn(o.description);
...
c(In, "extractComponentDescription");
const { combineParameters: vn } = __STORYBOOK_MODULE_PREVIEW_API__;
var Fn = /* @__PURE__ */ c((r) => {
  let {
    component: o,
    argTypes: a,
  ...
  return p ? vn(p, a) : a;
}, "enhanceArgTypes"), An = "storybook/docs", Un = `${An}/snippet-rendered`, Rn = /* @__PURE__ */ ((r) => (r.AUTO = "auto", r.CODE = "code", r.DYNAMIC = "dynamic", r))(Rn || {});
export {
  Fn as c,
  Rn as g,
  Un as y
