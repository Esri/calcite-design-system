...
import { a as B, g as w } from "./dom.js";
import { c as x, d as y, H as I } from "./form.js";
...
class q extends p {
  ...
  connectedCallback() {
    this.rootNode = this.el.getRootNode(), this.name && this.checkLastRadioButton(), z(this), x(this), this.updateTabIndexOfOtherRadioButtonsInGroup(), super.connectedCallback();
  }
  willUpdate(e) {
  ...
  handleKeyDown(e) {
    ...
    let c = t;
    w(i) === "rtl" && (t === "ArrowRight" && (c = "ArrowLeft"), t === "ArrowLeft" && (c = "ArrowRight"));
