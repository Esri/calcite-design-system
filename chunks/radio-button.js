import { a as f, L as p, d as r, s as l, E as m, x as k, c as v } from "./iframe.js";
...
class q extends p {
  ...
  render() {
    ...
    return C({ disabled: this.disabled, children: k`<div .ariaChecked=${this.checked} .ariaLabel=${F(this)} class=${l(u.container)} @blur=${this.onContainerBlur} @focus=${this.onContainerFocus} role=radio tabindex=${e ?? m} ${g(this.setContainerEl)}><div class=${l(u.radio)}></div></div>${I({ component: this })}` });
  }
}
v("calcite-radio-button", q);
export {
  q as RadioButton
};
