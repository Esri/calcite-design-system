...
class Q extends z {
  ...
  static {
    this.properties = { hasActionsEnd: 16, hasActionsStart: 16, hasContentBottom: 16, hasContentEnd: 16, hasContentStart: 16, hasCustomContent: 16, level: 16, expandable: 16, parentListEl: 16, active: 5, bordered: 5, sortDisabled: 5, closable: 7, closed: 7, description: 1, disabled: 7, dragDisabled: 7, dragHandle: 7, expanded: 7, filterHidden: 7, interactionMode: 1, label: 1, messageOverrides: 0, metadata: 0, displayMode: 3, addToItems: 0, moveToItems: 0, open: 7, scale: 3, selected: 7, selectionAppearance: 3, selectionMode: 3, setPosition: 9, setSize: 9, sortHandleOpen: 7, unavailable: 7, value: 1, iconStart: 3, iconEnd: 3, iconFlipRtl: 3 };
  }
  static {
    this.styles = [J, j];
  }
  ...
  async setFocus(e) {
    return this.focusSetter(() => {
      const { containerRef: t, parentListEl: n } = this, l = I.get(n);
      if (typeof l == "number") {
  ...
  setFocusCell(e, t, n) {
    ...
    }), e && (e === t ? e.tabIndex = 0 : e.removeAttribute("tabindex"), e.setAttribute(L, ""), n && I.set(l, o.indexOf(e)));
  }
  focusCell(e, t = !0) {
    const n = T(e);
  ...
  render() {
    const { expandable: e, expanded: t, level: n, active: l, label: o, selected: r, selectionAppearance: p, selectionMode: u, interactionMode: d, closed: f, filterHidden: g, bordered: y, disabled: E, hasContentBottom: w } = this, H = y && w, k = y && !w, $ = u !== "none" && p === "border", A = $ && r, B = $ && !r, R = d === "interactive" || d === "static" && u !== "none" && p === "border";
