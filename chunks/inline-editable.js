import { c as d, L as b, h as a, s as i, k as h, E as l, x as s, d as u } from "./iframe.js";
...
class $ extends b {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.cancelEditingButton = c(), this.confirmEditingButton = c(), this._editingEnabled = !1, this.enableEditingButton = c(), this.controls = !1, this.disabled = !1, this.loading = !1, this.messages = v(), this.calciteInlineEditableEditCancel = a({ cancelable: !1 }), this.calciteInlineEditableEditConfirm = a({ cancelable: !1 }), this.calciteInternalInlineEditableEnableEditingChange = a({ cancelable: !1 }), this.listen("calciteInternalInputBlur", this.blurHandler);
  }
  static {
  ...
  async setFocus() {
    await k(this), this.inputElement?.setFocus();
  }
  connectedCallback() {
