...
class $ extends b {
  constructor() {
    super(), this.cancelEditingButton = c(), this.confirmEditingButton = c(), this._editingEnabled = !1, this.enableEditingButton = c(), this.messages = v(), this.controls = !1, this.disabled = !1, this.loading = !1, this.calciteInlineEditableEditCancel = a({ cancelable: !1 }), this.calciteInlineEditableEditConfirm = a({ cancelable: !1 }), this.calciteInternalInlineEditableEnableEditingChange = a({ cancelable: !1 }), this.listen("calciteInternalInputBlur", this.blurHandler);
  }
  static {
  ...
  async handleDefaultSlotChange(t) {
    const e = k(t).filter((r) => r.matches("calcite-input"))[0];
