...
class $ extends b {
  constructor() {
    super(), this.cancelEditingButtonRef = o(), this._editingEnabled = !1, this.enableEditingButtonRef = o(), this.messages = v(), this.focusSetter = y()(this), this.controls = !1, this.disabled = !1, this.loading = !1, this.calciteInlineEditableEditCancel = a({ cancelable: !1 }), this.calciteInlineEditableEditConfirm = a({ cancelable: !1 }), this.calciteInternalInlineEditableEnableEditingChange = a({ cancelable: !1 }), this.listen("calciteInternalInputBlur", this.blurHandler);
  }
  static {
  ...
  async handleDefaultSlotChange(t) {
    ...
    this.inputEl = e, e && (await e.componentOnReady(), e.editingEnabled = this.editingEnabled, e.label = e.label || m(this), this.scale = this.scale || this.inputEl?.scale || "m");
  }
  onLabelClick() {
    this.setFocus();
  }
