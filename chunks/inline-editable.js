import { a as d, L as b, d as a, s as i, j as h, E as l, x as s, c as u } from "./iframe.js";
...
class $ extends b {
  constructor() {
    super(), this.cancelEditingButton = c(), this.confirmEditingButton = c(), this._editingEnabled = !1, this.enableEditingButton = c(), this.messages = k(), this.controls = !1, this.disabled = !1, this.loading = !1, this.calciteInlineEditableEditCancel = a({ cancelable: !1 }), this.calciteInlineEditableEditConfirm = a({ cancelable: !1 }), this.calciteInternalInlineEditableEnableEditingChange = a({ cancelable: !1 }), this.listen("calciteInternalInputBlur", this.blurHandler);
  }
  static {
  ...
  async setFocus() {
    await v(this), this.inputElement?.setFocus();
  }
  connectedCallback() {
  ...
  async handleDefaultSlotChange(t) {
    const e = y(t).filter((r) => r.matches("calcite-input"))[0];
