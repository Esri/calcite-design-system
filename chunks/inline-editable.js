...
import { a as p, L as f, c, n as o, s as n, b as r, d as E } from "./index.js";
...
class B extends f {
  constructor() {
    super(), this.cancelEditingButtonRef = d(), this.confirmChangesButtonRef = d(), this._editingEnabled = !1, this.enableEditingButtonRef = d(), this.shouldEmitCancel = !1, this.valuePriorToEditing = "", this.messages = C(), this.focusSetter = k()(this), this.interactiveContainer = $(this), this.controls = !1, this.disabled = !1, this.loading = !1, this.scale = "m", this.calciteInlineEditableEditCancel = c({ cancelable: !1 }), this.calciteInlineEditableEditConfirm = c({ cancelable: !1 }), this.calciteInternalInlineEditableEnableEditingChange = c({ cancelable: !1 }), v(this), this.listen("calciteInternalInputBlur", this.blurHandler), this.listen("calciteInternalInputNumberBlur", this.blurHandler), this.listen("calciteInternalInputTextBlur", this.blurHandler), this.listen("keydown", this.escapeKeyHandler);
  }
  static {
  ...
  editingEnabledWatcher(t, e) {
    this.inputEl && (this.inputEl.inlineEditing = t), !t && e && (this.shouldEmitCancel = !0);
  }
  blurHandler() {
    this.controls || this.disableEditing();
  }
  async handleDefaultSlotChange(t) {
    const e = y(t).filter((a) => a.matches("calcite-input, calcite-input-number, calcite-input-text"))[0];
    this.inputEl = e, e && (await e.componentOnReady(), e.inlineEditing = this.editingEnabled, e.label = e.label || m(this));
  }
  onLabelClick() {
    this.setFocus();
  }
