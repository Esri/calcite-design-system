import { a as P, L as w, d as E, s as r, E as z, x as d, c as X } from "./iframe.js";
...
class O extends w {
  ...
  renderEllipsis(t) {
    return p(t, d`<span class=${r(s.ellipsis)} data-test-ellipsis=${t ?? z}>&hellip;</span>`);
  }
  renderItems() {
    ...
    let m, c;
    l - 1 <= n ? (c = 1 + e, m = u - e) : i / e < n ? (c = 1 + e, m = 1 + n * e) : i + n * e >= t ? (c = u - n * e, m = u - e) : (c = i - e * ((n - 1) / 2), m = i + e * ((n - 1) / 2));
    for (let k = 0; k < n && c <= m; k++)
  ...
  renderPage(t) {
    ...
    return d`<li class=${r(s.listItem)}><button .ariaCurrent=${l ? "page" : "false"} class=${r({
      [s.page]: !0,
      [s.selected]: l
  ...
  renderPreviousChevron() {
    ...
    return p("previous", d`<button .ariaLabel=${i.previous} class=${r({
      [s.chevron]: !0,
      [s.disabled]: a
  ...
  renderNextChevron() {
    ...
    return p("next-button", d`<button .ariaLabel=${a.next} class=${r({
      [s.chevron]: !0,
      [s.disabled]: l
  ...
  renderFirstChevron() {
    ...
    return i ? p("first-button", d`<button .ariaLabel=${t.first} class=${r({
      [s.chevron]: !0,
      [s.disabled]: a
  ...
  renderLastChevron() {
    ...
    return i ? p("last-button", d`<button .ariaLabel=${t.last} class=${r({
      [s.chevron]: !0,
      [s.disabled]: l
  ...
  render() {
    ...
    return d`<ul class=${r(s.list)}><li class=${r({
      [s.listItem]: !0,
      [s.hiddenItem]: !t
