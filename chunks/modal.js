import { j as x, L as k, n as l, w as h, x as a, s as o, E as y, k as w } from "./iframe.js";
...
class M extends k {
  ...
  constructor() {
    ...
    })(this), this.ignoreOpenChange = !1, this.modalContent = p(), this.mutationObserver = f("mutation", () => this.updateFocusTrapElements()), this._open = !1, this.openEnd = () => {
  ...
  renderCloseButton() {
    return this.closeButtonDisabled ? null : m("button", a`<button .ariaLabel=${this.messages.close} class=${o(t.close)} @click=${this.handleCloseClick} title=${this.messages.close ?? y} ${d(this.closeButtonEl)}><calcite-icon .icon=${T.close} .scale=${$(this.scale)}></calcite-icon></button>`);
  }
  renderStyle() {
