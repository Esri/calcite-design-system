...
import { b as l, m as ae } from "./utils.js";
import { h as e } from "./formatting.js";
import { A as ie } from "./resources14.js";
...
`, J = e`
  <calcite-action-bar class="calcite-mode-dark" slot="action-bar"> ${ne} </calcite-action-bar>
`, K = e`
...
`, $ = '<footer slot="footer">My Shell Footer</footer>', g = e(`
  <div
    style="
    width:100%;
    height:100%;
...
const h = () => V[0], f = () => V[1], W = [];
["float", "float-content"].forEach((t, i) => {
  W[i] = e(`<calcite-shell content-behind>
    <header slot="header">
      <h2>My Shell Header</h2>
    </header>
    <div
...
const k = () => _[0], w = () => _[1], q = () => e(`<calcite-shell content-behind>
  ${H}
  <calcite-shell-panel slot="panel-start">${X}</calcite-shell-panel>
  ${g}
  <calcite-shell-center-row slot="center-row">${a}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${ee}</calcite-shell-panel>
  ${$}
</calcite-shell>`), L = () => e(`<calcite-shell
    style="
    width:100%;
    height:500px;
    max-height:80%;
...
["float", "float-content"].forEach((t, i) => {
  Z[i] = e(`
    ...
    >
        ...
        background-size: 20px 20px;
        background-position: 0 0, 0 10px, 10px -10px, -10px 0px;"></div>
        <calcite-shell-panel slot="panel-bottom" display-mode="${t}" layout="horizontal">${le}</calcite-shell-panel>
      </calcite-shell>
    `);
});
const M = () => Z[0], S = () => Z[1], C = () => e(`
  <calcite-shell
    style="
    width:100%;
    height:500px;
...
`), T = () => e(`<calcite-shell content-behind>
  ${H}
  <calcite-shell-panel slot="panel-start">${X}</calcite-shell-panel>
  ${g}
  <calcite-shell-center-row slot="center-row">${oe}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${ee}</calcite-shell-panel>
  ${$}
...
const B = () => e`<calcite-shell>
    ...
    ></calcite-popover>`, D = () => e`<calcite-shell>
    <calcite-shell-panel slot="panel-start" position="start" id="shell-panel-start">
      <calcite-action-bar slot="action-bar">
  ...
  </calcite-shell>`, I = () => e`<calcite-shell>
    <div
      style="
      width:100%;
      height:100%;
...
const u = () => e` <calcite-shell content-behind>
    <div style="
              width:100%;
              height:100%;
              background-image: linear-gradient(45deg, #ccc 25%, transparent 25%),
