...
import { h as e, k as l, j as ne } from "./index.js";
import { A as ce } from "./resources16.js";
...
`, X = e`
  <calcite-action-bar class="calcite-mode-dark" slot="action-bar"> ${le} </calcite-action-bar>
`, ee = e`
  <calcite-action-bar slot="action-bar"> ${oe} </calcite-action-bar>
`, te = e`
  ${X}
...
`, G = '<footer slot="footer">My Shell Footer</footer>', h = e(`
  <div
    style="
    width:100%;
    height:100%;
...
const b = () => _[0], v = () => _[1], Z = [];
["float", "float-content"].forEach((t, i) => {
  Z[i] = e(`<calcite-shell content-behind>
    <header slot="header">
      <h2>My Shell Header</h2>
    </header>
    <div
...
const q = () => Y[0], L = () => Y[1], M = () => e(`<calcite-shell content-behind>
  ${R}
  <calcite-shell-panel slot="panel-start">${te}</calcite-shell-panel>
  ${h}
  <calcite-shell-center-row slot="center-row">${a}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${ae}</calcite-shell-panel>
  ${G}
...
["float", "float-content"].forEach((t, i) => {
  Q[i] = e(`
    ...
    >
        ...
        background-size: 20px 20px;
        background-position: 0 0, 0 10px, 10px -10px, -10px 0px;"></div>
        <calcite-shell-panel slot="panel-bottom" display-mode="${t}" layout="horizontal">${se}</calcite-shell-panel>
      </calcite-shell>
    `);
});
const C = () => Q[0], P = () => Q[1], A = () => e(`
  <calcite-shell
    style="
    width:100%;
    height:500px;
...
`), F = () => e(`<calcite-shell content-behind>
  ${R}
  <calcite-shell-panel slot="panel-start">${te}</calcite-shell-panel>
  ${h}
  <calcite-shell-center-row slot="center-row">${re}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${ae}</calcite-shell-panel>
  ${G}
</calcite-shell>`), s = () => e` <calcite-shell
    style="
...
const O = () => e`<calcite-shell>
  ...
  </calcite-shell>`, D = () => e`<calcite-shell>
    ...
    ></calcite-popover>`, I = () => e`<calcite-shell>
    <calcite-shell-panel slot="panel-start" position="start" id="shell-panel-start">
      <calcite-action-bar slot="action-bar">
  ...
  </calcite-shell>`, j = () => e` <calcite-shell content-behind>
    <div
      style="
      width:100%;
      height:100%;
  ...
  </calcite-shell>`, H = () => e`<calcite-shell>
    <div
      style="
      width:100%;
      height:100%;
  ...
  </calcite-shell>`, $ = () => e` <calcite-shell content-behind>
    <div
      style="
      width:100%;
      height:100%;
...
const m = () => e` <calcite-shell content-behind>
    <div style="
              width:100%;
              height:100%;
              background-image: linear-gradient(45deg, #ccc 25%, transparent 25%),
...
export {
  ...
  v as closedPanelsFloatContent,
  M as contentBehind,
  C as contentBehindPanelBottomFloat,
  P as contentBehindPanelBottomFloatContent,
  m as customPanelWithOverflowingContent,
  o as darkModeRTL_TestOnly,
  ge as default,
  x as endPanelFloatContent_TestOnly,
  y as endPanelFloat_TestOnly,
  j as floatAllArrangements,
  $ as floatAllArrangementsStart,
  d as overlayDisplayMode_TestOnly,
  O as panelEndWithPositionStart_TestOnly,
  E as panelTopFloatHorizontal_TestOnly,
  z as panelTopFloatVertical_TestOnly,
  U as panelWithPopoverZIndex,
  g as panelsWithHeightsDefined,
  u as panelsWithOverflowingContent,
  I as popoverZIndex,
  H as resizableShellPanelWithDropdown,
  r as resizableShellPanels,
  p as resizableShellPanelsRTL,
  N as resizeHandlePositioning,
  F as shellCenterRowWithActionBar_TestOnly,
  D as shellPanelWithTabs,
  s as shellPanelZIndex_TestOnly,
  f as simple,
  k as slottedModalAndAlert,
  A as slottedPanelBottom_TestOnly,
  T as slottedPanelTopAndBottom,
  B as slottedPanelTopAndBottomAndSides,
  S as slottedPanelTop_TestOnly,
  q as slottedSheetFloat,
  L as slottedSheetFloatContent,
  w as slottedSheetOverlay
};
