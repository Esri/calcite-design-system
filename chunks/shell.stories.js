...
import { b as l, m as ie } from "./utils.js";
import { h as e } from "./formatting.js";
import { A as ne } from "./resources14.js";
...
const {
  ...
  args: {
    collapsed: !1,
    displayMode: Q.defaultValue,
    leadingPanelPosition: n.values[0],
    trailingPanelPosition: n.values[1],
    resizable: !0,
    detached: !1,
    heightScale: J.values[0],
    shellCenterRowPosition: n.values[1]
  },
  argTypes: {
    displayMode: {
      options: Q.values,
    ...
    leadingPanelPosition: {
      options: n.values.filter((t) => t !== "top" && t !== "bottom"),
      control: {
        type: "select"
      }
    },
...
`, K = e`
  <calcite-action-bar class="calcite-mode-dark" slot="action-bar"> ${ce} </calcite-action-bar>
`, X = e`
  <calcite-action-bar slot="action-bar"> ${le} </calcite-action-bar>
`, ee = e`
  ${K}
...
`, R = '<footer slot="footer">My Shell Footer</footer>', m = e(`
  <div
    style="
    width:100%;
    height:100%;
...
`), h = (t) => e`
  <calcite-shell>
    ...
    <calcite-shell-panel
      ...
      ${l("resizable", t.resizable)}
    >
      ${G}
    </calcite-shell-panel>
    ${m}
    <calcite-shell-center-row
      ${l("detached", t.detached)}
...
const V = [];
["float", "float-content"].forEach((t, i) => {
  V[i] = e(`<calcite-shell content-behind>
...
const f = () => V[0], b = () => V[1], _ = [];
["float", "float-content"].forEach((t, i) => {
  _[i] = e(`<calcite-shell content-behind>
    <header slot="header">
      <h2>My Shell Header</h2>
    </header>
    <div
...
const w = () => Z[0], q = () => Z[1], L = () => e(`<calcite-shell content-behind>
  ${$}
  <calcite-shell-panel slot="panel-start">${ee}</calcite-shell-panel>
  ${m}
  <calcite-shell-center-row slot="center-row">${a}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${te}</calcite-shell-panel>
  ${R}
</calcite-shell>`), M = () => e(`<calcite-shell
    style="
    width:100%;
    height:500px;
    max-height:80%;
  ...
  >
    ...
    <div class="global-nav" slot="header">Header Example</div>
    <calcite-shell-center-row slot="panel-top">${a}</calcite-shell-center-row>
    <footer slot="footer">Footer Example</footer>
  </calcite-shell>
`), Y = [];
["float", "float-content"].forEach((t, i) => {
  Y[i] = e(`
    ...
    >
        ...
        background-size: 20px 20px;
        background-position: 0 0, 0 10px, 10px -10px, -10px 0px;"></div>
        <calcite-shell-panel slot="panel-bottom" display-mode="${t}" layout="horizontal">${oe}</calcite-shell-panel>
      </calcite-shell>
    `);
});
const S = () => Y[0], C = () => Y[1], P = () => e(`
  <calcite-shell
    style="
    width:100%;
    height:500px;
  ...
  >
      ...
      background-position: 0 0, 0 10px, 10px -10px, -10px 0px;"></div>
      <div class="global-nav" slot="header">Header Example</div>
      <calcite-shell-center-row slot="panel-bottom">${a}</calcite-shell-center-row>
      <footer slot="footer">Footer Example</footer>
    </calcite-shell>
  `), A = () => e(`
  <calcite-shell
...
`), B = () => e(`<calcite-shell content-behind>
  ${$}
  <calcite-shell-panel slot="panel-start">${ee}</calcite-shell-panel>
  ${m}
  <calcite-shell-center-row slot="center-row">${se}</calcite-shell-center-row>
  <calcite-shell-panel slot="panel-end">${te}</calcite-shell-panel>
  ${R}
...
const F = () => e`<calcite-shell>
  ...
  </calcite-shell>`, O = () => e`<calcite-shell>
    <calcite-shell-panel
      layout="horizontal"
      slot="panel-top"
      position="start"
  ...
  </calcite-shell>`, N = () => e`<calcite-shell>
    ...
    ></calcite-popover>`, U = () => e`<calcite-shell>
    <calcite-shell-panel slot="panel-start" position="start" id="shell-panel-start">
      <calcite-action-bar slot="action-bar">
  ...
  </calcite-shell>`, I = () => e` <calcite-shell content-behind>
    <div
      style="
      width:100%;
      height:100%;
  ...
  </calcite-shell>`, H = () => e` <calcite-shell content-behind>
    <div
      style="
      width:100%;
      height:100%;
  ...
  </calcite-shell>`, u = () => e` <calcite-shell content-behind>
    <div
      style="
            width:100%;
            height:100%;
...
const g = () => e` <calcite-shell content-behind>
    <div style="
              width:100%;
              height:100%;
              background-image: linear-gradient(45deg, #ccc 25%, transparent 25%),
...
const me = ["simple", "darkModeRTL_TestOnly", "closedPanelsFloat", "closedPanelsFloatContent", "endPanelFloat_TestOnly", "endPanelFloatContent_TestOnly", "slottedModalAndAlert", "slottedSheetOverlay", "slottedSheetFloat", "slottedSheetFloatContent", "contentBehind", "slottedPanelTop_TestOnly", "contentBehindPanelBottomFloat", "contentBehindPanelBottomFloatContent", "slottedPanelBottom_TestOnly", "slottedPanelTopAndBottom", "slottedPanelTopAndBottomAndSides", "shellCenterRowWithActionBar_TestOnly", "shellPanelZIndex_TestOnly", "resizableShellPanels", "resizableShellPanelsRTL", "overlayDisplayMode_TestOnly", "panelEndWithPositionStart_TestOnly", "panelTopFloatHorizontal_TestOnly", "panelTopFloatVertical_TestOnly", "resizeHandlePositioning", "shellPanelWithTabs", "panelWithPopoverZIndex", "popoverZIndex", "floatAllArrangements", "resizableShellPanelWithDropdown", "floatAllArrangementsStart", "panelsWithOverflowingContent", "customPanelWithOverflowingContent"];
export {
  me as __namedExportsOrder,
  f as closedPanelsFloat,
  b as closedPanelsFloatContent,
  L as contentBehind,
  S as contentBehindPanelBottomFloat,
  C as contentBehindPanelBottomFloatContent,
  g as customPanelWithOverflowingContent,
  o as darkModeRTL_TestOnly,
  ge as default,
  y as endPanelFloatContent_TestOnly,
  v as endPanelFloat_TestOnly,
  I as floatAllArrangements,
  H as floatAllArrangementsStart,
  d as overlayDisplayMode_TestOnly,
  F as panelEndWithPositionStart_TestOnly,
  O as panelTopFloatHorizontal_TestOnly,
  E as panelTopFloatVertical_TestOnly,
  D as panelWithPopoverZIndex,
  u as panelsWithOverflowingContent,
  U as popoverZIndex,
  j as resizableShellPanelWithDropdown,
  r as resizableShellPanels,
  p as resizableShellPanelsRTL,
  z as resizeHandlePositioning,
  B as shellCenterRowWithActionBar_TestOnly,
  N as shellPanelWithTabs,
  s as shellPanelZIndex_TestOnly,
  h as simple,
  x as slottedModalAndAlert,
  P as slottedPanelBottom_TestOnly,
  A as slottedPanelTopAndBottom,
  T as slottedPanelTopAndBottomAndSides,
  M as slottedPanelTop_TestOnly,
  w as slottedSheetFloat,
  q as slottedSheetFloatContent,
  k as slottedSheetOverlay
};
