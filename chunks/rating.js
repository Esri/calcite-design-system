...
import { u as F, I as q } from "./interactive.js";
import { c as S, d as M, g as R } from "./label.js";
...
class H extends y {
  ...
  static {
    this.properties = { hoverValue: 16, average: 11, count: 11, disabled: 7, form: 3, labelText: 1, messageOverrides: 0, name: 3, readOnly: 7, required: 7, scale: 3, showChip: 7, status: 3, validationIcon: [3, { converter: x }], validationMessage: 1, validity: 0, value: 11 };
  }
  static {
    this.styles = K;
  }
  ...
  connectedCallback() {
    super.connectedCallback(), S(this), L(this);
  }
  async load() {
