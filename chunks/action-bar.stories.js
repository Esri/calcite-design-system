import { b as f, m as L } from "./utils.js";
...
const {
  ...
  <calcite-action-bar
    ${f("expand-disabled", c.expandDisabled)}
    ${f("expanded", c.expanded)}
    ${f("floating", c.floating)}
    position="${c.position}"
  >
...
`, g = () => `<calcite-action-bar expanded lang="he">
...
</calcite-action-bar>`, m = () => `<calcite-action-bar expanded lang="nb">
<calcite-action text-enabled text="Information" icon="information"></calcite-action>
<calcite-action text-enabled text="Feedback" slot="actions-end" icon="mega-phone"></calcite-action>
...
export {
  ...
  x as gridLayout,
  g as hebrewLocale_TestOnly,
  y as hongKongLocale_TestOnly,
  r as horizontal,
  d as horizontalOverflow_TestOnly,
  s as horizontalSmall,
  m as norwegianLocale_TestOnly,
  i as simple,
  h as ukrainianLocale_TestOnly,
  p as withDefinedWidths
};
