...
import { b as s, o as l, m as b } from "./utils3.js";
...
const {
  ...
  <calcite-text-area
    ...
    ${l("max-length", e.maxLength)}
    ${l("min-length", e.minLength)}
...
const c = () => a` <calcite-text-area disabled> </calcite-text-area> `, n = () => a` <calcite-text-area readonly> </calcite-text-area> `, d = () => a` <calcite-text-area resize="none"> </calcite-text-area> `, m = () => a`
...
`, x = () => a`<div style="width:500px;height:500px"><calcite-text-area></calcite-text-area></div>`, S = a`
  <style>
    .wrapper {
      display: flex;
      width: 800px;
...
const N = ["simple", "darkModeRTL", "withSlottedElements", "withSlottedElementsDarkModeRTL", "disabled", "readonly", "resizeDisabled", "groupSeparator", "exceedingMaxLength", "chineseLang", "insideContainerWithHeightAndWidth", "validationMessageAllScales"];
export {
  ...
  i as withSlottedElements,
  r as withSlottedElementsDarkModeRTL
};
