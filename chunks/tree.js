...
import { a as y, L as S, c as b, y as E, b as T, d as A } from "./index.js";
import { f as C, n as p, d as M } from "./dom.js";
...
const k = y`:host{display:block}:host(:focus){outline:2px solid transparent;outline-offset:2px}:host([hidden]){display:none}[hidden]{display:none}`;
class O extends S {
  constructor() {
