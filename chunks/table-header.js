import { a as d, L as h, s as i, E as c, x as o, c as p } from "./iframe.js";
...
class v extends h {
  constructor() {
    super(...arguments), this.containerEl = u(), this.messages = w({ blocking: !0 }), this.focused = !1, this.screenReaderText = "", this.alignment = "start", this.interactionMode = "interactive", this.numberCell = !1, this.parentRowAlignment = "start", this.selectionCell = !1;
  }
  static {
