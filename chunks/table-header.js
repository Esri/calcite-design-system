...
class f extends h {
  constructor() {
    super(...arguments), this.containerEl = b(), this.messages = v({ blocking: !0 }), this.focusSetter = g()(this), this.focused = !1, this.screenReaderText = "", this.alignment = "start", this.interactionMode = "interactive", this.numberCell = !1, this.parentRowAlignment = "start", this.selectionCell = !1;
  }
  static {
  ...
  async setFocus(t) {
    return this.focusSetter(() => this.containerEl.value, t);
  }
  async load() {
