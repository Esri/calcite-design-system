...
class E extends g {
  ...
  async setFocus(e) {
    return this.focusSetter(() => this.anchorEl.value, e);
  }
  handleClickOut(e) {
  ...
  async keyDownHandler(e) {
    const { hasSubmenu: n, href: a, layout: m, open: l, submenuItems: d } = this, i = e.key, u = e.target === this.dropdownActionEl.value;
  ...
  renderSubmenuItems(e) {
    ...
    })} .label=${this.messages.submenu} layout=vertical role=menu><slot name=${L.submenuItem} @slotchange=${this.handleMenuItemSlotChange}></slot></calcite-menu>`;
  }
  renderHrefIcon(e) {
