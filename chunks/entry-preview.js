import { O as _, B as a } from "./iframe.js";
import { d as O } from "./index.js";
/*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
v3.3.0-next.15 */
const { simulatePageLoad: s, simulateDOMContentLoaded: u } = __STORYBOOK_MODULE_PREVIEW_API__, { global: l } = __STORYBOOK_MODULE_GLOBAL__;
...
function M({ storyFn: n, kind: t, name: o, showMain: i, showError: d, forceRemount: p }, e) {
  ...
  if (i(), _(r)) {
    ...
    e.innerHTML = "", e.appendChild(r), u();
  } else d({ title: `Expecting an HTML snippet or DOM node from the story: "${o}" of "${t}".`, description: O`
