import { y as _, B as a } from "./iframe.js";
...
var y = Object.defineProperty, h = (n, t) => {
  for (var o in t) y(n, o, { get: t[o], enumerable: !0 });
}, L = {};
h(L, { parameters: () => g, render: () => T, renderToCanvas: () => M });
var { Node: m } = l, T = (n, t) => {
