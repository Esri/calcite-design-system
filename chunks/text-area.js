import { d as u, L as x, u as v, j as h, k as b, q as r, s, x as c, h as y } from "./iframe.js";
...
class V extends x {
  constructor() {
    ...
    }, q, { leading: !1 }), this.disabled = !1, this.groupSeparator = !1, this.limitText = !1, this.messages = F({ blocking: !0 }), this.readOnly = !1, this.required = !1, this.resize = "both", this.scale = "m", this.status = "idle", this.validity = {
      valid: !1,
      badInput: !1,
      customError: !1,
      patternMismatch: !1,
