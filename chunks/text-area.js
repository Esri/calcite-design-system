...
import { a as y, L as z, c as m, F as k, s as r, b as o, n as l, C as w, d as S } from "./index.js";
import { l as C } from "./live.js";
import { t as L } from "./throttle.js";
import { e as u, n as d } from "./ref.js";
import { b as $ } from "./index2.js";
import { g as E } from "./label.js";
import { u as A } from "./useLabel.js";
import { s as x } from "./dom.js";
import { n as h } from "./locale.js";
import { c as O, u as T } from "./observers.js";
import { g as H } from "./guid.js";
import { I } from "./InternalLabel.js";
import { V as R } from "./Validation.js";
import { u as M } from "./useT9n.js";
import { u as W } from "./useCancelable.js";
import { u as F } from "./useSetFocus.js";
import { u as j } from "./useInteractive.js";
import { u as q } from "./useForm.js";
import { s as D } from "./screen-reader.js";
const a = {
...
class B extends z {
  constructor() {
    ...
    }), this.cancelable = W()(this), this.updateSizeToAuto = L((e) => {
      this.el.style[e] = "auto";
    }, N, { edges: ["trailing"] }), this.messages = M({ blocking: !0 }), this.focusSetter = F()(this), this.interactiveContainer = j(this), this.endSlotHasElements = !1, this.startSlotHasElements = !1, this.disabled = !1, this.groupSeparator = !1, this.limitText = !1, this.loading = !1, this.readOnly = !1, this.required = !1, this.resize = "both", this.scale = "m", this.status = "idle", this.value = "", this.wrap = "soft", this.calciteTextAreaChange = m(), this.calciteTextAreaInput = m(), A(this);
  }
  static {
    this.properties = { endSlotHasElements: 16, startSlotHasElements: 16, columns: 11, disabled: 7, form: 3, groupSeparator: 7, label: 1, labelText: 1, limitText: 7, loading: 7, maxLength: 11, messageOverrides: 0, minLength: 11, name: 3, numberingSystem: 1, placeholder: 1, readOnly: 7, required: 7, resize: 3, rows: 11, scale: 3, status: 3, validationIcon: [3, { converter: k }], validationMessage: 1, validity: 32, value: 1, wrap: 3 };
  }
  static {
  ...
  setTextAreaEl(e) {
    T(this.resizeObserver, this.textAreaEl, e), this.textAreaEl = e;
  }
  setTextAreaHeight() {
  ...
  render() {
    ...
    return this.interactiveContainer({ disabled: this.disabled, children: o`<div class=${r(a.wrapper)}>${this.labelText && I({ labelText: this.labelText, onClick: this.onLabelClick, required: this.required, tooltipText: this.messages.required }) || ""}<div class=${r(a.loaderContainer)} ${d(this.loaderContainerRef)}>${this.loading ? t : null}<textarea aria-describedby=${this.guid ?? l} aria-errormessage=${f.validationMessage} .ariaInvalid=${this.status === "invalid" || this.isCharacterLimitExceeded()} .ariaLabel=${E(this)} .autofocus=${this.el.autofocus} class=${r({
      [a.textArea]: !0,
    ...
    })}><slot name=${v.footerStart} @slotchange=${(i) => this.startSlotHasElements = x(i)}></slot><slot name=${v.footerEnd} @slotchange=${(i) => this.endSlotHasElements = x(i)}></slot></div>${this.renderCharacterLimit()}</footer>${this.isCharacterLimitExceeded() && o`<span aria-live=polite class=${r(w.screenReaderText)} id=${this.guid ?? l}>${this.replacePlaceholdersInMessages()}</span>` || ""}</div>${this.validationMessage && this.status === "invalid" ? R({ icon: this.validationIcon, id: f.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}</div>` });
  }
