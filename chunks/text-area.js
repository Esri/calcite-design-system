...
import { a as z, L as y, c as m, F as w, s as r, b as o, n as l, d as k } from "./index.js";
...
class N extends y {
  constructor() {
    super(), this.attributeWatch = C(["autofocus", "spellcheck"], this.handleGlobalAttributesChanged), this.footerRef = u(), this.loaderContainerRef = u(), this.formSupport = j({
      inputType: "text"
    ...
    }, q, { edges: ["trailing"] }), this.messages = R({ blocking: !0 }), this.focusSetter = W()(this), this.interactiveContainer = F(this), this.endSlotHasElements = !1, this.startSlotHasElements = !1, this.disabled = !1, this.groupSeparator = !1, this.limitText = !1, this.loading = !1, this.readOnly = !1, this.required = !1, this.resize = "both", this.scale = "m", this.status = "idle", this.value = "", this.wrap = "soft", this.calciteTextAreaChange = m(), this.calciteTextAreaInput = m(), E(this);
  }
  static {
