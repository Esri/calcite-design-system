...
class de extends U {
  ...
  static {
    this.properties = { disabled: 7, focusTrapDisabled: 7, form: 3, hourFormat: 3, label: 1, labelText: 1, max: 3, messageOverrides: 0, min: 3, name: 1, numberingSystem: 3, open: 7, overlayPositioning: 1, placement: 3, readOnly: 7, required: 7, scale: 3, status: 3, step: 11, validationIcon: [3, { converter: N }], validationMessage: 1, validity: 0, value: 1 };
  }
  static {
