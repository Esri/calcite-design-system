...
var b = Object.freeze, nt = Object.defineProperty, rt = (e, a) => b(nt(e, "raw", { value: b(e.slice()) })), m;
const st = {
...
}, dt = t` <calcite-date-picker value="2020-11-27"></calcite-date-picker> `, ut = t(m || (m = rt([`
...
`;
var g = Object.freeze, ht = Object.defineProperty, vt = (e, a) => g(ht(e, "raw", { value: g(e.slice()) })), C;
const kt = {
  calciteGraphHighlightFillColor: ""
}, xt = t(C || (C = vt([`<div style="width:300px; height:100px">
...
}, Mt = t`<calcite-loader class="chromatic-ignore"></calcite-loader>`, _t = {
...
}, Xt = t`<calcite-rating></calcite-rating>`, Jt = {
...
`, he = {
  ...
  </calcite-menu>`, xe = t` ${v("horizontal")} ${v("vertical")} `, fe = {
...
const w = (e, a = !1) => t`<div style="${Ae(e, a)}">
    <style>
      .demo {
        display: flex;
    ...
    <div class="demo">
      ...
      <div class="demo-column">
        ${ce} ${ae} ${Dt} ${Rt} ${Et} ${Mt} ${K} ${de} ${se}
        ${ue} ${Vt} ${wt} ${xt} ${ie} ${Ut} ${Te} ${ne} ${lt}
      </div>
      <div class="demo-column">
        ${ve} ${be} ${ge} ${Z} ${j} ${Xt} ${we}
      </div>
...
const Ie = ["themingInteractive", "theming"], Le = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
