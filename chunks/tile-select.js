import { a as b, L as m, d as f, s as a, x as l, c as k } from "./iframe.js";
...
class z extends m {
  ...
  render() {
    const { checked: t, description: e, disabled: c, focused: u, heading: n, icon: o, inputAlignment: s, inputEnabled: p, width: r, iconFlipRtl: g } = this, d = n && o && !e, h = !!o;
    return y({ disabled: c, children: l`<div class=${a({
      ...
      [i.widthAuto]: r === "auto",
      [i.widthFull]: r === "full"
    })}><div class=${a({ [i.tile]: !0, [i.tileLargeVisual]: d })}>${o && l`<div class=${a({ [i.icon]: h })}><calcite-icon .flipRtl=${g} .icon=${o} scale=l></calcite-icon></div>` || ""}<div class=${a(i.tileContentContainer)}><div class=${a(i.tileContent)}>${n && l`<div class=${a(i.tileHeading)}>${n}</div>` || ""}${e && l`<div class=${a(i.tileDescription)}>${e}</div>` || ""}</div></div></div><slot></slot></div>` });
  }
}
