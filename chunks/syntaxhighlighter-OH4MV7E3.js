...
import { b as mt, A as ht, f as yt, s as Ee, S as bt, _ as xt, r as vt } from "./blocks.js";
import { f as we, R as G, k as Z, m as F } from "./index.js";
function xe(e) {
...
var At = F({
        ...
        var h = function(x) {
          ...
          for (var b = [], y = 0; y < x.length; y++) {
            ...
            if (typeof S != "string" && (S.type === "tag" && S.content[0] && S.content[0].type === "tag" ? S.content[0].content[0].content === "</" ? b.length > 0 && b[b.length - 1].tagName === h(S.content[0].content[1]) && b.pop() : S.content[S.content.length - 1].content === "/>" || b.push({
              ...
              var _ = h(S);
              y < x.length - 1 && (typeof x[y + 1] == "string" || x[y + 1].type === "plain-text") && (_ += h(x[y + 1]), x.splice(y + 1, 1)), y > 0 && (typeof x[y - 1] == "string" || x[y - 1].type === "plain-text") && (_ = h(x[y - 1]) + _, x.splice(y - 1, 1), y--), x[y] = new n.Token(
                "plain-text",
                _,
                null,
                _
  ...
  "../../node_modules/refractor/lang/markdown.js"(e, r) {
    ...
    function t(a) {
      (function(n) {
        ...
        function b(y) {
          var S = y.replace(h, "");
          return S = S.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function(E, _) {
  ...
  "../../node_modules/hastscript/node_modules/property-information/lib/aria.js"(e, r) {
    var t = Re(), a = ve(), n = t.booleanish, o = t.number, u = t.spaceSeparated;
    r.exports = a({
      transform: d,
      properties: {
  ...
  "../../node_modules/hastscript/node_modules/property-information/lib/html.js"(e, r) {
    var t = Re(), a = ve(), n = ot(), o = t.boolean, u = t.overloadedBoolean, d = t.booleanish, l = t.number, f = t.spaceSeparated, h = t.commaSeparated;
    r.exports = a({
      space: "html",
      attributes: {
  ...
  "../../node_modules/hastscript/node_modules/property-information/html.js"(e, r) {
    var t = Lt(), a = It(), n = $t(), o = Dt(), u = Rt(), d = qt();
    r.exports = t([n, a, o, u, d]);
  }
}), Mt = F({
  "../../node_modules/hastscript/node_modules/property-information/find.js"(e, r) {
    var t = De(), a = rt(), n = at(), o = "data";
    r.exports = f;
    var u = /^data[-\w.:]+$/i, d = /-[a-z]/g, l = /[A-Z]/g;
    function f(y, S) {
      var E = t(S), _ = S, A = n;
      return E in y.normal ? y.property[y.normal[E]] : (E.length > 4 && E.slice(0, 4) === o && u.test(S) && (S.charAt(4) === "-" ? _ = h(S) : S = C(S), A = a), new A(_, S));
    }
    function h(y) {
  ...
  "../../node_modules/hastscript/factory.js"(e, r) {
    var t = Mt(), a = De(), n = zt(), o = Ht().parse, u = Ut().parse;
    r.exports = l;
    ...
    function l(E, _, A) {
      ...
      return s;
      function s(g, m) {
        var c = n(g, _), w = Array.prototype.slice.call(arguments, 2), v = c.tagName.toLowerCase(), k;
        if (c.tagName = i && d.call(i, v) ? i[v] : v, m && f(m, c) && (w.unshift(m), m = null), m)
          for (k in m)
            p(c.properties, k, m[k]);
        return C(c.children, w), c.tagName === "template" && (c.content = { type: "root", children: c.children }, c.children = []), c;
      }
      function p(g, m, c) {
        var w, v, k;
        c == null || c !== c || (w = t(E, m), v = w.property, k = c, typeof k == "string" && (w.spaceSeparated ? k = o(k) : w.commaSeparated ? k = u(k) : w.commaOrSpaceSeparated && (k = o(u(k).join(" ")))), v === "style" && typeof c != "string" && (k = y(k)), v === "className" && g.className && (k = g.className.concat(k)), g[v] = x(w, v, k));
      }
    }
    function f(E, _) {
    ...
    function h(E, _) {
      var A = _.type;
      return E === "input" || !A || typeof A != "string" ? !1 : typeof _.children == "object" && "length" in _.children ? !0 : (A = A.toLowerCase(), E === "button" ? A !== "menu" && A !== "submit" && A !== "reset" && A !== "button" : "value" in _);
    }
    function C(E, _) {
      var A, i;
    ...
    function b(E, _, A) {
      var i = A;
      return E.number || E.positiveNumber ? !isNaN(i) && i !== "" && (i = Number(i)) : (E.boolean || E.overloadedBoolean) && typeof i == "string" && (i === "" || a(A) === a(_)) && (i = !0), i;
    }
    function y(E) {
      var _ = [], A;
      for (A in E)
  ...
  "../../node_modules/refractor/node_modules/parse-entities/index.js"(e, r) {
    var t = Wt(), a = Kt(), n = lt(), o = Xt(), u = Vt(), d = Jt();
    r.exports = B;
    var l = {}.hasOwnProperty, f = String.fromCharCode, h = Function.prototype, C = {
      ...
      attribute: !1,
      nonTerminated: !0
    }, x = 9, b = 10, y = 12, S = 32, E = 38, _ = 59, A = 60, i = 61, s = 35, p = 88, g = 120, m = 65533, c = "named", w = "hexadecimal", v = "decimal", k = {};
    k[w] = 16, k[v] = 10;
    var N = {};
    N[c] = u, N[v] = n, N[w] = o;
    var O = 1, H = 2, z = 3, X = 4, J = 5, W = 6, L = 7, I = {};
    I[O] = "Named character references must be terminated by a semicolon", I[H] = "Numeric character references must be terminated by a semicolon", I[z] = "Named character references cannot be empty", I[X] = "Numeric character references cannot be empty", I[J] = "Named character references must be known", I[W] = "Numeric character references cannot be disallowed", I[L] = "Numeric character references cannot be outside the permissible Unicode range";
    function B(j, $) {
      var T = {}, K, U;
      $ || ($ = {});
      for (U in C)
    ...
    function Q(j, $) {
      var T = $.additional, K = $.nonTerminated, U = $.text, re = $.reference, pe = $.warning, de = $.textContext, ke = $.referenceContext, me = $.warningContext, Ce = $.position, gt = $.indent || [], Fe = j.length, te = 0, He = -1, oe = Ce.column || 1, Ue = Ce.line || 1, le = "", je = [], ge, Ne, ie, P, ne, R, D, Y, Se, Oe, se, he, ue, ee, Pe, ye, _e, V, q;
  ...
  "../../node_modules/refractor/node_modules/prismjs/components/prism-core.js"(e, r) {
    var t = typeof window < "u" ? window : typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope ? self : {}, a = (function(n) {
      var o = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, u = 0, d = {}, l = {
        ...
        languages: {
          ...
          insertBefore: function(i, s, p, g) {
            ...
            var k = g[i];
            return g[i] = c, l.languages.DFS(l.languages, function(N, O) {
              O === k && N != i && (this[N] = c);
            }), c;
          },
          ...
          DFS: function i(s, p, g, m) {
            ...
            for (var w in s)
              if (s.hasOwnProperty(w)) {
                p.call(s, w, s[w], g || w);
                var v = s[w], k = l.util.type(v);
                k === "Object" && !m[c(v)] ? (m[c(v)] = !0, i(v, p, null, m)) : k === "Array" && !m[c(v)] && (m[c(v)] = !0, i(v, p, w, m));
              }
          }
        },
        plugins: {},
        ...
        highlightElement: function(i, s, p) {
          ...
          function k(O) {
            v.highlightedCode = O, l.hooks.run("before-insert", v), v.element.innerHTML = v.highlightedCode, l.hooks.run("after-highlight", v), l.hooks.run("complete", v), p && p.call(v.element);
          }
        ...
        for (var w in p)
          if (!(!p.hasOwnProperty(w) || !p[w])) {
            ...
            for (var k = 0; k < v.length; ++k) {
              if (c && c.cause == w + "," + k)
                return;
              var N = v[k], O = N.inside, H = !!N.lookbehind, z = !!N.greedy, X = N.alias;
              if (z && !N.pattern.global) {
                var J = N.pattern.toString().match(/[imsuy]*$/)[0];
                N.pattern = RegExp(N.pattern.source, J + "g");
              }
              for (var W = N.pattern || N, L = g.next, I = m; L !== s.tail && !(c && I >= c.reach); I += L.value.length, L = L.next) {
                var B = L.value;
                ...
                if (!(B instanceof f)) {
                  ...
                  if (z) {
                    if (M = h(W, I, i, H), !M || M.index >= i.length)
                      break;
                    var T = M.index, ce = M.index + M[0].length, j = I;
                    for (j += L.value.length; T >= j; )
                      L = L.next, j += L.value.length;
                    if (j -= L.value.length, I = j, L.value instanceof f)
                      continue;
                    for (var $ = L; $ !== s.tail && (j < ce || typeof $.value == "string"); $ = $.next)
                      Q++, j += $.value.length;
                    Q--, B = i.slice(I, j), M.index -= I;
                  } else if (M = h(W, 0, B, H), !M)
                    continue;
                  var T = M.index, K = M[0], U = B.slice(0, T), re = B.slice(T + K.length), pe = I + B.length;
                  ...
                  if (L = b(s, de, ke), re && b(s, L, re), Q > 1) {
                    ...
                    C(i, s, p, L.prev, I, me), c && me.reach > c.reach && (c.reach = me.reach);
                  }
                }
              }
            }
      ...
      if (!l.manual) {
        ...
        A === "loading" || A === "interactive" && E && E.defer ? document.addEventListener("DOMContentLoaded", _) : window.requestAnimationFrame ? window.requestAnimationFrame(_) : window.setTimeout(_, 16);
      }
      return l;
    })(t);
  ...
  "../../node_modules/refractor/core.js"(e, r) {
    ...
    var n = Zt(), o = Qt(), u = en(), d = et(), l = Je(), f = tn(), h = nn();
    a();
    ...
    x.prototype = u;
    var b = new x();
    r.exports = b, b.highlight = E, b.register = y, b.alias = S, b.registered = _, b.listLanguages = A, y(d), y(l), y(f), y(h), b.util.encode = p, b.Token.stringify = i;
    function y(c) {
    ...
    function S(c, w) {
      var v = b.languages, k = c, N, O, H, z;
      w && (k = {}, k[c] = w);
      for (N in k)
        for (O = k[N], O = typeof O == "string" ? [O] : O, H = O.length, z = -1; ++z < H; )
          v[O[z]] = v[N];
    }
    function E(c, w) {
      var v = u.highlight, k;
      ...
      if (b.util.type(w) === "Object")
        k = w, w = null;
      else {
        if (typeof w != "string")
          throw new Error("Expected `string` for `name`, got `" + w + "`");
        if (C.call(b.languages, w))
          k = b.languages[w];
        else
    ...
    function A() {
      var c = b.languages, w = [], v;
      for (v in c)
        C.call(c, v) && typeof c[v] == "object" && w.push(v);
      return w;
    }
    function i(c, w, v) {
      var k;
      return typeof c == "string" ? { type: "text", value: c } : b.util.type(c) === "Array" ? s(c, w) : (k = {
        type: c.type,
    ...
    function m() {
      var c = "Prism" in t, w = c ? t.Prism : void 0;
      return v;
      function v() {
...
const { logger: on } = __STORYBOOK_MODULE_CLIENT_LOGGER__, { global: ln } = __STORYBOOK_MODULE_GLOBAL__;
function Ke(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
function qe(e) {
  ...
  if (f) {
    ...
    if (!o)
      ...
      }, []), y = d.className && d.className.includes("token") ? ["token"] : [], S = d.className && y.concat(d.className.filter(function(_) {
        return !b.includes(_);
      }));
      x = fe(fe({}, d), {}, {
    ...
    var E = C(r.children);
    return G.createElement(f, xt({
      key: u
    }, x), E);
  }
}
var dn = Z(At()), gn = dn.default, fn = Z(Je()), mn = fn.default, hn = Z(Et()), yn = hn.default, bn = Z(kt()), xn = bn.default, vn = Z(Ct()), Sn = vn.default, _n = Z(Qe()), wn = _n.default, An = Z(Ft()), En = An.default, kn = Z(et()), Cn = kn.default, Fn = Z(jt()), jn = Fn.default, Nn = Z(tt()), On = Nn.default, Ln = Z(Nt()), In = Ln.default;
function $e(e, r) {
...
function Dn(e, r) {
  if (e) {
    ...
    return t === "Object" && e.constructor && (t = e.constructor.name), t === "Map" || t === "Set" ? Array.from(e) : t === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? $e(e, r) : void 0;
  }
}
function Rn() {
...
}), Bn = ["language", "children", "style", "customStyle", "codeTagProps", "useInlineStyles", "showLineNumbers", "showInlineLineNumbers", "startingLineNumber", "lineNumberContainerStyle", "lineNumberStyle", "wrapLines", "wrapLongLines", "lineProps", "renderer", "PreTag", "CodeTag", "code", "astGenerator"];
function Ye(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var a = Object.getOwnPropertySymbols(e);
...
function Gn(e, r, t, a, n, o, u, d, l) {
  ...
  for (var _ = function() {
    var p = h[b], g = p.children[0].value, m = zn(g);
    if (m) {
      var c = g.split(`
`);
...
`)
        ...
        if (v === 0) {
          ...
          if (z) {
            ...
            var W = [X], L = E(W, k, p.properties.className);
            C.push(L);
          }
        } else {
          var I = [N], B = E(I, k, p.properties.className);
          C.push(B);
        }
      }), x = b;
    }
...
function Kn(e, r) {
  return function(t) {
    ...
    var Q = E ? G.createElement(Un, {
      ...
      backgroundColor: "#fff"
    }, ce = ct(I) ? "hljs" : "prismjs", j = y ? Object.assign({}, B, {
    ...
    var K = (a = (n = L.match(/\n/g)) === null || n === void 0 ? void 0 : n.length) !== null && a !== void 0 ? a : 0, U = s + K, re = Gn(T, c, N, E, A, s, U, m, v);
    return G.createElement(z, j, G.createElement(J, x, !A && Q, O({
      rows: re,
      stylesheet: l,
      useInlineStyles: y
    })));
...
var Vn = (0, rn.default)(2)(
...
), ea = ({ children: e, className: r }) => G.createElement(bt, { horizontal: !0, vertical: !0, focusable: !0, className: r }, e), ta = Ee(ea)(
  {
    flex: 1,
    flexShrink: 0,
...
}, ra = ({ rows: e, stylesheet: r, useInlineStyles: t }) => e.map((a, n) => qe({
  node: pt(a),
  stylesheet: r,
  useInlineStyles: t,
  key: `code-segement${n}`
})), oa = (e, r) => r ? e ? ({ rows: t, ...a }) => e({ rows: t.map((n) => pt(n)), ...a }) : ra : e, dt = ({
  children: e,
  language: r = "jsx",
  copyable: t = !1,
  bordered: a = !1,
  ...
  let [x, b] = we.useState(!1), y = we.useCallback(
    (E) => {
      E.preventDefault(), Jn(h).then(() => {
  ...
  return G.createElement(
    ...
    G.createElement(ta, null, G.createElement(
      ze,
      {
        padded: n || a,
        language: r,
    ...
    t ? G.createElement(ht, { actionItems: [{ title: x ? "Copied" : "Copy", onClick: y }], flexLayout: !0 }) : null
  );
};
