...
class x extends h {
  constructor() {
    super(...arguments), this.closeButton = p(), this.transitionProp = "opacity", this.messages = b(), this.hasActionEnd = !1, this.closable = !1, this.iconFlipRtl = !1, this.kind = "brand", this.open = !1, this.scale = "m", this.width = "auto", this.calciteNoticeBeforeClose = i({ cancelable: !1 }), this.calciteNoticeBeforeOpen = i({ cancelable: !1 }), this.calciteNoticeClose = i({ cancelable: !1 }), this.calciteNoticeOpen = i({ cancelable: !1 });
  }
  static {
  ...
  willUpdate(t) {
    t.has("open") && (this.hasUpdated || this.open !== !1) && v(this), (t.has("icon") || t.has("kind") && (this.hasUpdated || this.kind !== "brand")) && (this.requestedIcon = s(r, this.icon, this.kind));
  }
  onBeforeClose() {
