import { j as a, L as c, x as n, z as i, s as e, q as r, k as m } from "./iframe.js";
...
class g extends c {
  ...
  render() {
    ...
    return n`<ul aria-labelledby=${this.guid ?? i} class=${e({ [t.list]: !0, [`scale--${l}`]: !0 })} role=group><li class=${e({ [t.label]: !0 })} id=${this.guid ?? i} role=presentation style=${r({ "--calcite-combobox-item-spacing-indent-multiplier": `${s}` })}><span class=${e(t.title)}>${this.label}</span></li><slot></slot></ul>`;
  }
}
