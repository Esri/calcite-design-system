...
`, n = () => e`<calcite-menu>
    ...
    <calcite-menu-item
      ...
      text-enabled
    ></calcite-menu-item>
  </calcite-menu>`, c = () => e`<calcite-menu layout="vertical">
    <calcite-menu-item
      icon-start="layer"
      breadcrumb
      icon-end="layer"
...
`, l = () => e`<calcite-panel>
  ...
  ></calcite-panel>`, u = () => e`<calcite-menu>
    ...
    </div>`, o = () => e`<calcite-menu dir="rtl" class="calcite-mode-dark">
    <calcite-menu-item text="Example item 1" text-enabled></calcite-menu-item>
    <calcite-menu-item text="Example item 2" text-enabled active></calcite-menu-item>
    <calcite-menu-item text="Example item 3" text-enabled></calcite-menu-item>
  </calcite-menu>`, r = () => e`<calcite-shell-panel width-scale="l">
  ...
  </calcite-shell-panel>`, d = () => e`<calcite-menu layout="vertical" dir="rtl" class="calcite-mode-dark">
    <calcite-menu-item text="Example item 1" text-enabled></calcite-menu-item>
    <calcite-menu-item text="Example item 2" text-enabled active></calcite-menu-item>
    <calcite-menu-item text="Example item 3" text-enabled></calcite-menu-item>
  </calcite-menu>`;
...
const E = ["simple", "iconsAndBreadcrumb", "iconsAndBreadcrumbVertical", "allScales", "activeVerticalOpenAllScales", "withNesting", "WithSubmenuOpen", "WithSubmenuOpenInVerticalLayoutAllScales", "darkModeRTL", "verticalComplexUseCase", "verticalLayoutInDarkModeRTL"];
export {
  u as WithSubmenuOpen,
  s as WithSubmenuOpenInVerticalLayoutAllScales,
  E as __namedExportsOrder,
  a as activeVerticalOpenAllScales,
  m as allScales,
  o as darkModeRTL,
  f as default,
  n as iconsAndBreadcrumb,
  c as iconsAndBreadcrumbVertical,
  i as simple,
  r as verticalComplexUseCase,
  d as verticalLayoutInDarkModeRTL,
  l as withNesting
};
