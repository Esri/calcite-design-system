import { a as u, L as f, d as h, s as t, x as a, C as b, c as $ } from "./iframe.js";
import { i as m } from "./keyed.js";
import { n as k } from "./ref.js";
import { c as p, s as v, g as S } from "./dom.js";
...
class w extends f {
  ...
  updateActiveItemOnChange(e) {
    const [i] = e.composedPath(), o = p(this.el, "calcite-accordion");
  ...
  accordionItemSyncHandler(e) {
    ...
    if (o.parentElement === i)
      return;
    const n = p(o, "calcite-accordion");
    i === n && (this.appearance = n.appearance, this.iconPosition = n.iconPosition, this.iconType = n.iconType, this.scale = n.scale, e.stopPropagation());
  }
  handleActionsStartSlotChange(e) {
    this.hasActionsStart = v(e);
  }
  handleActionsEndSlotChange(e) {
    this.hasActionsEnd = v(e);
  }
  storeHeaderEl(e) {
    this.headerEl = e;
  }
  ...
  renderActionsStart() {
    return a`<div class=${t(c.actionsStart)} .hidden=${!this.hasActionsStart}><slot name=${g.actionsStart} @slotchange=${this.handleActionsStartSlotChange}></slot></div>`;
  }
  renderActionsEnd() {
    return a`<div class=${t(c.actionsEnd)} .hidden=${!this.hasActionsEnd}><slot name=${g.actionsEnd} @slotchange=${this.handleActionsEndSlotChange}></slot></div>`;
  }
  render() {
    const { iconFlipRtl: e, heading: i, headingLevel: o } = this, d = S(this.el), n = this.iconStart ? m("icon-start", a`<calcite-icon class=${t({ [c.icon]: !0, [c.iconStart]: !0 })} .flipRtl=${e === "both" || e === "start"} .icon=${this.iconStart} .scale=${l(this.scale)}></calcite-icon>`) : null, x = this.iconEnd ? m("icon-end", a`<calcite-icon class=${t({ [c.iconEnd]: !0, [c.icon]: !0 })} .flipRtl=${e === "both" || e === "end"} .icon=${this.iconEnd} .scale=${l(this.scale)}></calcite-icon>`) : null, { description: s } = this;
