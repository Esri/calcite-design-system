...
class v extends s {
  ...
  render() {
    const { appearance: e, checked: l, layout: a, scale: n, value: c } = this;
    return this.el.ariaChecked = m(l), this.el.ariaLabel = c, this.el.role = "radio", o`<label class=${i({
      [t.label]: !0,
      [t.labelScale(n)]: !0,
      [t.labelHorizontal]: a === "horizontal",
      [t.labelOutline]: e === "outline",
      [t.labelOutlineFill]: e === "outline-fill"
    })}>${this.renderContent()}</label>`;
  }
  renderContent() {
    const { hasSlottedContent: e, iconEnd: l, iconStart: a } = this, n = a || l;
    return !e && n ? [this.renderIcon(n, !0), o`<slot @slotchange=${this.handleSlotChange}></slot>`] : [
      this.renderIcon(a),
