...
g.get.rgb = function(t) {
  ...
  if (l = t.match(e)) {
    for (h = l[2], l = l[1], i = 0; i < 3; i++) {
      const m = i * 2;
      a[i] = Number.parseInt(l.slice(m, m + 2), 16);
    }
...
c.rgb.hsv = function(t) {
  let n, e, r, o, s;
  const a = t[0] / 255, l = t[1] / 255, i = t[2] / 255, h = Math.max(a, l, i), m = h - Math.min(a, l, i), y = function(W) {
    return (h - W) / 6 / m + 1 / 2;
  };
  if (m === 0)
    o = 0, s = 0;
  else {
    switch (s = m / h, n = y(a), e = y(l), r = y(i), h) {
      case a: {
        o = r - e;
        break;
      }
...
for (const t of Object.keys(_))
  H[[..._[t].labels].sort().join("")] = t;
const N = {};
function p(t, n) {
  if (!(this instanceof p))
    return new p(t, n);
  if (n && n in $ && (n = null), n && !(n in _))
  ...
  if (t == null)
    ...
    this.model = n || "rgb", r = _[this.model].channels;
    ...
    this.model = H[s];
    const { labels: a } = _[this.model], l = [];
    for (e = 0; e < a.length; e++)
      l.push(t[a[e]]);
    this.color = I(l);
  }
  if (N[this.model])
    for (r = _[this.model].channels, e = 0; e < r; e++) {
...
p.prototype = {
  ...
  object() {
    const t = {}, { channels: n } = _[this.model], { labels: e } = _[this.model];
    for (let r = 0; r < n; r++)
      t[e[r]] = this.color[r];
  ...
  b: u("lab", 2),
  keyword(t) {
    return t !== void 0 ? new p(t) : _[this.model].keyword(this.color);
  },
  hex(t) {
    return t !== void 0 ? new p(t) : g.to.hex(...this.rgb().round().color);
  },
  hexa(t) {
    if (t !== void 0)
      return new p(t);
    ...
    return e.length === 1 && (e = "0" + e), g.to.hex(...n) + e;
  },
  rgbNumber() {
    const t = this.rgb().color;
...
for (const t of Object.keys(_)) {
  if ($.includes(t))
    continue;
  const { channels: n } = _[t];
  p.prototype[t] = function(...e) {
    return this.model === t ? new p(this) : e.length > 0 ? new p(e, t) : new p([...rt(_[this.model][t].raw(this.color)), this.valpha], t);
  }, p[t] = function(...e) {
    let r = e[0];
...
const dt = {
...
}, bt = p("#007AC2"), gt = "calcite-color-", pt = {
  r: 255,
  g: 255,
  b: 255
}, ot = {
  ...
  minus: "minus",
  plus: "plus"
}, kt = /^[0-9A-F]$/i, at = /^#[0-9A-F]{3}$/i, lt = /^#[0-9A-F]{6}$/i, it = /^#[0-9A-F]{4}$/i, ct = /^#[0-9A-F]{8}$/i, vt = (t) => Number((t * 100).toFixed()), St = (t) => Number((t / 100).toFixed(2));
function q(t, n = !1) {
  return O(t, n) || ht(t, n);
}
function B(t, n, e) {
...
function z(t, n = !1) {
  ...
  if (t.length === 3 || t.length === 4) {
    const [l, i, h, m] = t.split("");
    e = parseInt(`${l}${l}`, 16), r = parseInt(`${i}${i}`, 16), o = parseInt(`${h}${h}`, 16), s = parseInt(`${m}${m}`, 16) / 255;
  } else
