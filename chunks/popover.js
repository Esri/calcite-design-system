import { j as k, L as x, n, x as h, s, w as C, k as A } from "./iframe.js";
import { i as f } from "./keyed.js";
import { e as D, n as u } from "./ref.js";
import { e as m, r as F, b as $, f as L, c as O, h as T, F as g } from "./floating-ui.js";
import { F as H, f as z, t as R, q as B } from "./dom.js";
...
import { d as v, A as b, a as E, C as o } from "./resources13.js";
...
class J extends x {
  constructor() {
    ...
    })(this), this.guid = `calcite-popover-${U()}`, this.hasLoaded = !1, this.mutationObserver = N("mutation", () => this.updateFocusTrapElements()), this.transitionProp = "opacity", this.floatingLayout = "vertical", this.autoClose = !1, this.closable = !1, this.flipDisabled = !1, this.focusTrapDisabled = !1, this.messages = j(), this.offsetDistance = m, this.offsetSkidding = 0, this.open = !1, this.overlayPositioning = "absolute", this.placement = v, this.pointerDisabled = !1, this.scale = "m", this.triggerDisabled = !1, this.calcitePopoverBeforeClose = n({ cancelable: !1 }), this.calcitePopoverBeforeOpen = n({ cancelable: !1 }), this.calcitePopoverClose = n({ cancelable: !1 }), this.calcitePopoverOpen = n({ cancelable: !1 });
  }
  static {
  ...
  async setFocus() {
    await q(this), this.requestUpdate(), z(this.el);
  }
  ...
  onClose() {
    this.calcitePopoverClose.emit(), T(this), this.focusTrap.deactivate();
  }
  storeArrowEl(e) {
