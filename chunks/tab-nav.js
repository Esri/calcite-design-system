...
import { a as y, L as B, c as v, s as u, C as O, b as C, d as V } from "./index.js";
import { n as k } from "./ref.js";
import { i as E } from "./keyed.js";
import { u as L } from "./index2.js";
import { G as I, e as $, f as z } from "./dom.js";
...
class H extends B {
  ...
  scrollTabTitleIntoView(t, e = "smooth") {
    t && requestAnimationFrame(() => {
      ...
      if (!i)
        return;
      const s = i.getBoundingClientRect(), n = t.getBoundingClientRect(), l = i.scrollLeft, a = n.left - s.left;
      if (a < 0) {
        const o = l + a;
        i.scrollTo({ left: o, behavior: e });
      } else if (n.right > s.right) {
        const o = l + Math.min(n.right - s.right, a);
        i.scrollTo({ left: o, behavior: e });
      }
    });
  }
  ...
  onTabTitleWheel(t) {
    ...
    if (e.scrollWidth <= e.clientWidth)
      return;
    t.preventDefault();
    const { deltaX: i, deltaY: s } = t, n = Math.abs(i), l = Math.abs(s);
    let a;
    n === l ? a = this.lastScrollWheelAxis === "x" ? i : s : n > l ? (a = i, this.lastScrollWheelAxis = "x") : (a = s, this.lastScrollWheelAxis = "y");
    const o = (this.effectiveDir === "rtl" ? -1 : 1) * a;
    e.scrollBy(o, 0);
  }
  onSlotChange() {
  ...
  updateScrollingState() {
    ...
    if (!t)
      return;
    let e, i;
    const s = t.scrollLeft, n = t.clientWidth, l = t.scrollWidth;
    this.effectiveDir === "ltr" ? (e = s > d, i = l - (s + n) > d) : (e = s < -d, i = l - n + s > d), this.hasOverflowingStartTabTitle = e, this.hasOverflowingEndTabTitle = i;
  }
  scrollToTabTitles(t) {
    requestAnimationFrame(() => {
      ...
      if (!e)
        return;
      const i = e.getBoundingClientRect(), { effectiveDir: s } = this, n = t === "forward" && s === "ltr" || t === "backward" && s === "rtl";
      let l;
      const a = t === "forward" ? [...this.tabTitles].reverse() : this.tabTitles;
      if (!a.length)
        return;
      if (n) {
        let h;
      ...
      if (!l)
        return;
      const o = l.getBoundingClientRect(), b = e.scrollLeft, S = n ? b + (o.right - i.right) : b + (o.left - i.left);
      e.scrollTo({
        left: Math.round(S),
        behavior: "smooth"
      });
  ...
  handleTabTitleClose(t) {
    const { tabTitles: e } = this, i = e.filter((a) => !a.closed), s = this.enabledTabTitles, n = i.length, l = t.selected;
    if (this.hasVisibleTabTitles = n > 0, this.calciteInternalTabNavSlotChange.emit([...e]), n === 0) {
      this.selectedTitle = null, this.selectedTabId = void 0;
      return;
    }
    if (l) {
      const a = e.findIndex((b) => b === t), o = s.find((b) => e.indexOf(b) > a) || s.at(-1);
      if (!o) {
  ...
  renderScrollButton(t) {
    const { messages: e, scale: i, hasOverflowingEndTabTitle: s, hasOverflowingStartTabTitle: n } = this, l = t === "end";
    return E(t, C`<div class=${u({
      [c.scrollButton]: !0,
      [c.scrollBackwardButton]: !l,
      [c.scrollForwardButton]: l
    })}><calcite-button .ariaLabel=${l ? e.nextTabTitles : e.previousTabTitles} .disabled=${l ? !s : !n} icon-flip-rtl=both .iconStart=${l ? w.chevronRight : w.chevronLeft} kind=neutral @click=${l ? this.scrollToNextTabTitles : this.scrollToPreviousTabTitles} .scale=${i} tabindex=-1></calcite-button></div>`);
  }
}
V("calcite-tab-nav", H);
export {
