import { j as s, L as r, x as a, s as i, k as c } from "./iframe.js";
...
class x extends r {
  ...
  // #region Rendering
  render() {
    const { actionBar: e } = this, t = a`<div class=${i(n.content)}><slot></slot></div>`, o = [l("action-bar", a`<div class=${i(n.actionBarContainer)} .hidden=${!this.actionBar}><slot name=${p.actionBar} @slotchange=${this.handleActionBarSlotChange}></slot></div>`), t];
