...
import { a as l, L as o, y as s, s as n, b as r, d } from "./index.js";
...
class g extends o {
  ...
  internalTabChangeHandler(e) {
    e.composedPath().find(p) === this.parentTabsEl && (this.tab ? this.selected = this.tab === e.detail.tab : this.getTabIndex().then((c) => {
      this.selected = c === e.detail.tab;
    }), e.stopPropagation());
  }
  render() {
    const e = this.el.id || this.guid;
    return s(this.el, "aria-labelledby", this.labeledBy), s(this.el, "id", e), r`<div class=${n({ [a.container]: !0, [a.scale(this.scale)]: !0 })} role=tabpanel .tabIndex=${this.selected ? 0 : -1}><section class=${n(a.content)}><slot></slot></section></div>`;
  }
}
d("calcite-tab", g);
export {
