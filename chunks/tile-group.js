import { j as a, L as l, n as c, x as o, s as n, k as r } from "./iframe.js";
...
class f extends l {
  ...
  render() {
    ...
    return p({ disabled: this.disabled, children: o`<div .ariaLabel=${this.label} class=${n(u.container)} .role=${e}><slot @slotchange=${this.updateTiles} ${d(this.setSlotEl)}></slot></div>` });
  }
}
