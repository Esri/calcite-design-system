...
import { a as c, L as l, c as n, s as i, b as s, d as r } from "./index.js";
import { e as o, n as d } from "./ref.js";
import { i as h } from "./key.js";
import { g as b } from "./label.js";
import { u as m } from "./useLabel.js";
import { I as a } from "./InternalLabel.js";
...
class k extends l {
  ...
  keyDownHandler(e) {
    !this.disabled && h(e.key) && (this.toggle(), e.preventDefault());
  }
  onLabelClick() {
  ...
  render() {
    return this.interactiveContainer({ disabled: this.disabled, children: s`<div .ariaChecked=${this.checked} .ariaLabel=${b(this)} class=${i(t.container)} role=switch tabindex=0 ${d(this.switchRef)}>${this.labelTextStart && a({ alignmentCenter: !0, bottomSpacingDisabled: !0, labelText: this.labelTextStart, spacingInlineEnd: !0 }) || ""}<div class=${i(t.track)}><div class=${i(t.handle)}></div></div>${this.labelTextEnd && a({ alignmentCenter: !0, bottomSpacingDisabled: !0, labelText: this.labelTextEnd, spacingInlineStart: !0 }) || ""}</div>` });
  }
}
r("calcite-switch", k);
export {
