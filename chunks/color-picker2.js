...
/> `, j = e`<calcite-card selected selectable>
  <img alt="thumbnail" slot="thumbnail" style="width:260px" src="${o({ width: 260, height: 160 })}" />
...
></calcite-input>`, Y = {
  ...
  <calcite-input-number read-only step="any" value="100" number-button-type="horizontal"></calcite-input-number>`, ae = e`<calcite-input-number
    prefix-text="prefix"
    suffix-text="suffix"
    value="10"
    clearable
  ...
  prefix-text="prefix"
  suffix-text="suffix"
></calcite-input-text>`, se = e`<calcite-input-text clearable value="Clearable text"></calcite-input-text>`, de = e`<calcite-input-text loading value="Loading text"></calcite-input-text>`, pe = e`<calcite-input-text read-only value="Read only text"></calcite-input-text>`, be = {
