...
import { e as $, n as h } from "./ref.js";
...
import { g as w, a as ne } from "./utils2.js";
...
class ge extends T {
  constructor() {
    super(), this.commonDateSeparators = [".", "-", "/"], this.dialogId = I.dialog(P()), this.endInputRef = $(), this.focusOnOpen = !1, this.focusTrap = L({
      triggerProp: "open",
      focusTrapOptions: {
        onActivate: () => {
  ...
  valueWatcher(e) {
    if (!this.userChangedValue) {
      let t;
      Array.isArray(e) ? t = w(e) : e ? t = l(e) : t = void 0, !this.valueAsDateChangedExternally && t !== this.valueAsDate && (this.valueAsDate = t), this.localizeInputValues();
    }
  ...
  setRangeValue(e) {
    ...
    if (v === t)
      return;
    this.userChangedValue = !0, this.value = v, this.valueAsDate = v ? w(v) : void 0;
