...
import { i as E } from "./isEqual.js";
import { d as l, a as h, n as c, p as d, g as D, b as o, s as m, c as A, i as f } from "./date.js";
import { n as C, g as b } from "./locale.js";
import { u as z } from "./useT9n.js";
import { u as k } from "./useSetFocus.js";
import { g as u, a as $, b as M, c as P } from "./utils2.js";
const w = 2, U = { dateStyle: "full" }, F = {
  container: "container"
...
class L extends y {
  constructor() {
    super(), this.rangeValueChangedByUser = !1, this.messages = z({ blocking: !0 }), this.focusSetter = k()(this), this.calendars = 2, this.layout = "horizontal", this.monthStyle = "wide", this.proximitySelectionDisabled = !1, this.range = !1, this.scale = "m", this.calciteDatePickerChange = v({ cancelable: !1 }), this.calciteDatePickerRangeChange = v({ cancelable: !1 }), this.listen("keydown", this.keyDownHandler);
  }
  static {
  ...
  willUpdate(t) {
    const e = t.get("valueAsDate"), a = this.valueAsDate, i = this.rangeValueChangedByUser && !t.has("value") && this.range && E(e, a), s = t.has("value") && t.has("valueAsDate");
    this.rangeValueChangedByUser && !s && !i && (this.rangeValueChangedByUser = !1), t.has("value") && this.valueHandler(this.value), t.has("valueAsDate") && this.valueAsDateWatcher(this.valueAsDate), i && (this.rangeValueChangedByUser = !1);
    const n = u(t, "min"), r = u(t, "max");
    n === "min" ? this.minAsDate = this.min ? l(this.min) : void 0 : n === "minAsDate" && (this.minAsDate = l(h(this.minAsDate))), r === "max" ? this.maxAsDate = this.max ? l(this.max) : void 0 : r === "maxAsDate" && (this.maxAsDate = l(h(this.maxAsDate))), (t.has("range") && this.range || t.has("maxAsDate") || t.has("minAsDate")) && this.setActiveStartAndEndDates(), t.has("activeDate") && this.hasUpdated && this.activeDateWatcher(this.activeDate), t.has("messages") && this.hasUpdated && this.loadLocaleData().catch(x.error);
  }
  activeDateWatcher(t) {
    this.range && (t ? (this.activeStartDate = t, this.activeEndDate = c(this.activeStartDate)) : this.resetActiveDates());
  }
  valueHandler(t) {
    Array.isArray(t) ? (this.valueAsDate = t.every((e) => e === "") ? void 0 : $(t), this.rangeValueChangedByUser || this.resetActiveDates()) : t ? this.valueAsDate = l(t) : (this.valueAsDate = void 0, this.resetActiveDates());
  }
  ...
  async loadLocaleData() {
    const t = M(this.messages._lang);
    C.numberFormatOptions = {
      numberingSystem: this.numberingSystem,
      locale: t,
      useGrouping: !1
    }, this.localeData = await P(t), this.dateTimeFormat = b(t, U);
  }
  monthHeaderSelectChange(t) {
    const e = new Date(t.detail.date), a = t.detail.position;
    this.range ? a === "end" ? (this.activeEndDate = e, this.activeStartDate = d(e)) : (this.activeStartDate = e, this.activeEndDate = c(e)) : this.activeDate = e, t.stopPropagation();
  }
  monthActiveDateChange(t) {
    ...
    if (!this.range)
      ...
      const a = e.getMonth(), i = a !== this.activeStartDate?.getMonth() && (this.calendars === 1 || (this.activeStartDate ? a !== c(this.activeStartDate).getMonth() : !1));
      this.activeRange === "end" ? (!this.activeEndDate || this.activeStartDate && i) && (this.activeEndDate = e, this.activeStartDate = d(e)) : (this.activeStartDate && i || !this.activeStartDate) && (this.activeStartDate = e, this.activeEndDate = c(e));
    }
    t.stopPropagation();
  }
  monthHoverChange(t) {
    ...
    if (this.hoverRange = {
      ...
      const n = Math.abs(D(s, a)), r = Math.abs(D(s, i));
      s > i ? (this.hoverRange.end = s, this.hoverRange.focused = "end") : s < a ? (this.hoverRange.start = s, this.hoverRange.focused = "start") : s > a && s < i && (n < r ? (this.hoverRange.start = s, this.hoverRange.focused = "start") : (this.hoverRange.end = s, this.hoverRange.focused = "end"));
    } else
  ...
  setEndDate(t, e = !0) {
    ...
    this.rangeValueChangedByUser = !0, this.value = [h(a), h(t)], this.valueAsDate = [a, t], e && this.calciteDatePickerRangeChange.emit();
  }
  getStartDate() {
  ...
  setStartDate(t, e = !0) {
    ...
    this.rangeValueChangedByUser = !0, this.value = [h(t), h(a)], this.valueAsDate = [t, a], e && this.calciteDatePickerRangeChange.emit();
  }
  monthDateChange(t) {
    const e = new Date(t.detail), a = h(e);
    if (!this.range && a === h(this.valueAsDate))
      return;
    if (!this.range) {
    ...
    if (!i || !s && e < i)
      ...
      const n = D(e, i), r = D(e, s);
      r === 0 || n < 0 ? this.setStartDate(e) : n === 0 || r < 0 ? this.setEndDate(e) : n < r ? this.setStartDate(e) : this.setEndDate(e);
    }
    t.stopPropagation(), this.calciteDatePickerChange.emit();
  }
  getActiveDate(t, e, a) {
    const i = o(/* @__PURE__ */ new Date(), e, a);
    return o(this.activeDate, e, a) || t || (m(a, i) && !this.range ? A(i, e, a) : i);
  }
  getActiveEndDate(t, e, a) {
    return o(this.activeEndDate, e, a) || t || o(c(/* @__PURE__ */ new Date()), e, a);
  }
  setActiveStartAndEndDates() {
    if (this.range) {
      const t = o(Array.isArray(this.valueAsDate) ? this.valueAsDate[0] : this.valueAsDate, this.minAsDate, this.maxAsDate), e = o(Array.isArray(this.valueAsDate) ? this.valueAsDate[1] : void 0, this.minAsDate, this.maxAsDate);
