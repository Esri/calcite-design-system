import { h as f, L as y, k as v, i as p, x, j as S } from "./iframe.js";
...
import { g as A, a as z } from "./utils2.js";
...
class w extends y {
  ...
  // #region Lifecycle
  constructor() {
    super(), this.rangeValueChangedByUser = !1, this.layout = "horizontal", this.messages = k({ blocking: !0 }), this.monthStyle = "wide", this.proximitySelectionDisabled = !1, this.range = !1, this.scale = "m", this.calciteDatePickerChange = v({ cancelable: !1 }), this.calciteDatePickerRangeChange = v({ cancelable: !1 }), this.listen("keydown", this.keyDownHandler);
  }
  static {
  ...
  async loadLocaleData() {
    p() && (E.numberFormatOptions = {
      ...
      useGrouping: !1
    }, this.localeData = await z(this.messages._lang), this.dateTimeFormat = b(this.messages._lang, $));
  }
