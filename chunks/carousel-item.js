import { a as s, L as i, k as a, s as l, x as n, c } from "./iframe.js";
...
class d extends i {
  ...
  render() {
    ...
    return a(this.el, "id", t), n`<div .ariaLabel=${this.label} class=${l({ [e.container]: !0, [e.selected]: this.selected })} role=tabpanel><slot></slot></div>`;
  }
}
