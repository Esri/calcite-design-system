...
import { i as g, l as p, n as h, g as F, b as y } from "./locale.js";
...
function f(e, t, o = "en") {
  ...
  return e === "meridiem" && (t.find(({ type: n }) => n === "dayPeriod")?.value || null) ? z({ locale: o, parts: t }) ?? null : t.find(({ type: i }) => i === e)?.value || null;
}
function V(e) {
  if (!g(e))
    return null;
