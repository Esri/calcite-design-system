import { a as T, L as D, d as L, s as I, x as g, c as k } from "./iframe.js";
import { n as b } from "./ref.js";
import { i as B } from "./keyed.js";
import { b as C, n as r, h as c, r as p, s as x, u as d, v as A, o as $, m as H, O as V, w as P } from "./utils4.js";
...
}, z = T`:host{--calcite-internal-color-focus: var( --calcite-color-focus, var(--calcite-ui-focus-color, var(--calcite-color-brand)) )}:host{display:block}.container{display:flex;inline-size:100%;flex-wrap:nowrap;align-items:center}.hex-input{flex-grow:1;text-transform:uppercase}.opacity-input{inline-size:100px;margin-inline-start:-1px}:host([hidden]){display:none}[hidden]{display:none}`, m = C();
class U extends D {
  constructor() {
    super(...arguments), this.internalColor = m, this.alphaChannel = !1, this.allowEmpty = !1, this.hexLabel = "Hex", this.scale = "m", this.value = r(c(m, this.alphaChannel), this.alphaChannel, !0), this.calciteColorPickerHexInputChange = L({ cancelable: !1 });
  }
  static {
  ...
  onInputKeyDown(t) {
    ...
    if (u === "Tab" && d(h, this.alphaChannel) || u === "Enter") {
