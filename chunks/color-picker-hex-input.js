import { h as T, L as k, k as D, s as I, x as g, j as L } from "./iframe.js";
...
class U extends k {
  constructor() {
    super(...arguments), this.internalColor = f, this.alphaChannel = !1, this.allowEmpty = !1, this.hexLabel = "Hex", this.scale = "m", this.value = h(c(f, this.alphaChannel), this.alphaChannel, !0), this.calciteColorPickerHexInputChange = D({ cancelable: !1 });
  }
  static {
...
L("calcite-color-picker-hex-input", U);
export {
