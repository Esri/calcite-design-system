...
import { u as y, I as $ } from "./interactive.js";
import { u as g } from "./useSetFocus.js";
import { I as E, C as k } from "./resources10.js";
...
class S extends u {
  constructor() {
    super(...arguments), this.buttonEl = m(), this.focusSetter = g()(this), this.appearance = "solid", this.disabled = !1, this.icon = E.plus, this.iconFlipRtl = !1, this.kind = "brand", this.loading = !1, this.scale = "m", this.textEnabled = !1;
  }
  static {
  ...
  render() {
    const { appearance: t, kind: l, disabled: a, loading: o, scale: i, textEnabled: s, icon: c, label: e, text: n, iconFlipRtl: r } = this, d = s ? null : e || n || null;
    return $({ disabled: a, children: f`<calcite-button .appearance=${t === "solid" ? "solid" : "outline-fill"} class=${p(k.button)} .disabled=${a} .iconFlipRtl=${r ? "start" : null} .iconStart=${c} .kind=${l} .label=${e} .loading=${o} round .scale=${i} title=${d ?? h} type=button width=auto ${v(this.buttonEl)}>${this.textEnabled ? this.text : null}</calcite-button>` });
  }
}
x("calcite-fab", S);
export {
