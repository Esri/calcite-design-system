import { j as p, L as h, x as w, s as b, z as x, k as u } from "./iframe.js";
...
class C extends h {
  ...
  render() {
    ...
    return y({ disabled: t, children: w`<calcite-button .appearance=${s === "solid" ? "solid" : "outline-fill"} class=${b(k.button)} .disabled=${t} .iconFlipRtl=${r ? "start" : null} .iconStart=${d} .kind=${o} .label=${a} .loading=${e} round .scale=${i} title=${c ?? x} type=button width=auto ${m(this.buttonEl)}>${this.textEnabled ? this.text : null}</calcite-button>` });
  }
}
u("calcite-fab", C);
export {
