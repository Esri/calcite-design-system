import { a as I, L as E, d as $, s as n, C as d, x as a, k as M, E as A, c as z } from "./iframe.js";
...
class D extends E {
  ...
  render() {
    const e = H(this.el) === "rtl", t = this.selectionMode === "single" || this.selectionMode === "children" || this.selectionMode === "single-persist", o = this.selectionMode === "multiple" || this.selectionMode === "multichildren", s = this.selectionMode === "none" && !this.hasChildren, u = this.hasChildren && this.indeterminate, l = this.hasChildren || this.selectionMode === "ancestors" ? a`<calcite-icon class=${n({
      [i.chevron]: !0,
      [d.rtl]: e
    })} data-test-id=icon .icon=${this.hasChildren ? c.chevronRight : c.blank} @click=${this.iconClickHandler} .scale=${h(this.scale)}></calcite-icon>` : null, f = v("default-slot", a`<slot></slot>`), p = this.selectionMode === "ancestors" ? a`<div class=${n(i.checkboxContainer)}><calcite-icon class=${n(i.checkbox)} .icon=${this.selected ? c.checkSquareF : u ? c.minusSquareF : c.square} .scale=${h(this.scale)}></calcite-icon></div>` : null, r = t ? c.bulletPoint : o ? c.checkmark : s ? c.blank : null, x = r ? a`<calcite-icon class=${n({
    ...
    return this.el.ariaChecked = this.selectionMode === "multiple" || this.selectionMode === "multichildren" || this.selectionMode === "ancestors" ? m(this.selected) : void 0, this.el.ariaExpanded = this.hasChildren ? m(k) : void 0, this.el.inert = b, this.el.ariaLive = "polite", this.el.ariaSelected = this.selectionMode === "single" || this.selectionMode === "children" || this.selectionMode === "single-persist" ? m(this.selected) : void 0, this.el.toggleAttribute("calcite-hydrated-hidden", b), this.el.role = "treeitem", M(this.el, "tabIndex", this.disabled ? -1 : 0), F({ disabled: this.disabled, children: a`<div class=${n({ [i.itemExpanded]: k })}><div class=${n(i.nodeAndActionsContainer)}><div class=${n({
      [i.nodeContainer]: !0,
      [d.rtl]: e
    })} data-selection-mode=${this.selectionMode ?? A}>${l}${x}${p || null}${this.iconStart ? y : null}${p ? a`<label class=${n(i.checkboxLabel)}>${f}</label>` : f}</div><div class=${n(i.actionsEnd)} .hidden=${!C} ${T(this.actionSlotWrapper)}>${S}</div></div><div class=${n({
