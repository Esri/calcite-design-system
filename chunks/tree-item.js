import { a as I, L as E, d as $, s as n, C as d, x as a, k as M, E as w, c as A } from "./iframe.js";
import { i as v } from "./keyed.js";
import { e as z, n as T } from "./ref.js";
import { G as P, d as q, s as L, g as H, t as u } from "./dom.js";
...
class D extends E {
  ...
  render() {
    const e = H(this.el) === "rtl", t = this.selectionMode === "single" || this.selectionMode === "children" || this.selectionMode === "single-persist", o = this.selectionMode === "multiple" || this.selectionMode === "multichildren", s = this.selectionMode === "none" && !this.hasChildren, m = this.hasChildren && this.indeterminate, l = this.hasChildren || this.selectionMode === "ancestors" ? a`<calcite-icon class=${n({
      [i.chevron]: !0,
      [d.rtl]: e
    })} data-test-id=icon .icon=${this.hasChildren ? c.chevronRight : c.blank} @click=${this.iconClickHandler} .scale=${h(this.scale)}></calcite-icon>` : null, f = v("default-slot", a`<slot></slot>`), p = this.selectionMode === "ancestors" ? a`<div class=${n(i.checkboxContainer)}><calcite-icon class=${n(i.checkbox)} .icon=${this.selected ? c.checkSquareF : m ? c.minusSquareF : c.square} .scale=${h(this.scale)}></calcite-icon></div>` : null, r = t ? c.bulletPoint : o ? c.checkmark : s ? c.blank : null, x = r ? a`<calcite-icon class=${n({
      [i.bulletPointIcon]: r === c.bulletPoint,
      [i.checkmarkIcon]: r === c.checkmark,
      [d.rtl]: e
    })} .icon=${r} .scale=${h(this.scale)}></calcite-icon>` : null, b = !(this.parentExpanded || this.depth === 1), k = this.updateAfterInitialRender && this.expanded, { hasEndActions: C } = this, S = v("actionsEndSlot", a`<slot name=${g.actionsEnd} @slotchange=${this.actionsEndSlotChangeHandler}></slot>`), y = a`<calcite-icon class=${n(i.iconStart)} .flipRtl=${this.iconFlipRtl === "start" || this.iconFlipRtl === "both"} .icon=${this.iconStart} .scale=${h(this.scale)}></calcite-icon>`;
    return this.el.ariaChecked = this.selectionMode === "multiple" || this.selectionMode === "multichildren" || this.selectionMode === "ancestors" ? u(this.selected) : void 0, this.el.ariaExpanded = this.hasChildren ? u(k) : void 0, this.el.inert = b, this.el.ariaLive = "polite", this.el.ariaSelected = this.selectionMode === "single" || this.selectionMode === "children" || this.selectionMode === "single-persist" ? u(this.selected) : void 0, this.el.toggleAttribute("calcite-hydrated-hidden", b), this.el.role = "treeitem", M(this.el, "tabIndex", this.disabled ? -1 : 0), F({ disabled: this.disabled, children: a`<div class=${n({ [i.itemExpanded]: k })}><div class=${n(i.nodeAndActionsContainer)}><div class=${n({
      [i.nodeContainer]: !0,
      [d.rtl]: e
    })} data-selection-mode=${this.selectionMode ?? w}>${l}${x}${p || null}${this.iconStart ? y : null}${p ? a`<label class=${n(i.checkboxLabel)}>${f}</label>` : f}</div><div class=${n(i.actionsEnd)} .hidden=${!C} ${T(this.actionSlotWrapper)}>${S}</div></div><div class=${n({
      [i.childrenContainer]: !0,
      [d.rtl]: e
    })} data-test-id=calcite-tree-children @click=${this.childrenClickHandler} .role=${this.hasChildren ? "group" : void 0}><slot name=${g.children} @slotchange=${this.handleChildrenSlotChange}></slot></div></div>` });
  }
}
A("calcite-tree-item", D);
export {
  D as TreeItem
};
