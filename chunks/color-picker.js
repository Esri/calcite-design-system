...
import { D as g, C as K, g as ce, a as he, S as D, n as O, h as S, p as H, b, c as P, d as A, e as de, f as U, O as y, R as k, H as p, i as n, o as j, t as pe, j as W, k as N, l as ue, m as R, q as _ } from "./utils4.js";
...
class De extends le {
  ...
  handleValueChange(e, t) {
    ...
    const r = i && !e ? null : b(e != null && typeof e == "object" && A(this.mode) ? de(e) : e), h = !U(r, this.color);
  ...
  render() {
    const { channelsDisabled: e, color: t, colorFieldScopeLeft: i, colorFieldScopeTop: o, staticDimensions: { thumb: { radius: a } }, hexDisabled: s, hueScopeLeft: l, messages: r, alphaChannel: h, opacityScopeLeft: d, savedColors: C, savedDisabled: f, scale: m, scopeOrientation: w } = this, L = this.effectiveSliderWidth, M = t ? S(t, h) : null, G = a, Y = l ?? L * g.hue() / p.h, J = a, Z = d ?? L * R(g.alpha()) / y.max, z = t === void 0, F = w === "vertical", [Q, ee] = this.getAdjustedScopePosition(i, o), [te, ie] = this.getAdjustedScopePosition(Y, G), [oe, ae] = this.getAdjustedScopePosition(Z, J);
