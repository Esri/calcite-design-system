import { a as se, L as le, d as E, s as c, j as $, x as u, E as x, c as ne } from "./iframe.js";
import { n as v } from "./ref.js";
import { c as re } from "./repeat.js";
import { i as I } from "./keyed.js";
import { D as g, C as K, g as ce, a as he, S as D, n as O, h as b, p as H, b as S, c as P, d as A, e as de, f as U, O as y, R as k, H as p, i as n, o as j, t as pe, j as W, k as N, l as ue, m as R, q as _ } from "./utils4.js";
import { e as B, f as Ce, g as fe } from "./dom.js";
import { u as me, I as ge } from "./interactive.js";
import { i as ve } from "./key.js";
import { c as be } from "./component.js";
import { c as Se, r as V, a as ye } from "./math.js";
...
class De extends le {
  constructor() {
    ...
    }, this.channelMode = "rgb", this.channels = this.toChannels(g), this.staticDimensions = D.m, this.savedColors = [], this.allowEmpty = !1, this.alphaChannel = !1, this.channelsDisabled = !1, this.clearable = !1, this.disabled = !1, this.format = "auto", this.hexDisabled = !1, this.savedDisabled = !1, this.scale = "m", this.calciteColorPickerChange = E({ cancelable: !1 }), this.calciteColorPickerInput = E({ cancelable: !1 }), this.listen("keydown", this.handleChannelKeyUpOrDown, { capture: !0 }), this.listen("keyup", this.handleChannelKeyUpOrDown, { capture: !0 });
  }
  static {
  ...
  async load() {
    ...
    const { isClearable: e, color: t, format: i, value: o } = this, a = e && !o, s = H(o), l = a || i === "auto" && s || i === s, r = a ? null : l ? S(o) : t;
    l || this.showIncompatibleColorWarning(o, i), this.setMode(i, !1), this.internalColorSet(r, !1, "initial"), this.updateStaticDimensions(this.scale), this.updateDynamicDimensions(D[this.scale].minWidth);
  ...
  handleValueChange(e, t) {
    ...
    const r = i && !e ? null : S(e != null && typeof e == "object" && A(this.mode) ? de(e) : e), h = !U(r, this.color);
  ...
  render() {
    const { channelsDisabled: e, color: t, colorFieldScopeLeft: i, colorFieldScopeTop: o, staticDimensions: { thumb: { radius: a } }, hexDisabled: s, hueScopeLeft: l, messages: r, alphaChannel: h, opacityScopeLeft: d, savedColors: C, savedDisabled: f, scale: m, scopeOrientation: w } = this, L = this.effectiveSliderWidth, M = t ? b(t, h) : null, G = a, Y = l ?? L * g.hue() / p.h, J = a, Z = d ?? L * R(g.alpha()) / y.max, z = t === void 0, F = w === "vertical", [Q, ee] = this.getAdjustedScopePosition(i, o), [te, ie] = this.getAdjustedScopePosition(Y, G), [oe, ae] = this.getAdjustedScopePosition(Z, J);
