...
import { b as c, m as v } from "./utils3.js";
...
const {
  ...
  args: {
    layout: h.defaultValue,
    scale: u.defaultValue,
    numbered: !0,
    icon: !0,
    numberingSystem: g.defaultValue,
  ...
  argTypes: {
    layout: {
      options: h.values.filter((e) => e !== "grid" && e !== "inline" && e !== "center" && e !== "auto" && e !== "fixed" && e !== "none"),
      control: {
        type: "select"
      }
    },
...
const a = () => t` <calcite-stepper numbered style="width: 50vw">
  ...
  </calcite-stepper>`, s = () => t`<calcite-stepper>
...
`, r = () => t`<calcite-stepper layout="vertical" scale="s">
   ...
   <calcite-stepper layout="vertical" >
    ...
    </calcite-stepper>`, d = () => t`<calcite-stepper numbered style="border: 1px solid red; width: 600px; height: 400px;">
  ...
  </calcite-stepper>`, m = () => t`<calcite-stepper numbered>
    <calcite-stepper-item heading="Add info" selected>
      <calcite-notice width="full" open>
        <div slot="title">Step 1 content</div>
      </calcite-notice>
...
d.parameters = {
  ...
  docs: {
    ...d.parameters?.docs,
    source: {
      originalSource: `(): string => html\`<calcite-stepper numbered style="border: 1px solid red; width: 600px; height: 400px;">
    <calcite-stepper-item heading="Add info" selected>
      <div style="border: 1px solid green; height: 100%;">
        <calcite-notice width="full" open>
          <div slot="title">Step 1 content</div>
...
m.parameters = {
  ...
  docs: {
    ...m.parameters?.docs,
    source: {
      originalSource: `(): string => html\`<calcite-stepper numbered>
    <calcite-stepper-item heading="Add info" selected>
      <calcite-notice width="full" open>
        <div slot="title">Step 1 content</div>
      </calcite-notice>
...
const M = ["simple", "darkModeRTL", "overriddenWidth", "disabled", "arabicNumberingSystem", "verticalLayout", "horizontalSingleLayout", "verticalLayoutFullWidth", "horizontalContentHeight", "horizontalBoxSizing"];
export {
  M as __namedExportsOrder,
  l as arabicNumberingSystem,
  i as darkModeRTL,
  G as default,
  s as disabled,
  m as horizontalBoxSizing,
  d as horizontalContentHeight,
  o as horizontalSingleLayout,
  a as overriddenWidth,
  n as simple,
  p as verticalLayout,
