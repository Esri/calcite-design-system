import { q as ie, w as ue } from "./iframe.js";
import { v as oe, x as se, y as k, z as C, A as x, B as ce, a as fe } from "./dom.js";
...
var Z = {
  ...
  var u = i?.document || document, b = i?.trapStack || Ne, c = X({
    ...
    if (r.containerGroups = r.containers.map(function(t) {
      var a = oe(t, c.tabbableOptions), o = se(t, c.tabbableOptions), f = a.length > 0 ? a[0] : void 0, l = a.length > 0 ? a[a.length - 1] : void 0, v = o.find(function(m) {
        return k(m);
      ...
      return {
        ...
        nextTabbableNode: function(T) {
          var P = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, F = a.indexOf(T);
          return F < 0 ? P ? o.slice(o.indexOf(T) + 1).find(function(A) {
            return k(A);
    ...
    if (r.tabbableGroups.length > 0) {
      ...
      if (s < 0)
        ...
        var F = r.tabbableGroups.findIndex(function(S) {
          var _ = S.lastTabbableNode;
          return a === _;
        });
        if (F < 0 && (y.container === a || x(a, c.tabbableOptions) && !k(a, c.tabbableOptions) && !y.nextTabbableNode(a)) && (F = s), F >= 0) {
          var A = F === r.tabbableGroups.length - 1 ? 0 : F + 1, J = r.tabbableGroups[A];
          v = C(a) >= 0 ? J.firstTabbableNode : J.firstDomTabbableNode;
    ...
    if (o || a instanceof Document)
      ...
      })), w(f || r.mostRecentlyFocusedNode || E());
    }
    ...
    o && (K(t) && t.preventDefault(), w(o));
  }, W = function(t) {
    (c.isKeyForward(t) || c.isKeyBackward(t)) && ne(t, c.isKeyBackward(t));
  }, Y = function(t) {
    we(t) && R(c.escapeDeactivates, t) !== !1 && (t.preventDefault(), h.deactivate());
  }, z = function(t) {
    var a = j(t);
    ...
    if (r.active)
      return Z.activateTrap(b, h), r.delayInitialFocusTimer = c.delayInitialFocus ? ee(function() {
        w(E());
      }) : w(E()), u.addEventListener("focusin", H, !0), u.addEventListener("mousedown", L, {
        capture: !0,
        passive: !1
    ...
    if (r.active)
      return u.removeEventListener("focusin", H, !0), u.removeEventListener("mousedown", L, !0), u.removeEventListener("touchstart", L, !0), u.removeEventListener("click", z, !0), u.removeEventListener("keydown", W, !0), u.removeEventListener("keydown", Y), h;
  }, re = function(t) {
  ...
  return h = {
    ...
    deactivate: function(t) {
      ...
      clearTimeout(r.delayInitialFocusTimer), r.delayInitialFocusTimer = void 0, V(), r.active = !1, r.paused = !1, O(), Z.deactivateTrap(b, h);
      var o = p(a, "onDeactivate"), f = p(a, "onPostDeactivate"), l = p(a, "checkCanReturnFocus"), v = p(a, "returnFocus", "returnFocusOnDeactivate");
      o?.();
      var s = function() {
        ee(function() {
          v && w($(r.nodeFocusedBeforeActivation)), f?.();
        });
      };
...
function Ee(n, e) {
  ...
  return {
    fallbackFocus: i,
    setReturnFocus: (b) => (B.has(n) || fe(b), !1),
    ...e,
