...
import { v as oe, x as ue, y as k, z as C, A as G, B as se, a as ce } from "./dom.js";
import { J as le } from "./iframe.js";
...
var Z = {
  ...
  var o = i?.document || document, b = i?.trapStack || Ne, c = X({
    ...
    return n.containerGroups.findIndex(function(l) {
      ...
      return f.contains(t) || u?.includes(f) || v.find(function(s) {
        return s === t;
      });
    });
  }, N = function(t) {
    var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, u = a.hasFallback, l = u === void 0 ? !1 : u, f = a.params, v = f === void 0 ? [] : f, s = c[t];
    ...
    if (t === !1)
      return !1;
    if (t === void 0 || t && !G(t, c.tabbableOptions))
    ...
    if (n.containerGroups = n.containers.map(function(t) {
      var a = oe(t, c.tabbableOptions), u = ue(t, c.tabbableOptions), l = a.length > 0 ? a[0] : void 0, f = a.length > 0 ? a[a.length - 1] : void 0, v = u.find(function(m) {
        return k(m);
    ...
    if (a)
      return a.shadowRoot && a.shadowRoot.activeElement !== null ? I(a.shadowRoot) : a;
  }, F = function(t) {
    if (t !== !1 && t !== I(document)) {
      if (!t || !t.focus) {
        F(E());
    ...
    if (n.tabbableGroups.length > 0) {
      var s = g(a, u), y = s >= 0 ? n.containerGroups[s] : void 0;
      if (s < 0)
        ...
        if (m < 0 && (y.container === a || G(a, c.tabbableOptions) && !k(a, c.tabbableOptions) && !y.nextTabbableNode(a, !1)) && (m = s), m >= 0) {
        ...
        if (w < 0 && (y.container === a || G(a, c.tabbableOptions) && !k(a, c.tabbableOptions) && !y.nextTabbableNode(a)) && (w = s), w >= 0) {
          var A = w === n.tabbableGroups.length - 1 ? 0 : w + 1, V = n.tabbableGroups[A];
    ...
    if (u || a instanceof Document)
      ...
      if (n.mostRecentlyFocusedNode)
        if (C(n.mostRecentlyFocusedNode) > 0) {
          var v = g(n.mostRecentlyFocusedNode), s = n.containerGroups[v].tabbableNodes;
          if (s.length > 0) {
            var y = s.findIndex(function(m) {
              return m === n.mostRecentlyFocusedNode;
            });
            y >= 0 && (c.isKeyForward(n.recentNavEvent) ? y + 1 < s.length && (l = s[y + 1], f = !1) : y - 1 >= 0 && (l = s[y - 1], f = !1));
          }
        } else
    ...
    (c.isKeyForward(t) || c.isKeyBackward(t)) && re(t, c.isKeyBackward(t));
  }, Y = function(t) {
    ...
    if (n.active)
      return Z.activateTrap(b, h), n.delayInitialFocusTimer = c.delayInitialFocus ? ee(function() {
        F(E());
    ...
    a && F(E());
  }, S = typeof window < "u" && "MutationObserver" in window ? new MutationObserver(ne) : void 0, O = function() {
    S && (S.disconnect(), n.active && !n.paused && n.containers.map(function(t) {
      S.observe(t, {
        subtree: !0,
        childList: !0
      });
  ...
  return h = {
    ...
    activate: function(t) {
      ...
      l || D(), n.active = !0, n.paused = !1, n.nodeFocusedBeforeActivation = I(o), a?.();
      var f = function() {
        l && D(), J(), O(), u?.();
      };
    ...
    deactivate: function(t) {
      ...
      clearTimeout(n.delayInitialFocusTimer), n.delayInitialFocusTimer = void 0, U(), n.active = !1, n.paused = !1, O(), Z.deactivateTrap(b, h);
      ...
      return v && f ? (f($(n.nodeFocusedBeforeActivation)).then(s, s), this) : (s(), this);
    },
    pause: function(t) {
...
function Ee(r, e) {
  ...
  return {
    fallbackFocus: i,
    setReturnFocus: (b) => (B.has(r) || ce(b), !1),
    ...e,
