...
class $ extends v {
  ...
  handleDefaultSlotChange(e) {
    const t = [];
    this.blockAndGroups = O(e).filter((s) => c(s) ? (t.push(s), !0) : w(s)), T(t), this.updateBlockAndGroupScale();
  }
  ...
  render() {
    ...
    return this.interactiveContainer({ disabled: this.disabled, children: b`<div class=${p(u.container)}>${this.dragEnabled ? b`<span aria-live=assertive class=${p(u.assistiveText)}>${this.assistiveText}</span>` : null}${e ? b`<calcite-scrim class=${p(u.scrim)} .loading=${e}></calcite-scrim>` : null}<div .ariaBusy=${P(e, void 0)} .ariaLabel=${t || ""} class=${p(u.groupContainer)} role=group><slot @slotchange=${this.handleDefaultSlotChange}></slot></div></div>` });
  }
}
