...
import { a as g, L as v, D as E, c as h, s as u, C as B, b as p, d as I } from "./index.js";
import { d as S } from "./debounce.js";
import { c as x } from "./observers.js";
import { g as O, b as C } from "./dom.js";
import { g as D } from "./guid.js";
import { u as G } from "./useSetFocus.js";
import { u as A } from "./useCancelable.js";
import { u as y } from "./useInteractive.js";
import { u as M } from "./useSortable.js";
import { i as P } from "./resources2.js";
import { s as H } from "./screen-reader.js";
import { i as c } from "./resources10.js";
import { t as T } from "./aria.js";
const m = {
  container: "container",
  groupContainer: "group-container",
  scrim: "scrim"
}, b = "calcite-block-group", k = "calcite-block", $ = P("calcite-block-group"), w = g`:host([disabled]){cursor:default;-webkit-user-select:none;user-select:none;opacity:var(--calcite-opacity-disabled)}:host([disabled]) *,:host([disabled]) ::slotted(*){pointer-events:none}:host{display:block}.container{position:relative}:host([hidden]){display:none}[hidden]{display:none}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}.interaction-container{display:contents}:host([slot=children]) slot::slotted(calcite-block){border-block-end-width:0}`;
function U(d) {
  d.forEach((e) => {
...
class R extends v {
  ...
  updateBlockItems() {
    ...
    a.forEach((o) => {
      o.closest(b) === t && (o.moveToItems = l.filter((i) => this.validateSortMenuItem({
        type: "move",
        fromEl: n,
        toEl: i.element,
        dragEl: o,
  ...
  updateGroupItems() {
    const { el: e, group: t } = this, s = O(e), l = t ? Array.from(s.querySelectorAll(`${b}[group="${t}"]`)).filter((a) => !a.disabled && a.dragEnabled) : [];
  ...
  setParentBlockGroup() {
    this.parentBlockGroupEl = this.el.parentElement?.closest(b) || void 0;
  }
  handleDefaultSlotChange(e) {
    const t = [];
    this.blockAndGroups = C(e).filter((s) => c(s) ? (t.push(s), !0) : $(s)), U(t), this.updateBlockAndGroupScale();
  }
  ...
  render() {
    ...
    return this.interactiveContainer({ disabled: this.disabled, children: p`<div class=${u(m.container)}>${this.dragEnabled ? p`<span aria-live=assertive class=${u(B.screenReaderText)}>${this.assistiveText}</span>` : null}${e ? p`<calcite-scrim class=${u(m.scrim)} .loading=${e}></calcite-scrim>` : null}<div .ariaBusy=${T(e, void 0)} .ariaLabel=${t || ""} class=${u(m.groupContainer)} role=group><slot @slotchange=${this.handleDefaultSlotChange}></slot></div></div>` });
  }
}
I("calcite-block-group", R);
export {
  R as BlockGroup
};
