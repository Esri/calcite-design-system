import { j as a, L as i, n as o, o as l, x as n, s as r, k as c } from "./iframe.js";
...
class g extends i {
  ...
  // #region Rendering
  render() {
    return this.el.role = "radiogroup", n`<div aria-errormessage=${e.validationMessage} .ariaInvalid=${this.status === "invalid"} class=${r(p.itemWrapper)}><slot></slot></div>${this.validationMessage && this.status === "invalid" ? u({ icon: this.validationIcon, id: e.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}`;
  }
}
