...
class P extends g {
  constructor() {
    super(...arguments), this.guid = `calcite-action-menu-${b()}`, this.actionElements = [], this.menuButtonClick = () => {
      ...
      e.tabIndex = -1, e.setAttribute("role", "menuitem"), e.id || (e.id = i), e.activeDescendant = t === o;
  ...
  connectMenuButtonEl() {
    ...
    this.menuButtonEl !== i && (this.disconnectMenuButtonEl(), this.menuButtonEl = i, this.setTooltipReferenceElement(), i && (i.active = n, i.setAttribute("aria-controls", t), i.setAttribute("aria-expanded", M(n)), i.setAttribute("aria-haspopup", "true"), i.id || (i.id = e), i.label || (i.label = o), i.text || (i.text = o), i.addEventListener("click", this.menuButtonClick), i.addEventListener("keydown", this.menuButtonKeyDown)));
  }
  ...
  renderMenuButton() {
    ...
    return a`<slot name=${d.trigger} @slotchange=${this.setMenuButtonEl}><calcite-action .appearance=${e} class=${c(h.defaultTrigger)} .icon=${A.menu} .scale=${n} .text=${t} .textEnabled=${o} ${r(this.setDefaultMenuButtonEl)}></calcite-action></slot>`;
  }
  renderMenuItems() {
