...
import { b as n, o as A, m as I } from "./utils3.js";
import { h as l } from "./formatting.js";
import { i as N } from "./helpers.js";
import { A as O } from "./resources34.js";
import "./label2.js";
import "./slider.js";
var Z = {}, E = Object.freeze, W = Object.defineProperty, B = (e, i) => E(W(e, "raw", { value: E(e.slice()) })), P, C;
const {
  scale: _,
  sliderFillPlacement: z,
  status: D
} = O, Q = {
  ...
  parameters: {
    chromatic: {
      ...
      diffThreshold: Number(Z.CHROMATIC_DIFF_THRESHOLD) || 0.3,
      delay: 500
    }
  }
}, k = (e) => l`
  <calcite-slider
    ...
    ${A("validation-icon", e.validationIcon)}
  ></calcite-slider>
`, h = () => l`
  <calcite-slider
    min="0"
...
const f = () => {
  ...
  const i = document.createElement("div"), x = H({
    range: [-100, 100],
    values: [-33.32, 30.87],
  ...
  }), V = ["red", "green", "blue"], R = V.map((g, t) => `${1 / (V.length - 1) * t}`);
  a.histogramStops = V.map((g, t) => ({
    offset: parseFloat(R[t]),
    color: g
...
const X = ["simple", "range", "darkModeMirroredRange", "rangeLabeledTicks", "rangeLabeledTicksOverlappingAtMax", "rangeLabeledTicksOverlappingAtMin", "rangeLabeledTicksEdgePositioningAtMax", "rangeLabeledTicksEdgePositioningAtMin", "Histogram", "darkModeHistogramRTL", "disabled", "wordBreakDoesNotAffectLabels", "WithLabelHandlesAndNoValue", "WithLargeFontSize", "maxTickRendering", "rendersWhenTrackRelatedPropChanges", "spaceGroupSeparatorNoBreak", "fillPlacements", "customLabelsAndTicks", "validationMessageAllScales", "negativeSignHandlingForDifferentNumberingSystems"];
export {
  f as Histogram,
  ...
  q as negativeSignHandlingForDifferentNumberingSystems,
  h as range,
