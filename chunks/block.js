...
class N extends w {
  ...
  renderLoaderStatusIcon() {
    ...
    return e ? s("loader", n`<div class=${a(t.icon)}><calcite-loader inline .label=${o.loading}></calcite-loader></div>`) : i ? s("status-icon", n`<div class=${a(t.icon)}><calcite-icon class=${a({
      [t.statusIcon]: !0,
      [t.valid]: i == "valid",
      [t.invalid]: i == "invalid"
    })} .icon=${u[i]} scale=s></calcite-icon></div>`) : s("icon-slot", n`<div class=${a(t.icon)} .hidden=${!this.hasIcon}>${s("icon-slot", n`<slot name=${h.icon} @slotchange=${this.iconSlotChangeHandler}></slot>`)}</div>`);
  }
  renderActionsEnd() {
