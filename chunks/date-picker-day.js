import { a as s, L as n, d as c, k as o, x as d, c as h } from "./iframe.js";
import { a as v } from "./date.js";
import { c as u, t as f } from "./dom.js";
import { u as y, I as p } from "./interactive.js";
...
class k extends n {
  ...
  load() {
    this.parentDatePickerEl = u(this.el, "calcite-date-picker");
  }
  updated() {
    y(this);
  }
  ...
  render() {
    const e = v(this.value).replaceAll("-", "");
    ...
    const r = i.localize(String(this.day)), l = this.dateTimeFormat.format(this.value);
    return this.el.ariaLabel = l, this.el.ariaSelected = f(this.active), o(this.el, "id", e), this.el.role = "button", o(this.el, "tabIndex", this.active && !this.disabled ? 0 : -1), p({ disabled: this.disabled, children: d`<div aria-hidden=true class="day-wrapper"><span class="day"><span class="text">${r}</span></span></div>` });
  }
}
