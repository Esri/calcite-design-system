import { b as i, m as N } from "./utils.js";
import { h as t } from "./formatting.js";
import { A as V } from "./resources14.js";
import { p as j, a as U } from "./floating-ui.js";
...
const {
  ...
  args: {
    ...
    collapsed: !1,
    collapsible: !1,
    collapseDirection: E.defaultValue,
...
}, z = `<h3 class="heading" slot="${c.headerContent}">Heading</h3>`, n = t`
  <p>
...
`, v = () => t`<div style="width: 300px;">
  ...
  </calcite-panel>`, M = () => t`<calcite-panel
    height-scale="s"
    heading="Header!"
  ...
  </calcite-panel>`, A = () => t`<calcite-panel style="width: 400px;" height-scale="s" menu-open>
    <calcite-action text="banana" text-enabled icon="banana" slot="header-menu-actions"></calcite-action>
    <calcite-action text="measure" text-enabled icon="measure" slot="header-menu-actions"></calcite-action>
    <calcite-action-bar slot="action-bar">
      <calcite-action-group>
  ...
  ></calcite-panel>`, O = () => t` <style>
    ...
    <calcite-fab slot="fab"></calcite-fab
  ></calcite-panel>`, L = () => t` <calcite-panel style="max-height: 300px; height: 300px; width: 500px" heading="My Panel"
    ><div>My Content</div>
    <calcite-fab slot="fab"></calcite-fab
  ></calcite-panel>`, B = () => t`<calcite-panel height-scale="s" heading="My Panel">Slotted content!</calcite-panel>`, P = () => t`<calcite-panel style="--calcite-panel-header-border-block-end:none;" height-scale="s" heading="My Panel"
...
export {
  ...
  F as footerAndContentTopBottomSlots,
  x as footerPadding_TestOnly,
  q as footerSlotPrecedence,
  I as footerStartAndEndSlots,
  S as footerVariations,
  M as footerWithoutContent_TestOnly,
  L as noOverflowContentWithFab_TestOnly,
  r as onlyProps,
  _ as overflowContentWithFab_TestOnly,
  O as overflowContent_TestOnly,
  D as scalesFontAndPadding,
  s as simple,
  v as withActionBar_TestOnly,
  h as withDescriptionAndIcon,
  p as withIcon,
  P as withNoHeaderBorderBlockEnd_TestOnly,
  W as withSlottedAlert,
  B as withTextContentOnly
};
