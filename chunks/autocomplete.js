...
import { a as S, L as T, c, F as g, A as s, s as r, b as m, d as w } from "./index.js";
...
class A extends T {
  constructor() {
    super(), this.guid = H(), this.attributeWatch = z(["autofocus", "enterkeyhint", "inputmode"], this.handleGlobalAttributesChanged), this.direction = O(), this.formSupport = K({
      inputType: "text"
