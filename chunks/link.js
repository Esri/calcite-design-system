...
import { u as x, I as E } from "./interactive.js";
...
class R extends p {
  constructor() {
    super(), this.childRef = v(), this.focusSetter = S()(this), this.disabled = !1, this.download = !1, this.listen("click", this.clickHandler);
  }
  static {
    this.properties = { disabled: 7, download: [3, { converter: f }], href: 3, iconEnd: 3, iconFlipRtl: 3, iconStart: 3, rel: 1, target: 1 };
  }
  static {
    this.styles = z;
  }
  ...
  render() {
    ...
    return this.el.role = "presentation", E({ disabled: this.disabled, children: g`<${a} class=${n({ [m.rtl]: r === "rtl" })} download=${(i === "a" ? t === !0 || t === "" ? "" : t || null : null) ?? e} href=${(i === "a" && this.href) ?? e} @click=${this.childElClickHandler} rel=${(i === "a" && this.rel) ?? e} tabindex=${u} target=${(i === "a" && this.target) ?? e} ${y(
      this.childRef
