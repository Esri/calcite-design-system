import { j as y, L as C, x as e, s as n, z as c, k as z } from "./iframe.js";
...
class B extends C {
  ...
  renderIconContainer() {
    const { loading: t, icon: a, scale: i, el: r, iconFlipRtl: d, indicator: b } = this, p = i === "l" ? "l" : "m", h = t ? e`<calcite-loader inline .label=${this.messages.loading} .scale=${p}></calcite-loader>` : null, l = a ? e`<calcite-icon class=${n({ [o.indicatorWithIcon]: b })} .flipRtl=${d} .icon=${a} .scale=${S(this.scale)}></calcite-icon>` : null, s = h || l, u = s || r.children?.length, v = e`<div class=${n({
      [o.slotContainer]: !0,
