...
class B extends w {
  constructor() {
    super(...arguments), this.guid = `calcite-action-${I()}`, this.buttonEl = z(), this.buttonId = `${this.guid}-button`, this.indicatorId = `${this.guid}-indicator`, this.mutationObserver = F("mutation", () => this.requestUpdate()), this.messages = H({ blocking: !0 }), this.active = !1, this.appearance = "solid", this.compact = !1, this.disabled = !1, this.dragHandle = !1, this.iconFlipRtl = !1, this.indicator = !1, this.loading = !1, this.scale = "m", this.width = "auto", this.textEnabled = !1;
  }
  static {
    this.properties = { active: 7, alignment: 3, appearance: 3, compact: 7, disabled: 7, dragHandle: 7, icon: 3, iconFlipRtl: 7, indicator: 7, label: 1, loading: 7, messageOverrides: 0, scale: 3, width: 3, text: 1, textEnabled: 7 };
  }
  static {
    this.styles = j;
  }
