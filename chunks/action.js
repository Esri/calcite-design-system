...
import { a as y, L as z, s as a, b as e, n as r, C as k, d as w } from "./index.js";
...
class O extends z {
  ...
  renderButton() {
    ...
    return this.dragHandle ? e`<span .ariaBusy=${$(l, void 0)} .ariaControlsElements=${x} .ariaDescribedByElements=${this.aria?.describedByElements} .ariaExpanded=${this.aria?.expanded} .ariaHasPopup=${this.aria?.hasPopup} .ariaLabelledByElements=${h} .ariaOwnsElements=${this.aria?.ownsElements} .ariaPressed=${this.aria?.pressed} class=${a(c)} id=${u ?? r} role=button tabindex=${(this.disabled ? void 0 : 0) ?? r} ${p(this.buttonRef)}>${b}</span>` : e`<button .ariaBusy=${$(l, void 0)} .ariaChecked=${this.aria?.checked} .ariaControlsElements=${x} .ariaDescribedByElements=${this.aria?.describedByElements} .ariaExpanded=${this.aria?.expanded} .ariaHasPopup=${this.aria?.hasPopup} .ariaLabelledByElements=${h} .ariaOwnsElements=${this.aria?.ownsElements} .ariaPressed=${this.aria?.pressed} class=${a(c)} .disabled=${o} id=${u ?? r} .role=${this.aria?.role} type=${this.type ?? r} ${p(this.buttonRef)}>${b}</button>`;
  }
  render() {
