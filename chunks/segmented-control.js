...
import { g as b, d as w } from "./dom.js";
import { c as y, a as I, d as C, H as k } from "./form.js";
...
class $ extends p {
  ...
  connectedCallback() {
    super.connectedCallback(), A(this), y(this);
  }
  willUpdate(e) {
  ...
  handleKeyDown(e) {
    ...
    if (t.indexOf(a) === -1)
      return;
    let l = a;
    b(i) === "rtl" && (a === "ArrowRight" && (l = "ArrowLeft"), a === "ArrowLeft" && (l = "ArrowRight"));
    const { items: o } = this;
    let n = -1;
