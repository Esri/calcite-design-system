import { c as m, L as p, h as u, j as f, s as g, x as c, d as v } from "./iframe.js";
...
class $ extends p {
  ...
  async selectItem(e, t = !1) {
    ...
    }), this.selectedItem = s, s && t && (await this.updateComplete, this.calciteSegmentedControlChange.emit()), s && s.focus();
  }
  // #endregion
  // #region Rendering
  render() {
