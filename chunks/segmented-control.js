...
import { a as w, d as y } from "./dom.js";
...
class F extends p {
  ...
  static {
    this.properties = { appearance: 3, disabled: 7, form: 3, layout: 3, labelText: 1, messageOverrides: 0, name: 3, required: 7, scale: 3, selectedItem: 0, status: 3, validationIcon: [3, { converter: f }], validationMessage: 1, validity: 0, value: 1, width: 3 };
  }
  static {
    this.styles = T;
  }
