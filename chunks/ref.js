...
import { i as $, r as a, t as _, e as f, A as l } from "./index.js";
const h = (t, s) => {
  const e = t._$AN;
...
function u(t, s = !1, e = 0) {
  ...
  if (c !== void 0 && c.size !== 0) if (s) if (Array.isArray(i)) for (let n = e; n < i.length; n++) h(i[n], !1), o(i[n]);
  else i != null && (h(i, !1), o(i));
  else h(this, t);
}
const v = (t) => {
  t.type == _.CHILD && (t._$AP ??= u, t._$AQ ??= A);
};
class G extends $ {
  constructor() {
...
const r = /* @__PURE__ */ new WeakMap(), N = f(class extends G {
  render(t) {
    return l;
  }
  update(t, [s]) {
