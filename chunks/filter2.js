import { a as s, L as c, d as l, s as r, x as o, D as n, c as d } from "./iframe.js";
...
class k extends c {
  constructor() {
    super(...arguments), this.filterDebounced = m((e, t = !1, i) => this.updateFiltered(a(this.items ?? [], e, this.filterProps), t, i), n.filter), this.textInput = u(), this._value = "", this.messages = b(), this.disabled = !1, this.filteredItems = [], this.items = [], this.scale = "m", this.calciteFilterChange = l({ cancelable: !1 });
  }
  static {
