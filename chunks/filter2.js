...
import { a as s, L as c, D as l, c as r, s as o, b as n, d } from "./index.js";
import { d as u } from "./debounce.js";
import { e as h, n as p } from "./ref.js";
import { f as a } from "./filter.js";
import { u as f } from "./useCancelable.js";
...
class k extends c {
  ...
  keyDownHandler(e) {
    e.defaultPrevented || (e.key === "Escape" && this.value.length > 0 && (this.clear(), e.preventDefault()), e.key === "Enter" && e.preventDefault());
  }
  clear() {
  ...
  render() {
    ...
    return this.interactiveContainer({ disabled: e, children: n`<div class=${o(g.container)}><label><calcite-input clearable .disabled=${e} .icon=${y.search} .label=${this.label ?? this.messages.label} .messageOverrides=${{ clear: this.messages.clear }} @calciteInputInput=${this.inputHandler} @keydown=${this.keyDownHandler} .placeholder=${this.placeholder} .scale=${t} type=text .value=${this.value} ${p(this.textInputRef)}></calcite-input></label></div>` });
  }
}
d("calcite-filter", k);
export {
