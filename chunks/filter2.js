import { c as a, L as l, h as r, s as n, x as c, D as o, d } from "./iframe.js";
...
class D extends l {
  constructor() {
    super(...arguments), this.filterDebounced = v((e, t = !1, s) => this.updateFiltered(i(this.items ?? [], e, this.filterProps), t, s), o.filter), this.textInput = h(), this._value = "", this.disabled = !1, this.filteredItems = [], this.items = [], this.messages = b(), this.scale = "m", this.calciteFilterChange = r({ cancelable: !1 });
  }
  static {
