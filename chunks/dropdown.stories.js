...
import { b as x, m as R } from "./utils3.js";
import { h as e } from "./formatting.js";
import { d as o } from "./floating-ui.js";
import { A as B } from "./resources34.js";
import { a as G } from "./modes.js";
import "./button.js";
import "./dropdown.js";
import "./dropdown-group.js";
import "./dropdown-item.js";
var _ = Object.freeze, I = Object.defineProperty, V = (t, W) => _(I(t, "raw", { value: _(t.slice()) })), A;
const {
  clickType: $,
  menuPlacement: L,
  ...
  args: {
    placement: L.defaultValue,
    open: !0,
    overlayPositioning: C.defaultValue,
    scale: c.defaultValue,
    width: c.defaultValue,
    widthScale: c.defaultValue,
    type: $.defaultValue,
    closeOnSelectDisabled: !1,
    disabled: !1,
    selectionMode: P.values[0]
  },
  argTypes: {
    placement: {
      options: L.values,
    ...
    selectionMode: {
      options: P.values.filter((t) => t !== "children" && t !== "single-persist" && t !== "multichildren" && t !== "ancestors"),
      control: {
        type: "select"
      }
    }
  ...
  <calcite-dropdown
    ...
    type="${t.type}"
    ${x("close-on-select-disabled", t.closeOnSelectDisabled)}
    ${x("disabled", t.disabled)}
  >
...
</div>`, T = () => e`<div style="width: 300px; border: solid">
...
const K = ["simple", "smallViewport", "simpleAutoWidth", "simpleFullWidth", "withIcons", "groupsAndSelectionModes", "itemsAsLinks", "darkModeRTL", "itemsAsLinksDarkMode", "scrollingAfterCertainItems", "scrollingWithoutMaxItems", "noScrollingWhenMaxItemsEqualsItems", "disabled", "flipPositioning", "alignedCenter", "alignedCenterRTL", "flipPlacements", "mediumIconForLargeDropdownItem", "triggerWordBreak", "settingFullWidthEnablesTriggerTruncation", "openInAllScales", "offsetPlacement", "referenceElement"];
export {
  K as __namedExportsOrder,
  f as alignedCenter,
  y as alignedCenterRTL,
  d as darkModeRTL,
  J as default,
  h as disabled,
  v as flipPlacements,
  l as flipPositioning,
  s as groupsAndSelectionModes,
  u as itemsAsLinks,
  n as itemsAsLinksDarkMode,
  S as mediumIconForLargeDropdownItem,
  b as noScrollingWhenMaxItemsEqualsItems,
  O as offsetPlacement,
  D as openInAllScales,
  M as referenceElement,
  r as scrollingAfterCertainItems,
  g as scrollingWithoutMaxItems,
  T as settingFullWidthEnablesTriggerTruncation,
  a as simple,
  p as simpleAutoWidth,
  w as simpleFullWidth,
  i as smallViewport,
  k as triggerWordBreak,
  m as withIcons
};
