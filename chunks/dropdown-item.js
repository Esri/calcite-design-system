...
import { C as o, I as w } from "./resources9.js";
...
class z extends k {
  ...
  render() {
    ...
    })}>${t !== "none" ? n`<calcite-icon class=${i(o.icon)} .icon=${t === "multiple" ? w.check : w.bulletPoint} .scale=${r(this.scale)}></calcite-icon>` : null}${f}</div>` });
  }
}
D("calcite-dropdown-item", z);
export {
  z as DropdownItem
};
