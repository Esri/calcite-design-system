import { j as v, L as g, n as s, x as i, s as n, z as l, w as k, k as I } from "./iframe.js";
...
class S extends g {
  ...
  // #region Rendering
  render() {
    const { href: e, selectionMode: t, label: d, iconFlipRtl: c } = this, p = i`<calcite-icon class=${n(o.iconStart)} .flipRtl=${c === "start" || c === "both"} .icon=${this.iconStart} .scale=${r(this.scale)}></calcite-icon>`, a = i`<span class=${n(o.itemContent)}><slot></slot></span>`, h = i`<calcite-icon class=${n(o.iconEnd)} .flipRtl=${c === "end" || c === "both"} .icon=${this.iconEnd} .scale=${r(this.scale)}></calcite-icon>`, m = this.iconStart && this.iconEnd ? [p, a, h] : this.iconStart ? [p, a] : this.iconEnd ? [a, h] : a, w = e ? i`<a .ariaLabel=${d} class=${n(o.link)} href=${e ?? l} rel=${this.rel ?? l} tabindex=-1 target=${this.target ?? l} ${D(this.childLink)}>${m}</a>` : m, b = e ? null : t === "single" ? "menuitemradio" : t === "multiple" ? "menuitemcheckbox" : "menuitem", f = t !== "none" ? y(this.selected) : null, { disabled: u } = this;
    return this.el.ariaChecked = f, this.el.ariaLabel = e ? "" : d, this.el.role = b, k(this.el, "tabIndex", u ? -1 : 0), C({ disabled: u, children: i`<div class=${n({
      [o.container]: !0,
