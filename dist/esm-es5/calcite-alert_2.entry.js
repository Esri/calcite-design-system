...
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './core-2b8c2af5.js';
import { g as getElementDir } from './dom-6bb56f1f.js';
import { c as checkCircle24F, e as exclamationMarkTriangle24F, l as lightbulb24F, a as x32 } from './index-9de72867.js';
...
var CalciteAlerts = /** @class */ (function () {
    ...
    class_2.prototype.updateQueueOnOpen = function (event) {
    ...
    class_2.prototype.updateQueueOnClose = function (event) {
        var _this = this;
        if (this.alertQueue.includes(event.detail.requestedAlert))
    ...
    Object.defineProperty(class_2, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}.overflow-hidden{overflow:hidden}calcite-tab{display:none}calcite-tab[is-active]{display:block}:host{display:none;position:fixed;left:0;right:0;bottom:0;pointer-events:none;z-index:101}:host:host([active]){display:block}"; },
        enumerable: true,
        configurable: true
    });
    return class_2;
