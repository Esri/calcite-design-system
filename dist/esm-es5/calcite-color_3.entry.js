...
import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-610ae5e8.js';
...
var CalciteColor = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.initColorFieldAndSlider = function (canvas) {
            ...
            var captureColor = function (x, y) {
                ...
                _this.internalColorSet(_this.color.hsv().saturationv(saturation).value(value));
            };
            ...
            var captureSliderColor = function (x) {
                ...
                var hue = (360 / width) * x;
                _this.internalColorSet(_this.color.hue(hue));
            };
        };
    }
    ...
    class_1.prototype.render = function () {
        var _a, _b, _c, _d, _e;
        var _this = this;
        var _f = this, color = _f.color, intlDeleteColor = _f.intlDeleteColor, el = _f.el, hideHex = _f.hideHex, hideChannels = _f.hideChannels, hideSaved = _f.hideSaved, intlHex = _f.intlHex, intlSaved = _f.intlSaved, intlSaveColor = _f.intlSaveColor, savedColors = _f.savedColors, scale = _f.scale, theme = _f.theme;
        ...
        return (h("div", { class: CSS.container }, h("canvas", { class: (_a = {},
                ...
                _c) }, intlHex), h("calcite-color-hex-input", { class: CSS.control, onCalciteColorHexInputChange: this.handleHexInputChange, ref: function (node) { return (_this.hexInputNode = node); }, scale: hexInputScale, value: selectedColorInHex, theme: theme, dir: elementDir }))), hideChannels ? null : (h("calcite-tabs", { class: (_d = {},
                _d[CSS.colorModeContainer] = true,
                _d[CSS.splitSection] = true,
                _d), dir: elementDir }, h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (h("div", { class: (_e = {}, _e[CSS.savedColorsSection] = true, _e[CSS.section] = true, _e) }, h("div", { class: CSS.header }, h("label", null, intlSaved), h("div", { class: CSS.savedColorsButtons }, h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS.deleteColor, color: "dark", iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS.saveColor, color: "dark", iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (h("div", { class: CSS.savedColors }, __spreadArrays(savedColors.map(function (color) { return (h("calcite-color-swatch", { class: CSS.savedColor, color: color, active: selectedColorInHex === color, key: color, onClick: _this.handleSavedColorSelect, onKeyDown: _this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })); })))) : null))));
    };
    // --------------------------------------------------------------------------
    //
    //  Private Methods
