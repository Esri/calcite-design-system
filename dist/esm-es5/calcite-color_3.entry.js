...
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-6a6cba1d.js';
...
var CalciteColor = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.handleSavedColorSelect = function (event) {
            ...
            _this.color = color(swatch.color);
        };
        this.handleChannelInput = function (event) {
            ...
            var clamped = Math.max(0, Math.min(Number(input.value), limit));
            input.value = "" + clamped;
        };
        ...
        this.renderChannel = function (value, index, label, ariaLabel) { return (h("calcite-input", { "aria-label": ariaLabel, class: CSS.channel, "data-channel-index": index, numberButtonType: "none", onInput: _this.handleChannelInput, onChange: _this.handleChannelChange, prefixText: label, scale: "s", type: "number", value: value.toString() })); };
        ...
        this.initColorFieldAndSlider = function (canvas) {
            ...
            var captureColor = function (x, y) {
                ...
                _this.color = _this.color.hsv().saturationv(saturation).value(value);
            };
            ...
            canvas.addEventListener("mousemove", function (_a) {
                ...
                if (region === "color-field") {
                    ...
                    var color_1 = _this.color.hsv();
                    var _b = _this.dimensions, _c = _b.colorField, height = _c.height, width = _c.width, radius = _b.thumb.radius;
                    var centerX = Math.round(color_1.saturationv() / (HSV_LIMITS.s / width));
                    var centerY = Math.round(height - color_1.value() / (HSV_LIMITS.v / height));
                    ...
                    var sliderThumbColor = _this.color.hsv().saturationv(100).value(100);
            ...
            var captureSliderColor = function (x) {
                ...
                var hue = (360 / width) * x;
                _this.color = _this.color.hue(hue);
            };
        };
    }
    class_1.prototype.handleColorChange = function (color) {
        this.drawColorFieldAndSlider();
        var value = this.toValue(color);
    ...
    class_1.prototype.handleValueChange = function (value, oldValue) {
        ...
        var modeChanged = this.mode !== nextMode;
        this.mode = nextMode;
        var color$1 = color(value);
        var colorChanged = !colorEqual(color$1, this.color);
    ...
    class_1.prototype.componentWillLoad = function () {
        ...
        var valueAttr = this.el.getAttribute("value");
        if (valueAttr) {
    ...
    class_1.prototype.render = function () {
        var _a, _b, _c, _d, _e;
        var _this = this;
        var _f = this, color = _f.color, intlDeleteColor = _f.intlDeleteColor, el = _f.el, intlHex = _f.intlHex, intlSaved = _f.intlSaved, intlSaveColor = _f.intlSaveColor, savedColors = _f.savedColors, scale = _f.scale, theme = _f.theme;
        var selectedColorInHex = color.hex();
        ...
        return (h(Host, null, h("canvas", { class: (_a = {},
                _a[CSS.colorFieldAndSlider] = true,
                _a[CSS.colorFieldAndSliderInteractive] = colorFieldAndSliderInteractive,
                _a), onMouseEnter: this.handleColorFieldAndSliderMouseEnterOrMove, onMouseLeave: this.handleColorFieldAndSliderMouseLeave, onMouseMove: this.handleColorFieldAndSliderMouseEnterOrMove, ref: this.initColorFieldAndSlider }), h("div", { class: (_b = {}, _b[CSS.controlSection] = true, _b[CSS.section] = true, _b) }, h("div", { class: CSS.hexOptions }, h("span", { class: (_c = {},
                _c[CSS.header] = true,
                _c[CSS.headerHex] = true,
                _c[CSS.underlinedHeader] = true,
                _c) }, intlHex), h("calcite-color-hex-input", { class: CSS.control, onCalciteColorHexInputChange: this.handleHexInputChange, ref: function (node) { return (_this.hexInputNode = node); }, scale: hexInputScale, value: selectedColorInHex, theme: theme, dir: elementDir })), h("calcite-tabs", { class: (_d = {},
                _d[CSS.colorModeContainer] = true,
                _d[CSS.splitSection] = true,
                _d), dir: elementDir }, h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))), h("div", { class: (_e = {}, _e[CSS.savedColorsSection] = true, _e[CSS.section] = true, _e) }, h("div", { class: CSS.header }, h("label", null, intlSaved), h("div", { class: CSS.savedColorsButtons }, h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS.deleteColor, color: "dark", iconStart: "minus", onClick: this.deleteColor, scale: scale }), h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS.saveColor, color: "dark", iconStart: "plus", onClick: this.saveColor, scale: scale }))), h("div", { class: CSS.savedColors }, __spreadArrays(savedColors.map(function (color) { return (h("calcite-color-swatch", { class: CSS.savedColor, color: color, active: selectedColorInHex === color, key: color, onClick: _this.handleSavedColorSelect, onKeyDown: _this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })); }))))));
    };
    // --------------------------------------------------------------------------
    //
    //  Private Methods
    ...
    class_1.prototype.toValue = function (color) {
        ...
        var colorObject = color[mode]().object();
        if (mode.endsWith("a")) {
    ...
    class_1.prototype.drawColorFieldAndSlider = function () {
    ...
    class_1.prototype.drawActiveColorFieldColor = function () {
        var color = this.color.hsv();
        var _a = this.dimensions, _b = _a.colorField, height = _b.height, width = _b.width, radius = _a.thumb.radius;
        var x = color.saturationv() / (HSV_LIMITS.s / width);
        var y = height - color.value() / (HSV_LIMITS.v / height);
    ...
    class_1.prototype.drawActiveHueSliderColor = function () {
        var color = this.color.hsv().saturationv(100).value(100);
...
var calciteColorHexInputCss = ":host([hidden]){display:none}:host{display:block}.container{width:100%;display:-ms-inline-grid;display:inline-grid;-ms-grid-columns:1fr auto;grid-template-columns:1fr auto;-ms-flex-align:center;align-items:center}.preview{-ms-grid-column:2;-ms-grid-column-span:1;grid-column:2/3;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;pointer-events:none;margin:0 6px;z-index:1}.preview,.input{-ms-grid-row:1;grid-row:1}.input{-ms-grid-column:1;-ms-grid-column-span:2;grid-column:1/3;text-transform:uppercase;width:100%}";
var DEFAULT_COLOR$1 = color();
var CalciteColorHexInput = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.onCalciteInputBlur = function (event) {
            ...
            node.value = _this.formatForInternalInput(rgbToHex(_this.internalColor.object()));
        };
    ...
    class_2.prototype.handleValueChange = function (value, oldValue) {
        var normalized = normalizeHex(value);
        if (isValidHex(normalized)) {
            var changed = normalized !== normalizeHex(this.internalColor.hex());
            this.internalColor = color(normalized);
            this.value = normalized;
            if (changed) {
    ...
    class_2.prototype.render = function () {
        ...
        var elementDir = getElementDir(el);
        return (h("div", { class: CSS$1.container }, h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onChange: this.onInputChange, onCalciteInputBlur: this.onCalciteInputBlur, onKeyDown: this.onInputKeyDown, prefixText: "#", ref: function (node) { return (_this.inputNode = node); }, scale: "s", value: hexInputValue }), h("calcite-color-swatch", { active: true, class: CSS$1.preview, scale: "s", color: "#" + hexInputValue })));
    };
    //--------------------------------------------------------------------------
    //
    //  Public Methods
    ...
    //
    //--------------------------------------------------------------------------
    class_2.prototype.formatForInternalInput = function (hex) {
        return hex.replace("#", "");
    };
...
var calciteColorSwatchCss = ":host([hidden]){display:none}:host{display:-ms-inline-flexbox;display:inline-flex}:host([scale=s]){height:20px;width:20px}:host([scale=m]){height:24px;width:24px}:host([scale=l]){height:28px;width:28px}.swatch{height:inherit;width:inherit;overflow:visible}.swatch rect{-webkit-transition:all 150ms ease-in-out;transition:all 150ms ease-in-out}";
var ACTIVE_BORDER_COLOR = "rgba(0, 0, 0, 0.15)";
var CalciteColorSwatch = /** @class */ (function () {
    ...
    CalciteColorSwatch.prototype.handleColorChange = function (color$1) {
    ...
    CalciteColorSwatch.prototype.render = function () {
        var _a = this, internalColor = _a.internalColor, active = _a.active, theme = _a.theme;
        ...
        return (h(Host, { "aria-label": hex, title: hex }, h("svg", { class: CSS$2.swatch, xmlns: "http://www.w3.org/2000/svg" }, h("rect", { width: "100%", height: "100%", fill: hex, stroke: borderColor, rx: borderRadius }))));
    };
