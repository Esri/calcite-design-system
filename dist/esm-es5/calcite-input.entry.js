...
var CalciteInput = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        var inputClearButton = (h("div", { class: "calcite-input-clear-button", onClick: function () { return _this.clearInputValue(); } }, h("calcite-icon", { theme: this.theme, icon: "x", scale: iconScale })));
        ...
        var numberButtonsHorizontalUp = (h("div", { class: "calcite-input-number-button-item " + numberButtonClassModifier, onMouseDown: this.updateNumberValue, "data-adjustment": "up" }, h("calcite-icon", { theme: this.theme, scale: iconScale, icon: "chevron-up" })));
        var numberButtonsHorizontalDown = (h("div", { class: "calcite-input-number-button-item " + numberButtonClassModifier, onMouseDown: this.updateNumberValue, "data-adjustment": "down" }, h("calcite-icon", { theme: this.theme, scale: iconScale, icon: "chevron-down" })));
