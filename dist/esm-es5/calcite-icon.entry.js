...
import { d as getAssetPath, r as registerInstance, h, H as Host, g as getElement } from './index-1713631a.js';
...
function fetchIcon(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var size, filled, iconName, id, path;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    size = scaleToPx[scale];
                    filled = icon.charAt(icon.length - 1) === "F";
                    iconName = filled ? icon.substring(0, icon.length - 1) : icon;
                    id = "" + normalizeIconName(iconName) + size + (filled ? "F" : "");
                    if (iconCache[id]) {
