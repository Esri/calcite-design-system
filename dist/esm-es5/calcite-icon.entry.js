...
import { e as getAssetPath, r as registerInstance, h, H as Host, g as getElement } from './index-610ae5e8.js';
...
var calciteIconCss = ":host([hidden]){display:none}:host{display:-ms-inline-flexbox;display:inline-flex}:host([scale=s]){height:16px;min-height:16px;width:16px;min-width:16px}:host([scale=m]){height:24px;min-height:24px;width:24px;min-width:24px}:host([scale=l]){height:32px;min-height:32px;width:32px;min-width:32px}.mirrored{-webkit-transform:scaleX(-1);transform:scaleX(-1)}.svg{display:block}";
var CalciteIcon = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { "aria-label": semantic ? textLabel : null, role: semantic ? "img" : null }, h("svg", { class: (_a = {},
                ...
                _a.svg = true,
                _a), xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", height: "100%", width: "100%", viewBox: "0 0 " + size + " " + size }, paths.map(function (path) { return typeof path === "string" ? (h("path", { d: path })) : (h("path", { d: path.d, opacity: "opacity" in path ? path.opacity : 1 })); }))));
    };
    //--------------------------------------------------------------------------
    //
    //  Private Methods
