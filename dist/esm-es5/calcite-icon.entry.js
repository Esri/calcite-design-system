...
import { d as getAssetPath, r as registerInstance, h, H as Host, g as getElement } from './core-b5a9209a.js';
...
var CalciteIcon = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _a;
        var _b = this, el = _b.el, mirrored = _b.mirrored, pathData = _b.pathData, scale = _b.scale;
        var dir = getElementDir(el);
        var size = scaleToPx[scale];
        return (h(Host, { role: "img" }, h("svg", { class: (_a = {},
    ...
    class_1.prototype.waitUntilVisible = function (callback) {
        ...
        this.intersectionObserver = new IntersectionObserver(function (_a) {
            var iconEntry = _a[0];
