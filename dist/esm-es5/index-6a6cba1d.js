...
var addHydratedFlag = function (elm) { return (elm.setAttribute('calcite-hydrated', '')); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, import('./shadow-css-a471cd43.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 3:
                style_1 = _a.sent();
                _a.label = 4;
            case 4:
            ...
            var hostId = void 0;
            {
                ...
                if (hostId) {
                    if (supportsShadow && cmpMeta_1.$flags$ & 1 /* shadowDomEncapsulation */) {
                        var scopeId_2 = addStyle(elm.shadowRoot, cmpMeta_1);
