...
import { a as ESCAPE, T as TAB, b as END, H as HOME, D as DOWN, U as UP, E as ENTER, S as SPACE } from './keys-e08384ed.js';
var CSS = {
...
var CalciteComboboxItem = /** @class */ (function () {
    ...
    class_1.prototype.renderIcon = function (scale) {
        var iconScale = scale === "xs" || scale === "s" || scale === "m"
            ? "s"
            : scale === "l"
                ? "m"
                : "l";
