...
var CalciteLink = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { dir: dir, theme: theme }, h(Tag, Object.assign({}, attributes, { role: role, tabindex: tabIndex, ref: function (el) { return (_this.childEl = el); } }), this.icon && this.iconPosition === "start" ? iconEl : null, h("slot", null), this.icon && this.iconPosition === "end" ? iconEl : null)));
    };
    //--------------------------------------------------------------------------
    //
    //  Public Methods
