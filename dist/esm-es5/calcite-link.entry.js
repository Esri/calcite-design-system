...
var CalciteLink = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { dir: dir }, h(Tag, Object.assign({}, attributes, { href: Tag === "a" && this.href, role: role, tabIndex: tabIndex, ref: function (el) { return (_this.childEl = el); } }), this.iconStart ? iconStartEl : null, h("slot", null), this.iconEnd ? iconEndEl : null)));
    };
    //--------------------------------------------------------------------------
    //
    //  Public Methods
    ...
    class_1.prototype.getAttributes = function () {
        ...
        var props = ["color", "dir", "icon", "icon-position", "id", "theme"];
