...
var CalciteTabNav = /** @class */ (function () {
    ...
    CalciteTabNav.prototype.render = function () {
        var _this = this;
        return (h(Host, { role: "tablist" }, h("div", { class: "tab-nav", ref: function (el) { return (_this.tabNavEl = el); } }, h("slot", null))));
    };
    ...
    CalciteTabNav.prototype.focusPreviousTabHandler = function (e) {
        ...
        var previousTab = this.tabTitles[currentIndex - 1] || this.tabTitles[this.tabTitles.length - 1];
        previousTab.focus();
        e.stopPropagation();
        e.preventDefault();
    };
...
var CalciteTabTitle = /** @class */ (function () {
    ...
    class_2.prototype.render = function () {
        var id = this.el.id || this.guid;
        var iconStartEl = (h("calcite-icon", { class: "calcite-tab-title--icon icon-start", icon: this.iconStart, scale: "s" }));
        var iconEndEl = (h("calcite-icon", { class: "calcite-tab-title--icon icon-end", icon: this.iconEnd, scale: "s" }));
    ...
    class_2.prototype.updateHasText = function () {
        this.hasText = this.el.textContent.trim().length > 0;
    };
    class_2.prototype.setupTextContentObserver = function () {
        var _this = this;
        {
