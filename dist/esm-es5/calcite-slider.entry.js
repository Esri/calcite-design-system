...
var CalciteSlider = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { id: id, "is-range": this.isRange }, h("div", { class: "track" }, h("div", { class: "track__range", style: { left: left, right: right } }), h("div", { class: "ticks" }, this.tickValues.map(function (number) { return (h("span", { class: {
                tick: true,
