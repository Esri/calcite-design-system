...
import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './core-30c05663.js';
...
var CalcitePopover = /** @class */ (function () {
    ...
    class_1.prototype.getModifiers = function () {
        var _a = this, arrowEl = _a.arrowEl, flipPlacements = _a.flipPlacements, disableFlip = _a.disableFlip, disablePointer = _a.disablePointer, offsetDistance = _a.offsetDistance, offsetSkidding = _a.offsetSkidding;
        var flipModifier = {
            name: "flip",
            enabled: !disableFlip
        };
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { role: "dialog", class: (_a = {},
                _a[HOST_CSS.hydratedInvisible] = !displayed,
                _a), "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, arrowNode, h("div", { class: CSS.container }, this.renderImage(), h("div", { class: CSS.content }, h("slot", null), this.renderCloseButton()))));
    };
