...
var CalcitePopover = /** @class */ (function () {
    ...
    class_1.prototype.getModifiers = function () {
        ...
        var autoRE = /auto/gi;
        var _a = this, placement = _a.placement, xOffset = _a.xOffset, yOffset = _a.yOffset;
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { role: "dialog", "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, h("div", { class: (_a = {},
                ...
                _a) }, this.renderImage(), h("div", { class: CSS.content }, h("slot", null), this.renderCloseButton()))));
    };
