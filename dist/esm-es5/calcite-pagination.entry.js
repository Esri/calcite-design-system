...
var CalcitePagination = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, null, h("button", { class: (_a = {},
                ...
                _a), "aria-label": this.textLabelPrevious, onClick: this.previousClicked, disabled: start < num }, h("calcite-icon", { scale: iconScale, icon: "chevronLeft" })), total > num ? this.renderPage(1) : null, this.renderLeftEllipsis(iconScale), this.renderPages(), this.renderRightEllipsis(iconScale), this.renderPage(this.getLastStart()), h("button", { class: (_b = {},
                _b[CSS.next] = true,
