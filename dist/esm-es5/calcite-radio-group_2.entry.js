...
var calciteRadioGroupCss = ":host([hidden]){display:none}:host{display:-ms-flexbox;display:flex}::slotted(calcite-radio-group-item[checked]),::slotted(calcite-radio-group-item:focus){z-index:0}";
var navigationKeys = {
    up: "ArrowUp",
    down: "ArrowDown",
    left: "ArrowLeft",
