...
import { r as registerInstance, h, H as Host, g as getElement } from './index-5295a268.js';
...
var CalciteTooltip = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        var _a = this, _referenceElement = _a._referenceElement, open = _a.open;
        var displayed = _referenceElement && open;
        return (h(Host, { role: "tooltip", "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, h("div", { class: CSS.arrow, ref: function (arrowEl) { return (_this.arrowEl = arrowEl); } }), h("div", { class: CSS.container }, h("slot", null))));
    };
...
var CalciteTooltipManager = /** @class */ (function () {
    function CalciteTooltipManager(hostRef) {
        ...
        this.toggle = function (event, value) {
            ...
            var tooltipReference = target.closest(_this.selector);
            var describedByElement = tooltipReference && getDescribedByElement(tooltipReference);
