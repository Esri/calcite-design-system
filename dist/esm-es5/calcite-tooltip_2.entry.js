...
import { H as HOST_CSS, b as getDescribedByElement } from './dom-d74d6fbc.js';
import { g as guid } from './guid-ef96c8c4.js';
import { d as defaultOffsetDistance, u as updatePopper, c as createPopper } from './popper-800609e8.js';
var CSS = {
    container: "container",
    arrow: "arrow"
};
...
var CalciteTooltipManager = /** @class */ (function () {
    ...
    //
    // --------------------------------------------------------------------------
    CalciteTooltipManager.prototype.componentDidLoad = function () {
        var el = this.el;
    ...
    CalciteTooltipManager.prototype.componentDidUnload = function () {
        var el = this.el;
    ...
    Object.defineProperty(CalciteTooltipManager.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
