...
var CalciteDatePicker = /** @class */ (function () {
    ...
    CalciteDatePicker.prototype.render = function () {
        ...
        return (h(Host, { role: "application", dir: dir }, h("div", { class: "slot" }, h("slot", null)), !this.noCalendarInput && (h("div", { role: "application" }, h("calcite-input", { type: "text", value: formattedDate, placeholder: this.localeData.placeholder, icon: "calendar", onCalciteInputFocus: function () { return (_this.active = true); }, onCalciteInputChange: function (e) { return _this.input(e.detail.value); }, onCalciteInputBlur: function (e) { return _this.blur(e.detail); }, scale: this.scale, "number-button-type": "none" }))), h("div", { class: "calendar-picker-wrapper" }, h("calcite-date-month-header", { activeDate: activeDate, selectedDate: date || new Date(), prevMonthLabel: this.prevMonthLabel, nextMonthLabel: this.nextMonthLabel, locale: this.locale, min: min, max: max, onCalciteActiveDateChange: function (e) {
...
var CalciteDateMonthHeader = /** @class */ (function () {
    ...
    CalciteDateMonthHeader.prototype.render = function () {
        ...
        var dir = getElementDir(this.el);
        return (h(Host, { dir: dir }, h("div", { class: "header", "aria-hidden": "true" }, h("button", { class: "chevron", "aria-label": this.prevMonthLabel, onClick: function () { return _this.selectPrevMonth(); } }, h("calcite-icon", { icon: "chevron-left", scale: iconScale, mirrored: true, dir: dir })), h("div", { class: "text" }, h("span", { class: "month", role: "heading" }, localizedMonth), h("input", { class: "year", type: "text", inputmode: "numeric", maxlength: "4", minlength: "4", pattern: "\\d*", value: "" + localizedYear.slice(-4), onKeyDown: function (event) { return _this.onYearKey(event); }, onChange: function (event) { return _this.setYear(event.target.value); }, ref: function (el) { return (_this.yearInput = el); } })), h("button", { class: "chevron", "aria-label": this.nextMonthLabel, onClick: function () { return _this.selectNextMonth(); } }, h("calcite-icon", { icon: "chevron-right", scale: iconScale, mirrored: true, dir: dir })))));
    };
    //--------------------------------------------------------------------------
    //
    //  Private Methods
