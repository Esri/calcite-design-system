...
var CalciteModal = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { dir: dir, role: "dialog", "aria-modal": "true", "is-active": this.isActive }, h("calcite-scrim", { class: "scrim", theme: "dark" }), this.renderStyle(), h("div", { class: "modal" }, h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusLastElement.bind(this) }), h("div", { class: "modal__header" }, this.renderCloseButton(), h("header", { class: "modal__title" }, h("slot", { name: "header" }))), h("div", { class: {
            ...
            }, ref: function (el) { return (_this.modalContent = el); } }, h("slot", { name: "content" })), this.renderFooter(), h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusFirstElement.bind(this) }))));
    };
    ...
    class_1.prototype.renderCloseButton = function () {
        var _this = this;
        return !this.disableCloseButton ? (h("button", { class: "modal__close", "aria-label": this.intlClose, title: this.intlClose, ref: function (el) { return (_this.closeButtonEl = el); }, onClick: function () { return _this.close(); } }, h("calcite-icon", { icon: "x", scale: "l" }))) : null;
    };
    ...
    class_1.prototype.handleEscape = function (e) {
        ...
        if (this.active && !this.disableEscape && getKey(e.key) === "Escape") {
            this.beforeClose(this.el).then(function () {
                _this.active = false;
            });
        }
    };
    ...
    class_1.prototype.close = function () {
        var _this = this;
        return this.beforeClose(this.el).then(function () {
            var _a;
            _this.isActive = false;
            (_a = _this.previousActiveElement) === null || _a === void 0 ? void 0 : _a.focus();
