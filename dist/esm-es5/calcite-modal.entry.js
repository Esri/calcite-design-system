...
import { h as hasSlottedContent, g as getElementDir, a as getElementTheme } from './chunk-6bb56f1f.js';
import { x as x24 } from './chunk-9de72867.js';
/**
...
var CalciteModal = /** @class */ (function () {
    ...
    //
    //--------------------------------------------------------------------------
    CalciteModal.prototype.componentDidLoad = function () {
        var _this = this;
        var back = this.el.shadowRoot.querySelector("slot[name=back]");
        var secondary = this.el.shadowRoot.querySelector("slot[name=secondary]");
        back.addEventListener("slotchange", function () {
            _this.hideBackButton = !hasSlottedContent(back);
        });
        secondary.addEventListener("slotchange", function () {
            _this.hideSecondaryButton = !hasSlottedContent(secondary);
        });
    };
    ...
    //
    //--------------------------------------------------------------------------
    CalciteModal.prototype.handleEscape = function (e) {
        if (e.key === "Escape") {
            this.close();
        }
    };
    ...
    //--------------------------------------------------------------------------
    /** Open the modal */
    CalciteModal.prototype.open = function () {
    ...
    CalciteModal.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Object.defineProperty(CalciteModal.prototype, "el", {
