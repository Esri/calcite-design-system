...
var CalciteModal = /** @class */ (function () {
    ...
    class_1.prototype.renderCloseButton = function () {
        var _this = this;
        return !this.disableCloseButton ? (h("button", { class: "modal__close", "aria-label": this.closeLabel, title: this.closeLabel, ref: function (el) { return (_this.closeButtonEl = el); }, onClick: function () { return _this.close(); } }, h("calcite-icon", { icon: "x", scale: "l" }))) : null;
    };
    class_1.prototype.render = function () {
        var _this = this;
        var dir = getElementDir(this.el);
        return (h(Host, { dir: dir, role: "dialog", "aria-modal": "true", class: { "is-active": this.isActive } }, h("calcite-scrim", { class: "scrim", theme: "dark" }), h("div", { class: "modal" }, h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusLastElement.bind(this) }), h("div", { class: "modal__header" }, this.renderCloseButton(), h("header", { class: "modal__title" }, h("slot", { name: "header" }))), h("div", { class: {
                modal__content: true,
