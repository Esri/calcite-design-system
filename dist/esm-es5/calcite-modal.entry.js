...
import { a as x24 } from './index-dc732c5a.js';
/**
...
var CalciteModal = /** @class */ (function () {
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        setTimeout(function () {
                            if (_this.firstFocus) {
                                ...
                                var focusableElements = queryShadowRoot(_this.el, isHidden, isFocusable);
                                if (focusableElements.length > 0) {
                                    focusableElements[0].focus();
                                }
                                else {
                                    _this.closeButton && _this.closeButton.focus();
                                }
                            }
                            resolve(_this.el);
                        }, 300);
    ...
    class_1.prototype.focusLastElement = function () {
        var focusableElements = queryShadowRoot(this.el, isHidden, isFocusable)
            .filter(function (el) { return !el.getAttribute("data-focus-fence"); });
        if (focusableElements.length > 0) {
