...
import { g as getElementDir, a as getElementTheme, b as getElementProp } from './dom-0361c8d2.js';
...
var CalciteDropdownItem = /** @class */ (function () {
    ...
    CalciteDropdownItem.prototype.render = function () {
        ...
        var contentEl = !this.href ? (slottedContent) : (h("a", { href: this.href, title: this.linkTitle }, slottedContent));
