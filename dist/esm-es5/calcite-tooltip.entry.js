...
var CalciteTooltip = /** @class */ (function () {
    ...
    class_1.prototype.getModifiers = function () {
        var _boundariesElement = this._boundariesElement;
        return {
            preventOverflow: {
                enabled: true,
