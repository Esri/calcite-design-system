...
var CalciteLabel = /** @class */ (function () {
    ...
    CalciteLabel.prototype.componentDidLoad = function () {
        ...
        if (this.layout === "inline" || this.layout === "inline-space-between") {
            ...
            (_a = this.slottedContent).append.apply(_a, this.displayedSlottedContent);
        }
    };
    CalciteLabel.prototype.render = function () {
        ...
        return (h(Host, { theme: theme, dir: dir }, h("label", Object.assign({}, attributes, { ref: function (el) { return (_this.slottedContent = el); } }), h("slot", null))));
    };
