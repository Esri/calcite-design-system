...
import { b as getDescribedByElement } from './dom-084e3cc4.js';
import { g as guid } from './guid-f3b487d7.js';
import { d as defaultOffsetDistance, u as updatePopper, c as createPopper } from './popper-541f05c6.js';
var CSS = {
    container: "container",
    arrow: "arrow",
...
var CalcitePopover = /** @class */ (function () {
    ...
    class_1.prototype.renderCloseButton = function () {
        ...
        return closeButton ? (h("button", { ref: function (closeButtonEl) { return (_this.closeButtonEl = closeButtonEl); }, "aria-label": intlClose, title: intlClose, class: (_c = {}, _c[CSS.closeButton] = true, _c), onClick: this.hide }, h("calcite-icon", { icon: "x", scale: "m" }))) : null;
    };
    class_1.prototype.render = function () {
        var _this = this;
        var _c = this, _referenceElement = _c._referenceElement, open = _c.open, disablePointer = _c.disablePointer;
        ...
        return (h(Host, { role: "dialog", "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, arrowNode, h("div", { class: CSS.container }, this.renderImage(), h("div", { class: CSS.content }, h("slot", null), this.renderCloseButton()))));
    };
...
var CalcitePopoverManager = /** @class */ (function () {
    ...
    CalcitePopoverManager.prototype.closeOpenPopovers = function (event) {
        ...
        var describedByElement = getDescribedByElement(target.closest(selector));
