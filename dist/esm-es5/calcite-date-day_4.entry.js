...
var CalciteDatePicker = /** @class */ (function () {
    function CalciteDatePicker(hostRef) {
        ...
        this.syncProxyInputToThis = function () {
            var date = isNaN(Date.parse(_this.value)) ? new Date() : new Date("" + _this.value);
            _this.inputProxy.value = date.toISOString().substr(0, 10);
