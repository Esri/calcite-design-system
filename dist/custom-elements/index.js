...
const CalciteColor = class extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { class: CSS$2.container }, h("canvas", { class: {
            ...
            } }, intlHex), h("calcite-color-hex-input", { class: CSS$2.control, onCalciteColorHexInputChange: this.handleHexInputChange, ref: (node) => (this.hexInputNode = node), scale: hexInputScale, value: selectedColorInHex, theme: theme, dir: elementDir }))), hideChannels ? null : (h("calcite-tabs", { class: {
                [CSS$2.colorModeContainer]: true,
                [CSS$2.splitSection]: true
            }, dir: elementDir }, h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (h("div", { class: { [CSS$2.savedColorsSection]: true, [CSS$2.section]: true } }, h("div", { class: CSS$2.header }, h("label", null, intlSaved), h("div", { class: CSS$2.savedColorsButtons }, h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS$2.deleteColor, color: "dark", iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS$2.saveColor, color: "dark", iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (h("div", { class: CSS$2.savedColors }, [
...
const calciteIconCss = ":host([hidden]){display:none}:host{display:-ms-inline-flexbox;display:inline-flex}:host([scale=s]){height:16px;min-height:16px;width:16px;min-width:16px}:host([scale=m]){height:24px;min-height:24px;width:24px;min-width:24px}:host([scale=l]){height:32px;min-height:32px;width:32px;min-width:32px}.mirrored{-webkit-transform:scaleX(-1);transform:scaleX(-1)}.svg{display:block}";
...
const CalciteIcon = class extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { "aria-label": semantic ? textLabel : null, role: semantic ? "img" : null }, h("svg", { class: {
                ...
                svg: true
            }, xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", height: "100%", width: "100%", viewBox: `0 0 ${size} ${size}` }, paths.map((path) => typeof path === "string" ? (h("path", { d: path })) : (h("path", { d: path.d, opacity: "opacity" in path ? path.opacity : 1 }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
const CalciteInput = class extends HTMLElement {
    ...
    render() {
        ...
        const inputClearButton = (h("div", { class: "calcite-input-clear-button", onClick: () => this.clearInputValue() }, h("calcite-icon", { theme: this.theme, icon: "x", scale: iconScale })));
        ...
        const numberButtonsHorizontalUp = (h("div", { class: `calcite-input-number-button-item ${numberButtonClassModifier}`, onMouseDown: this.updateNumberValue, "data-adjustment": "up" }, h("calcite-icon", { theme: this.theme, scale: iconScale, icon: "chevron-up" })));
        const numberButtonsHorizontalDown = (h("div", { class: `calcite-input-number-button-item ${numberButtonClassModifier}`, onMouseDown: this.updateNumberValue, "data-adjustment": "down" }, h("calcite-icon", { theme: this.theme, scale: iconScale, icon: "chevron-down" })));
...
const CalciteLink = class extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { dir: dir }, h(Tag, Object.assign({}, attributes, { href: Tag === "a" && this.href, role: role, tabIndex: tabIndex, ref: (el) => (this.childEl = el) }), this.iconStart ? iconStartEl : null, h("slot", null), this.iconEnd ? iconEndEl : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
...
const CalcitePagination = class extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, null, h("button", { class: {
            ...
            }, "aria-label": this.textLabelPrevious, onClick: this.previousClicked, disabled: start < num }, h("calcite-icon", { scale: iconScale, icon: "chevronLeft" })), total > num ? this.renderPage(1) : null, this.renderLeftEllipsis(iconScale), this.renderPages(), this.renderRightEllipsis(iconScale), this.renderPage(this.getLastStart()), h("button", { class: {
                [CSS$7.next]: true,
...
const calciteRadioButtonCss = ":host([hidden]){display:none}:host-context([theme=dark]){--calcite-ui-blue-1:#00A0FF;--calcite-ui-blue-2:#0087D7;--calcite-ui-blue-3:#47BBFF;--calcite-ui-green-1:#36DA43;--calcite-ui-green-2:#11AD1D;--calcite-ui-green-3:#44ED51;--calcite-ui-yellow-1:#FFC900;--calcite-ui-yellow-2:#F4B000;--calcite-ui-yellow-3:#FFE24D;--calcite-ui-red-1:#FE583E;--calcite-ui-red-2:#F3381B;--calcite-ui-red-3:#FF7465;--calcite-ui-background:#202020;--calcite-ui-foreground-1:#2b2b2b;--calcite-ui-foreground-2:#353535;--calcite-ui-foreground-3:#404040;--calcite-ui-text-1:#ffffff;--calcite-ui-text-2:#bfbfbf;--calcite-ui-text-3:#9f9f9f;--calcite-ui-border-1:#4a4a4a;--calcite-ui-border-2:#404040;--calcite-ui-border-3:#353535;--calcite-ui-border-4:#757575;--calcite-ui-border-5:#9f9f9f}:host{cursor:pointer}:host .hasLabel{display:grid;grid-gap:8px;-ms-flex-align:center;align-items:center;--calcite-label-margin-bottom:0}:host .radio{border-radius:100%;-webkit-box-shadow:inset 0 0 0 1px var(--calcite-ui-border-1);box-shadow:inset 0 0 0 1px var(--calcite-ui-border-1);cursor:pointer;-webkit-transition:all 0.15s ease-in-out;transition:all 0.15s ease-in-out}:host([hovered]) .radio{-webkit-box-shadow:inset 0 0 0 2px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 2px var(--calcite-ui-blue-1)}:host([disabled]){cursor:default;opacity:0.4}:host([disabled]) .radio,:host([disabled]) label{cursor:default}:host([hovered][disabled]) .radio{-webkit-box-shadow:inset 0 0 0 1px var(--calcite-ui-border-1);box-shadow:inset 0 0 0 1px var(--calcite-ui-border-1)}:host([scale=s]) .hasLabel{grid-template-columns:12px 1fr 4px;grid-template-rows:16px 1fr}:host([scale=s]) .radio{height:12px;min-width:12px;max-width:12px}:host([scale=s][checked]) .radio,:host([hovered][scale=s][checked][disabled]) .radio{-webkit-box-shadow:inset 0 0 0 4px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 4px var(--calcite-ui-blue-1)}:host([scale=s][focused]) .radio{-webkit-box-shadow:inset 0 0 0 4px var(--calcite-ui-blue-1), 0 0 0 2px var(--calcite-ui-foreground-1), 0 0 0 4px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 4px var(--calcite-ui-blue-1), 0 0 0 2px var(--calcite-ui-foreground-1), 0 0 0 4px var(--calcite-ui-blue-1)}:host([scale=m]) .hasLabel{grid-template-columns:16px 1fr 4px;grid-template-rows:20px 1fr}:host([scale=m]) .radio{height:16px;min-width:16px;max-width:16px}:host([scale=m][checked]) .radio,:host([hovered][scale=m][checked][disabled]) .radio{-webkit-box-shadow:inset 0 0 0 5px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 5px var(--calcite-ui-blue-1)}:host([scale=m][focused]) .radio{-webkit-box-shadow:inset 0 0 0 5px var(--calcite-ui-blue-1), 0 0 0 2px var(--calcite-ui-foreground-1), 0 0 0 4px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 5px var(--calcite-ui-blue-1), 0 0 0 2px var(--calcite-ui-foreground-1), 0 0 0 4px var(--calcite-ui-blue-1)}:host([scale=l]) .hasLabel{grid-gap:12px;grid-template-columns:20px 1fr 4px;grid-template-rows:24px 1fr}:host([scale=l]) .radio{height:20px;min-width:20px;max-width:20px}:host([scale=l][checked]) .radio,:host([hovered][scale=l][checked][disabled]) .radio{-webkit-box-shadow:inset 0 0 0 6px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 6px var(--calcite-ui-blue-1)}:host([scale=l][focused]) .radio{-webkit-box-shadow:inset 0 0 0 6px var(--calcite-ui-blue-1), 0 0 0 2px var(--calcite-ui-foreground-1), 0 0 0 4px var(--calcite-ui-blue-1);box-shadow:inset 0 0 0 6px var(--calcite-ui-blue-1), 0 0 0 2px var(--calcite-ui-foreground-1), 0 0 0 4px var(--calcite-ui-blue-1)}:host([hidden]){display:none}";
...
const CalciteRadioButton = class extends HTMLElement {
    ...
    render() {
        if (this.el.textContent) {
            return (h(Host, { "aria-checked": this.checked.toString(), "aria-disabled": this.disabled }, h("div", { class: "hasLabel" }, h("div", { class: "radio" }), h("calcite-label", { dir: getElementDir(this.el), scale: this.scale }, h("slot", null)))));
        }
        return (h(Host, { "aria-checked": this.checked.toString(), "aria-disabled": this.disabled }, h("div", { class: "radio" }), h("slot", null)));
    }
    get el() { return this; }
    static get watchers() { return {
...
const calciteRadioGroupCss = ":host([hidden]){display:none}:host{display:-ms-flexbox;display:flex;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;margin-top:0.25rem;border:1px solid var(--calcite-ui-border-1);background-color:var(--calcite-ui-foreground-1)}:host([layout=vertical]){-ms-flex-direction:column;flex-direction:column;-ms-flex-align:start;align-items:start;-ms-flex-item-align:start;align-self:flex-start}:host([width=full]){width:100%}:host([width=full]) ::slotted(calcite-radio-group-item){-ms-flex:1 1 auto;flex:1 1 auto}:host([width=full][layout=vertical]) ::slotted(calcite-radio-group-item){-ms-flex-pack:start;justify-content:start}::slotted(calcite-radio-group-item[checked]),::slotted(calcite-radio-group-item:focus){z-index:0}";
...
const CalciteSwitch = class extends HTMLElement {
    ...
    render() {
        const dir = getElementDir(this.el);
        return (h(Host, { dir: dir, role: "checkbox", "aria-checked": this.switched.toString(), tabIndex: this.disabled ? -1 : this.tabIndex }, h("div", { class: "track" }, h("div", { class: "handle" }))));
    }
    get tabIndex() {
...
const CalciteTabNav = class extends HTMLElement {
    ...
    render() {
        return (h(Host, { role: "tablist" }, h("div", { class: "tab-nav", ref: (el) => (this.tabNavEl = el) }, h("slot", null))));
    }
    componentDidRender() {
    ...
    focusPreviousTabHandler(e) {
        ...
        const previousTab = this.tabTitles[currentIndex - 1] || this.tabTitles[this.tabTitles.length - 1];
        previousTab.focus();
        e.stopPropagation();
        e.preventDefault();
    }
...
const CalciteTabTitle = class extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { id: id, "aria-controls": this.controls, "aria-expanded": this.active.toString(), role: "tab", tabindex: "0", hasText: this.hasText }, h("a", null, this.iconStart ? iconStartEl : null, h("slot", null), this.iconEnd ? iconEndEl : null)));
    }
    componentDidLoad() {
...
const CalciteTile = class extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        attachShadow(this);
...
const CalciteTileSelect = class extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        attachShadow(this);
...
const CalciteTileSelectGroup = class extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        attachShadow(this);
...
const CalciteTooltipManager = class extends HTMLElement {
    ...
    // --------------------------------------------------------------------------
    render() {
        return h(Host, { onkeyup: this.keyUpHandler });
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const CalciteAccordion$1 = /*@__PURE__*/proxyCustomElement(CalciteAccordion, [1,"calcite-accordion",{"theme":[513],"scale":[1537],"appearance":[1537],"iconPosition":[1537,"icon-position"],"iconType":[1537,"icon-type"],"selectionMode":[1537,"selection-mode"]},[[0,"calciteAccordionItemKeyEvent","calciteAccordionItemKeyEvent"],[0,"calciteAccordionItemRegister","registerCalciteAccordionItem"],[0,"calciteAccordionItemSelect","updateActiveItemOnChange"]]]);
...
const CalciteAlert$1 = /*@__PURE__*/proxyCustomElement(CalciteAlert, [1,"calcite-alert",{"active":[1540],"autoDismiss":[4,"auto-dismiss"],"autoDismissDuration":[1537,"auto-dismiss-duration"],"color":[1537],"theme":[513],"scale":[1537],"icon":[4],"intlClose":[1,"intl-close"],"queue":[32],"queueLength":[32],"queued":[32]},[[8,"calciteAlertSync","alertSync"],[8,"calciteAlertRegister","alertRegister"]]]);
const CalciteButton$1 = /*@__PURE__*/proxyCustomElement(CalciteButton, [1,"calcite-button",{"color":[1537],"appearance":[1537],"theme":[513],"scale":[1537],"width":[1537],"loading":[516],"round":[516],"floating":[516],"href":[513],"iconStart":[513,"icon-start"],"iconEnd":[513,"icon-end"],"disabled":[516],"hasText":[32]}]);
const CalciteCard$1 = /*@__PURE__*/proxyCustomElement(CalciteCard, [1,"calcite-card",{"loading":[516],"selected":[1540],"selectable":[516],"theme":[513]}]);
const CalciteCheckbox$1 = /*@__PURE__*/proxyCustomElement(CalciteCheckbox, [1,"calcite-checkbox",{"checked":[1540],"hovered":[1540],"focused":[1540],"indeterminate":[1540],"name":[513],"value":[513],"scale":[1537],"disabled":[516],"theme":[513]},[[8,"calciteLabelFocus","handleLabelFocus"],[0,"click","onClick"],[0,"keydown","keyDownHandler"],[1,"mouseenter","mouseenter"],[1,"mouseleave","mouseleave"]]]);
const CalciteChip$1 = /*@__PURE__*/proxyCustomElement(CalciteChip, [1,"calcite-chip",{"value":[1],"theme":[513],"scale":[513],"color":[1537],"appearance":[1537],"icon":[513],"dismissible":[516]}]);
const CalciteColor$1 = /*@__PURE__*/proxyCustomElement(CalciteColor, [1,"calcite-color",{"appearance":[513],"color":[16],"hideHex":[4,"hide-hex"],"hideChannels":[4,"hide-channels"],"hideSaved":[4,"hide-saved"],"intlB":[1,"intl-b"],"intlBlue":[1,"intl-blue"],"intlDeleteColor":[1,"intl-delete-color"],"intlG":[1,"intl-g"],"intlGreen":[1,"intl-green"],"intlH":[1,"intl-h"],"intlHsv":[1,"intl-hsv"],"intlHex":[1,"intl-hex"],"intlHue":[1,"intl-hue"],"intlR":[1,"intl-r"],"intlRed":[1,"intl-red"],"intlRgb":[1,"intl-rgb"],"intlS":[1,"intl-s"],"intlSaturation":[1,"intl-saturation"],"intlSaveColor":[1,"intl-save-color"],"intlSaved":[1,"intl-saved"],"intlV":[1,"intl-v"],"intlValue":[1,"intl-value"],"scale":[513],"storageId":[1,"storage-id"],"theme":[513],"value":[1025],"colorFieldAndSliderInteractive":[32],"channelMode":[32],"channels":[32],"dimensions":[32],"savedColors":[32]}]);
...
const CalciteInput$1 = /*@__PURE__*/proxyCustomElement(CalciteInput, [4,"calcite-input",{"status":[1537],"loading":[516],"scale":[1537],"alignment":[1537],"value":[1537],"clearable":[516],"step":[514],"min":[514],"max":[514],"prefixText":[1,"prefix-text"],"suffixText":[1,"suffix-text"],"icon":[520],"type":[1537],"numberButtonType":[1537,"number-button-type"],"theme":[513],"required":[4],"autofocus":[4],"placeholder":[1],"disabled":[516]},[[0,"calciteLabelFocus","handleLabelFocus"],[0,"keydown","keyDownHandler"]]]);
const CalciteInputMessage$1 = /*@__PURE__*/proxyCustomElement(CalciteInputMessage, [1,"calcite-input-message",{"active":[516],"icon":[516],"scale":[1537],"status":[1537],"theme":[513],"type":[1537]}]);
const CalciteLabel$1 = /*@__PURE__*/proxyCustomElement(CalciteLabel, [1,"calcite-label",{"status":[1537],"scale":[1537],"theme":[513],"layout":[1537]}]);
const CalciteLink$1 = /*@__PURE__*/proxyCustomElement(CalciteLink, [1,"calcite-link",{"color":[1537],"theme":[513],"href":[513],"iconStart":[513,"icon-start"],"iconEnd":[513,"icon-end"],"disabled":[516],"userSelect":[516,"user-select"]}]);
...
const CalciteNotice$1 = /*@__PURE__*/proxyCustomElement(CalciteNotice, [1,"calcite-notice",{"active":[1540],"color":[1537],"intlClose":[1,"intl-close"],"theme":[513],"scale":[1537],"width":[1537],"dismissible":[516],"icon":[4]}]);
...
const CalciteRadioButton$1 = /*@__PURE__*/proxyCustomElement(CalciteRadioButton, [1,"calcite-radio-button",{"checked":[1540],"disabled":[516],"focused":[1540],"guid":[513],"hidden":[516],"hovered":[1540],"name":[513],"required":[516],"scale":[1537],"theme":[1537],"value":[513]},[[0,"click","check"],[1,"mouseenter","mouseenter"],[1,"mouseleave","mouseleave"]]]);
...
const CalciteScrim$1 = /*@__PURE__*/proxyCustomElement(CalciteScrim, [1,"calcite-scrim",{"loading":[516],"theme":[513]}]);
const CalciteSlider$1 = /*@__PURE__*/proxyCustomElement(CalciteSlider, [1,"calcite-slider",{"theme":[513],"disabled":[516],"min":[514],"max":[514],"value":[1538],"minValue":[2,"min-value"],"maxValue":[2,"max-value"],"minLabel":[1,"min-label"],"maxLabel":[1,"max-label"],"snap":[4],"step":[2],"pageStep":[2,"page-step"],"ticks":[2],"labelTicks":[516,"label-ticks"],"labelHandles":[516,"label-handles"],"precise":[4],"histogram":[16],"hasHistogram":[1540,"has-histogram"],"tickValues":[32],"activeProp":[32],"minMaxValueRange":[32],"minValueDragRange":[32],"maxValueDragRange":[32]},[[8,"calciteLabelFocus","handleLabelFocus"],[0,"keydown","keyDownHandler"],[0,"click","clickHandler"]]]);
const CalciteSplitButton$1 = /*@__PURE__*/proxyCustomElement(CalciteSplitButton, [1,"calcite-split-button",{"color":[1537],"theme":[513],"scale":[1537],"dropdownIconType":[1537,"dropdown-icon-type"],"primaryText":[513,"primary-text"],"primaryIconStart":[513,"primary-icon-start"],"primaryIconEnd":[513,"primary-icon-end"],"primaryLabel":[513,"primary-label"],"dropdownLabel":[513,"dropdown-label"],"loading":[516],"disabled":[516]}]);
const CalciteStepper$1 = /*@__PURE__*/proxyCustomElement(CalciteStepper, [1,"calcite-stepper",{"theme":[513],"scale":[1537],"numbered":[1540],"icon":[1540],"layout":[1537],"requestedContent":[16]},[[0,"calciteStepperItemKeyEvent","calciteStepperItemKeyEvent"],[0,"calciteStepperItemRegister","registerItem"],[0,"calciteStepperItemSelect","updateItem"]]]);
const CalciteStepperItem$1 = /*@__PURE__*/proxyCustomElement(CalciteStepperItem, [1,"calcite-stepper-item",{"active":[1540],"complete":[516],"error":[4],"disabled":[4],"itemTitle":[1,"item-title"],"itemSubtitle":[1,"item-subtitle"],"layout":[1537],"icon":[1028],"numbered":[1028],"scale":[1537]},[[0,"keydown","keyDownHandler"],[16,"calciteStepperItemChange","updateActiveItemOnChange"]]]);
const CalciteSwitch$1 = /*@__PURE__*/proxyCustomElement(CalciteSwitch, [1,"calcite-switch",{"switched":[1540],"name":[1537],"value":[1537],"color":[1537],"scale":[1537],"disabled":[516],"theme":[513]},[[8,"calciteLabelFocus","handleLabelFocus"],[0,"click","onClick"],[0,"keydown","keyDownHandler"]]]);
const CalciteTab$1 = /*@__PURE__*/proxyCustomElement(CalciteTab, [1,"calcite-tab",{"tab":[513],"active":[1540],"labeledBy":[32]},[[16,"calciteTabChange","tabChangeHandler"]]]);
...
const CalciteTabTitle$1 = /*@__PURE__*/proxyCustomElement(CalciteTabTitle, [1,"calcite-tab-title",{"tab":[513],"active":[1540],"iconStart":[513,"icon-start"],"iconEnd":[513,"icon-end"],"layout":[1537],"position":[1537],"controls":[32],"hasText":[32]},[[16,"calciteTabChange","tabChangeHandler"],[0,"click","onClick"],[0,"keydown","keyDownHandler"]]]);
const CalciteTabs$1 = /*@__PURE__*/proxyCustomElement(CalciteTabs, [1,"calcite-tabs",{"theme":[513],"layout":[513],"position":[513],"titles":[32],"tabs":[32]},[[0,"calciteTabTitleRegister","calciteTabTitleRegister"],[0,"calciteTabTitleUnregister","calciteTabTitleUnregister"],[0,"calciteTabRegister","calciteTabRegister"],[0,"calciteTabUnregister","calciteTabUnregister"]]]);
const CalciteTile$1 = /*@__PURE__*/proxyCustomElement(CalciteTile, [1,"calcite-tile",{"active":[516],"description":[513],"embed":[516],"focused":[516],"heading":[513],"hidden":[516],"href":[513],"icon":[513],"theme":[513]}]);
const CalciteTileSelect$1 = /*@__PURE__*/proxyCustomElement(CalciteTileSelect, [1,"calcite-tile-select",{"checked":[1540],"description":[513],"disabled":[516],"focused":[1540],"heading":[513],"hidden":[516],"icon":[513],"name":[513],"showInput":[513,"show-input"],"theme":[513],"type":[513],"value":[513]},[[0,"calciteCheckboxChange","calciteCheckboxChangeEvent"],[0,"calciteCheckboxFocusedChange","calciteCheckboxFocusedChangeEvent"],[0,"calciteRadioButtonChange","calciteRadioButtonChangeEvent"],[0,"calciteRadioButtonFocusedChange","calciteRadioButtonFocusedChangeEvent"],[0,"click","click"],[1,"mouseenter","mouseenter"],[1,"mouseleave","mouseleave"]]]);
const CalciteTileSelectGroup$1 = /*@__PURE__*/proxyCustomElement(CalciteTileSelectGroup, [1,"calcite-tile-select-group"]);
...
const CalciteTree$1 = /*@__PURE__*/proxyCustomElement(CalciteTree, [1,"calcite-tree",{"lines":[1540],"theme":[513],"scale":[1537],"selectionMode":[1537,"selection-mode"],"root":[516]},[[0,"focus","onFocus"],[0,"calciteTreeItemSelect","onClick"]]]);
const CalciteTreeItem$1 = /*@__PURE__*/proxyCustomElement(CalciteTreeItem, [1,"calcite-tree-item",{"selected":[1540],"expanded":[1540],"parentExpanded":[4,"parent-expanded"],"depth":[514],"hasChildren":[516,"has-children"],"lines":[516],"scale":[513],"selectionMode":[32]},[[0,"click","onClick"],[0,"keydown","keyDownHandler"]]]);
