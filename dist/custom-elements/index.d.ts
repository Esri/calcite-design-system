...
interface CalciteColor extends Components.CalciteColor, HTMLElement {}
export const CalciteColor: {
  prototype: CalciteColor;
  new (): CalciteColor;
};

interface CalciteColorHexInput extends Components.CalciteColorHexInput, HTMLElement {}
export const CalciteColorHexInput: {
  prototype: CalciteColorHexInput;
  new (): CalciteColorHexInput;
};

interface CalciteColorSwatch extends Components.CalciteColorSwatch, HTMLElement {}
export const CalciteColorSwatch: {
  prototype: CalciteColorSwatch;
  new (): CalciteColorSwatch;
};
...
interface CalciteDate extends Components.CalciteDate, HTMLElement {}
export const CalciteDate: {
  prototype: CalciteDate;
  new (): CalciteDate;
};

interface CalciteDateDay extends Components.CalciteDateDay, HTMLElement {}
export const CalciteDateDay: {
  prototype: CalciteDateDay;
  new (): CalciteDateDay;
};

interface CalciteDateMonth extends Components.CalciteDateMonth, HTMLElement {}
export const CalciteDateMonth: {
  prototype: CalciteDateMonth;
  new (): CalciteDateMonth;
};

interface CalciteDateMonthHeader extends Components.CalciteDateMonthHeader, HTMLElement {}
export const CalciteDateMonthHeader: {
  prototype: CalciteDateMonthHeader;
  new (): CalciteDateMonthHeader;
};
