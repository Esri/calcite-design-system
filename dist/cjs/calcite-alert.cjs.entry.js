...
const CalciteAlert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { active: this.active, role: role, dir: dir, "aria-hidden": hidden }, this.icon ? this.setIcon() : null, index.h("div", { class: "alert-content" }, index.h("slot", { name: "alert-title" }), index.h("slot", { name: "alert-message" }), index.h("slot", { name: "alert-link" })), count, !this.autoDismiss ? closeButton : null, this.active && this.autoDismiss ? progress : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
