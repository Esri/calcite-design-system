...
const CalciteAlert = class {
    ...
    render() {
        ...
        const closeButton = (index.h("button", { class: "alert-close", type: "button", "aria-label": this.intlClose, onClick: () => this.closeAlert(), ref: (el) => (this.closeButton = el) }, index.h("calcite-icon", { icon: "x", scale: "m" })));
