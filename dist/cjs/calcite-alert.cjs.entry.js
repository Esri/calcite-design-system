...
const CalciteAlert = class {
    ...
    render() {
        ...
        const closeButton = (core.h("button", { class: "alert-close", "aria-label": "close", onClick: () => this.close(), ref: el => (this.closeButton = el) }, core.h("calcite-icon", { icon: "x", scale: "s" })));
