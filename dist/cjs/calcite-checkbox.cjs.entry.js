...
class CalciteCheckbox {
    constructor(hostRef) {
        ...
        this.calciteCheckboxChange = __chunk_1.createEvent(this, "calciteCheckboxChange", 7);
    }
    onClick({ target }) {
    ...
    keyDownHandler({ keyCode }) {
        if (keyCode === __chunk_2.SPACE || keyCode === __chunk_2.ENTER) {
            this.toggle();
        }
    }
    checkedWatcher() {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { role: "checkbox", "aria-checked": this.checked, tabindex: this.disabled ? "-1" : "0" }, __chunk_1.h("svg", { class: "check-svg", viewBox: "0 0 16 16" }, __chunk_1.h("path", { d: this.getPath(), fill: "white" })), __chunk_1.h("slot", null)));
    }
    setupProxyInput() {
