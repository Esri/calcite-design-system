...
const CalciteTab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { id: id, "aria-labelledby": this.labeledBy, "aria-expanded": this.active.toString(), role: "tabpanel" }, index.h("section", null, index.h("slot", null))));
    }
    componentDidLoad() {
...
const CalciteTabNav = class {
    ...
    render() {
        return (index.h(index.Host, { role: "tablist" }, index.h("div", { class: "tab-nav", ref: (el) => (this.tabNavEl = el) }, index.h("slot", null))));
    }
    componentDidRender() {
...
const CalciteTabTitle = class {
    ...
    render() {
        const id = this.el.id || this.guid;
        const iconStartEl = (index.h("calcite-icon", { class: "calcite-tab-title--icon icon-start", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (index.h("calcite-icon", { class: "calcite-tab-title--icon icon-end", icon: this.iconEnd, scale: "s" }));
        return (index.h(index.Host, { id: id, "aria-controls": this.controls, "aria-expanded": this.active.toString(), role: "tab", tabindex: "0", hasText: this.hasText }, index.h("a", null, this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null)));
    }
    componentDidLoad() {
