...
const CalciteTab = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { id: id, "aria-labeledby": this.labeledBy, "aria-expanded": this.active.toString(), role: "tabpanel" }, index.h("section", null, index.h("slot", null))));
    }
    componentDidLoad() {
...
const CalciteTabTitle = class {
    ...
    render() {
        const id = this.el.id || this.guid;
        return (index.h(index.Host, { id: id, "aria-controls": this.controls, "aria-expanded": this.active.toString(), role: "tab", tabindex: "0" }, index.h("a", null, index.h("slot", null))));
    }
    componentDidLoad() {
