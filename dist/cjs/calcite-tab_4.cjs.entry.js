...
class CalciteTab {
    constructor(hostRef) {
         ...
         * @internal
         */
        this.guid = `calcite-tab-title-${__chunk_3.guid()}`;
     ...
     */
    async getTabIndex() {
        return Promise.resolve(Array.prototype.indexOf.call(__chunk_4.nodeListToArray(this.el.parentElement.children).filter(e => e.matches("calcite-tab")), this.el));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
