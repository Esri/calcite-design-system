...
class CalciteAlert {
    constructor(hostRef) {
        ...
        this.iconDefaults = {
            green: __chunk_5.checkCircle24F,
            yellow: __chunk_5.exclamationMarkTriangle24F,
            red: __chunk_5.exclamationMarkTriangle24F,
            blue: __chunk_5.lightbulb24F
        };
    ...
    render() {
        ...
        const closeButton = (__chunk_1.h("button", { class: "alert-close", "aria-label": "close", onClick: () => this.closeCalciteAlert() }, __chunk_1.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "32", width: "32", viewBox: "0 0 32 32" }, __chunk_1.h("path", { d: __chunk_5.x32 }))));
        ...
        return (__chunk_1.h(__chunk_1.Host, { active: !!this.active, dir: dir }, icon, __chunk_1.h("div", { class: "alert-content" }, __chunk_1.h("slot", { name: "alert-title" }), __chunk_1.h("slot", { name: "alert-message" }), __chunk_1.h("slot", { name: "alert-link" })), count, close, progress));
    }
...
class CalciteAlerts {
    ...
    get el() { return __chunk_1.getElement(this); }
    static get style() { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}.overflow-hidden{overflow:hidden}calcite-tabs{display:block}:host{display:none;position:fixed;left:0;right:0;bottom:0;pointer-events:none;z-index:101}:host:host([active]){display:block}"; }
}
