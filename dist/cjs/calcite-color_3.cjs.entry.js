...
const CalciteColor = class {
    ...
    render() {
        ...
        return (index.h("div", { class: CSS.container }, index.h("canvas", { class: {
            ...
            } }, intlHex), index.h("calcite-color-hex-input", { class: CSS.control, onCalciteColorHexInputChange: this.handleHexInputChange, ref: (node) => (this.hexInputNode = node), scale: hexInputScale, value: selectedColorInHex, theme: theme, dir: elementDir }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
