...
const CalciteNotice = class {
    constructor(hostRef) {
        ...
        this.calciteNoticeClose = core.createEvent(this, "calciteNoticeClose", 7);
        this.calciteNoticeOpen = core.createEvent(this, "calciteNoticeOpen", 7);
    }
    //--------------------------------------------------------------------------
    //
    //  Lifecycle
    ...
    render() {
        ...
        const closeButton = (core.h("button", { class: "notice-close", "aria-label": "close", onClick: () => this.close(), ref: el => (this.closeButton = el) }, core.h("calcite-icon", { icon: "x", scale: "s" })));
        return (core.h(core.Host, { active: this.active, dir: dir }, this.icon ? this.setIcon() : null, core.h("div", { class: "notice-content" }, core.h("slot", { name: "notice-title" }), core.h("slot", { name: "notice-message" }), core.h("slot", { name: "notice-link" })), this.dismissible ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
