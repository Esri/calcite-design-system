...
const CalciteNotice = class {
    ...
    render() {
        ...
        const closeButton = (index.h("button", { class: "notice-close", "aria-label": this.intlClose, onClick: () => this.close(), ref: () => this.closeButton }, index.h("calcite-icon", { icon: "x", scale: "m" })));
