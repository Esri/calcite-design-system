...
const CalciteNotice = class {
    ...
    render() {
        ...
        const closeButton = (core.h("button", { class: "notice-close", "aria-label": "close", onClick: () => this.close(), ref: el => (this.closeButton = el) }, core.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "32", width: "32", viewBox: "0 0 32 32" }, core.h("path", { d: index.x32 }))));
