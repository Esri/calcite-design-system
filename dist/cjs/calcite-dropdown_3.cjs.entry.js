...
const CalciteDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("slot", { name: "dropdown-trigger", "aria-haspopup": "true", "aria-expanded": this.active.toString() }), index.h("div", { class: "calcite-dropdown-wrapper", role: "menu", style: {
...
const CalciteDropdownItem = class {
    ...
    render() {
        ...
        const contentEl = !this.href ? (slottedContent) : (index.h("a", Object.assign({}, attributes), slottedContent));
