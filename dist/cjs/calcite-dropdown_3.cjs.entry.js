...
const CalciteDropdownItem = class {
    ...
    render() {
        ...
        const scale = dom.getElementProp(this.el, "scale", "m");
        if (!this.href) {
            return (core.h(core.Host, { theme: theme, dir: dir, scale: scale, tabindex: "0", role: "menuitem", "aria-selected": this.active.toString() }, core.h("slot", null)));
        }
        else {
            return (core.h(core.Host, { theme: theme, dir: dir, scale: scale, tabindex: "0", role: "menuitem", "aria-selected": this.active.toString(), isLink: true }, core.h("a", { href: this.href, title: this.linkTitle }, core.h("slot", null))));
        }
    }
    //--------------------------------------------------------------------------
    //
