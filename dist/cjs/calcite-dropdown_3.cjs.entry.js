...
const CalciteDropdownGroup = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, groupTitle, core.h("slot", null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const CalciteDropdownItem = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { dir: dir, tabindex: "0", role: "menuitem", "aria-selected": this.active.toString(), isLink: this.href }, contentEl));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
