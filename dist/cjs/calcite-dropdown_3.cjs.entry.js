...
const CalciteDropdown = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir, tabIndex: this.disabled ? -1 : null }, index.h("slot", { name: "dropdown-trigger", "aria-haspopup": "true", "aria-expanded": this.active.toString() }), index.h("div", { class: "calcite-dropdown-wrapper", role: "menu", style: {
