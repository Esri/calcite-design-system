...
const CalciteModal = class {
    ...
    //--------------------------------------------------------------------------
    renderCloseButton() {
        return !this.disableCloseButton ? (index.h("button", { class: "modal__close", "aria-label": this.closeLabel, title: this.closeLabel, ref: (el) => (this.closeButtonEl = el), onClick: () => this.close() }, index.h("calcite-icon", { icon: "x", scale: "l" }))) : null;
    }
    render() {
