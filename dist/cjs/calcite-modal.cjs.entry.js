...
const __chunk_5 = require('./chunk-1dda50bd.js');
...
class CalciteModal {
    constructor(hostRef) {
        ...
        this.calciteModalOpen = __chunk_1.createEvent(this, "calciteModalOpen", 7);
        this.calciteModalClose = __chunk_1.createEvent(this, "calciteModalClose", 7);
    }
    //--------------------------------------------------------------------------
    //
    //  Lifecycle
    ...
    componentDidLoad() {
        ...
        back.addEventListener("slotchange", () => {
            this.hideBackButton = !__chunk_4.hasSlottedContent(back);
        });
        secondary.addEventListener("slotchange", () => {
            this.hideSecondaryButton = !__chunk_4.hasSlottedContent(secondary);
        });
    }
    render() {
        const dir = __chunk_4.getElementDir(this.el);
        const theme = __chunk_4.getElementTheme(this.el);
        return (__chunk_1.h(__chunk_1.Host, { role: "dialog", "aria-modal": "true", class: { "is-active": this.isActive }, dir: dir, theme: theme }, __chunk_1.h("div", { class: "modal" }, __chunk_1.h("focus-trap", { ref: el => (this.trap = el) }, __chunk_1.h("div", { class: "modal__header" }, __chunk_1.h("button", { class: "modal__close", "aria-label": this.closeLabel, onClick: () => this.close() }, __chunk_1.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24", width: "24", viewBox: "0 0 24 24", fill: "currentColor" }, __chunk_1.h("path", { d: __chunk_5.x24 }))), __chunk_1.h("header", { class: "modal__title" }, __chunk_1.h("slot", { name: "header" }))), __chunk_1.h("div", { class: "modal__content" }, __chunk_1.h("slot", { name: "content" })), __chunk_1.h("div", { class: {
                modal__footer: true,
                "modal__footer--hide-back": this.hideBackButton,
                "modal__footer--hide-secondary": this.hideSecondaryButton
            } }, __chunk_1.h("slot", { name: "back" }), __chunk_1.h("slot", { name: "secondary" }), __chunk_1.h("slot", { name: "primary" }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
