...
const CalciteModal = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir, role: "dialog", "aria-modal": "true", "is-active": this.isActive }, index.h("calcite-scrim", { class: "scrim", theme: "dark" }), this.renderStyle(), index.h("div", { class: "modal" }, index.h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusLastElement.bind(this) }), index.h("div", { class: "modal__header" }, this.renderCloseButton(), index.h("header", { class: "modal__title" }, index.h("slot", { name: "header" }))), index.h("div", { class: {
                modal__content: true,
                "modal__content--spaced": !this.noPadding
            }, ref: (el) => (this.modalContent = el) }, index.h("slot", { name: "content" })), this.renderFooter(), index.h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusFirstElement.bind(this) }))));
    }
    renderFooter() {
    ...
    renderCloseButton() {
        return !this.disableCloseButton ? (index.h("button", { class: "modal__close", "aria-label": this.intlClose, title: this.intlClose, ref: (el) => (this.closeButtonEl = el), onClick: () => this.close() }, index.h("calcite-icon", { icon: "x", scale: "l" }))) : null;
    }
    renderStyle() {
