...
const CalciteAccordionItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { tabindex: "0", "aria-expanded": this.active.toString(), dir: dir }, index.h("div", { class: "accordion-item-header", onClick: this.itemHeaderClickHandler }, index.h("div", { class: "accordion-item-header-text" }, index.h("span", { class: "accordion-item-title" }, this.itemTitle), index.h("span", { class: "accordion-item-subtitle" }, this.itemSubtitle)), index.h("calcite-icon", { class: "accordion-item-icon", icon: this.iconType === "chevron"
                ? "chevronUp"
                : this.iconType === "caret"
                    ? "caretUp"
                    : this.active
