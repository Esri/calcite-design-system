...
const CalciteIcon = require('./CalciteIcon-8eca6969.js');
...
const CalciteAccordionItem = class {
    ...
    render() {
        const dir = dom.getElementDir(this.el);
        return (core.h(core.Host, { dir: dir, tabindex: "0", "aria-expanded": this.active.toString() }, core.h("div", { class: "accordion-item-header", onClick: this.itemHeaderClickHander }, core.h("span", { class: "accordion-item-title" }, this.itemTitle), core.h("div", { class: "accordion-item-icon" }, core.h(CalciteIcon.CalciteIcon, { size: "16", path: index.chevronLeft16 }))), core.h("div", { class: "accordion-item-content" }, core.h("slot", null))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
