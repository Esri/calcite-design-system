...
const CalciteSwitch = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir, role: "checkbox", "aria-checked": this.switched.toString(), tabIndex: this.disabled ? -1 : this.tabIndex }, index.h("div", { class: "track" }, index.h("div", { class: "handle" }))));
    }
    get tabIndex() {
