...
const CalciteSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { role: "checkbox", "aria-checked": this.switched.toString(), tabIndex: this.tabIndex }, index.h("div", { class: "track" }, index.h("div", { class: "handle" })), index.h("slot", null)));
    }
    get tabIndex() {
