...
const CalciteSwitch = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { role: "checkbox", dir: dir, "aria-checked": this.switched.toString(), tabindex: "0" }, core.h("div", { class: "track" }, core.h("div", { class: "handle" })), core.h("slot", null)));
    }
    setupProxyInput() {
