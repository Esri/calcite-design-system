...
class CalciteRadioGroup {
    constructor(hostRef) {
        ...
        this.calciteRadioGroupChange = __chunk_1.createEvent(this, "calciteRadioGroupChange", 7);
    }
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { role: "radiogroup" }, __chunk_1.h("slot", null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
    ...
    handleKeyDown(event) {
        ...
        const dir = __chunk_4.getElementDir(el);
...
class CalciteRadioGroupItem {
    constructor(hostRef) {
        ...
        this.calciteRadioGroupItemChange = __chunk_1.createEvent(this, "calciteRadioGroupItemChange", 7);
    }
    handleCheckedChange() {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "radio", "aria-checked": checked ? "true" : "false" }, __chunk_1.h("label", null, __chunk_1.h("slot", null, value), __chunk_1.h("slot", { name: "input" }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
