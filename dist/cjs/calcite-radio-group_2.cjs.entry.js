...
const dom = require('./dom-51cd86d5.js');
...
const CalciteRadioGroupItem = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { role: "radio", "aria-checked": checked ? "true" : "false" }, core.h("label", null, this.hasLabel ? core.h("slot", null) : value, core.h("slot", { name: "input" }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
