...
const CalciteLabel = class {
    constructor(hostRef) {
        ...
        this.handleClick = (event) => {
            ...
            if (this.requestedFor) {
                dom.focusElement(document.getElementById(this.requestedFor));
            }
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir, onClick: this.handleClick }, index.h("label", Object.assign({}, attributes, { ref: (el) => (this.slottedContent = el) }), index.h("slot", null))));
    }
