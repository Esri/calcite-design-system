...
const CalciteCombobox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { active: this.active, onFocusin: this.comboboxFocusHandler, onFocusout: this.comboboxFocusHandler, dir: dir }, index.h("div", { class: "selections" }, this.selectedItems.map((item) => {
            return (index.h("calcite-chip", { key: item.value, scale: this.scale, value: item.value, dir: dir }, item.textLabel));
