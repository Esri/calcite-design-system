...
const CalciteInput = class {
    ...
    connectedCallback() {
        ...
        const foundStatus = dom.getElementProp(this.el, "status", "idle");
        if (!status.includes(this.status))
            this.status = !status.includes(foundStatus) ? "idle" : foundStatus;
        const scale = ["s", "m", "l"];
        const foundScale = dom.getElementProp(this.el, "scale", "m");
    ...
    render() {
        ...
        const inputClearButton = (index.h("div", { class: "calcite-input-clear-button", onClick: () => this.clearInputValue() }, index.h("calcite-icon", { theme: this.theme, icon: "x", scale: iconScale })));
        ...
        const numberButtonsHorizontalUp = (index.h("div", { class: `calcite-input-number-button-item ${numberButtonClassModifier}`, onMouseDown: this.updateNumberValue, "data-adjustment": "up" }, index.h("calcite-icon", { theme: this.theme, scale: iconScale, icon: "chevron-up" })));
        const numberButtonsHorizontalDown = (index.h("div", { class: `calcite-input-number-button-item ${numberButtonClassModifier}`, onMouseDown: this.updateNumberValue, "data-adjustment": "down" }, index.h("calcite-icon", { theme: this.theme, scale: iconScale, icon: "chevron-down" })));
