...
const CalciteIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "aria-label": semantic ? textLabel : null, role: semantic ? "img" : null }, index.h("svg", { class: {
                ...
                svg: true
            }, xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", height: "100%", width: "100%", viewBox: `0 0 ${size} ${size}` }, paths.map((path) => typeof path === "string" ? (index.h("path", { d: path })) : (index.h("path", { d: path.d, opacity: "opacity" in path ? path.opacity : 1 }))))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
