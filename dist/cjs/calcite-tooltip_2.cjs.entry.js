...
const CalciteTooltip = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "tooltip", "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, index.h("div", { class: CSS.arrow, ref: (arrowEl) => (this.arrowEl = arrowEl) }), index.h("div", { class: CSS.container }, index.h("slot", null))));
    }
...
const CalciteTooltipManager = class {
    constructor(hostRef) {
        ...
        this.toggle = (event, value = true) => {
            ...
            const describedByElement = tooltipReference && dom.getDescribedByElement(tooltipReference);
