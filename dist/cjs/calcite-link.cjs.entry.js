...
const CalciteLink = class {
    ...
    render() {
        ...
        const iconStartEl = (index.h("calcite-icon", { class: "calcite-link--icon icon-start", icon: this.iconStart, scale: "s" }));
        const iconEndEl = (index.h("calcite-icon", { class: "calcite-link--icon icon-end", icon: this.iconEnd, scale: "s" }));
        return (index.h(index.Host, { dir: dir }, index.h(Tag, Object.assign({}, attributes, { href: Tag === "a" && this.href, role: role, tabIndex: tabIndex, ref: (el) => (this.childEl = el) }), this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
