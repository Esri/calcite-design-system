...
const CalciteLink = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir, theme: theme }, index.h(Tag, Object.assign({}, attributes, { role: role, tabindex: tabIndex, ref: (el) => (this.childEl = el) }), this.icon && this.iconPosition === "start" ? iconEl : null, index.h("slot", null), this.icon && this.iconPosition === "end" ? iconEl : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
