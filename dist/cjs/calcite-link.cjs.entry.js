...
const CalciteLink = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { dir: dir }, index.h(Tag, Object.assign({}, attributes, { role: role, tabIndex: tabIndex, ref: (el) => (this.childEl = el) }), this.iconStart ? iconStartEl : null, index.h("slot", null), this.iconEnd ? iconEndEl : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
