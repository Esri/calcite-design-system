...
const popper = require('./popper-5a7bfd23.js');
...
const CalcitePopover = class {
    ...
    renderCloseButton() {
        ...
        return closeButton ? (index.h("button", { ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), "aria-label": intlClose, title: intlClose, class: { [CSS.closeButton]: true }, onClick: this.hide }, index.h("calcite-icon", { icon: "x", scale: "m" }))) : null;
    }
    render() {
        ...
        return (index.h(index.Host, { role: "dialog", "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, arrowNode, index.h("div", { class: CSS.container }, this.renderImage(), index.h("div", { class: CSS.content }, index.h("slot", null), this.renderCloseButton()))));
    }
