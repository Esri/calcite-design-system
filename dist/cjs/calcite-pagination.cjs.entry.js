...
const CalcitePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("button", { class: {
            ...
            }, "aria-label": this.textLabelPrevious, onClick: this.previousClicked, disabled: start < num }, index.h("calcite-icon", { scale: iconScale, icon: "chevronLeft" })), total > num ? this.renderPage(1) : null, this.renderLeftEllipsis(iconScale), this.renderPages(), this.renderRightEllipsis(iconScale), this.renderPage(this.getLastStart()), index.h("button", { class: {
                [CSS.next]: true,
