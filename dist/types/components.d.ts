...
export namespace Components {
  ...
  interface CalcitePopover {
    ...
    */
    'open': boolean;
    /**
    * Determines where the element will be positioned. horizontal: Positioned to the left or right of the referenceElement. vertical: Positioned above or below the referenceElement.
    */
...
declare namespace LocalJSX {
  ...
  interface CalcitePopover extends JSXBase.HTMLAttributes<HTMLCalcitePopoverElement> {
    /**
    * Display and position the component.
    */
    'open'?: boolean;
