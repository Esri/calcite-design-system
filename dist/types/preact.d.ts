...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-color": Omit<JSX.CalciteColor, "onCalciteColorChange"> & JSXInternal.HTMLAttributes<HTMLCalciteColorElement> & {
        "oncalciteColorChange"?: (event: CustomEvent<any>) => void;
      }

      "calcite-color-hex-input": Omit<JSX.CalciteColorHexInput, "onCalciteColorHexInputChange"> & JSXInternal.HTMLAttributes<HTMLCalciteColorHexInputElement> & {
        "oncalciteColorHexInputChange"?: (event: CustomEvent<any>) => void;
      }

      "calcite-color-swatch": JSX.CalciteColorSwatch & JSXInternal.HTMLAttributes<HTMLCalciteColorSwatchElement>
      ...
      "calcite-radio-button": Omit<JSX.CalciteRadioButton, "onCalciteRadioButtonChange" | "onCalciteRadioButtonFocusedChange"> & JSXInternal.HTMLAttributes<HTMLCalciteRadioButtonElement> & {
