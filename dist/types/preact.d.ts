...
declare module "preact/src/jsx" {
  namespace JSXInternal {
    interface IntrinsicElements {
      ...
      "calcite-alert": Omit<JSX.CalciteAlert, "onCalciteAlertClose" | "onCalciteAlertOpen" | "onCalciteAlertSync"> & JSXInternal.HTMLAttributes<HTMLCalciteAlertElement> & {
      ...
      "calcite-example": Omit<JSX.CalciteExample, "onOpen"> & JSXInternal.HTMLAttributes<HTMLCalciteExampleElement> & {
      ...
      "calcite-stepper": Omit<JSX.CalciteStepper, "onCalciteStepperItemHasChanged"> & JSXInternal.HTMLAttributes<HTMLCalciteStepperElement> & {
        "oncalciteStepperItemHasChanged"?: (event: CustomEvent<any>) => void;
      }

      "calcite-stepper-item": Omit<JSX.CalciteStepperItem, "onCalciteStepperItemKeyEvent" | "onCalciteStepperItemSelected" | "onRegisterCalciteStepperItem"> & JSXInternal.HTMLAttributes<HTMLCalciteStepperItemElement> & {
      ...
      "calcite-switch": Omit<JSX.CalciteSwitch, "onCalciteSwitchChange" | "onChange"> & JSXInternal.HTMLAttributes<HTMLCalciteSwitchElement> & {
