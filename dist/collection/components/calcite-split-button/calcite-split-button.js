...
export class CalciteButtonWithDropdown {
    ...
    render() {
        ...
        return (h(Host, { dir: dir },
            h("div", { class: "split-button__container" },
                h("calcite-button", { dir: dir, "aria-label": this.primaryLabel, color: this.color, scale: this.scale, loading: this.loading, icon: this.primaryIcon, iconPosition: "start", disabled: this.disabled, theme: this.theme, onClick: this.calciteSplitButtonPrimaryClickHandler }, this.primaryText),
                ...
                h("calcite-dropdown", { alignment: "end", dir: dir, theme: this.theme, scale: this.scale, width: this.scale },
                    h("calcite-button", { dir: dir, "aria-label": this.dropdownLabel, slot: "dropdown-trigger", scale: this.scale, color: this.color, disabled: this.disabled, theme: this.theme, icon: this.dropdownIcon }),
                    h("slot", null)))));
    }
    get dropdownIcon() {
    ...
    static get properties() { return {
        ...
        "dropdownIconType": {
            ...
            "complexType": {
                "original": "| \"chevron\"\n    | \"caret\"\n    | \"ellipsis\"",
                "resolved": "\"caret\" | \"chevron\" | \"ellipsis\"",
                "references": {}
            },
            "required": false,
            "optional": false,
