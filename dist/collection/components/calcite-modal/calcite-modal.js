...
export class CalciteModal {
    ...
    //--------------------------------------------------------------------------
    renderCloseButton() {
        return !this.disableCloseButton ? (h("button", { class: "modal__close", "aria-label": this.closeLabel, title: this.closeLabel, ref: (el) => (this.closeButtonEl = el), onClick: () => this.close() },
