...
export class CalciteDatePicker {
    ...
    render() {
        ...
        return (h(Host, { role: "application", dir: dir },
            h("slot", null),
            !this.noCalendarInput && (h("div", { class: "date-input-wrapper", role: "application" },
                h("calcite-icon", { icon: "calendar", class: "calendar-icon", scale: "s" }),
                h("input", { type: "text", placeholder: this.localeData.placeholder, value: formattedDate, class: "date-input", onFocus: () => (this.showCalendar = true), onInput: (e) => this.input(e.target.value), onBlur: (e) => this.blur(e.target) }))),
