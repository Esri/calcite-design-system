    ...
    render() {
        ...
        return (h(Host, { dir: dir },
            h("div", { class: "header", "aria-hidden": "true" },
                h("button", { class: "chevron", "aria-label": this.prevMonthLabel, disabled: prevMonthDate.getMonth() === activeMonth, onClick: () => this.calciteActiveDateChange.emit(prevMonthDate) },
                ...
                h("button", { class: "chevron", "aria-label": this.nextMonthLabel, disabled: nextMonthDate.getMonth() === activeMonth, onClick: () => this.calciteActiveDateChange.emit(nextMonthDate) },
