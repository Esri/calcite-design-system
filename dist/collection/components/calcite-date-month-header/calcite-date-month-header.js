    ...
    render() {
        ...
        return (h(Host, { dir: dir },
            h("div", { class: "header", "aria-hidden": "true" },
                h("button", { class: "chevron", "aria-label": this.prevMonthLabel, onClick: () => this.selectPrevMonth() },
                ...
                h("button", { class: "chevron", "aria-label": this.nextMonthLabel, onClick: () => this.selectNextMonth() },
