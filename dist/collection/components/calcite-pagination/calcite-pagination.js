import { Component, Element, Event, h, Host, Prop, Method, State, Watch, } from "@stencil/core";
...
export class CalcitePagination {
    ...
    render() {
        return (h(Host, { class: this.backgroundStyle },
            h("a", { class: {
                    [CSS.previous]: true,
                    [CSS.disabled]: this.selectedIndex <= 1,
                }, tabIndex: 0, title: this.textLabelPrevious, onClick: this.previousClicked },
            ...
            h("a", { class: {
                ...
                }, tabIndex: 0, title: this.textLabelNext, onClick: this.nextClicked },
