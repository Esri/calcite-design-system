import { Component, h, Host, Prop, State, Listen, Event, Element, Build, } from "@stencil/core";
...
export class CalciteCombobox {
    ...
    render() {
        ...
        return (h(Host, { active: this.active, onFocusin: this.comboboxFocusHandler, onFocusout: this.comboboxFocusHandler, dir: dir },
            ...
            h("ul", { id: listBoxId, "aria-label": this.label, role: "listbox", class: { list: true }, "aria-multiselectable": "true" },
                h("slot", null))));
    }
