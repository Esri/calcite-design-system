...
export class CalciteAlert {
    ...
    render() {
        ...
        return (h(Host, { theme: this.theme, active: !!this.active, duration: this.duration },
            icon,
    ...
    static get methods() { return {
        "closeCalciteAlert": {
            ...
            "docs": {
                "text": "emit the `calciteAlerClose` event - <calcite-alerts> listens for this, if the alert is not active, but is the queue, this will remove it from the queue",
                "tags": []
            }
        },
        "openCalciteAlert": {
            ...
            "docs": {
                "text": "emit the `calciteAlertOpen` event - <calcite-alerts> listens for this, and determines if it should open the alert or add it to the queue",
                "tags": []
            }
        }
    }; }
