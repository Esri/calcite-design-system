...
export class CalciteInput {
    ...
    render() {
        ...
        const childEl = this.childElType !== "textarea" ? (h("input", Object.assign({}, attributes, { onBlur: () => this.inputBlurHandler(), onFocus: () => this.inputFocusHandler(), onInput: (e) => this.inputInputHandler(e), type: this.type, min: this.min, max: this.max, step: this.step, value: this.value, placeholder: this.placeholder || "", required: this.required ? true : null, autofocus: this.autofocus ? true : null }))) : ([
            h("textarea", Object.assign({}, attributes, { onBlur: () => this.inputBlurHandler(), onFocus: () => this.inputFocusHandler(), onInput: (e) => this.inputInputHandler(e), required: this.required ? true : null, placeholder: this.placeholder || "", autofocus: this.autofocus ? true : null }),
                h("slot", null)),
