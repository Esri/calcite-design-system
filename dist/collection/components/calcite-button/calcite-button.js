...
export class CalciteButton {
    ...
    render() {
        ...
        const graphic = this.loading ? (h("div", { class: "calcite-button--graphic" }, loader)) : this.icon ? (h("div", { class: "calcite-button--graphic" },
            h("svg", { class: "calcite-button--icon", xmlns: "http://www.w3.org/2000/svg", preserveAspectRatio: "xMidYMid meet", viewBox: "0 0 24 24" },
