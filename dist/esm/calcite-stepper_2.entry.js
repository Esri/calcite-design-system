...
import { g as getElementDir, a as getElementProp } from './dom-d74d6fbc.js';
import { b as END, H as HOME, L as LEFT, U as UP, R as RIGHT, D as DOWN, E as ENTER, S as SPACE } from './keys-e08384ed.js';
...
const CalciteStepperItem = class {
    ...
    setIcon() {
        ...
        return (h("calcite-icon", { icon: path, filled: filled, scale: "s", class: "stepper-item-icon" }));
    }
    determineActiveItem() {
