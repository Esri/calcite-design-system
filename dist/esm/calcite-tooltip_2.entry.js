...
const CalciteTooltip = class {
    ...
    render() {
        ...
        return (h(Host, { role: "tooltip", "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, h("div", { class: CSS.arrow, ref: (arrowEl) => (this.arrowEl = arrowEl) }), h("div", { class: CSS.container }, h("slot", null))));
    }
...
const CalciteTooltipManager = class {
    constructor(hostRef) {
        ...
        this.toggle = (event, value = true) => {
            ...
            const describedByElement = tooltipReference && getDescribedByElement(tooltipReference);
