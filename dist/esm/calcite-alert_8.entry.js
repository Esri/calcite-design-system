...
class CalciteAlert {
    ...
    render() {
        ...
        const count = h("div", { class: `${this.queueLength > 0 ? 'is-active ' : ''}alert-count` }, "+", this.queueLength > 0 ? this.queueLength : 1);
...
class CalciteModal {
    ...
    static get style() { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}calcite-tabs{display:block}.example-class{padding:1.5rem;color:#d83020;-webkit-box-shadow:0 0 16px 0 rgba(0,0,0,.05);box-shadow:0 0 16px 0 rgba(0,0,0,.05);border:1px solid #007ac2}"; }
}
