...
const CalcitePopover = class {
    ...
    renderCloseButton() {
        ...
        return closeButton ? (h("button", { ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), "aria-label": intlClose, title: intlClose, class: { [CSS.closeButton]: true }, onClick: this.hide }, h("calcite-icon", { icon: "x", scale: "m" }))) : null;
    }
    render() {
