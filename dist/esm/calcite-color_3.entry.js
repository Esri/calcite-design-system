...
const CalciteColor = class {
    ...
    render() {
        ...
        return (h("div", { class: CSS.container }, h("canvas", { class: {
            ...
            } }, intlHex), h("calcite-color-hex-input", { class: CSS.control, onCalciteColorHexInputChange: this.handleHexInputChange, ref: (node) => (this.hexInputNode = node), scale: hexInputScale, value: selectedColorInHex, theme: theme, dir: elementDir }))), hideChannels ? null : (h("calcite-tabs", { class: {
