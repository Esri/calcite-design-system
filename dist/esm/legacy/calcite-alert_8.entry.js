...
import { d as h, e as registerInstance, f as createEvent, g as Host, h as getElement } from './calcite-a092ddcb.js';
...
var CalciteAlert = /** @class */ (function () {
    function CalciteAlert(hostRef) {
        ...
        this.alertClose = createEvent(this, "alertClose", 7);
        this.alertOpen = createEvent(this, "alertOpen", 7);
    }
    CalciteAlert.prototype.close = function () {
    ...
    CalciteAlert.prototype.componentWillUpdate = function () {
        var _this = this;
        this.isActive = this.currentAlert === this.id;
        if (this.isActive)
            this.alertOpen.emit(this.id);
        if (this.isActive && this.dismiss)
            setTimeout(function () { _this.close(); }, this.duration === 'fast' ? 6000 : this.duration === 'slow' ? 14000 : 10000);
    };
    ...
    CalciteAlert.prototype.render = function () {
        var _this = this;
        var closeButton = (h("button", { class: "alert-close", "aria-label": "close", onClick: function () { return _this.close(); } }, h("svg", { xmlns: 'http://www.w3.org/2000/svg', height: '32', width: '32', viewBox: '0 0 32 32' }, h("path", { d: x32 }))));
        var close = !this.dismiss ? closeButton : '';
        var icon = this.icon ? this.setIcon() : '';
        var count = h("div", { class: (this.queueLength > 0 ? 'is-active ' : '') + "alert-count" }, "+", this.queueLength > 0 ? this.queueLength : 1);
        var progress = this.isActive && this.dismiss ? h("div", { class: "alert-dismiss" }) : '';
        return (h(Host, { theme: this.theme, "is-active": !!this.isActive, duration: this.duration }, icon, h("div", { class: "alert-content" }, h("slot", { name: "alert-title" }), h("slot", { name: "alert-message" }), h("slot", { name: "alert-link" })), count, close, progress));
    };
...
var CalciteAlerts = /** @class */ (function () {
    function CalciteAlerts(hostRef) {
        ...
        this.isActive = false;
        this.queue = [];
        this.alertsClose = createEvent(this, "alertsClose", 7);
        this.alertsOpen = createEvent(this, "alertsOpen", 7);
    }
    CalciteAlerts.prototype.open = function (requestedAlert) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    CalciteAlerts.prototype.updateQueue = function (event) {
        var _this = this;
        if (this.queue.includes(event.detail))
            this.queue = this.queue.filter(function (e) { return e !== event.detail; });
        if (this.queue.length < 1)
            setTimeout(function () { _this.isActive = false; }, 300);
    ...
    CalciteAlerts.prototype.render = function () {
        ...
        return (h(Host, { "is-active": !!this.isActive }, h(AlertInterface.Provider, { state: alertState }, h("slot", null))));
    };
    ...
    Object.defineProperty(CalciteAlerts, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}\@-webkit-keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}\@keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}:host{position:fixed;visibility:hidden;opacity:0;left:0;right:0;bottom:1.5rem;height:0;z-index:101;pointer-events:none;-webkit-transition:all .15s ease-in-out;transition:all .15s ease-in-out;-webkit-transition-delay:.3s;transition-delay:.3s}\@media only screen and (max-width:600px){:host{bottom:0}}:host([is-active]){height:auto;visibility:visible;opacity:1}"; },
        enumerable: true,
        configurable: true
    });
...
var CalciteModal = /** @class */ (function () {
    function CalciteModal(hostRef) {
        registerInstance(this, hostRef);
    }
    CalciteModal.prototype.getText = function () {
        return format(this.first, this.middle, this.last);
    };
    CalciteModal.prototype.render = function () {
        return h("div", { class: "example-class" }, "Hello, World! I'm ", this.getText());
    };
    Object.defineProperty(CalciteModal, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}\@-webkit-keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}\@keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}.example-class{padding:1.5rem;color:#d83020;-webkit-box-shadow:0 0 16px 0 rgba(0,0,0,.05);box-shadow:0 0 16px 0 rgba(0,0,0,.05);border:1px solid #007ac2}"; },
        enumerable: true,
        configurable: true
    });
    return CalciteModal;
...
var CalciteTab = /** @class */ (function () {
    function CalciteTab(hostRef) {
        ...
        this.isActive = false;
        this.calciteRegisterTab = createEvent(this, "calciteRegisterTab", 7);
    }
    ...
    CalciteTab.prototype.getTabIndex = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(Array.prototype.indexOf.call(this.el.parentElement.querySelectorAll("calcite-tab"), this.el))];
            });
        });
    };
    CalciteTab.prototype.registerLabeledBy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.labeledBy = id;
                return [2 /*return*/];
    ...
    CalciteTab.prototype.render = function () {
        return (h(Host, { "aria-labeledby": this.labeledBy, "aria-expanded": this.isActive ? "true" : "false", role: "tabpanel" }, h("section", null, h("slot", null))));
    };
    ...
    Object.defineProperty(CalciteTab, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}\@-webkit-keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}\@keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}:host([is-active]) section{display:block}section{display:none}"; },
        enumerable: true,
        configurable: true
    });
    return CalciteTab;
...
var CalciteTabNav = /** @class */ (function () {
    ...
    CalciteTabNav.prototype.focusPreviousTabHandler = function (e) {
        var tabs = this.el.parentElement.querySelectorAll("calcite-tab-title");
    ...
    CalciteTabNav.prototype.tabTitleRegistationHandler = function (e) {
    ...
    Object.defineProperty(CalciteTabNav, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}\@-webkit-keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}\@keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}.tab-nav{display:-ms-flexbox;display:flex;padding:.5rem 0}::slotted(calcite-tab-title){margin-right:1.25rem}:host([dir=rtl]) ::slotted(calcite-tab-title){margin-right:0;margin-left:1.25rem}"; },
        enumerable: true,
        configurable: true
    });
...
var CalciteTabTitle = /** @class */ (function () {
    function CalciteTabTitle(hostRef) {
        ...
        this.isActive = false;
        this.calciteActivateTab = createEvent(this, "calciteActivateTab", 7);
        this.calciteFocusNextTab = createEvent(this, "calciteFocusNextTab", 7);
        this.calciteFocusPreviousTab = createEvent(this, "calciteFocusPreviousTab", 7);
        this.calciteRegisterTabTitle = createEvent(this, "calciteRegisterTabTitle", 7);
    }
    CalciteTabTitle.prototype.tabChangeHand = function (event) {
        var _this = this;
        if (this.tab) {
            this.isActive = this.tab === event.detail.tab;
        }
    ...
    CalciteTabTitle.prototype.componentDidLoad = function () {
        var _this = this;
        this.getTabIndex().then(function (index) {
            _this.calciteRegisterTabTitle.emit({
                id: _this.id,
                index: index
            });
        });
    ...
    CalciteTabTitle.prototype.setControledBy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.controls = id;
                return [2 /*return*/];
    ...
    CalciteTabTitle.prototype.render = function () {
        return (h(Host, { "aria-controls": this.controls, "aria-expanded": this.isActive ? "true" : "false", role: "tab", tabindex: "0" }, h("a", null, h("slot", null))));
    };
    ...
    Object.defineProperty(CalciteTabTitle, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}\@-webkit-keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}\@keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}:host{-ms-flex:0 1 auto;flex:0 1 auto;outline:none}:host(:active) a,:host(:focus) a,:host(:hover) a{outline:none;text-decoration:none;color:var(--calcite-tabs-color-active);border-bottom-color:var(--calcite-tabs-border-hover)}:host([is-active]) a{color:var(--calcite-tabs-color-active);border-bottom-color:var(--calcite-tabs-border-active)}a{-webkit-box-sizing:border-box;box-sizing:border-box;font-size:.875rem;line-height:1.5;padding:.5rem 0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;border-bottom:3px solid transparent;cursor:pointer;-webkit-transition:all .15s ease-in-out;transition:all .15s ease-in-out;color:var(--calcite-tabs-color);outline:none}"; },
        enumerable: true,
        configurable: true
    });
...
var CalciteTabs = /** @class */ (function () {
    ...
    CalciteTabs.prototype.tabTitleRegistationHandler = function (e) {
        var _a = e.detail, index = _a.index, id = _a.id;
    ...
    CalciteTabs.prototype.tabRegistationHandler = function (e) {
        var _a = e.detail, index = _a.index, id = _a.id;
        this.tabs[index] = {
            id: id,
            tab: e.target
    ...
    CalciteTabs.prototype.render = function () {
        return (h("div", null, h("slot", { name: "tab-nav" }), h("section", { class: "tab-contents" }, h("slot", null))));
    };
    Object.defineProperty(CalciteTabs, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}\@-webkit-keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}\@keyframes dismissProgress{0%{width:0;opacity:0}to{width:100%;opacity:1}}:host{--calcite-tabs-color:#2b2b2b;--calcite-tabs-border:#eaeaea;--calcite-tabs-border-hover:#dfdfdf;--calcite-tabs-color-active:#151515;--calcite-tabs-border-active:#007ac2}:host([theme=dark]){--calcite-tabs-color:#f3f3f3;--calcite-tabs-border:#404040;--calcite-tabs-border-hover:#757575;--calcite-tabs-color-active:#f8f8f8;--calcite-tabs-border-active:#fff}.tab-contents{margin-top:1px;border-top:1px solid var(--calcite-tabs-border)}"; },
        enumerable: true,
        configurable: true
    });
    return CalciteTabs;
}());
export { CalciteAlert as calcite_alert, CalciteAlerts as calcite_alerts, CalciteLoader as calcite_loader, CalciteModal as calcite_modal, CalciteTab as calcite_tab, CalciteTabNav as calcite_tab_nav, CalciteTabTitle as calcite_tab_title, CalciteTabs as calcite_tabs };
