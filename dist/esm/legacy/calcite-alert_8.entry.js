...
import { d as h, e as registerInstance, f as createEvent, g as Host, h as getElement } from './calcite-8e778405.js';
...
var CalciteModal = /** @class */ (function () {
    ...
    Object.defineProperty(CalciteModal, "style", {
        get: function () { return "body{font-family:Avenir Next W01,Avenir Next W00,Avenir Next,Avenir,Helvetica Neue,sans-serif}calcite-tabs{display:block}.example-class{padding:1.5rem;color:#d83020;-webkit-box-shadow:0 0 16px 0 rgba(0,0,0,.05);box-shadow:0 0 16px 0 rgba(0,0,0,.05);border:1px solid #007ac2}"; },
        enumerable: true,
        configurable: true
    });
    return CalciteModal;
...
var CalciteTab = /** @class */ (function () {
    ...
    CalciteTab.prototype.tabChangeHandler = function (event) {
        var _this = this;
        if (!nodeListToArray(event.target.parentNode.children).some(function (child) { return child == _this.el; })) {
            return;
        }
        if (this.tab) {
...
var CalciteTabTitle = /** @class */ (function () {
    function CalciteTabTitle(hostRef) {
        registerInstance(this, hostRef);
        this.id = "calcite-tab-title-" + guid();
        this.isActive = false;
    ...
    CalciteTabTitle.prototype.setControlledBy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.controls = id;
                return [2 /*return*/];
