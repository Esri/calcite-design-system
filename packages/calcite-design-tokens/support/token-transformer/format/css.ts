import sd, { Core as StyleDictionary, Dictionary, File, Platform, Options } from "style-dictionary";

const { formatHelpers } = sd;

/**
 * Exports CSS style formats
 *
 ...
 */
export function formatCSSFunction(fileInfo: {
...
export function registerCSSFormat(sd: StyleDictionary): void {
  sd.registerFormat({
    name: formatCSS,
    formatter: formatCSSFunction,
  });
}

export const formatCSS = "calcite/css";
