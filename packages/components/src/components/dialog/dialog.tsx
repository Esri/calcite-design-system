 ...
 * @slot description - A slot for adding content to the description area of the component's default header. Takes precedence over the `description` property.
 * @slot heading - A slot for adding content to the heading area of the component's default header. Takes precedence over the `heading` property.
