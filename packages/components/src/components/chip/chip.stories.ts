...
export const overriddenDeprecatedIconColor = (): string =>
  html`<calcite-chip icon="banana" style="--calcite-ui-icon-color: blue" label="Banana" closable>Banana</calcite-chip>`;
