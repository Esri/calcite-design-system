...
export class InputDatePicker extends LitElement implements FloatingUIComponent, LabelableComponent {
  ...
  override willUpdate(changes: PropertyValues<this>): void {
    ...
    if ((minSource || maxSource) && !Array.isArray(this.valueAsDate)) {
      const validValueAsDate = dateFromRange(
        this.valueAsDate,
        this.minAsDate ?? null,
        this.maxAsDate ?? null,
      );
  ...
  private valueAsDateWatcher(valueAsDate: Date | (Date | null)[] | undefined): void {
  ...
  private calciteInternalInputInputHandler(event: CustomEvent<any>): void {
    ...
    if (inRange(date ?? null, this.min ?? null, this.max ?? null)) {
  ...
  private setRangeValue(valueAsDate: (Date | undefined)[]): void {
    ...
    this.value = newValue;
    this.valueAsDate = newValue ? (getValueAsDateRange(newValue) ?? undefined) : undefined;
