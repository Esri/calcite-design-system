...
type SheetStoryArgs = Pick<Sheet, "open" | "position" | "displayMode" | "resizable" | "heading">;
...
export const resizable = (): string =>
  html`<calcite-sheet resizable label="libero nunc" open position="inline-start" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const resizableRTL = (): string =>
  html`<calcite-sheet dir="rtl" resizable label="libero nunc" open position="inline-start" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const resizableWithDropdown = (): string =>
  html`<calcite-sheet width="s" resizable label="libero nunc" open position="inline-start" heading="Map">
      ...
      </calcite-dropdown></calcite-sheet
    >
    <script>
...
export const resizableBlockStart = (): string =>
  html`<calcite-sheet resizable label="libero nunc" open position="block-start" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const resizableFloatInlineStart = (): string =>
  html`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="inline-start" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const resizableFloatInlineEnd = (): string =>
  html`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="inline-end" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const resizableFloatBlockStart = (): string =>
  html`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="block-start" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const resizableFloatBlockEnd = (): string =>
  html`<calcite-sheet display-mode="float" resizable label="libero nunc" open position="block-end" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;
...
export const inlineStartFloat_TestOnly = (): string =>
  html`<calcite-sheet label="libero nunc" open position="inline-start" display-mode="float" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const blockStartFloat_TestOnly = (): string =>
  html`<calcite-sheet label="libero nunc" open position="block-start" display-mode="float" heading="Heading"
    >${panelHTML}</calcite-sheet
  >`;

export const inlineStart_TestOnly = (): string =>
  html`<calcite-sheet label="libero nunc" open position="inline-start" heading="Heading">${panelHTML}</calcite-sheet>`;

export const inlineEnd_TestOnly = (): string =>
  html`<calcite-sheet label="libero nunc" open position="inline-end" heading="Heading">${panelHTML}</calcite-sheet>`;

export const blockStart_TestOnly = (): string =>
  html`<calcite-sheet label="libero nunc" open position="block-start" heading="Heading">${panelHTML}</calcite-sheet>`;

export const blockEnd_TestOnly = (): string =>
  html`<calcite-sheet label="libero nunc" open position="block-end" heading="Heading">${panelHTML}</calcite-sheet>`;

export const darkModeFloatRTL_TestOnly = (): string =>
  html`<div dir="rtl">
    <calcite-sheet label="libero nunc" open position="inline-start" display-mode="float" heading="Heading"
      >${panelHTML}</calcite-sheet
    >
  </div>`;
