 ...
 * @mdn [Microtask Guide - In Depth](https://developer.mozilla.org/en-US/docs/Web/API/HTML_DOM_API/Microtask_guide/In_depth)
 */
 ...
 *
 * @mdn [Microtask Guide - Event Loops](https://developer.mozilla.org/en-US/docs/Web/API/HTML_DOM_API/Microtask_guide/In_depth#event_loops)
 */
 ...
 *
 * @mdn [Microtask Guide - Tasks](https://developer.mozilla.org/en-US/docs/Web/API/HTML_DOM_API/Microtask_guide#tasks)
 */
