...
export const tabs = html`
  ...
  <calcite-tabs position="bottom" style="--calcite-tab-icon-start-color: purple">
  ...
  <calcite-tabs position="top" style="--calcite-tab-icon-end-color: purple">
    <calcite-tab-nav slot="title-group">
      <calcite-tab-title closable icon-start="arrow-left" icon-end="arrow-right" selected
        >Tab 1 Title
      </calcite-tab-title>
...
export const tabsBordered = html`
  ...
  <calcite-tabs bordered position="bottom" style="--calcite-tab-icon-start-color: purple">
    <calcite-tab-nav slot="title-group">
      <calcite-tab-title closable icon-start="arrow-left" icon-end="arrow-right" selected
        >Tab 1 Title
      </calcite-tab-title>
