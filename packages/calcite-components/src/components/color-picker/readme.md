...
| Name                                              | Description                                                          |
| ------------------------------------------------- | -------------------------------------------------------------------- |
| `--calcite-color-picker-button-corner-radius`     | defines the button in the component's corner radius.                 |
| `--calcite-color-picker-button-loader-color`      | defines the button in the component's loader color.                  |
| `--calcite-color-picker-button-text-color`        | defines the button in the component's text color.                    |
| `--calcite-color-picker-button-text-color-active` | defines the button in the component's text color in an active state. |
| `--calcite-color-picker-button-text-color-focus`  | defines the button in the component's text color in a focus state.   |
| `--calcite-color-picker-button-text-color-hover`  | defines the button in the component's text color in a hover state.   |
| `--calcite-color-picker-tabs-background-color`    | The background color of the sub-component.                           |
| `--calcite-color-picker-tabs-border-color`        | The border color of the sub-component.                               |
