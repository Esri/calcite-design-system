    ...
    Omit<TextualInputComponent, "pattern">
{
  ...
  /**
   * TODO: [MIGRATION] the codemod converted this Stencil \@Watch() to attribute watcher because it didn't find the following properties in your component: autofocus.
   ...
   */
  attributeWatch = useWatchAttributes(["autofocus"], this.handleGlobalAttributesChanged);
