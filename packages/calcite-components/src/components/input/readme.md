...
| `--calcite-input-progress-background-color`     | Defines the background color of the progress sub-component.                  |
| `--calcite-input-progress-fill-color`           | Defines the background color of the progress sub-component bar.              |
| `--calcite-input-progress-text-color`           | Defines the text color of the progress sub-component.                        |
