...
| Name                                             | Description                                                  |
| ------------------------------------------------ | ------------------------------------------------------------ |
| `--calcite-table-button-background-color`        | defines the component's background color.                    |
| `--calcite-table-button-background-color-active` | defines the component's background color in an active state. |
| `--calcite-table-button-background-color-hover`  | defines the component's background color in a hover state.   |
| `--calcite-table-button-corner-radius`           | defines the component's corner radius.                       |
| `--calcite-table-button-text-color`              | defines the component's text color.                          |
| `--calcite-table-button-text-color-active`       | defines the component's text color in an active state.       |
| `--calcite-table-button-text-color-focus`        | defines the component's text color in a focus state.         |
| `--calcite-table-button-text-color-hover`        | defines the component's text color in a hover state.         |
