...
For complete usage and implementation guidance on the `calcite-menu-item` component, visit Calcites [documentation page](https://developers.arcgis.com/calcite-design-system/components/menu-item/).
