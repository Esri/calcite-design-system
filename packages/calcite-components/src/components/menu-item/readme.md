...
For complete usage and implementation guidance for `calcite-menu-item`, refer to the [documentation page](https://developers.arcgis.com/calcite-design-system/components/menu-item/).
