    ...
    return (
      <Host onBlur={this.resetActiveDates} onKeyDown={this.keyDownHandler}>
        <div class="container">
          <div class="start">
            {this.renderCalendar(
              this.getStartCalendarActiveDate(activeDate),
              maxStartDate,
              minStartDate,
              date,
              endDate,
          ...
          <div class="end">
            {this.range &&
              this.renderCalendar(
                this.getEndCalendarActiveDate(activeDate),
                maxEndDate,
                minEndDate,
                date,
                endDate,
  ...
  monthHeaderSelectChange = (event: CustomEvent<Date>): void => {
    ...
    if (!this.range) {
      ...
      if (target.position === "end") {
        ...
        this.activeEndDate = this.activeEndDate ? prevMonth(this.activeEndDate) : nextMonth(date);
      }
