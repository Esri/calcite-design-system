...
export default {
  ...
  parameters: {
    chromatic: {
      ...
      diffThreshold:
        Number(
          /* TODO: [MIGRATION] Unknown env variable. See https://qawebgis.esri.com/arcgis-components/?path=/docs/references-lumina-publishing--docs#bundling-code-conditionally for docs on what env variables are available and how to define additional */ import.meta
