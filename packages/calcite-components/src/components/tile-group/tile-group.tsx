  ...
  implements InteractiveComponent, SelectableGroupComponent
{
   ...
   * Otherwise, read the documentation about required properties: https://qawebgis.esri.com/arcgis-components/?path=/docs/references-lumina-properties--docs#string-properties
   *
   * @required
   */
  ...
  override willUpdate(changes: PropertyValues<this>): void {
    ...
    if (
      ...
      this.handleSelectionModeOrAppearanceChange();
    }
  }
  ...
  private scaleWatcher(): void {
    this.updateTiles();
  }

  private handleSelectionModeOrAppearanceChange(): void {
    this.updateTiles();
  }
