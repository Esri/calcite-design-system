...
| `--calcite-button-background-color-active` | defines the component's background color in an active state.           |
| `--calcite-button-background-color-hover`  | defines the component's background color in a hover state.             |
| `--calcite-button-border-color`            | defines the component's border color.                                  |
| `--calcite-button-border-color-active`     | defines the component's border color in an active state.               |
| `--calcite-button-border-color-focus`      | defines the component's border color in a focus state.                 |
| `--calcite-button-border-color-hover`      | defines the component's border color in a hover state.                 |
...
| `--calcite-button-icon-color-active`       | defines the color of an icon in the component when in an active state. |
| `--calcite-button-icon-color-focus`        | defines the color of an icon in the component when in a focused state. |
| `--calcite-button-icon-color-hover`        | defines the color of an icon in the component when in a hover state.   |
| `--calcite-button-loader-color`            | defines the component's loader color.                                  |
| `--calcite-button-shadow`                  | defines the component's shadow.                                        |
| `--calcite-button-shadow-active`           | defines the component's shadow color in an active state.               |
| `--calcite-button-shadow-focus`            | defines the component's shadow color in a focus state.                 |
| `--calcite-button-shadow-hover`            | defines the component's shadow color in a hover state.                 |
| `--calcite-button-text-color`              | defines the component's text color.                                    |
| `--calcite-button-text-color-active`       | defines the component's text color in an active state.                 |
| `--calcite-button-text-color-focus`        | defines the component's text color in a focus state.                   |
| `--calcite-button-text-color-hover`        | defines the component's text color in a hover state.                   |
