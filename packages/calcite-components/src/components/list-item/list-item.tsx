  ...
  implements InteractiveComponent, LoadableComponent, SortableComponentItem
{
  ...
  private actionsEndEl = createRef<HTMLTableCellElement>();

  private actionsStartEl = createRef<HTMLTableCellElement>();

  private containerEl = createRef<HTMLTableRowElement>();

  private contentEl = createRef<HTMLTableCellElement>();

  private defaultSlotEl = createRef<HTMLSlotElement>();

  private handleGridEl = createRef<HTMLTableCellElement>();
