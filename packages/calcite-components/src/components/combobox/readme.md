...
| Name                                              | Description                                                      |
| ------------------------------------------------- | ---------------------------------------------------------------- |
| `--calcite-combobox-background-color`             | defines the background color of the component                    |
| `--calcite-combobox-border-color`                 | defines the border color of the component                        |
| `--calcite-combobox-chip-background-color-active` | defines the background color of a chip sub-component when active |
| `--calcite-combobox-input-height`                 | [Deprecated] Specifies the height of the component's input.      |
| `--calcite-combobox-text-color`                   | defines the text color of the component                          |
