...
For complete usage and implementation guidance on the `calcite-block-section` component, visit Calcites [documentation page](https://developers.arcgis.com/calcite-design-system/components/block-section/).
