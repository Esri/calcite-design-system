...
export class ActionBar extends LitElement implements LoadableComponent {
  ...
  override willUpdate(changes: PropertyValues<this>): void {
    ...
    if (
      ...
      this.overflowDisabledHandler(this.overflowActionsDisabled);
    }
  }
  ...
  private overflowDisabledHandler(overflowActionsDisabled: boolean): void {
  ...
  private handleDefaultSlotChange(event: Event): void {
    const groups = slotChangeGetAssignedElements(event).filter((el): el is ActionGroup["el"] =>
