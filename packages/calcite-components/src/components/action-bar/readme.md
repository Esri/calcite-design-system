...
| `messageOverrides`        | --                          | Use this property to override individual strings used by the component.                                                                                                                                                                                                                                                                                                     | `{ expand?: string; collapse?: string; expandLabel?: string; collapseLabel?: string; }` | `undefined`  |
