...
For complete usage and implementation guidance on the `calcite-loader` component, visit Calcites [documentation page](https://developers.arcgis.com/calcite-design-system/components/loader/).
