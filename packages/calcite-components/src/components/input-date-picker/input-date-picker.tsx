    ...
    OpenCloseComponent
{
  ...
  override willUpdate(changes: PropertyValues<this>): void {
    ...
    if (
      ...
      (changes.has("focusedInput") && (this.hasUpdated || this.focusedInput !== "start"))
    ) {
      this.setReferenceEl();
    }
  ...
  private valueAsDateWatcher(valueAsDate: Date | Date[]): void {
    ...
    const newValue =
      this.range && Array.isArray(valueAsDate)
        ...
        : dateToISO(Array.isArray(valueAsDate) ? valueAsDate[0] : valueAsDate);
  ...
  private calciteDaySelectHandler(): void {
