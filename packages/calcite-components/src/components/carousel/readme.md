...
| `controlOverlay`     | `control-overlay`    | control if the dot / bar and arrows are overlaid on the slotted content container or displayed adjacent to the slotted content | `boolean`                                                                                                            | `undefined` |
| `controlAppearance`  | `control-appearance` | control if the displayed control are dot, or bar                                                                               | `"circle" \| "square"`                                                                                               | `"circle"`  |
