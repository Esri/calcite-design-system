...
| `messageOverrides`   | --                  | Use this property to override individual strings used by the component.                                                                                                          | `{ previous?: string; next?: string; play?: string; pause?: string; carousel?: string; carouselItemProgress?: string; }` | `undefined` |
