...
describe("calcite-pick-list-item", () => {
  ...
  it("should toggle selected attribute when clicked", async () => {
    const page = await newE2EPage(`<calcite-pick-list-item label="test"></calcite-pick-list-item>`);
  ...
  it("should toggle selected attribute when icon is clicked", async () => {
    const page = await newE2EPage(`<calcite-pick-list-item label="test" icon="circle"></calcite-pick-list-item>`);
  ...
  it("should fire event calciteListItemChange when item is clicked", async () => {
    const page = await newE2EPage(`<calcite-pick-list-item label="test" value="example"></calcite-pick-list-item>`);
    const item = await page.find("calcite-pick-list-item");
    await page.evaluate(() => {
  ...
  it("allows for easy removal", async () => {
    const page = await newE2EPage(
      `<calcite-pick-list-item label="test" value="example" removable></calcite-pick-list-item>`,
    );
