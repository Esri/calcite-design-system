...
For complete usage and implementation guidance on the `calcite-pick-list-item` component, refer to the [documentation page](https://developers.arcgis.com/calcite-design-system/components/pick-list-item/).
