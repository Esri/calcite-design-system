...
| `--calcite-input-button-background-color`       | defines the background color of a button in the component.                   |
| `--calcite-input-button-background-color-hover` | defines the background color of a button in the component when it's hovered. |
| `--calcite-input-button-border-color`           | defines the border color of a button in the component.                       |
| `--calcite-input-button-icon-color`             | defines the icon color of a button in the component.                         |
| `--calcite-input-button-icon-color-active`      | defines the icon color of a button in the component when it's active.        |
| `--calcite-input-button-icon-color-hover`       | defines the icon color of a button in the component when it's hovered.       |
| `--calcite-input-corner-radius`                 | defines the corner radius of the component.                                  |
| `--calcite-input-icon-color`                    | defines the icon color of the component.                                     |
| `--calcite-input-placeholder-text-color`        | defines the color of placeholder text in the component.                      |
| `--calcite-input-prefix-background-color`       | defines the background color of the prefix sub-component.                    |
| `--calcite-input-prefix-text-color`             | defines the text color of the prefix sub-component.                          |
| `--calcite-input-shadow`                        | defines the shadow of the component.                                         |
| `--calcite-input-suffix-background-color`       | defines the background color of the suffix sub-component.                    |
| `--calcite-input-suffix-text-color`             | defines the text color of the suffix sub-component.                          |
