...
import { assertCaretPosition, getElementRect, getElementXY, selectText } from "../../tests/utils";
...
describe("calcite-input-number", () => {
  ...
  describe("theme", () => {
    describe("default", () => {
      ...
      themed(`calcite-input-number`, tokens);
    });
    describe("clearable", () => {
      const tokens: ComponentTestTokens = {
      ...
      themed(html`<calcite-input-number value="test" clearable />`, tokens);
    });
    describe("loading", () => {
      const tokens: ComponentTestTokens = {
      ...
      themed(html`<calcite-input-number loading />`, tokens);
    });
    describe("prefix and suffix", () => {
      ...
      themed(html`<calcite-input-number prefix-text="prefix" suffix-text="suffix" />`, tokens);
    });
  });
});
