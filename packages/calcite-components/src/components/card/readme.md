...
For complete usage and implementation guidance on the `calcite-card` component, refer to the [documentation page](https://developers.arcgis.com/calcite-design-system/components/card/).
