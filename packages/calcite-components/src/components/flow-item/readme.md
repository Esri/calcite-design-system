...
| `--calcite-flow-item-action-background-color-active` | defines the background color of an action sub-component is active inside the component.                       |
| `--calcite-flow-item-action-background-color-hover`  | defines the background color of an action sub-component is hovered or focused inside the component.           |
| `--calcite-flow-item-background-color`               | Specifies the background color of the component.                                                              |
| `--calcite-flow-item-border-color`                   | Specifies the border color of the component.                                                                  |
| `--calcite-flow-item-description-text-color`         | Specifies the text color of the component's description.                                                      |
| `--calcite-flow-item-fab-z-index`                    | Specifies the component fab's z-index.                                                                        |
| `--calcite-flow-item-footer-background-color`        | Specifies the background color of the component's footer.                                                     |
| `--calcite-flow-item-footer-padding`                 | [Deprecated] Use `--calcite-flow-item-footer-space` instead. Specifies the padding of the component's footer. |
| `--calcite-flow-item-footer-space`                   | Specifies the spacing of the component's footer.                                                              |
| `--calcite-flow-item-header-background-color`        | Specifies the component header's background color.                                                            |
| `--calcite-flow-item-header-border-block-end`        | [Deprecated] No longer necessary. Specifies the component header's block end border.                          |
| `--calcite-flow-item-header-z-index`                 | Specifies the component header's z-index.                                                                     |
| `--calcite-flow-item-heading-text-color`             | Specifies the component's heading text color.                                                                 |
