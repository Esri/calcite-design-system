...
For complete usage and implementation guidance for `calcite-dropdown-item`, refer to the [documentation page](https://developers.arcgis.com/calcite-design-system/components/dropdown-item/).
