...
export const customLabelsAndTicks = (): string => html`
  ...
  <div class="container">
    ...
    <div class="side">
      ...
      <label>Label formatter (single value + long label)</label>
      <calcite-slider
        class="singleFormattedLongLabelSlider"
        label-handles
        label-ticks
        layout="vertical"
        style="margin-top: 6.25rem"
  ...
  <script>
    ...
    const singleValueLongLabelSlider = document.querySelectorAll(".singleFormattedLongLabelSlider");

    singleValueLongLabelSlider.forEach((e, i) => {
      e.labelFormatter = function (value) {
        return "long " + value + " label";
      };
    });

    const minMaxValueLongLabelSlider = document.querySelectorAll(".minMaxFormattedLongLabelSlider");

    minMaxValueLongLabelSlider.forEach((e, i) => {
      e.labelFormatter = function (value) {
        return "long " + value + " label";
      };
    });
