...
const config: Omit<Config, "content"> = {
  theme: {
    ...
    extend: {
      ...
      spacing: {
        0: "var(--calcite-space-none)",
        px: "var(--calcite-space-px)",
        0.5: "var(--calcite-space-3xs)",
        1: "var(--calcite-space-2xs)",
        ...
        5: "var(--calcite-space-xl)",
        6: "var(--calcite-space-2xl)",
        8: "var(--calcite-space-3xl)",
        9: "2.25rem",
        10: "var(--calcite-space-4xl)",
        11: "var(--calcite-space-4xl-plus)",
        12: "var(--calcite-space-5xl)",
        13: "var(--calcite-space-5xl-plus)",
      },
      transitionProperty: {
        margin: "margin",
        color: "color",
