...
| Name          | CSS                                          | SCSS                                           |
| ------------- | -------------------------------------------- | ---------------------------------------------- |
| Semantic      | @esri/calcite-design-tokens/css/semantic.css | @esri/calcite-design-tokens/scss/semantic.scss |
| Calcite Light | @esri/calcite-design-tokens/css/light.css    | @esri/calcite-design-tokens/scss/light.scss    |
| Calcite Dark  | @esri/calcite-design-tokens/css/dark.css     | @esri/calcite-design-tokens/scss/dark.scss     |
