...
```css
@import "@esri/calcite-design-tokens/css/semantic";
...
| Name          | CSS                                                                      | SCSS                                                                       |
| ------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| Semantic      | @esri/calcite-design-tokens/css @esri/calcite-design-tokens/css/semantic | @esri/calcite-design-tokens/scss @esri/calcite-design-tokens/scss/semantic |
