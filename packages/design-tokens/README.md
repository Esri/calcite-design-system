...
| -------- | --------------------------------------- | ------------------------------------------------- | --------------------------------------------------- |
| index    | all semantic tokens                     | @esri/calcite-design-tokens/dist/css/index.css    | @esri/calcite-design-tokens/dist/scss/index.scss    |
| semantic | semantic tokens (no color)              | @esri/calcite-design-tokens/dist/css/semantic.css | @esri/calcite-design-tokens/dist/scss/semantic.scss |
