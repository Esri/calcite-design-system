...
const config: Config = {
  source: ["src/tokens/semantic/color/light.json", "src/tokens/theme/color/light.json"],
  include: ["src/tokens/semantic/color/light.json", "src/tokens/theme/color/light.json", "src/tokens/core/[!$]*.json"],
