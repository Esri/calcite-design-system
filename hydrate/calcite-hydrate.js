...
class CalciteButton {
    ...
    render() {
        ...
        if (this.iconposition === "start") {
            return (h(Host, { dir: dir, hastext: this.hastext }, h(Tag, Object.assign({}, attributes, { role: role, disabled: this.disabled }), loader, icon, h("slot", null))));
        }
        else if (this.iconposition === "end") {
            return (h(Host, { dir: dir, hastext: this.hastext }, h(Tag, Object.assign({}, attributes, { role: role, disabled: this.disabled }), loader, h("slot", null), icon)));
        }
        else {
            h(Host, { dir: dir, hastext: this.hastext }, h(Tag, Object.assign({}, attributes, { role: role, disabled: this.disabled }), loader, h("slot", null)));
        }
    }
    get el() { return getElement(this); }
    static get cmpMeta() { return {
