...
const chevronRight16F = "M10.217 8l-6-6h2.766l6 6-6 6H4.217z";
...
class CalciteRadioGroupItem {
    ...
    render() {
        ...
        return (h(Host, { role: "radio", "aria-checked": checked ? "true" : "false" }, h("label", null, this.hasLabel ? h("slot", null) : value, h("slot", { name: "input" }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
class CalciteTreeItem {
    ...
    render() {
        const dir = getElementDir(this.el);
        const icon = this.hasChildren ? (h("svg", { class: "calcite-tree-chevron", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 16 16" }, h("path", { d: chevronRight16F }))) : (h("svg", { class: "calcite-tree-indicator", height: "16", width: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" }, h("circle", { cx: "8", cy: "8", r: "3" })));
