...
class CalciteDropdownItem {
    ...
    render() {
        ...
        return (h(Host, { theme: theme, dir: dir, scale: scale, tabindex: "0", role: "menuitem", "aria-selected": this.active.toString(), isLink: this.href }, contentEl));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
class CalcitePopover {
    ...
    render() {
        ...
        const arrowNode = !disablePointer ? (h("div", { class: CSS$2.arrow, ref: arrowEl => (this.arrowEl = arrowEl) })) : null;
        return (h(Host, { role: "dialog", class: {
                [HOST_CSS.hydratedInvisible]: !displayed
            }, "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, arrowNode, h("div", { class: CSS$2.container }, this.renderImage(), h("div", { class: CSS$2.content }, h("slot", null), this.renderCloseButton()))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
class CalciteTooltip {
    ...
    render() {
        ...
        return (h(Host, { role: "tooltip", class: {
                [HOST_CSS.hydratedInvisible]: !displayed
            }, "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, h("div", { class: CSS$3.arrow, ref: arrowEl => (this.arrowEl = arrowEl) }), h("div", { class: CSS$3.container }, h("slot", null))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "offsetDistance": ["offsetDistanceOffsetHandler"],
