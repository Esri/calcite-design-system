...
declare namespace LocalJSX {
  ...
  interface CalciteConfig extends JSXBase.HTMLAttributes {
    'theme'?: "light" | "dark";
  }
...
declare global {
  ...
  interface HTMLCalciteConfigElement extends Components.CalciteConfig, HTMLStencilElement {}
  var HTMLCalciteConfigElement: {
    prototype: HTMLCalciteConfigElement;
    new (): HTMLCalciteConfigElement;
  };
  ...
  interface HTMLElementTagNameMap {
    ...
    'calcite-config': HTMLCalciteConfigElement;
