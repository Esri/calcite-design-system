...
| `timePickerScale`  | `time-picker-scale`  | Scale of the time-picker rendered in the input popover. Default's to `scale`         | `"l" \| "m" \| "s"`                         | `undefined` |
| `placement`        | `placement`          | Determines where the time-picker component will be positioned relative to the input. | `Placement \| PlacementRtl \| VariationRtl` | `"auto"`    |
