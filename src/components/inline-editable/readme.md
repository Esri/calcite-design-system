...
| `intlCancelEditing`  | `intl-cancel-editing`  | <span style="color:red">**[DEPRECATED]**</span> – translations are now built-in, if you need to override a string, please use `messageOverrides`.<br/><br/>Accessible name for the component's cancel editing button. | `string`              | `undefined` |
| `intlConfirmChanges` | `intl-confirm-changes` | <span style="color:red">**[DEPRECATED]**</span> – translations are now built-in, if you need to override a string, please use `messageOverrides`.<br/><br/>Accessible name for the component's confirm edits button.  | `string`              | `undefined` |
| `intlEnableEditing`  | `intl-enable-editing`  | <span style="color:red">**[DEPRECATED]**</span> – translations are now built-in, if you need to override a string, please use `messageOverrides`.<br/><br/>Accessible name for the component's enable editing button. | `string`              | `undefined` |
