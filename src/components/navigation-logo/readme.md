...
| `subtext`     | `subtext`      | Specifies the subtext to display, such as an organization or application description.                                                     | `string`  | `undefined` |
| `text`        | `text`         | Specifies the text to display, such as a product name.                                                                                    | `string`  | `undefined` |
| `textEnabled` | `text-enabled` | When `true`, displays the `text` and `subText` contents.                                                                                  | `boolean` | `false`     |
