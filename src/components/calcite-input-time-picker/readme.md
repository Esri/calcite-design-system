...
| ------------------- | --------------------- | ---------------------------------------------------------------------------------------------- | ------------------- | ----------- |
| `active`            | `active`              | The active state of the time input. When true, the time input popup is displayed.              | `boolean`           | `false`     |
| `disabled`          | `disabled`            | The disabled state of the time input                                                           | `boolean`           | `false`     |
| `guid`              | `guid`                | The id attribute of the input time picker. When omitted, a globally unique identifier is used. | `string`            | `undefined` |
