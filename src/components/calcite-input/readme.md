...
| ------------------ | -------------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| `alignment`        | `alignment`          | specify the alignment of the value of the input                     | `"end" or "start"`                                                                                                                                                                     | `"start"`    |
...
| `icon`             | `icon`               | for recognized input types, show an icon if applicable              | `boolean or string`                                                                                                                                                                    | `false`      |
| `loading`          | `loading`            | specify if the input is in loading state                            | `boolean`                                                                                                                                                                              | `false`      |
| `numberButtonType` | `number-button-type` | specify the placement of the number buttons                         | `"horizontal" or "none" or "vertical"`                                                                                                                                                 | `"vertical"` |
...
| `theme`            | `theme`              | specify the alignment of dropdown, defaults to left                 | `"dark" or "light"`                                                                                                                                                                    | `undefined`  |
| `type`             | `type`               | specify the input type                                              | `"color" or "date" or "datetime-local" or "email" or "file" or "image" or "month" or "number" or "password" or "search" or "tel" or "text" or "textarea" or "time" or "url" or "week"` | `"text"`     |
