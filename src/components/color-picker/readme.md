...
| `appearance`       | `appearance`        | Specifies the appearance style of the component - `"solid"` (containing border) or `"minimal"` (no containing border).                                                                                                                                                                                         | `"default" \| "minimal" \| "solid"`                                                                                                                                                                                                     | `"solid"`       |
