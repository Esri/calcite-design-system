...
| `selectionMode` | `selection-mode` |                                                                                                                                                                             | `TreeSelectionMode.Children \| TreeSelectionMode.Multi \| TreeSelectionMode.MultiChildren \| TreeSelectionMode.None \| TreeSelectionMode.Single` | `TreeSelectionMode.Single` |
| `size`          | `size`           |                                                                                                                                                                             | `"m" \| "s"`                                                                                                                                     | `"m"`                      |
