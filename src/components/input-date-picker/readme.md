...
| `calciteInputDatePickerBeforeClose` |                                                                                                                                                                      | `CustomEvent<void>`            |
| `calciteInputDatePickerBeforeOpen`  |                                                                                                                                                                      | `CustomEvent<void>`            |
| `calciteInputDatePickerChange`      | This event fires when the input date picker value changes.                                                                                                           | `CustomEvent<void>`            |
| `calciteInputDatePickerClose`       |                                                                                                                                                                      | `CustomEvent<void>`            |
| `calciteInputDatePickerOpen`        |                                                                                                                                                                      | `CustomEvent<void>`            |
