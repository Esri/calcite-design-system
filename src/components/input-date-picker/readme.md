...
| `messageOverrides`           | --                             | Use this property to override individual strings used by the component.                                                                                                                                                                                                                                                                                                     | `{ chooseDate?: string; nextMonth?: string; prevMonth?: string; year?: string; }`                                                                                                                                                       | `undefined`            |
