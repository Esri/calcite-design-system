...
| `datePickerScale`            | `date-picker-scale`            | Scale of the calcite-date-picker rendered in the input popover. Default's to `scale`                                               | `"l" \| "m" \| "s"`                         | `undefined`                               |
| `placement`                  | `placement`                    | Determines where the date-picker component will be positioned relative to the input.                                               | `Placement \| PlacementRtl \| VariationRtl` | `"bottom-leading"`                        |
