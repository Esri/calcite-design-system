...
| `placement`                     | `placement`          | Determines where the component will be positioned relative to the referenceElement.        | `"left" \| "right" \| "auto" \| "top" \| "bottom" \| "auto-start" \| "auto-end" \| "top-start" \| "top-end" \| "right-start" \| "right-end" \| "bottom-end" \| "bottom-start" \| "left-end" \| "left-start" \| "leading-start" \| "leading" \| "leading-end" \| "trailing-end" \| "trailing" \| "trailing-start"` | `"auto"`    |
