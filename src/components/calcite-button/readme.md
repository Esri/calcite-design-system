...
| ------------- | --------------- | -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `alignment`   | `alignment`     | specify the alignment of button elements, defaults to center.                                      | `"start" \| "end" \| "center" \| "space-between" \| "icon-start-space-between" \| "icon-end-space-between"` | `center`    |
