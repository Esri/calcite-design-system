...
| -------------- | --------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------- |
| `appearance`   | `appearance`    | specify the appearance style of the button, defaults to solid.                                     | `"clear" or "outline" or "solid" or "transparent"` | `"solid"`   |
...
| `theme`        | `theme`         | Select theme (light or dark)                                                                       | `"dark" or "light"`                                | `"light"`   |
