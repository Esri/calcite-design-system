...
| `closable`                      | `closable`            | When true, display a close button within the Popover                                                                                                                                                                                                                                                                                                                                      | `boolean`                                                                 | `false`                   |
...
| `placement`                     | `placement`           | Determines where the component will be positioned relative to the `referenceElement`.                                                                                                                                                                                                                                                                                                     | `Placement \| AutoPlacement \| VariationPlacement \| DeprecatedPlacement` | `defaultPopoverPlacement` |
