...
| `intlClear`        | `intl-clear`         | <span style="color:red">**[DEPRECATED]**</span> – translations are now built-in, if you need to override a string, please use `messageOverrides`.<br/><br/>Accessible name for the component's clear button.              | `string`                                                                                                                                                                                                                                | `undefined`  |
