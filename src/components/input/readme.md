...
| `intlLoading`      | `intl-loading`       | string to override English loading text                                                                                                                                                                                                      | `string`                                                                                                                                                                               | `COMMON_TEXT.loading`                     |
...
| `numberingSystem`  | `numbering-system`   | standard UniCode numeral system tag for localization                                                                                                                                                                                         | `string`                                                                                                                                                                               | `undefined`                               |
