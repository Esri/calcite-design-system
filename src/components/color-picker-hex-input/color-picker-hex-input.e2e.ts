...
describe("calcite-color-picker-hex-input", () => {
  ...
  it("supports no color", async () => {
    ...
    await page.setContent(html`<calcite-color-picker-hex-input allow-empty></calcite-color-picker-hex-input>`);
  ...
  it("accepts shorthand hex", async () => {
    const page = await newE2EPage();
    await page.setContent(html`<calcite-color-picker-hex-input></calcite-color-picker-hex-input>`);
  ...
  it("accepts shorthand hexa", async () => {
    const page = await newE2EPage();
    await page.setContent(html`<calcite-color-picker-hex-input alpha-channel></calcite-color-picker-hex-input>`);
  ...
  it("normalizes value when initialized", async () => {
    const page = await newE2EPage();
    await page.setContent(html`<calcite-color-picker-hex-input value="#f0f"></calcite-color-picker-hex-input>`);
    const input = await page.find(`calcite-color-picker-hex-input`);
  ...
  it("normalizes hexa value when initialized", async () => {
    ...
    await page.setContent(
      html`<calcite-color-picker-hex-input alpha-channel value="#f0f0"></calcite-color-picker-hex-input>`
    );
    const input = await page.find(`calcite-color-picker-hex-input`);
  ...
  it("ignores invalid hexa", async () => {
    ...
    const page = await newE2EPage();
    await page.setContent(
      html`<calcite-color-picker-hex-input alpha-channel value="${hex}"></calcite-color-picker-hex-input>`
    );
    const input = await page.find(`calcite-color-picker-hex-input`);
  ...
  it("emits event when color changes via user and not programmatically", async () => {
    const page = await newE2EPage();
    await page.setContent(html`<calcite-color-picker-hex-input value="#b33f33"></calcite-color-picker-hex-input>`);
  ...
  it("prevents entering chars if invalid hexa chars or it exceeds max hexa length", async () => {
    const page = await newE2EPage();
    await page.setContent(
      html`<calcite-color-picker-hex-input alpha-channel value="#b33f33"></calcite-color-picker-hex-input>`
    );
    const input = await page.find("calcite-color-picker-hex-input");
    ...
    describe("when color value is required", () => {
      ...
      describe("hexa", () => {
        ...
        beforeEach(async () => {
          page = await newE2EPage();
          await page.setContent(
            html`<calcite-color-picker-hex-input alpha-channel value=${startingHexa}></calcite-color-picker-hex-input>`
          );
