...
| `intlHex`         | `intl-hex`         | Accessible name for the Hex input.                                                                                                                                                                                                                                                                             | `string`                                                                                                                                                                                                                                | `TEXT.hex`                          |
| `intlNoColor`     | `intl-no-color`    | Accessible name for the Hex input when there is no color selected.                                                                                                                                                                                                                                             | `string`                                                                                                                                                                                                                                | `TEXT.noColor`                      |
