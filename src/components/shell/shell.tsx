 ...
 * @slot shell-panel-start - A slot for adding the starting `calcite-shell-panel`.
 * @slot shell-panel-end - A slot for adding the ending `calcite-shell-panel`.
  ...
  renderMain(): VNode {
    ...
    return (
      <div class={mainClasses}>
        ...
        <slot name={SLOTS.shellPanelStart} />
        {this.renderContent()}
        <slot name={SLOTS.shellPanelEnd} />
