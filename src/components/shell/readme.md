...
```html
<calcite-shell>
  <calcite-shell-panel slot="shell-panel-start" position="start" detached>
   ...
   <calcite-shell-panel slot="shell-panel-end" position="end" detached height-scale="l">
      <calcite-action-bar slot="action-bar">
        <calcite-action-group>
...
```html
<calcite-shell>
  <calcite-shell-panel slot="shell-panel-start" position="start">
...
<calcite-shell>
  ...
  <calcite-shell-panel slot="shell-panel-end" position="end"> Trailing panel! (right side) </calcite-shell-panel>
