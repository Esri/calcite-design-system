...
describe("calcite-shell", () => {
  ...
  it("should be accessible", async () =>
    accessible(`
    <calcite-shell>
      <calcite-shell-panel slot="${SLOTS.shellPanelStart}" position="start">
        <p>Primary Content</p>
      </calcite-shell-panel>
      <calcite-shell-panel slot="${SLOTS.shellPanelEnd}" position="end">
        <p>Primary Content</p>
      </calcite-shell-panel>
    </calcite-shell>
    `));
  ...
  it("should place content behind", async () => {
    ...
    <calcite-shell-panel slot="${SLOTS.shellPanelStart}" position="end">
      <p>Primary Content</p>
    </calcite-shell-panel>
    <calcite-shell-panel slot="${SLOTS.shellPanelEnd}" position="start">
      <p>Primary Content</p>
    </calcite-shell-panel>
  </calcite-shell>`);
