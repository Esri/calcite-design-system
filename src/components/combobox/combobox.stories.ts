...
export const ScrollHomeEnd = stepStory(
  ...
  createSteps("calcite-combobox")
    ...
    .focus("#myCombobox")
    .snapshot("inFocus")
    .keys("calcite-combobox", "End")
    .snapshot("ScrollToEnd")
    .keys("calcite-combobox", "Home")
    .snapshot("ScrollHome")
);

export const ComboboxOverflow = stepStory(
  (): string => html`
    <calcite-combobox
      id="myCombobox"
      label="ScrollHomeEnd Combobox"
  ...
  createSteps("calcite-combobox")
    ...
    .snapshot("inFocus")
    .keys("calcite-combobox", "Home")
    .snapshot("ScrollToHome")
    .press("ArrowDown")
    .snapshot("MoveIntoView")
);
