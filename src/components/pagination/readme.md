...
| `textLabelNext`     | `text-label-next`     | <span style="color:red">**[DEPRECATED]**</span> – translations are now built-in, if you need to override a string, please use `messageOverrides`<br/><br/>Accessible name for the component's next button.     | `string`                                                                                                                                                                                                                                | `undefined` |
| `textLabelPrevious` | `text-label-previous` | <span style="color:red">**[DEPRECATED]**</span> – translations are now built-in, if you need to override a string, please use `messageOverrides`<br/><br/>Accessible name for the component's previous button. | `string`                                                                                                                                                                                                                                | `undefined` |
