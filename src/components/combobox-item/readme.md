...
| `constant`               | `constant`        | <span style="color:red">**[DEPRECATED]**</span> use `filterDisabled` instead.<br/><br/>When `true`, omits the component from the `calcite-combobox` filtered search results. | `boolean` | `undefined` |
