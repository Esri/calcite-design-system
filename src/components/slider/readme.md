...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| `calciteSliderChange` | Fires on when the thumb is released on slider If you need to constantly listen to the drag event, please use calciteSliderInput instead                                                                                                                                                               | `CustomEvent<void>` |
| `calciteSliderInput`  | Fires on all updates to the slider. :warning: Will be fired frequently during drag. If you are performing any expensive operations consider using a debounce or throttle to avoid locking up the main thread.                                                                                         | `CustomEvent<void>` |
| `calciteSliderUpdate` | <span style="color:red">**[DEPRECATED]**</span> use calciteSliderInput instead<br/><br/>Fires on all updates to the slider. :warning: Will be fired frequently during drag. If you are performing any expensive operations consider using a debounce or throttle to avoid locking up the main thread. | `CustomEvent<void>` |
