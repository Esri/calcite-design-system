...
| `placement`                     | `placement`          | Determines where the component will be positioned relative to the referenceElement. | `"left" \| "right" \| "auto" \| "auto-start" \| "auto-end" \| "top-start" \| "top" \| "top-end" \| "right-start" \| "right-end" \| "bottom-end" \| "bottom" \| "bottom-start" \| "left-end" \| "left-start" \| "leading-start" \| "leading" \| "leading-end" \| "trailing-end" \| "trailing" \| "trailing-start"` | `"auto"`    |
