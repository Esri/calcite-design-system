...
(function () {
    ...
    var loadToggles = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    root = window.location.pathname.split("demos").shift();
                    return [4 /*yield*/, window.fetch(root + "demos/toggles.template")];
                case 1:
                    response = _a.sent();
    ...
    var attachHandlers = function () {
        ...
        buttons.forEach(function (button) {
            return button.addEventListener("click", function (event) { return toggleProperty(event.target.dataset.jsId); });
        });
    };
    var components = null;
    var excludedComponents = ["calcite-button"];
