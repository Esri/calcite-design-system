...
"
  >
  ...
  </calcite-shell>`,shellPanelWithTabs=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`<calcite-shell>
  ...
  </calcite-shell>`,panelWithPopoverZIndex=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q` <style>
      #viewDiv {
        padding: 0;
        margin: 0;
        height: 100%;
    ...
    </calcite-popover>`,popoverZIndex=()=>_support_formatting__WEBPACK_IMPORTED_MODULE_1__.q`<calcite-shell>
    <calcite-shell-panel slot="panel-start" position="start" id="shell-panel-start">
      <calcite-action-bar slot="action-bar">
